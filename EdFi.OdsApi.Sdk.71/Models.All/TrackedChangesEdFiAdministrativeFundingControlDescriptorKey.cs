...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_administrativeFundingControlDescriptorKey")]
    public partial class TrackedChangesEdFiAdministrativeFundingControlDescriptorKey : IEquatable<TrackedChangesEdFiAdministrativeFundingControlDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiAdministrativeFundingControlDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiAdministrativeFundingControlDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiAdministrativeFundingControlDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiAdministrativeFundingControlDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiAdministrativeFundingControlDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiAdministrativeFundingControlDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiAdministrativeFundingControlDescriptorKey input)
        {
            if (input == null)
            {
                return false;
