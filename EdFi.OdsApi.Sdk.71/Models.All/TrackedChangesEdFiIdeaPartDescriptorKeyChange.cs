...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_ideaPartDescriptorKeyChange")]
    public partial class TrackedChangesEdFiIdeaPartDescriptorKeyChange : IEquatable<TrackedChangesEdFiIdeaPartDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiIdeaPartDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiIdeaPartDescriptorKey oldKeyValues = default(TrackedChangesEdFiIdeaPartDescriptorKey), TrackedChangesEdFiIdeaPartDescriptorKey newKeyValues = default(TrackedChangesEdFiIdeaPartDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiIdeaPartDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiIdeaPartDescriptorKey NewKeyValues { get; set; }
        ...
        {
            return this.Equals(input as TrackedChangesEdFiIdeaPartDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiIdeaPartDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiIdeaPartDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiIdeaPartDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
