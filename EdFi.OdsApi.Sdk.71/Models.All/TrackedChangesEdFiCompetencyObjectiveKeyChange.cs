...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_competencyObjectiveKeyChange")]
    public partial class TrackedChangesEdFiCompetencyObjectiveKeyChange : IEquatable<TrackedChangesEdFiCompetencyObjectiveKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCompetencyObjectiveKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCompetencyObjectiveKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiCompetencyObjectiveKey oldKeyValues = default(TrackedChangesEdFiCompetencyObjectiveKey), TrackedChangesEdFiCompetencyObjectiveKey newKeyValues = default(TrackedChangesEdFiCompetencyObjectiveKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiCompetencyObjectiveKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiCompetencyObjectiveKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCompetencyObjectiveKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCompetencyObjectiveKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCompetencyObjectiveKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCompetencyObjectiveKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCompetencyObjectiveKeyChange input)
        {
            if (input == null)
            {
                return false;
