...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_surveySectionKeyChange")]
    public partial class TrackedChangesEdFiSurveySectionKeyChange : IEquatable<TrackedChangesEdFiSurveySectionKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiSurveySectionKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiSurveySectionKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiSurveySectionKey oldKeyValues = default(TrackedChangesEdFiSurveySectionKey), TrackedChangesEdFiSurveySectionKey newKeyValues = default(TrackedChangesEdFiSurveySectionKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiSurveySectionKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiSurveySectionKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiSurveySectionKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSurveySectionKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSurveySectionKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSurveySectionKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSurveySectionKeyChange input)
        {
            if (input == null)
            {
                return false;
