...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiBalanceSheetDimensionReference : IEquatable<EdFiBalanceSheetDimensionReference>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiBalanceSheetDimensionReference(string code = default(string), int fiscalYear = default(int), Link link = default(Link))
        {
        ...
        {
            return this.Equals(input as EdFiBalanceSheetDimensionReference);
        }

        /// <summary>
        /// Returns true if EdFiBalanceSheetDimensionReference instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiBalanceSheetDimensionReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiBalanceSheetDimensionReference input)
        {
            if (input == null)
            {
                return false;
