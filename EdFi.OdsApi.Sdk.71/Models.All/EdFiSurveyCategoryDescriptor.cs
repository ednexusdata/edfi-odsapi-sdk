...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_surveyCategoryDescriptor")]
    public partial class EdFiSurveyCategoryDescriptor : IEquatable<EdFiSurveyCategoryDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSurveyCategoryDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiSurveyCategoryDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSurveyCategoryDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="surveyCategoryDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiSurveyCategoryDescriptor(string id = default(string), int surveyCategoryDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiSurveyCategoryDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiSurveyCategoryDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiSurveyCategoryDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "surveyCategoryDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiSurveyCategoryDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  SurveyCategoryDescriptorId: ").Append(SurveyCategoryDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiSurveyCategoryDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiSurveyCategoryDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiSurveyCategoryDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiSurveyCategoryDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.SurveyCategoryDescriptorId == input.SurveyCategoryDescriptorId ||
                    this.SurveyCategoryDescriptorId.Equals(input.SurveyCategoryDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.SurveyCategoryDescriptorId.GetHashCode();
