...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_schoolCategoryDescriptor")]
    public partial class EdFiSchoolCategoryDescriptor : IEquatable<EdFiSchoolCategoryDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSchoolCategoryDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiSchoolCategoryDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSchoolCategoryDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="schoolCategoryDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiSchoolCategoryDescriptor(string id = default(string), int schoolCategoryDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiSchoolCategoryDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiSchoolCategoryDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiSchoolCategoryDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "schoolCategoryDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SchoolCategoryDescriptorId: ").Append(SchoolCategoryDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiSchoolCategoryDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiSchoolCategoryDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiSchoolCategoryDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiSchoolCategoryDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.SchoolCategoryDescriptorId == input.SchoolCategoryDescriptorId ||
                    this.SchoolCategoryDescriptorId.Equals(input.SchoolCategoryDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.SchoolCategoryDescriptorId.GetHashCode();
