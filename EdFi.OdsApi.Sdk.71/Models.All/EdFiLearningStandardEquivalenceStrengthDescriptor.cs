...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_learningStandardEquivalenceStrengthDescriptor")]
    public partial class EdFiLearningStandardEquivalenceStrengthDescriptor : IEquatable<EdFiLearningStandardEquivalenceStrengthDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiLearningStandardEquivalenceStrengthDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiLearningStandardEquivalenceStrengthDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiLearningStandardEquivalenceStrengthDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="learningStandardEquivalenceStrengthDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiLearningStandardEquivalenceStrengthDescriptor(string id = default(string), int learningStandardEquivalenceStrengthDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiLearningStandardEquivalenceStrengthDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiLearningStandardEquivalenceStrengthDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiLearningStandardEquivalenceStrengthDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.LearningStandardEquivalenceStrengthDescriptorId = learningStandardEquivalenceStrengthDescriptorId;
        ...
        [DataMember(Name = "learningStandardEquivalenceStrengthDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiLearningStandardEquivalenceStrengthDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  LearningStandardEquivalenceStrengthDescriptorId: ").Append(LearningStandardEquivalenceStrengthDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiLearningStandardEquivalenceStrengthDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiLearningStandardEquivalenceStrengthDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiLearningStandardEquivalenceStrengthDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiLearningStandardEquivalenceStrengthDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.LearningStandardEquivalenceStrengthDescriptorId == input.LearningStandardEquivalenceStrengthDescriptorId ||
                    this.LearningStandardEquivalenceStrengthDescriptorId.Equals(input.LearningStandardEquivalenceStrengthDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.LearningStandardEquivalenceStrengthDescriptorId.GetHashCode();
