...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_reporterDescriptionDescriptorKeyChange")]
    public partial class TrackedChangesEdFiReporterDescriptionDescriptorKeyChange : IEquatable<TrackedChangesEdFiReporterDescriptionDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiReporterDescriptionDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiReporterDescriptionDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiReporterDescriptionDescriptorKey oldKeyValues = default(TrackedChangesEdFiReporterDescriptionDescriptorKey), TrackedChangesEdFiReporterDescriptionDescriptorKey newKeyValues = default(TrackedChangesEdFiReporterDescriptionDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiReporterDescriptionDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiReporterDescriptionDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiReporterDescriptionDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiReporterDescriptionDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiReporterDescriptionDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiReporterDescriptionDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiReporterDescriptionDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
