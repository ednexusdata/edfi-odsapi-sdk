...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_attemptStatusDescriptor")]
    public partial class EdFiAttemptStatusDescriptor : IEquatable<EdFiAttemptStatusDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAttemptStatusDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiAttemptStatusDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAttemptStatusDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="attemptStatusDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiAttemptStatusDescriptor(string id = default(string), int attemptStatusDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiAttemptStatusDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiAttemptStatusDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiAttemptStatusDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "attemptStatusDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AttemptStatusDescriptorId: ").Append(AttemptStatusDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiAttemptStatusDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiAttemptStatusDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiAttemptStatusDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiAttemptStatusDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AttemptStatusDescriptorId == input.AttemptStatusDescriptorId ||
                    this.AttemptStatusDescriptorId.Equals(input.AttemptStatusDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.AttemptStatusDescriptorId.GetHashCode();
