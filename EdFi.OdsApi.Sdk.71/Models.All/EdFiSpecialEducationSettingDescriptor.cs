...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_specialEducationSettingDescriptor")]
    public partial class EdFiSpecialEducationSettingDescriptor : IEquatable<EdFiSpecialEducationSettingDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSpecialEducationSettingDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiSpecialEducationSettingDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSpecialEducationSettingDescriptor" /> class.
        /// </summary>
        ...
        public EdFiSpecialEducationSettingDescriptor(string id = default(string), int specialEducationSettingDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiSpecialEducationSettingDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiSpecialEducationSettingDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiSpecialEducationSettingDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "specialEducationSettingDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SpecialEducationSettingDescriptorId: ").Append(SpecialEducationSettingDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiSpecialEducationSettingDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiSpecialEducationSettingDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiSpecialEducationSettingDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiSpecialEducationSettingDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.SpecialEducationSettingDescriptorId == input.SpecialEducationSettingDescriptorId ||
                    this.SpecialEducationSettingDescriptorId.Equals(input.SpecialEducationSettingDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.SpecialEducationSettingDescriptorId.GetHashCode();
