...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_separationReasonDescriptorKeyChange")]
    public partial class TrackedChangesEdFiSeparationReasonDescriptorKeyChange : IEquatable<TrackedChangesEdFiSeparationReasonDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiSeparationReasonDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiSeparationReasonDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiSeparationReasonDescriptorKey oldKeyValues = default(TrackedChangesEdFiSeparationReasonDescriptorKey), TrackedChangesEdFiSeparationReasonDescriptorKey newKeyValues = default(TrackedChangesEdFiSeparationReasonDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiSeparationReasonDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiSeparationReasonDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiSeparationReasonDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSeparationReasonDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSeparationReasonDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSeparationReasonDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSeparationReasonDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
