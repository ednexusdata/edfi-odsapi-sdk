...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_entryGradeLevelReasonDescriptorKeyChange")]
    public partial class TrackedChangesEdFiEntryGradeLevelReasonDescriptorKeyChange : IEquatable<TrackedChangesEdFiEntryGradeLevelReasonDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiEntryGradeLevelReasonDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiEntryGradeLevelReasonDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiEntryGradeLevelReasonDescriptorKey oldKeyValues = default(TrackedChangesEdFiEntryGradeLevelReasonDescriptorKey), TrackedChangesEdFiEntryGradeLevelReasonDescriptorKey newKeyValues = default(TrackedChangesEdFiEntryGradeLevelReasonDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiEntryGradeLevelReasonDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiEntryGradeLevelReasonDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiEntryGradeLevelReasonDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiEntryGradeLevelReasonDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiEntryGradeLevelReasonDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiEntryGradeLevelReasonDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiEntryGradeLevelReasonDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
