...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiEducationOrganizationPeerAssociation : IEquatable<EdFiEducationOrganizationPeerAssociation>, IValidatableObject
    {
        ...
        public EdFiEducationOrganizationPeerAssociation(string id = default(string), EdFiEducationOrganizationReference educationOrganizationReference = default(EdFiEducationOrganizationReference), EdFiEducationOrganizationReference peerEducationOrganizationReference = default(EdFiEducationOrganizationReference), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
