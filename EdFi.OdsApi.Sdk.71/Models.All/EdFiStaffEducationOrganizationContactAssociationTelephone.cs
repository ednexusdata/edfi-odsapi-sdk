...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiStaffEducationOrganizationContactAssociationTelephone : IEquatable<EdFiStaffEducationOrganizationContactAssociationTelephone>, IValidatableObject
    {
        ...
        public EdFiStaffEducationOrganizationContactAssociationTelephone(string telephoneNumberTypeDescriptor = default(string), string telephoneNumber = default(string), bool? doNotPublishIndicator = default(bool?), int? orderOfPriority = default(int?), bool? textMessageCapabilityIndicator = default(bool?))
        {
            ...
            {
                throw new ArgumentNullException("telephoneNumberTypeDescriptor is a required property for EdFiStaffEducationOrganizationContactAssociationTelephone and cannot be null");
            }
            this.TelephoneNumberTypeDescriptor = telephoneNumberTypeDescriptor;
            // to ensure "telephoneNumber" is required (not null)
            if (telephoneNumber == null)
            {
                throw new ArgumentNullException("telephoneNumber is a required property for EdFiStaffEducationOrganizationContactAssociationTelephone and cannot be null");
            }
