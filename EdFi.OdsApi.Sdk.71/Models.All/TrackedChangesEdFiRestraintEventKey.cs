...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_restraintEventKey")]
    public partial class TrackedChangesEdFiRestraintEventKey : IEquatable<TrackedChangesEdFiRestraintEventKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiRestraintEventKey(string restraintEventIdentifier = default(string), long schoolId = default(long), string studentUniqueId = default(string))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiRestraintEventKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiRestraintEventKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiRestraintEventKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiRestraintEventKey input)
        {
            if (input == null)
            {
                return false;
