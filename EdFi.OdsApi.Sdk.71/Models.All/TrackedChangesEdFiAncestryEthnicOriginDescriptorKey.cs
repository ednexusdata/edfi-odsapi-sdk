...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_ancestryEthnicOriginDescriptorKey")]
    public partial class TrackedChangesEdFiAncestryEthnicOriginDescriptorKey : IEquatable<TrackedChangesEdFiAncestryEthnicOriginDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiAncestryEthnicOriginDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiAncestryEthnicOriginDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiAncestryEthnicOriginDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiAncestryEthnicOriginDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiAncestryEthnicOriginDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiAncestryEthnicOriginDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiAncestryEthnicOriginDescriptorKey input)
        {
            if (input == null)
            {
                return false;
