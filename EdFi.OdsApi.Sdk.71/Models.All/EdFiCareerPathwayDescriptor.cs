...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_careerPathwayDescriptor")]
    public partial class EdFiCareerPathwayDescriptor : IEquatable<EdFiCareerPathwayDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCareerPathwayDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiCareerPathwayDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCareerPathwayDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="careerPathwayDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        [DataMember(Name = "careerPathwayDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CareerPathwayDescriptorId: ").Append(CareerPathwayDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiCareerPathwayDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiCareerPathwayDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiCareerPathwayDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiCareerPathwayDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CareerPathwayDescriptorId == input.CareerPathwayDescriptorId ||
                    this.CareerPathwayDescriptorId.Equals(input.CareerPathwayDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.CareerPathwayDescriptorId.GetHashCode();
