...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_postSecondaryInstitutionLevelDescriptor")]
    public partial class EdFiPostSecondaryInstitutionLevelDescriptor : IEquatable<EdFiPostSecondaryInstitutionLevelDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiPostSecondaryInstitutionLevelDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiPostSecondaryInstitutionLevelDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiPostSecondaryInstitutionLevelDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="postSecondaryInstitutionLevelDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiPostSecondaryInstitutionLevelDescriptor(string id = default(string), int postSecondaryInstitutionLevelDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiPostSecondaryInstitutionLevelDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiPostSecondaryInstitutionLevelDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiPostSecondaryInstitutionLevelDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "postSecondaryInstitutionLevelDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PostSecondaryInstitutionLevelDescriptorId: ").Append(PostSecondaryInstitutionLevelDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiPostSecondaryInstitutionLevelDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiPostSecondaryInstitutionLevelDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiPostSecondaryInstitutionLevelDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiPostSecondaryInstitutionLevelDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.PostSecondaryInstitutionLevelDescriptorId == input.PostSecondaryInstitutionLevelDescriptorId ||
                    this.PostSecondaryInstitutionLevelDescriptorId.Equals(input.PostSecondaryInstitutionLevelDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.PostSecondaryInstitutionLevelDescriptorId.GetHashCode();
