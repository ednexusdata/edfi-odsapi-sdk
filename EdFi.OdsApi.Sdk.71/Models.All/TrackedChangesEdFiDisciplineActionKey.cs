...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TrackedChangesEdFiDisciplineActionKey : IEquatable<TrackedChangesEdFiDisciplineActionKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiDisciplineActionKey(string disciplineActionIdentifier = default(string), DateTime disciplineDate = default(DateTime), string studentUniqueId = default(string))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiDisciplineActionKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiDisciplineActionKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiDisciplineActionKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiDisciplineActionKey input)
        {
            if (input == null)
            {
                return false;
