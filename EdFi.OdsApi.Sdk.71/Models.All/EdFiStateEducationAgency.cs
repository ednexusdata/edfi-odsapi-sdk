...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiStateEducationAgency : IEquatable<EdFiStateEducationAgency>, IValidatableObject
    {
        ...
        public EdFiStateEducationAgency(string id = default(string), List<EdFiEducationOrganizationCategory> categories = default(List<EdFiEducationOrganizationCategory>), long stateEducationAgencyId = default(long), List<EdFiStateEducationAgencyAccountability> accountabilities = default(List<EdFiStateEducationAgencyAccountability>), List<EdFiEducationOrganizationAddress> addresses = default(List<EdFiEducationOrganizationAddress>), List<EdFiStateEducationAgencyFederalFunds> federalFunds = default(List<EdFiStateEducationAgencyFederalFunds>), List<EdFiEducationOrganizationIdentificationCode> identificationCodes = default(List<EdFiEducationOrganizationIdentificationCode>), List<EdFiEducationOrganizationIndicator> indicators = default(List<EdFiEducationOrganizationIndicator>), List<EdFiEducationOrganizationInstitutionTelephone> institutionTelephones = default(List<EdFiEducationOrganizationInstitutionTelephone>), List<EdFiEducationOrganizationInternationalAddress> internationalAddresses = default(List<EdFiEducationOrganizationInternationalAddress>), string nameOfInstitution = default(string), string operationalStatusDescriptor = default(string), string shortNameOfInstitution = default(string), string webSite = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "categories" is required (not null)
            if (categories == null)
            {
                throw new ArgumentNullException("categories is a required property for EdFiStateEducationAgency and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("nameOfInstitution is a required property for EdFiStateEducationAgency and cannot be null");
            }
        ...
        [DataMember(Name = "stateEducationAgencyId", IsRequired = true, EmitDefaultValue = true)]
