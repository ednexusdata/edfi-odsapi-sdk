...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiSurveyQuestionReference : IEquatable<EdFiSurveyQuestionReference>, IValidatableObject
    {
        ...
        public EdFiSurveyQuestionReference(string _namespace = default(string), string questionCode = default(string), string surveyIdentifier = default(string), Link link = default(Link))
        {
            ...
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiSurveyQuestionReference and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "questionCode" is required (not null)
            if (questionCode == null)
            {
                throw new ArgumentNullException("questionCode is a required property for EdFiSurveyQuestionReference and cannot be null");
            }
            this.QuestionCode = questionCode;
            // to ensure "surveyIdentifier" is required (not null)
            if (surveyIdentifier == null)
            {
                throw new ArgumentNullException("surveyIdentifier is a required property for EdFiSurveyQuestionReference and cannot be null");
            }
