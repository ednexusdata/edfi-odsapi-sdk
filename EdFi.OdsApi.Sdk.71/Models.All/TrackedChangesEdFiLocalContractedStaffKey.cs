...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_localContractedStaffKey")]
    public partial class TrackedChangesEdFiLocalContractedStaffKey : IEquatable<TrackedChangesEdFiLocalContractedStaffKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiLocalContractedStaffKey(DateTime asOfDate = default(DateTime), string accountIdentifier = default(string), long educationOrganizationId = default(long), int fiscalYear = default(int), string staffUniqueId = default(string))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiLocalContractedStaffKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiLocalContractedStaffKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiLocalContractedStaffKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiLocalContractedStaffKey input)
        {
            if (input == null)
            {
                return false;
