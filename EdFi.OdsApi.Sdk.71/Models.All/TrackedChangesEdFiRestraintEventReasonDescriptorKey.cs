...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_restraintEventReasonDescriptorKey")]
    public partial class TrackedChangesEdFiRestraintEventReasonDescriptorKey : IEquatable<TrackedChangesEdFiRestraintEventReasonDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiRestraintEventReasonDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiRestraintEventReasonDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiRestraintEventReasonDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiRestraintEventReasonDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiRestraintEventReasonDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiRestraintEventReasonDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiRestraintEventReasonDescriptorKey input)
        {
            if (input == null)
            {
                return false;
