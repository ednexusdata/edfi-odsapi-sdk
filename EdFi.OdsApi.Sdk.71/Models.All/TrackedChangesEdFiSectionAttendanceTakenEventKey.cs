...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TrackedChangesEdFiSectionAttendanceTakenEventKey : IEquatable<TrackedChangesEdFiSectionAttendanceTakenEventKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiSectionAttendanceTakenEventKey(string calendarCode = default(string), DateTime date = default(DateTime), long schoolId = default(long), int schoolYear = default(int), string localCourseCode = default(string), string sectionIdentifier = default(string), string sessionName = default(string))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSectionAttendanceTakenEventKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSectionAttendanceTakenEventKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSectionAttendanceTakenEventKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSectionAttendanceTakenEventKey input)
        {
            if (input == null)
            {
                return false;
