...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_weaponDescriptorKey")]
    public partial class TrackedChangesEdFiWeaponDescriptorKey : IEquatable<TrackedChangesEdFiWeaponDescriptorKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiWeaponDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiWeaponDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiWeaponDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiWeaponDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiWeaponDescriptorKey input)
        {
            if (input == null)
            {
                return false;
