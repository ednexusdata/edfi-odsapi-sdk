...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_modelEntityDescriptor")]
    public partial class EdFiModelEntityDescriptor : IEquatable<EdFiModelEntityDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiModelEntityDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiModelEntityDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiModelEntityDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="modelEntityDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiModelEntityDescriptor(string id = default(string), int modelEntityDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiModelEntityDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiModelEntityDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiModelEntityDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.ModelEntityDescriptorId = modelEntityDescriptorId;
        ...
        [DataMember(Name = "modelEntityDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiModelEntityDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  ModelEntityDescriptorId: ").Append(ModelEntityDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiModelEntityDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiModelEntityDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiModelEntityDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiModelEntityDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ModelEntityDescriptorId == input.ModelEntityDescriptorId ||
                    this.ModelEntityDescriptorId.Equals(input.ModelEntityDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ModelEntityDescriptorId.GetHashCode();
