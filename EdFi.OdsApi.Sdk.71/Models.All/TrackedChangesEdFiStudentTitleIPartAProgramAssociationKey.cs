...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_studentTitleIPartAProgramAssociationKey")]
    public partial class TrackedChangesEdFiStudentTitleIPartAProgramAssociationKey : IEquatable<TrackedChangesEdFiStudentTitleIPartAProgramAssociationKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiStudentTitleIPartAProgramAssociationKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiStudentTitleIPartAProgramAssociationKey(DateTime beginDate = default(DateTime), long educationOrganizationId = default(long), long programEducationOrganizationId = default(long), string programName = default(string), string programTypeDescriptor = default(string), string studentUniqueId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiStudentTitleIPartAProgramAssociationKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStudentTitleIPartAProgramAssociationKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStudentTitleIPartAProgramAssociationKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStudentTitleIPartAProgramAssociationKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStudentTitleIPartAProgramAssociationKey input)
        {
            if (input == null)
            {
                return false;
