...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_costRateDescriptor")]
    public partial class EdFiCostRateDescriptor : IEquatable<EdFiCostRateDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCostRateDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiCostRateDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCostRateDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="costRateDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiCostRateDescriptor(string id = default(string), int costRateDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiCostRateDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiCostRateDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiCostRateDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "costRateDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CostRateDescriptorId: ").Append(CostRateDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiCostRateDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiCostRateDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiCostRateDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiCostRateDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CostRateDescriptorId == input.CostRateDescriptorId ||
                    this.CostRateDescriptorId.Equals(input.CostRateDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.CostRateDescriptorId.GetHashCode();
