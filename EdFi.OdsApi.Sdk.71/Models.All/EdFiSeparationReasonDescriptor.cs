...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_separationReasonDescriptor")]
    public partial class EdFiSeparationReasonDescriptor : IEquatable<EdFiSeparationReasonDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSeparationReasonDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiSeparationReasonDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSeparationReasonDescriptor" /> class.
        /// </summary>
        ...
        public EdFiSeparationReasonDescriptor(string id = default(string), int separationReasonDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiSeparationReasonDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiSeparationReasonDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiSeparationReasonDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "separationReasonDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SeparationReasonDescriptorId: ").Append(SeparationReasonDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiSeparationReasonDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiSeparationReasonDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiSeparationReasonDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiSeparationReasonDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.SeparationReasonDescriptorId == input.SeparationReasonDescriptorId ||
                    this.SeparationReasonDescriptorId.Equals(input.SeparationReasonDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.SeparationReasonDescriptorId.GetHashCode();
