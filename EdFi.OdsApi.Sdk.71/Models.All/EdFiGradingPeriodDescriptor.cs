...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_gradingPeriodDescriptor")]
    public partial class EdFiGradingPeriodDescriptor : IEquatable<EdFiGradingPeriodDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiGradingPeriodDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiGradingPeriodDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiGradingPeriodDescriptor" /> class.
        /// </summary>
        ...
        public EdFiGradingPeriodDescriptor(string id = default(string), int gradingPeriodDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiGradingPeriodDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiGradingPeriodDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiGradingPeriodDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "gradingPeriodDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  GradingPeriodDescriptorId: ").Append(GradingPeriodDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiGradingPeriodDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiGradingPeriodDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiGradingPeriodDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiGradingPeriodDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.GradingPeriodDescriptorId == input.GradingPeriodDescriptorId ||
                    this.GradingPeriodDescriptorId.Equals(input.GradingPeriodDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.GradingPeriodDescriptorId.GetHashCode();
