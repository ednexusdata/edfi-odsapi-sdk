...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_stateAbbreviationDescriptor")]
    public partial class EdFiStateAbbreviationDescriptor : IEquatable<EdFiStateAbbreviationDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStateAbbreviationDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiStateAbbreviationDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStateAbbreviationDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="stateAbbreviationDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiStateAbbreviationDescriptor(string id = default(string), int stateAbbreviationDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiStateAbbreviationDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiStateAbbreviationDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiStateAbbreviationDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "stateAbbreviationDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  StateAbbreviationDescriptorId: ").Append(StateAbbreviationDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiStateAbbreviationDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiStateAbbreviationDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStateAbbreviationDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStateAbbreviationDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.StateAbbreviationDescriptorId == input.StateAbbreviationDescriptorId ||
                    this.StateAbbreviationDescriptorId.Equals(input.StateAbbreviationDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.StateAbbreviationDescriptorId.GetHashCode();
