...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_courseAttemptResultDescriptorKey")]
    public partial class TrackedChangesEdFiCourseAttemptResultDescriptorKey : IEquatable<TrackedChangesEdFiCourseAttemptResultDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCourseAttemptResultDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCourseAttemptResultDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCourseAttemptResultDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCourseAttemptResultDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCourseAttemptResultDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCourseAttemptResultDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCourseAttemptResultDescriptorKey input)
        {
            if (input == null)
            {
                return false;
