...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_localEncumbranceKey")]
    public partial class TrackedChangesEdFiLocalEncumbranceKey : IEquatable<TrackedChangesEdFiLocalEncumbranceKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiLocalEncumbranceKey(DateTime asOfDate = default(DateTime), string accountIdentifier = default(string), long educationOrganizationId = default(long), int fiscalYear = default(int))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiLocalEncumbranceKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiLocalEncumbranceKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiLocalEncumbranceKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiLocalEncumbranceKey input)
        {
            if (input == null)
            {
                return false;
