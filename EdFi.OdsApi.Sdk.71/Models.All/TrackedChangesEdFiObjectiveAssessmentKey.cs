...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_objectiveAssessmentKey")]
    public partial class TrackedChangesEdFiObjectiveAssessmentKey : IEquatable<TrackedChangesEdFiObjectiveAssessmentKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiObjectiveAssessmentKey(string identificationCode = default(string), string assessmentIdentifier = default(string), string _namespace = default(string))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiObjectiveAssessmentKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiObjectiveAssessmentKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiObjectiveAssessmentKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiObjectiveAssessmentKey input)
        {
            if (input == null)
            {
                return false;
