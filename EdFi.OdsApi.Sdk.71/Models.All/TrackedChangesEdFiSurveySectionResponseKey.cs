...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_surveySectionResponseKey")]
    public partial class TrackedChangesEdFiSurveySectionResponseKey : IEquatable<TrackedChangesEdFiSurveySectionResponseKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiSurveySectionResponseKey(string _namespace = default(string), string surveyIdentifier = default(string), string surveyResponseIdentifier = default(string), string surveySectionTitle = default(string))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSurveySectionResponseKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSurveySectionResponseKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSurveySectionResponseKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSurveySectionResponseKey input)
        {
            if (input == null)
            {
                return false;
