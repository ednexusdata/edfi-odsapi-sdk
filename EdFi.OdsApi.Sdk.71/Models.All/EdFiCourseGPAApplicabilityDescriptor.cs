...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_courseGPAApplicabilityDescriptor")]
    public partial class EdFiCourseGPAApplicabilityDescriptor : IEquatable<EdFiCourseGPAApplicabilityDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCourseGPAApplicabilityDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiCourseGPAApplicabilityDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCourseGPAApplicabilityDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="courseGPAApplicabilityDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiCourseGPAApplicabilityDescriptor(string id = default(string), int courseGPAApplicabilityDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiCourseGPAApplicabilityDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiCourseGPAApplicabilityDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiCourseGPAApplicabilityDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "courseGPAApplicabilityDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CourseGPAApplicabilityDescriptorId: ").Append(CourseGPAApplicabilityDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiCourseGPAApplicabilityDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiCourseGPAApplicabilityDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiCourseGPAApplicabilityDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiCourseGPAApplicabilityDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CourseGPAApplicabilityDescriptorId == input.CourseGPAApplicabilityDescriptorId ||
                    this.CourseGPAApplicabilityDescriptorId.Equals(input.CourseGPAApplicabilityDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.CourseGPAApplicabilityDescriptorId.GetHashCode();
