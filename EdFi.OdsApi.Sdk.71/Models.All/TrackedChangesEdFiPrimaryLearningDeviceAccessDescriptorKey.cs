...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_primaryLearningDeviceAccessDescriptorKey")]
    public partial class TrackedChangesEdFiPrimaryLearningDeviceAccessDescriptorKey : IEquatable<TrackedChangesEdFiPrimaryLearningDeviceAccessDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiPrimaryLearningDeviceAccessDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiPrimaryLearningDeviceAccessDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiPrimaryLearningDeviceAccessDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiPrimaryLearningDeviceAccessDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiPrimaryLearningDeviceAccessDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiPrimaryLearningDeviceAccessDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiPrimaryLearningDeviceAccessDescriptorKey input)
        {
            if (input == null)
            {
                return false;
