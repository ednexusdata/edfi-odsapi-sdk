...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_enrollmentTypeDescriptor")]
    public partial class EdFiEnrollmentTypeDescriptor : IEquatable<EdFiEnrollmentTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiEnrollmentTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiEnrollmentTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiEnrollmentTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="enrollmentTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiEnrollmentTypeDescriptor(string id = default(string), int enrollmentTypeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiEnrollmentTypeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiEnrollmentTypeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiEnrollmentTypeDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.EnrollmentTypeDescriptorId = enrollmentTypeDescriptorId;
        ...
        [DataMember(Name = "enrollmentTypeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiEnrollmentTypeDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  EnrollmentTypeDescriptorId: ").Append(EnrollmentTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiEnrollmentTypeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiEnrollmentTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiEnrollmentTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiEnrollmentTypeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.EnrollmentTypeDescriptorId == input.EnrollmentTypeDescriptorId ||
                    this.EnrollmentTypeDescriptorId.Equals(input.EnrollmentTypeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.EnrollmentTypeDescriptorId.GetHashCode();
