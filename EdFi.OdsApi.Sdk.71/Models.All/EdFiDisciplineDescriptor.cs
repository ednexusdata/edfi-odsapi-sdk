...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_disciplineDescriptor")]
    public partial class EdFiDisciplineDescriptor : IEquatable<EdFiDisciplineDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiDisciplineDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiDisciplineDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiDisciplineDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="disciplineDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiDisciplineDescriptor(string id = default(string), int disciplineDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiDisciplineDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiDisciplineDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiDisciplineDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "disciplineDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DisciplineDescriptorId: ").Append(DisciplineDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiDisciplineDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiDisciplineDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiDisciplineDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiDisciplineDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.DisciplineDescriptorId == input.DisciplineDescriptorId ||
                    this.DisciplineDescriptorId.Equals(input.DisciplineDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.DisciplineDescriptorId.GetHashCode();
