...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_assessmentIdentificationSystemDescriptor")]
    public partial class EdFiAssessmentIdentificationSystemDescriptor : IEquatable<EdFiAssessmentIdentificationSystemDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAssessmentIdentificationSystemDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiAssessmentIdentificationSystemDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAssessmentIdentificationSystemDescriptor" /> class.
        /// </summary>
        ...
        public EdFiAssessmentIdentificationSystemDescriptor(string id = default(string), int assessmentIdentificationSystemDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiAssessmentIdentificationSystemDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiAssessmentIdentificationSystemDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiAssessmentIdentificationSystemDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "assessmentIdentificationSystemDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AssessmentIdentificationSystemDescriptorId: ").Append(AssessmentIdentificationSystemDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiAssessmentIdentificationSystemDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiAssessmentIdentificationSystemDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiAssessmentIdentificationSystemDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiAssessmentIdentificationSystemDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AssessmentIdentificationSystemDescriptorId == input.AssessmentIdentificationSystemDescriptorId ||
                    this.AssessmentIdentificationSystemDescriptorId.Equals(input.AssessmentIdentificationSystemDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.AssessmentIdentificationSystemDescriptorId.GetHashCode();
