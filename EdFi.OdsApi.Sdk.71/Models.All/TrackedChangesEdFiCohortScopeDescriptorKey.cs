...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_cohortScopeDescriptorKey")]
    public partial class TrackedChangesEdFiCohortScopeDescriptorKey : IEquatable<TrackedChangesEdFiCohortScopeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCohortScopeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCohortScopeDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCohortScopeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCohortScopeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCohortScopeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCohortScopeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCohortScopeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
