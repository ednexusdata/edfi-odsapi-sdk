...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_programSponsorDescriptor")]
    public partial class EdFiProgramSponsorDescriptor : IEquatable<EdFiProgramSponsorDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiProgramSponsorDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiProgramSponsorDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiProgramSponsorDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="programSponsorDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiProgramSponsorDescriptor(string id = default(string), int programSponsorDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiProgramSponsorDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiProgramSponsorDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiProgramSponsorDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "programSponsorDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ProgramSponsorDescriptorId: ").Append(ProgramSponsorDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiProgramSponsorDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiProgramSponsorDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiProgramSponsorDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiProgramSponsorDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ProgramSponsorDescriptorId == input.ProgramSponsorDescriptorId ||
                    this.ProgramSponsorDescriptorId.Equals(input.ProgramSponsorDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ProgramSponsorDescriptorId.GetHashCode();
