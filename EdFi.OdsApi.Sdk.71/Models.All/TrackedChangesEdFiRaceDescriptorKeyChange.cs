...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_raceDescriptorKeyChange")]
    public partial class TrackedChangesEdFiRaceDescriptorKeyChange : IEquatable<TrackedChangesEdFiRaceDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiRaceDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiRaceDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiRaceDescriptorKey oldKeyValues = default(TrackedChangesEdFiRaceDescriptorKey), TrackedChangesEdFiRaceDescriptorKey newKeyValues = default(TrackedChangesEdFiRaceDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiRaceDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiRaceDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiRaceDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiRaceDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiRaceDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiRaceDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiRaceDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
