...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_licenseTypeDescriptor")]
    public partial class EdFiLicenseTypeDescriptor : IEquatable<EdFiLicenseTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiLicenseTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiLicenseTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiLicenseTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="licenseTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiLicenseTypeDescriptor(string id = default(string), int licenseTypeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiLicenseTypeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiLicenseTypeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiLicenseTypeDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "licenseTypeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  LicenseTypeDescriptorId: ").Append(LicenseTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiLicenseTypeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiLicenseTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiLicenseTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiLicenseTypeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.LicenseTypeDescriptorId == input.LicenseTypeDescriptorId ||
                    this.LicenseTypeDescriptorId.Equals(input.LicenseTypeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.LicenseTypeDescriptorId.GetHashCode();
