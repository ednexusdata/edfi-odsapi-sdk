...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_disabilityDeterminationSourceTypeDescriptorKey")]
    public partial class TrackedChangesEdFiDisabilityDeterminationSourceTypeDescriptorKey : IEquatable<TrackedChangesEdFiDisabilityDeterminationSourceTypeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiDisabilityDeterminationSourceTypeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiDisabilityDeterminationSourceTypeDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiDisabilityDeterminationSourceTypeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiDisabilityDeterminationSourceTypeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiDisabilityDeterminationSourceTypeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiDisabilityDeterminationSourceTypeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiDisabilityDeterminationSourceTypeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
