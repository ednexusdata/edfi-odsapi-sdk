...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiLocalEncumbrance : IEquatable<EdFiLocalEncumbrance>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as EdFiLocalEncumbrance);
        }

        /// <summary>
        /// Returns true if EdFiLocalEncumbrance instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiLocalEncumbrance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiLocalEncumbrance input)
        {
            if (input == null)
            {
                return false;
