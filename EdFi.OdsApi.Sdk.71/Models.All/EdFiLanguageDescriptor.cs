...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_languageDescriptor")]
    public partial class EdFiLanguageDescriptor : IEquatable<EdFiLanguageDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiLanguageDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiLanguageDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiLanguageDescriptor" /> class.
        /// </summary>
        ...
        public EdFiLanguageDescriptor(string id = default(string), int languageDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiLanguageDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiLanguageDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiLanguageDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "languageDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  LanguageDescriptorId: ").Append(LanguageDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiLanguageDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiLanguageDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiLanguageDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiLanguageDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.LanguageDescriptorId == input.LanguageDescriptorId ||
                    this.LanguageDescriptorId.Equals(input.LanguageDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.LanguageDescriptorId.GetHashCode();
