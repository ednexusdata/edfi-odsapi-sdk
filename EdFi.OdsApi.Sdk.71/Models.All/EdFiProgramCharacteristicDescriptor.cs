...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_programCharacteristicDescriptor")]
    public partial class EdFiProgramCharacteristicDescriptor : IEquatable<EdFiProgramCharacteristicDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiProgramCharacteristicDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiProgramCharacteristicDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiProgramCharacteristicDescriptor" /> class.
        /// </summary>
        ...
        public EdFiProgramCharacteristicDescriptor(string id = default(string), int programCharacteristicDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiProgramCharacteristicDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiProgramCharacteristicDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiProgramCharacteristicDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "programCharacteristicDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ProgramCharacteristicDescriptorId: ").Append(ProgramCharacteristicDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiProgramCharacteristicDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiProgramCharacteristicDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiProgramCharacteristicDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiProgramCharacteristicDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ProgramCharacteristicDescriptorId == input.ProgramCharacteristicDescriptorId ||
                    this.ProgramCharacteristicDescriptorId.Equals(input.ProgramCharacteristicDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ProgramCharacteristicDescriptorId.GetHashCode();
