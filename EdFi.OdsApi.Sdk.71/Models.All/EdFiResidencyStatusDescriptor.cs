...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_residencyStatusDescriptor")]
    public partial class EdFiResidencyStatusDescriptor : IEquatable<EdFiResidencyStatusDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiResidencyStatusDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiResidencyStatusDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiResidencyStatusDescriptor" /> class.
        /// </summary>
        ...
        public EdFiResidencyStatusDescriptor(string id = default(string), int residencyStatusDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiResidencyStatusDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiResidencyStatusDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiResidencyStatusDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "residencyStatusDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ResidencyStatusDescriptorId: ").Append(ResidencyStatusDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiResidencyStatusDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiResidencyStatusDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiResidencyStatusDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiResidencyStatusDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ResidencyStatusDescriptorId == input.ResidencyStatusDescriptorId ||
                    this.ResidencyStatusDescriptorId.Equals(input.ResidencyStatusDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ResidencyStatusDescriptorId.GetHashCode();
