...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_visaDescriptorKey")]
    public partial class TrackedChangesEdFiVisaDescriptorKey : IEquatable<TrackedChangesEdFiVisaDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiVisaDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiVisaDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiVisaDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiVisaDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiVisaDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiVisaDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiVisaDescriptorKey input)
        {
            if (input == null)
            {
                return false;
