...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_educationOrganizationCategoryDescriptor")]
    public partial class EdFiEducationOrganizationCategoryDescriptor : IEquatable<EdFiEducationOrganizationCategoryDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiEducationOrganizationCategoryDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiEducationOrganizationCategoryDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiEducationOrganizationCategoryDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="educationOrganizationCategoryDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiEducationOrganizationCategoryDescriptor(string id = default(string), int educationOrganizationCategoryDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiEducationOrganizationCategoryDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiEducationOrganizationCategoryDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiEducationOrganizationCategoryDescriptor and cannot be null");
            }
        ...
        {
            return this.Equals(input as EdFiEducationOrganizationCategoryDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiEducationOrganizationCategoryDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiEducationOrganizationCategoryDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiEducationOrganizationCategoryDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.EducationOrganizationCategoryDescriptorId == input.EducationOrganizationCategoryDescriptorId ||
                    this.EducationOrganizationCategoryDescriptorId.Equals(input.EducationOrganizationCategoryDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.EducationOrganizationCategoryDescriptorId.GetHashCode();
