...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_assessmentPeriodDescriptorKey")]
    public partial class TrackedChangesEdFiAssessmentPeriodDescriptorKey : IEquatable<TrackedChangesEdFiAssessmentPeriodDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiAssessmentPeriodDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiAssessmentPeriodDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiAssessmentPeriodDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiAssessmentPeriodDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiAssessmentPeriodDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiAssessmentPeriodDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiAssessmentPeriodDescriptorKey input)
        {
            if (input == null)
            {
                return false;
