...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_homelessProgramServiceDescriptor")]
    public partial class EdFiHomelessProgramServiceDescriptor : IEquatable<EdFiHomelessProgramServiceDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiHomelessProgramServiceDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiHomelessProgramServiceDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiHomelessProgramServiceDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="homelessProgramServiceDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiHomelessProgramServiceDescriptor(string id = default(string), int homelessProgramServiceDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiHomelessProgramServiceDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiHomelessProgramServiceDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiHomelessProgramServiceDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "homelessProgramServiceDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  HomelessProgramServiceDescriptorId: ").Append(HomelessProgramServiceDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiHomelessProgramServiceDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiHomelessProgramServiceDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiHomelessProgramServiceDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiHomelessProgramServiceDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.HomelessProgramServiceDescriptorId == input.HomelessProgramServiceDescriptorId ||
                    this.HomelessProgramServiceDescriptorId.Equals(input.HomelessProgramServiceDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.HomelessProgramServiceDescriptorId.GetHashCode();
