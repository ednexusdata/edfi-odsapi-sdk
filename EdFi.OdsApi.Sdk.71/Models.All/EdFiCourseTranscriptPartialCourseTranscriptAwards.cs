...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiCourseTranscriptPartialCourseTranscriptAwards : IEquatable<EdFiCourseTranscriptPartialCourseTranscriptAwards>, IValidatableObject
    {
        /// <summary>
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NumericGradeEarned, length must be less than 20.", new [] { "NumericGradeEarned" });
            }

            // NumericGradeEarned (string) minLength
            if (this.NumericGradeEarned != null && this.NumericGradeEarned.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NumericGradeEarned, length must be greater than 1.", new [] { "NumericGradeEarned" });
            }
