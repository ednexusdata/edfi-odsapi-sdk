...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_curriculumUsedDescriptorKey")]
    public partial class TrackedChangesEdFiCurriculumUsedDescriptorKey : IEquatable<TrackedChangesEdFiCurriculumUsedDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCurriculumUsedDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCurriculumUsedDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCurriculumUsedDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCurriculumUsedDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCurriculumUsedDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCurriculumUsedDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCurriculumUsedDescriptorKey input)
        {
            if (input == null)
            {
                return false;
