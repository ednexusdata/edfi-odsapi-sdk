...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_credentialFieldDescriptorKeyChange")]
    public partial class TrackedChangesEdFiCredentialFieldDescriptorKeyChange : IEquatable<TrackedChangesEdFiCredentialFieldDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCredentialFieldDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCredentialFieldDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiCredentialFieldDescriptorKey oldKeyValues = default(TrackedChangesEdFiCredentialFieldDescriptorKey), TrackedChangesEdFiCredentialFieldDescriptorKey newKeyValues = default(TrackedChangesEdFiCredentialFieldDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiCredentialFieldDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiCredentialFieldDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCredentialFieldDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCredentialFieldDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCredentialFieldDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCredentialFieldDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCredentialFieldDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
