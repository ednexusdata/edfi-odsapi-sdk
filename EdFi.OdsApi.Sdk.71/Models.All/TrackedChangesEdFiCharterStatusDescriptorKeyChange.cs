...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_charterStatusDescriptorKeyChange")]
    public partial class TrackedChangesEdFiCharterStatusDescriptorKeyChange : IEquatable<TrackedChangesEdFiCharterStatusDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCharterStatusDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCharterStatusDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiCharterStatusDescriptorKey oldKeyValues = default(TrackedChangesEdFiCharterStatusDescriptorKey), TrackedChangesEdFiCharterStatusDescriptorKey newKeyValues = default(TrackedChangesEdFiCharterStatusDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiCharterStatusDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiCharterStatusDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCharterStatusDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCharterStatusDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCharterStatusDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCharterStatusDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCharterStatusDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
