...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "tpdm_coteachingStyleObservedDescriptor")]
    public partial class TpdmCoteachingStyleObservedDescriptor : IEquatable<TpdmCoteachingStyleObservedDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmCoteachingStyleObservedDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmCoteachingStyleObservedDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmCoteachingStyleObservedDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="coteachingStyleObservedDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmCoteachingStyleObservedDescriptor(string id = default(string), int coteachingStyleObservedDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for TpdmCoteachingStyleObservedDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for TpdmCoteachingStyleObservedDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for TpdmCoteachingStyleObservedDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "coteachingStyleObservedDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CoteachingStyleObservedDescriptorId: ").Append(CoteachingStyleObservedDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmCoteachingStyleObservedDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmCoteachingStyleObservedDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmCoteachingStyleObservedDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmCoteachingStyleObservedDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CoteachingStyleObservedDescriptorId == input.CoteachingStyleObservedDescriptorId ||
                    this.CoteachingStyleObservedDescriptorId.Equals(input.CoteachingStyleObservedDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.CoteachingStyleObservedDescriptorId.GetHashCode();
