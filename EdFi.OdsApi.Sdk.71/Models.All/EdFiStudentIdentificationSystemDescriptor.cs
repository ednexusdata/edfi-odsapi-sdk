...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_studentIdentificationSystemDescriptor")]
    public partial class EdFiStudentIdentificationSystemDescriptor : IEquatable<EdFiStudentIdentificationSystemDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentIdentificationSystemDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiStudentIdentificationSystemDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentIdentificationSystemDescriptor" /> class.
        /// </summary>
        ...
        public EdFiStudentIdentificationSystemDescriptor(string id = default(string), int studentIdentificationSystemDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiStudentIdentificationSystemDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiStudentIdentificationSystemDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiStudentIdentificationSystemDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "studentIdentificationSystemDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  StudentIdentificationSystemDescriptorId: ").Append(StudentIdentificationSystemDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiStudentIdentificationSystemDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiStudentIdentificationSystemDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStudentIdentificationSystemDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStudentIdentificationSystemDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.StudentIdentificationSystemDescriptorId == input.StudentIdentificationSystemDescriptorId ||
                    this.StudentIdentificationSystemDescriptorId.Equals(input.StudentIdentificationSystemDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.StudentIdentificationSystemDescriptorId.GetHashCode();
