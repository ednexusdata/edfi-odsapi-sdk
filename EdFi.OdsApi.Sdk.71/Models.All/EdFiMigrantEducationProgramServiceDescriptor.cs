...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_migrantEducationProgramServiceDescriptor")]
    public partial class EdFiMigrantEducationProgramServiceDescriptor : IEquatable<EdFiMigrantEducationProgramServiceDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiMigrantEducationProgramServiceDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiMigrantEducationProgramServiceDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiMigrantEducationProgramServiceDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="migrantEducationProgramServiceDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiMigrantEducationProgramServiceDescriptor(string id = default(string), int migrantEducationProgramServiceDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiMigrantEducationProgramServiceDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiMigrantEducationProgramServiceDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiMigrantEducationProgramServiceDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "migrantEducationProgramServiceDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MigrantEducationProgramServiceDescriptorId: ").Append(MigrantEducationProgramServiceDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiMigrantEducationProgramServiceDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiMigrantEducationProgramServiceDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiMigrantEducationProgramServiceDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiMigrantEducationProgramServiceDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.MigrantEducationProgramServiceDescriptorId == input.MigrantEducationProgramServiceDescriptorId ||
                    this.MigrantEducationProgramServiceDescriptorId.Equals(input.MigrantEducationProgramServiceDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.MigrantEducationProgramServiceDescriptorId.GetHashCode();
