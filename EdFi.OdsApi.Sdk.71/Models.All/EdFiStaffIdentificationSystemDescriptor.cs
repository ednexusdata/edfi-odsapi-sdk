...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_staffIdentificationSystemDescriptor")]
    public partial class EdFiStaffIdentificationSystemDescriptor : IEquatable<EdFiStaffIdentificationSystemDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStaffIdentificationSystemDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiStaffIdentificationSystemDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStaffIdentificationSystemDescriptor" /> class.
        /// </summary>
        ...
        public EdFiStaffIdentificationSystemDescriptor(string id = default(string), int staffIdentificationSystemDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiStaffIdentificationSystemDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiStaffIdentificationSystemDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiStaffIdentificationSystemDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "staffIdentificationSystemDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  StaffIdentificationSystemDescriptorId: ").Append(StaffIdentificationSystemDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiStaffIdentificationSystemDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiStaffIdentificationSystemDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStaffIdentificationSystemDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStaffIdentificationSystemDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.StaffIdentificationSystemDescriptorId == input.StaffIdentificationSystemDescriptorId ||
                    this.StaffIdentificationSystemDescriptorId.Equals(input.StaffIdentificationSystemDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.StaffIdentificationSystemDescriptorId.GetHashCode();
