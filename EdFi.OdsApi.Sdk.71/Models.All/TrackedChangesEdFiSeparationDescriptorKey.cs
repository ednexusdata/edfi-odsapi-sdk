...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_separationDescriptorKey")]
    public partial class TrackedChangesEdFiSeparationDescriptorKey : IEquatable<TrackedChangesEdFiSeparationDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiSeparationDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiSeparationDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiSeparationDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSeparationDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSeparationDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSeparationDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSeparationDescriptorKey input)
        {
            if (input == null)
            {
                return false;
