...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_neglectedOrDelinquentProgramServiceDescriptor")]
    public partial class EdFiNeglectedOrDelinquentProgramServiceDescriptor : IEquatable<EdFiNeglectedOrDelinquentProgramServiceDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiNeglectedOrDelinquentProgramServiceDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiNeglectedOrDelinquentProgramServiceDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiNeglectedOrDelinquentProgramServiceDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="neglectedOrDelinquentProgramServiceDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiNeglectedOrDelinquentProgramServiceDescriptor(string id = default(string), int neglectedOrDelinquentProgramServiceDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiNeglectedOrDelinquentProgramServiceDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiNeglectedOrDelinquentProgramServiceDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiNeglectedOrDelinquentProgramServiceDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "neglectedOrDelinquentProgramServiceDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  NeglectedOrDelinquentProgramServiceDescriptorId: ").Append(NeglectedOrDelinquentProgramServiceDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiNeglectedOrDelinquentProgramServiceDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiNeglectedOrDelinquentProgramServiceDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiNeglectedOrDelinquentProgramServiceDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiNeglectedOrDelinquentProgramServiceDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.NeglectedOrDelinquentProgramServiceDescriptorId == input.NeglectedOrDelinquentProgramServiceDescriptorId ||
                    this.NeglectedOrDelinquentProgramServiceDescriptorId.Equals(input.NeglectedOrDelinquentProgramServiceDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.NeglectedOrDelinquentProgramServiceDescriptorId.GetHashCode();
