...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_eventCircumstanceDescriptorKey")]
    public partial class TrackedChangesEdFiEventCircumstanceDescriptorKey : IEquatable<TrackedChangesEdFiEventCircumstanceDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiEventCircumstanceDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiEventCircumstanceDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiEventCircumstanceDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiEventCircumstanceDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiEventCircumstanceDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiEventCircumstanceDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiEventCircumstanceDescriptorKey input)
        {
            if (input == null)
            {
                return false;
