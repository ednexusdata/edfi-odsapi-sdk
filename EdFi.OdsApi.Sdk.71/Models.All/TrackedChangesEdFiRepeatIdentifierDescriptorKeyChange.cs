...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_repeatIdentifierDescriptorKeyChange")]
    public partial class TrackedChangesEdFiRepeatIdentifierDescriptorKeyChange : IEquatable<TrackedChangesEdFiRepeatIdentifierDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiRepeatIdentifierDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiRepeatIdentifierDescriptorKey oldKeyValues = default(TrackedChangesEdFiRepeatIdentifierDescriptorKey), TrackedChangesEdFiRepeatIdentifierDescriptorKey newKeyValues = default(TrackedChangesEdFiRepeatIdentifierDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiRepeatIdentifierDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiRepeatIdentifierDescriptorKey NewKeyValues { get; set; }
        ...
        {
            return this.Equals(input as TrackedChangesEdFiRepeatIdentifierDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiRepeatIdentifierDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiRepeatIdentifierDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiRepeatIdentifierDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
