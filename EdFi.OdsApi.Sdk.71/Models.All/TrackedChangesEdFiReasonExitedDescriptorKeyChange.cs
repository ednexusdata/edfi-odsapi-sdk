...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_reasonExitedDescriptorKeyChange")]
    public partial class TrackedChangesEdFiReasonExitedDescriptorKeyChange : IEquatable<TrackedChangesEdFiReasonExitedDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiReasonExitedDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiReasonExitedDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiReasonExitedDescriptorKey oldKeyValues = default(TrackedChangesEdFiReasonExitedDescriptorKey), TrackedChangesEdFiReasonExitedDescriptorKey newKeyValues = default(TrackedChangesEdFiReasonExitedDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiReasonExitedDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiReasonExitedDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiReasonExitedDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiReasonExitedDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiReasonExitedDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiReasonExitedDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiReasonExitedDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
