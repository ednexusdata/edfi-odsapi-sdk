...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_projectDimensionReportingTag")]
    public partial class EdFiProjectDimensionReportingTag : IEquatable<EdFiProjectDimensionReportingTag>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiProjectDimensionReportingTag" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiProjectDimensionReportingTag() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiProjectDimensionReportingTag" /> class.
        /// </summary>
        /// <param name="reportingTagDescriptor">Optional tag for accountability reporting. (required).</param>
        public EdFiProjectDimensionReportingTag(string reportingTagDescriptor = default(string))
        {
            // to ensure "reportingTagDescriptor" is required (not null)
            if (reportingTagDescriptor == null)
            {
                throw new ArgumentNullException("reportingTagDescriptor is a required property for EdFiProjectDimensionReportingTag and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiProjectDimensionReportingTag {\n");
        ...
        {
            return this.Equals(input as EdFiProjectDimensionReportingTag);
        }

        /// <summary>
        /// Returns true if EdFiProjectDimensionReportingTag instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiProjectDimensionReportingTag to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiProjectDimensionReportingTag input)
        {
            if (input == null)
            {
                return false;
