...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_financialCollectionDescriptor")]
    public partial class EdFiFinancialCollectionDescriptor : IEquatable<EdFiFinancialCollectionDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiFinancialCollectionDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiFinancialCollectionDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiFinancialCollectionDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="financialCollectionDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiFinancialCollectionDescriptor(string id = default(string), int financialCollectionDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiFinancialCollectionDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiFinancialCollectionDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiFinancialCollectionDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.FinancialCollectionDescriptorId = financialCollectionDescriptorId;
        ...
        [DataMember(Name = "financialCollectionDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiFinancialCollectionDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  FinancialCollectionDescriptorId: ").Append(FinancialCollectionDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiFinancialCollectionDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiFinancialCollectionDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiFinancialCollectionDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiFinancialCollectionDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.FinancialCollectionDescriptorId == input.FinancialCollectionDescriptorId ||
                    this.FinancialCollectionDescriptorId.Equals(input.FinancialCollectionDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.FinancialCollectionDescriptorId.GetHashCode();
