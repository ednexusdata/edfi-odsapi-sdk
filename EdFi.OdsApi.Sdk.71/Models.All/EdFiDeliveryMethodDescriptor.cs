...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_deliveryMethodDescriptor")]
    public partial class EdFiDeliveryMethodDescriptor : IEquatable<EdFiDeliveryMethodDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiDeliveryMethodDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiDeliveryMethodDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiDeliveryMethodDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="deliveryMethodDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiDeliveryMethodDescriptor(string id = default(string), int deliveryMethodDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiDeliveryMethodDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiDeliveryMethodDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiDeliveryMethodDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "deliveryMethodDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DeliveryMethodDescriptorId: ").Append(DeliveryMethodDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiDeliveryMethodDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiDeliveryMethodDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiDeliveryMethodDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiDeliveryMethodDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.DeliveryMethodDescriptorId == input.DeliveryMethodDescriptorId ||
                    this.DeliveryMethodDescriptorId.Equals(input.DeliveryMethodDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.DeliveryMethodDescriptorId.GetHashCode();
