...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_weaponDescriptorKeyChange")]
    public partial class TrackedChangesEdFiWeaponDescriptorKeyChange : IEquatable<TrackedChangesEdFiWeaponDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiWeaponDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiWeaponDescriptorKey oldKeyValues = default(TrackedChangesEdFiWeaponDescriptorKey), TrackedChangesEdFiWeaponDescriptorKey newKeyValues = default(TrackedChangesEdFiWeaponDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiWeaponDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiWeaponDescriptorKey NewKeyValues { get; set; }
        ...
        {
            return this.Equals(input as TrackedChangesEdFiWeaponDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiWeaponDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiWeaponDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiWeaponDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
