...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_courseIdentificationSystemDescriptor")]
    public partial class EdFiCourseIdentificationSystemDescriptor : IEquatable<EdFiCourseIdentificationSystemDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCourseIdentificationSystemDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiCourseIdentificationSystemDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCourseIdentificationSystemDescriptor" /> class.
        /// </summary>
        ...
        public EdFiCourseIdentificationSystemDescriptor(string id = default(string), int courseIdentificationSystemDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiCourseIdentificationSystemDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiCourseIdentificationSystemDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiCourseIdentificationSystemDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "courseIdentificationSystemDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CourseIdentificationSystemDescriptorId: ").Append(CourseIdentificationSystemDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiCourseIdentificationSystemDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiCourseIdentificationSystemDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiCourseIdentificationSystemDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiCourseIdentificationSystemDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CourseIdentificationSystemDescriptorId == input.CourseIdentificationSystemDescriptorId ||
                    this.CourseIdentificationSystemDescriptorId.Equals(input.CourseIdentificationSystemDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.CourseIdentificationSystemDescriptorId.GetHashCode();
