...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_tpdm_aidTypeDescriptorKeyChange")]
    public partial class TrackedChangesTpdmAidTypeDescriptorKeyChange : IEquatable<TrackedChangesTpdmAidTypeDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesTpdmAidTypeDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesTpdmAidTypeDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesTpdmAidTypeDescriptorKey oldKeyValues = default(TrackedChangesTpdmAidTypeDescriptorKey), TrackedChangesTpdmAidTypeDescriptorKey newKeyValues = default(TrackedChangesTpdmAidTypeDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesTpdmAidTypeDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesTpdmAidTypeDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesTpdmAidTypeDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesTpdmAidTypeDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesTpdmAidTypeDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesTpdmAidTypeDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesTpdmAidTypeDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
