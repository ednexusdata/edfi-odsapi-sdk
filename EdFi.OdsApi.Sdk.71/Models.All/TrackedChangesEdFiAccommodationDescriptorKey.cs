...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_accommodationDescriptorKey")]
    public partial class TrackedChangesEdFiAccommodationDescriptorKey : IEquatable<TrackedChangesEdFiAccommodationDescriptorKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiAccommodationDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiAccommodationDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiAccommodationDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiAccommodationDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiAccommodationDescriptorKey input)
        {
            if (input == null)
            {
                return false;
