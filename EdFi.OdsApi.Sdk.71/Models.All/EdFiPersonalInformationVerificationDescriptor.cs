...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_personalInformationVerificationDescriptor")]
    public partial class EdFiPersonalInformationVerificationDescriptor : IEquatable<EdFiPersonalInformationVerificationDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiPersonalInformationVerificationDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiPersonalInformationVerificationDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiPersonalInformationVerificationDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="personalInformationVerificationDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiPersonalInformationVerificationDescriptor(string id = default(string), int personalInformationVerificationDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiPersonalInformationVerificationDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiPersonalInformationVerificationDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiPersonalInformationVerificationDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "personalInformationVerificationDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PersonalInformationVerificationDescriptorId: ").Append(PersonalInformationVerificationDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiPersonalInformationVerificationDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiPersonalInformationVerificationDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiPersonalInformationVerificationDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiPersonalInformationVerificationDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.PersonalInformationVerificationDescriptorId == input.PersonalInformationVerificationDescriptorId ||
                    this.PersonalInformationVerificationDescriptorId.Equals(input.PersonalInformationVerificationDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.PersonalInformationVerificationDescriptorId.GetHashCode();
