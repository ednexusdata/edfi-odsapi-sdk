...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_accountTypeDescriptorKeyChange")]
    public partial class TrackedChangesEdFiAccountTypeDescriptorKeyChange : IEquatable<TrackedChangesEdFiAccountTypeDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiAccountTypeDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiAccountTypeDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiAccountTypeDescriptorKey oldKeyValues = default(TrackedChangesEdFiAccountTypeDescriptorKey), TrackedChangesEdFiAccountTypeDescriptorKey newKeyValues = default(TrackedChangesEdFiAccountTypeDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiAccountTypeDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiAccountTypeDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiAccountTypeDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiAccountTypeDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiAccountTypeDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiAccountTypeDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiAccountTypeDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
