...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_absenceEventCategoryDescriptor")]
    public partial class EdFiAbsenceEventCategoryDescriptor : IEquatable<EdFiAbsenceEventCategoryDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAbsenceEventCategoryDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiAbsenceEventCategoryDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAbsenceEventCategoryDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="absenceEventCategoryDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiAbsenceEventCategoryDescriptor(string id = default(string), int absenceEventCategoryDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiAbsenceEventCategoryDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiAbsenceEventCategoryDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiAbsenceEventCategoryDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "absenceEventCategoryDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AbsenceEventCategoryDescriptorId: ").Append(AbsenceEventCategoryDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiAbsenceEventCategoryDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiAbsenceEventCategoryDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiAbsenceEventCategoryDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiAbsenceEventCategoryDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AbsenceEventCategoryDescriptorId == input.AbsenceEventCategoryDescriptorId ||
                    this.AbsenceEventCategoryDescriptorId.Equals(input.AbsenceEventCategoryDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.AbsenceEventCategoryDescriptorId.GetHashCode();
