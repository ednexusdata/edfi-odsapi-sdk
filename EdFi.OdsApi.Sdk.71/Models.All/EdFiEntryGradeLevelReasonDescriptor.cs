...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_entryGradeLevelReasonDescriptor")]
    public partial class EdFiEntryGradeLevelReasonDescriptor : IEquatable<EdFiEntryGradeLevelReasonDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiEntryGradeLevelReasonDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiEntryGradeLevelReasonDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiEntryGradeLevelReasonDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="entryGradeLevelReasonDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiEntryGradeLevelReasonDescriptor(string id = default(string), int entryGradeLevelReasonDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiEntryGradeLevelReasonDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiEntryGradeLevelReasonDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiEntryGradeLevelReasonDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "entryGradeLevelReasonDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  EntryGradeLevelReasonDescriptorId: ").Append(EntryGradeLevelReasonDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiEntryGradeLevelReasonDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiEntryGradeLevelReasonDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiEntryGradeLevelReasonDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiEntryGradeLevelReasonDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.EntryGradeLevelReasonDescriptorId == input.EntryGradeLevelReasonDescriptorId ||
                    this.EntryGradeLevelReasonDescriptorId.Equals(input.EntryGradeLevelReasonDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.EntryGradeLevelReasonDescriptorId.GetHashCode();
