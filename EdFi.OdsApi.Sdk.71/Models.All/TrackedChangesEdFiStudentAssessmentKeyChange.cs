...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_studentAssessmentKeyChange")]
    public partial class TrackedChangesEdFiStudentAssessmentKeyChange : IEquatable<TrackedChangesEdFiStudentAssessmentKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiStudentAssessmentKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiStudentAssessmentKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiStudentAssessmentKey oldKeyValues = default(TrackedChangesEdFiStudentAssessmentKey), TrackedChangesEdFiStudentAssessmentKey newKeyValues = default(TrackedChangesEdFiStudentAssessmentKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiStudentAssessmentKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiStudentAssessmentKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiStudentAssessmentKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStudentAssessmentKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStudentAssessmentKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStudentAssessmentKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStudentAssessmentKeyChange input)
        {
            if (input == null)
            {
                return false;
