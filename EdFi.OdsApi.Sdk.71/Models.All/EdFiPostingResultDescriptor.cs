...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_postingResultDescriptor")]
    public partial class EdFiPostingResultDescriptor : IEquatable<EdFiPostingResultDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiPostingResultDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiPostingResultDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiPostingResultDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="postingResultDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiPostingResultDescriptor(string id = default(string), int postingResultDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiPostingResultDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiPostingResultDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiPostingResultDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "postingResultDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PostingResultDescriptorId: ").Append(PostingResultDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiPostingResultDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiPostingResultDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiPostingResultDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiPostingResultDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.PostingResultDescriptorId == input.PostingResultDescriptorId ||
                    this.PostingResultDescriptorId.Equals(input.PostingResultDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.PostingResultDescriptorId.GetHashCode();
