...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_eligibilityDelayReasonDescriptor")]
    public partial class EdFiEligibilityDelayReasonDescriptor : IEquatable<EdFiEligibilityDelayReasonDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiEligibilityDelayReasonDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiEligibilityDelayReasonDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiEligibilityDelayReasonDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="eligibilityDelayReasonDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiEligibilityDelayReasonDescriptor(string id = default(string), int eligibilityDelayReasonDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiEligibilityDelayReasonDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiEligibilityDelayReasonDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiEligibilityDelayReasonDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.EligibilityDelayReasonDescriptorId = eligibilityDelayReasonDescriptorId;
        ...
        [DataMember(Name = "eligibilityDelayReasonDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiEligibilityDelayReasonDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  EligibilityDelayReasonDescriptorId: ").Append(EligibilityDelayReasonDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiEligibilityDelayReasonDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiEligibilityDelayReasonDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiEligibilityDelayReasonDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiEligibilityDelayReasonDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.EligibilityDelayReasonDescriptorId == input.EligibilityDelayReasonDescriptorId ||
                    this.EligibilityDelayReasonDescriptorId.Equals(input.EligibilityDelayReasonDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.EligibilityDelayReasonDescriptorId.GetHashCode();
