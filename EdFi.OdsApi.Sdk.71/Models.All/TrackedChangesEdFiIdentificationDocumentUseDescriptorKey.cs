...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_identificationDocumentUseDescriptorKey")]
    public partial class TrackedChangesEdFiIdentificationDocumentUseDescriptorKey : IEquatable<TrackedChangesEdFiIdentificationDocumentUseDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiIdentificationDocumentUseDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiIdentificationDocumentUseDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiIdentificationDocumentUseDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiIdentificationDocumentUseDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiIdentificationDocumentUseDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiIdentificationDocumentUseDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiIdentificationDocumentUseDescriptorKey input)
        {
            if (input == null)
            {
                return false;
