...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_localActualKeyChange")]
    public partial class TrackedChangesEdFiLocalActualKeyChange : IEquatable<TrackedChangesEdFiLocalActualKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiLocalActualKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiLocalActualKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiLocalActualKey oldKeyValues = default(TrackedChangesEdFiLocalActualKey), TrackedChangesEdFiLocalActualKey newKeyValues = default(TrackedChangesEdFiLocalActualKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiLocalActualKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiLocalActualKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiLocalActualKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiLocalActualKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiLocalActualKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiLocalActualKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiLocalActualKeyChange input)
        {
            if (input == null)
            {
                return false;
