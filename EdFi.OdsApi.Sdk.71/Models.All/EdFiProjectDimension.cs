...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_projectDimension")]
    public partial class EdFiProjectDimension : IEquatable<EdFiProjectDimension>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiProjectDimension" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiProjectDimension() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiProjectDimension" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="code">The code representation of the account project dimension. (required).</param>
        /// <param name="fiscalYear">The fiscal year for which the account project dimension is valid. (required).</param>
        ...
        public EdFiProjectDimension(string id = default(string), string code = default(string), int fiscalYear = default(int), string codeName = default(string), List<EdFiProjectDimensionReportingTag> reportingTags = default(List<EdFiProjectDimensionReportingTag>), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "code" is required (not null)
            if (code == null)
            {
                throw new ArgumentNullException("code is a required property for EdFiProjectDimension and cannot be null");
            }
            this.Code = code;
        ...
        public List<EdFiProjectDimensionReportingTag> ReportingTags { get; set; }
        ...
        {
            return this.Equals(input as EdFiProjectDimension);
        }

        /// <summary>
        /// Returns true if EdFiProjectDimension instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiProjectDimension to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiProjectDimension input)
        {
            if (input == null)
            {
                return false;
