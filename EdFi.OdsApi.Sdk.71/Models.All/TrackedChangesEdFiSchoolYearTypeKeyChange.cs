...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_schoolYearTypeKeyChange")]
    public partial class TrackedChangesEdFiSchoolYearTypeKeyChange : IEquatable<TrackedChangesEdFiSchoolYearTypeKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiSchoolYearTypeKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiSchoolYearTypeKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiSchoolYearTypeKey oldKeyValues = default(TrackedChangesEdFiSchoolYearTypeKey), TrackedChangesEdFiSchoolYearTypeKey newKeyValues = default(TrackedChangesEdFiSchoolYearTypeKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiSchoolYearTypeKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiSchoolYearTypeKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiSchoolYearTypeKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSchoolYearTypeKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSchoolYearTypeKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSchoolYearTypeKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSchoolYearTypeKeyChange input)
        {
            if (input == null)
            {
                return false;
