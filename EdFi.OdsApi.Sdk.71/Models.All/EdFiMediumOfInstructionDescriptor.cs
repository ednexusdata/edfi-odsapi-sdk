...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_mediumOfInstructionDescriptor")]
    public partial class EdFiMediumOfInstructionDescriptor : IEquatable<EdFiMediumOfInstructionDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiMediumOfInstructionDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiMediumOfInstructionDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiMediumOfInstructionDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="mediumOfInstructionDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiMediumOfInstructionDescriptor(string id = default(string), int mediumOfInstructionDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiMediumOfInstructionDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiMediumOfInstructionDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiMediumOfInstructionDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "mediumOfInstructionDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MediumOfInstructionDescriptorId: ").Append(MediumOfInstructionDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiMediumOfInstructionDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiMediumOfInstructionDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiMediumOfInstructionDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiMediumOfInstructionDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.MediumOfInstructionDescriptorId == input.MediumOfInstructionDescriptorId ||
                    this.MediumOfInstructionDescriptorId.Equals(input.MediumOfInstructionDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.MediumOfInstructionDescriptorId.GetHashCode();
