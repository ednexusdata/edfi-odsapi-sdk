...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TrackedChangesEdFiGradeKey : IEquatable<TrackedChangesEdFiGradeKey>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TrackedChangesEdFiGradeKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiGradeKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiGradeKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiGradeKey input)
        {
            if (input == null)
            {
                return false;
