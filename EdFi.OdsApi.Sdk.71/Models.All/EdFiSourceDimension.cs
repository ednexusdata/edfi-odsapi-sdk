...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// EdFiSourceDimension
    /// </summary>
    [DataContract(Name = "edFi_sourceDimension")]
    public partial class EdFiSourceDimension : IEquatable<EdFiSourceDimension>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSourceDimension" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiSourceDimension() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSourceDimension" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="code">The code representation of the account source dimension. (required).</param>
        /// <param name="fiscalYear">The fiscal year for which the account source dimension is valid. (required).</param>
        /// <param name="codeName">A description of the account source dimension..</param>
        /// <param name="reportingTags">An unordered collection of sourceDimensionReportingTags. Optional tag for accountability reporting..</param>
        /// <param name="etag">A unique system-generated value that identifies the version of the resource..</param>
        /// <param name="lastModifiedDate">The date and time the resource was last modified..</param>
        public EdFiSourceDimension(string id = default(string), string code = default(string), int fiscalYear = default(int), string codeName = default(string), List<EdFiSourceDimensionReportingTag> reportingTags = default(List<EdFiSourceDimensionReportingTag>), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "code" is required (not null)
            if (code == null)
            {
                throw new ArgumentNullException("code is a required property for EdFiSourceDimension and cannot be null");
            }
            this.Code = code;
        ...
        /// </summary>
        /// <value>A description of the account source dimension.</value>
        ...
        /// </summary>
        /// <value>An unordered collection of sourceDimensionReportingTags. Optional tag for accountability reporting.</value>
        [DataMember(Name = "reportingTags", EmitDefaultValue = false)]
        public List<EdFiSourceDimensionReportingTag> ReportingTags { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiSourceDimension {\n");
        ...
        {
            return this.Equals(input as EdFiSourceDimension);
        }

        /// <summary>
        /// Returns true if EdFiSourceDimension instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiSourceDimension to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiSourceDimension input)
        {
            if (input == null)
            {
                return false;
