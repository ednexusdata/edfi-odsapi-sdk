...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_diagnosisDescriptor")]
    public partial class EdFiDiagnosisDescriptor : IEquatable<EdFiDiagnosisDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiDiagnosisDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiDiagnosisDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiDiagnosisDescriptor" /> class.
        /// </summary>
        ...
        public EdFiDiagnosisDescriptor(string id = default(string), int diagnosisDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiDiagnosisDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiDiagnosisDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiDiagnosisDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "diagnosisDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DiagnosisDescriptorId: ").Append(DiagnosisDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiDiagnosisDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiDiagnosisDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiDiagnosisDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiDiagnosisDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.DiagnosisDescriptorId == input.DiagnosisDescriptorId ||
                    this.DiagnosisDescriptorId.Equals(input.DiagnosisDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.DiagnosisDescriptorId.GetHashCode();
