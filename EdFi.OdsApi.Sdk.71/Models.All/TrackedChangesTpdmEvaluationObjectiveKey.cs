...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_tpdm_evaluationObjectiveKey")]
    public partial class TrackedChangesTpdmEvaluationObjectiveKey : IEquatable<TrackedChangesTpdmEvaluationObjectiveKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesTpdmEvaluationObjectiveKey" /> class.
        /// </summary>
        ...
        public TrackedChangesTpdmEvaluationObjectiveKey(string evaluationObjectiveTitle = default(string), long educationOrganizationId = default(long), string evaluationPeriodDescriptor = default(string), string evaluationTitle = default(string), string performanceEvaluationTitle = default(string), string performanceEvaluationTypeDescriptor = default(string), int schoolYear = default(int), string termDescriptor = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesTpdmEvaluationObjectiveKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesTpdmEvaluationObjectiveKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesTpdmEvaluationObjectiveKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesTpdmEvaluationObjectiveKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesTpdmEvaluationObjectiveKey input)
        {
            if (input == null)
            {
                return false;
