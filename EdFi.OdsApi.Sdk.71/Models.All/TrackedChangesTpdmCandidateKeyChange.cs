...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_tpdm_candidateKeyChange")]
    public partial class TrackedChangesTpdmCandidateKeyChange : IEquatable<TrackedChangesTpdmCandidateKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesTpdmCandidateKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesTpdmCandidateKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesTpdmCandidateKey oldKeyValues = default(TrackedChangesTpdmCandidateKey), TrackedChangesTpdmCandidateKey newKeyValues = default(TrackedChangesTpdmCandidateKey))
        {
            this.Id = id;
        ...
        public TrackedChangesTpdmCandidateKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesTpdmCandidateKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesTpdmCandidateKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesTpdmCandidateKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesTpdmCandidateKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesTpdmCandidateKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesTpdmCandidateKeyChange input)
        {
            if (input == null)
            {
                return false;
