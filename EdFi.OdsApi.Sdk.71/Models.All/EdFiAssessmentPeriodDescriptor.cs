...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_assessmentPeriodDescriptor")]
    public partial class EdFiAssessmentPeriodDescriptor : IEquatable<EdFiAssessmentPeriodDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAssessmentPeriodDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiAssessmentPeriodDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAssessmentPeriodDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="assessmentPeriodDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiAssessmentPeriodDescriptor(string id = default(string), int assessmentPeriodDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiAssessmentPeriodDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiAssessmentPeriodDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiAssessmentPeriodDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "assessmentPeriodDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AssessmentPeriodDescriptorId: ").Append(AssessmentPeriodDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiAssessmentPeriodDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiAssessmentPeriodDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiAssessmentPeriodDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiAssessmentPeriodDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AssessmentPeriodDescriptorId == input.AssessmentPeriodDescriptorId ||
                    this.AssessmentPeriodDescriptorId.Equals(input.AssessmentPeriodDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.AssessmentPeriodDescriptorId.GetHashCode();
