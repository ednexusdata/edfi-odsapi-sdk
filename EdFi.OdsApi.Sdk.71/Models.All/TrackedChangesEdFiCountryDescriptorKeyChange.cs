...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_countryDescriptorKeyChange")]
    public partial class TrackedChangesEdFiCountryDescriptorKeyChange : IEquatable<TrackedChangesEdFiCountryDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCountryDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCountryDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiCountryDescriptorKey oldKeyValues = default(TrackedChangesEdFiCountryDescriptorKey), TrackedChangesEdFiCountryDescriptorKey newKeyValues = default(TrackedChangesEdFiCountryDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiCountryDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiCountryDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCountryDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCountryDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCountryDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCountryDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCountryDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
