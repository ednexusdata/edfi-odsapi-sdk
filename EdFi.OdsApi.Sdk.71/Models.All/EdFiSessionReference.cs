...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiSessionReference : IEquatable<EdFiSessionReference>, IValidatableObject
    {
        ...
        public EdFiSessionReference(long schoolId = default(long), int schoolYear = default(int), string sessionName = default(string), Link link = default(Link))
        {
            ...
            if (sessionName == null)
            {
                throw new ArgumentNullException("sessionName is a required property for EdFiSessionReference and cannot be null");
            }
