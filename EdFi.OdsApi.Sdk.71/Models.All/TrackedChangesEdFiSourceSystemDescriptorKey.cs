...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_sourceSystemDescriptorKey")]
    public partial class TrackedChangesEdFiSourceSystemDescriptorKey : IEquatable<TrackedChangesEdFiSourceSystemDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiSourceSystemDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiSourceSystemDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiSourceSystemDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSourceSystemDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSourceSystemDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSourceSystemDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSourceSystemDescriptorKey input)
        {
            if (input == null)
            {
                return false;
