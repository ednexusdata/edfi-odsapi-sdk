...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_eligibilityEvaluationTypeDescriptor")]
    public partial class EdFiEligibilityEvaluationTypeDescriptor : IEquatable<EdFiEligibilityEvaluationTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiEligibilityEvaluationTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiEligibilityEvaluationTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiEligibilityEvaluationTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="eligibilityEvaluationTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiEligibilityEvaluationTypeDescriptor(string id = default(string), int eligibilityEvaluationTypeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiEligibilityEvaluationTypeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiEligibilityEvaluationTypeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiEligibilityEvaluationTypeDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.EligibilityEvaluationTypeDescriptorId = eligibilityEvaluationTypeDescriptorId;
        ...
        [DataMember(Name = "eligibilityEvaluationTypeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiEligibilityEvaluationTypeDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  EligibilityEvaluationTypeDescriptorId: ").Append(EligibilityEvaluationTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiEligibilityEvaluationTypeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiEligibilityEvaluationTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiEligibilityEvaluationTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiEligibilityEvaluationTypeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.EligibilityEvaluationTypeDescriptorId == input.EligibilityEvaluationTypeDescriptorId ||
                    this.EligibilityEvaluationTypeDescriptorId.Equals(input.EligibilityEvaluationTypeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.EligibilityEvaluationTypeDescriptorId.GetHashCode();
