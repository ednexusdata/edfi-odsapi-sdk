...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_homelessPrimaryNighttimeResidenceDescriptorKey")]
    public partial class TrackedChangesEdFiHomelessPrimaryNighttimeResidenceDescriptorKey : IEquatable<TrackedChangesEdFiHomelessPrimaryNighttimeResidenceDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiHomelessPrimaryNighttimeResidenceDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiHomelessPrimaryNighttimeResidenceDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiHomelessPrimaryNighttimeResidenceDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiHomelessPrimaryNighttimeResidenceDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiHomelessPrimaryNighttimeResidenceDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiHomelessPrimaryNighttimeResidenceDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiHomelessPrimaryNighttimeResidenceDescriptorKey input)
        {
            if (input == null)
            {
                return false;
