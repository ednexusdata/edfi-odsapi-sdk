...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_courseKeyChange")]
    public partial class TrackedChangesEdFiCourseKeyChange : IEquatable<TrackedChangesEdFiCourseKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCourseKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCourseKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiCourseKey oldKeyValues = default(TrackedChangesEdFiCourseKey), TrackedChangesEdFiCourseKey newKeyValues = default(TrackedChangesEdFiCourseKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiCourseKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiCourseKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCourseKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCourseKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCourseKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCourseKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCourseKeyChange input)
        {
            if (input == null)
            {
                return false;
