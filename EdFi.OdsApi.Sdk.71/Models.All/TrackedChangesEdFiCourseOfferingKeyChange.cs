...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_courseOfferingKeyChange")]
    public partial class TrackedChangesEdFiCourseOfferingKeyChange : IEquatable<TrackedChangesEdFiCourseOfferingKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCourseOfferingKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCourseOfferingKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiCourseOfferingKey oldKeyValues = default(TrackedChangesEdFiCourseOfferingKey), TrackedChangesEdFiCourseOfferingKey newKeyValues = default(TrackedChangesEdFiCourseOfferingKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiCourseOfferingKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiCourseOfferingKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCourseOfferingKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCourseOfferingKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCourseOfferingKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCourseOfferingKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCourseOfferingKeyChange input)
        {
            if (input == null)
            {
                return false;
