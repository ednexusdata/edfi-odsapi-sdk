...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_diplomaTypeDescriptor")]
    public partial class EdFiDiplomaTypeDescriptor : IEquatable<EdFiDiplomaTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiDiplomaTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiDiplomaTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiDiplomaTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="diplomaTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiDiplomaTypeDescriptor(string id = default(string), int diplomaTypeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiDiplomaTypeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiDiplomaTypeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiDiplomaTypeDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "diplomaTypeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DiplomaTypeDescriptorId: ").Append(DiplomaTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiDiplomaTypeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiDiplomaTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiDiplomaTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiDiplomaTypeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.DiplomaTypeDescriptorId == input.DiplomaTypeDescriptorId ||
                    this.DiplomaTypeDescriptorId.Equals(input.DiplomaTypeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.DiplomaTypeDescriptorId.GetHashCode();
