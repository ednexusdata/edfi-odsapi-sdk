...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiSurveyResponseStaffTargetAssociation : IEquatable<EdFiSurveyResponseStaffTargetAssociation>, IValidatableObject
    {
        ...
        public EdFiSurveyResponseStaffTargetAssociation(string id = default(string), EdFiStaffReference staffReference = default(EdFiStaffReference), EdFiSurveyResponseReference surveyResponseReference = default(EdFiSurveyResponseReference), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
