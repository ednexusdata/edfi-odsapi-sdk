...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TrackedChangesEdFiStudentCompetencyObjectiveKey : IEquatable<TrackedChangesEdFiStudentCompetencyObjectiveKey>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStudentCompetencyObjectiveKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStudentCompetencyObjectiveKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStudentCompetencyObjectiveKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStudentCompetencyObjectiveKey input)
        {
            if (input == null)
            {
                return false;
