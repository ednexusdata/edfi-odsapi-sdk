...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiCourseTranscript : IEquatable<EdFiCourseTranscript>, IValidatableObject
    {
        ...
        public bool Equals(EdFiCourseTranscript input)
        {
            ...
            return 
                ...
                (
                    ...
                    input.PartialCourseTranscriptAwards != null &&
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // AlternativeCourseTitle (string) minLength
            if (this.AlternativeCourseTitle != null && this.AlternativeCourseTitle.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AlternativeCourseTitle, length must be greater than 1.", new [] { "AlternativeCourseTitle" });
            }
            ...
            // AssigningOrganizationIdentificationCode (string) minLength
            if (this.AssigningOrganizationIdentificationCode != null && this.AssigningOrganizationIdentificationCode.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AssigningOrganizationIdentificationCode, length must be greater than 1.", new [] { "AssigningOrganizationIdentificationCode" });
            }

            // AttemptedCredits (double?) minimum
            if (this.AttemptedCredits < (double?)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AttemptedCredits, must be a value greater than or equal to 0.", new [] { "AttemptedCredits" });
            }
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CourseCatalogURL, length must be greater than 5.", new [] { "CourseCatalogURL" });
            }
            ...
            // CourseTitle (string) minLength
            if (this.CourseTitle != null && this.CourseTitle.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CourseTitle, length must be greater than 1.", new [] { "CourseTitle" });
            }

            // EarnedCredits (double?) minimum
            if (this.EarnedCredits < (double?)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for EarnedCredits, must be a value greater than or equal to 0.", new [] { "EarnedCredits" });
            }
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ExternalEducationOrganizationNameOfInstitution, length must be less than 75.", new [] { "ExternalEducationOrganizationNameOfInstitution" });
            }

            // ExternalEducationOrganizationNameOfInstitution (string) minLength
            if (this.ExternalEducationOrganizationNameOfInstitution != null && this.ExternalEducationOrganizationNameOfInstitution.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ExternalEducationOrganizationNameOfInstitution, length must be greater than 1.", new [] { "ExternalEducationOrganizationNameOfInstitution" });
            }
            ...
            // FinalLetterGradeEarned (string) minLength
            if (this.FinalLetterGradeEarned != null && this.FinalLetterGradeEarned.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for FinalLetterGradeEarned, length must be greater than 1.", new [] { "FinalLetterGradeEarned" });
            }
