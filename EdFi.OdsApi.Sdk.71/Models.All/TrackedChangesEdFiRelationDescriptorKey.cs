...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_relationDescriptorKey")]
    public partial class TrackedChangesEdFiRelationDescriptorKey : IEquatable<TrackedChangesEdFiRelationDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiRelationDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiRelationDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiRelationDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiRelationDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiRelationDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiRelationDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiRelationDescriptorKey input)
        {
            if (input == null)
            {
                return false;
