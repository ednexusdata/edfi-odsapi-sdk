...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_calendarTypeDescriptor")]
    public partial class EdFiCalendarTypeDescriptor : IEquatable<EdFiCalendarTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCalendarTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiCalendarTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCalendarTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="calendarTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiCalendarTypeDescriptor(string id = default(string), int calendarTypeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiCalendarTypeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiCalendarTypeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiCalendarTypeDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "calendarTypeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CalendarTypeDescriptorId: ").Append(CalendarTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiCalendarTypeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiCalendarTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiCalendarTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiCalendarTypeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CalendarTypeDescriptorId == input.CalendarTypeDescriptorId ||
                    this.CalendarTypeDescriptorId.Equals(input.CalendarTypeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.CalendarTypeDescriptorId.GetHashCode();
