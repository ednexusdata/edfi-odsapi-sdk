...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_disciplineActionKeyChange")]
    public partial class TrackedChangesEdFiDisciplineActionKeyChange : IEquatable<TrackedChangesEdFiDisciplineActionKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiDisciplineActionKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiDisciplineActionKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiDisciplineActionKey oldKeyValues = default(TrackedChangesEdFiDisciplineActionKey), TrackedChangesEdFiDisciplineActionKey newKeyValues = default(TrackedChangesEdFiDisciplineActionKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiDisciplineActionKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiDisciplineActionKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiDisciplineActionKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiDisciplineActionKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiDisciplineActionKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiDisciplineActionKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiDisciplineActionKeyChange input)
        {
            if (input == null)
            {
                return false;
