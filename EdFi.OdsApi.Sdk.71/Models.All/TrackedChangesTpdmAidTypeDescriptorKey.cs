...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_tpdm_aidTypeDescriptorKey")]
    public partial class TrackedChangesTpdmAidTypeDescriptorKey : IEquatable<TrackedChangesTpdmAidTypeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesTpdmAidTypeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesTpdmAidTypeDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesTpdmAidTypeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesTpdmAidTypeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesTpdmAidTypeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesTpdmAidTypeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesTpdmAidTypeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
