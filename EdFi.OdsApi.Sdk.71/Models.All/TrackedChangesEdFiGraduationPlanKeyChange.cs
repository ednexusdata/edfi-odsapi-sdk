...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_graduationPlanKeyChange")]
    public partial class TrackedChangesEdFiGraduationPlanKeyChange : IEquatable<TrackedChangesEdFiGraduationPlanKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiGraduationPlanKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiGraduationPlanKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiGraduationPlanKey oldKeyValues = default(TrackedChangesEdFiGraduationPlanKey), TrackedChangesEdFiGraduationPlanKey newKeyValues = default(TrackedChangesEdFiGraduationPlanKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiGraduationPlanKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiGraduationPlanKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiGraduationPlanKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiGraduationPlanKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiGraduationPlanKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiGraduationPlanKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiGraduationPlanKeyChange input)
        {
            if (input == null)
            {
                return false;
