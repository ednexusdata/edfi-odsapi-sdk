...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_tpdm_certificationRouteDescriptorKey")]
    public partial class TrackedChangesTpdmCertificationRouteDescriptorKey : IEquatable<TrackedChangesTpdmCertificationRouteDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesTpdmCertificationRouteDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesTpdmCertificationRouteDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesTpdmCertificationRouteDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesTpdmCertificationRouteDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesTpdmCertificationRouteDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesTpdmCertificationRouteDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesTpdmCertificationRouteDescriptorKey input)
        {
            if (input == null)
            {
                return false;
