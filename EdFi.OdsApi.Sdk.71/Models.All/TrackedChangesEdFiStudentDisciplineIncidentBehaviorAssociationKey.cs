...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_studentDisciplineIncidentBehaviorAssociationKey")]
    public partial class TrackedChangesEdFiStudentDisciplineIncidentBehaviorAssociationKey : IEquatable<TrackedChangesEdFiStudentDisciplineIncidentBehaviorAssociationKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiStudentDisciplineIncidentBehaviorAssociationKey(string behaviorDescriptor = default(string), string incidentIdentifier = default(string), long schoolId = default(long), string studentUniqueId = default(string))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStudentDisciplineIncidentBehaviorAssociationKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStudentDisciplineIncidentBehaviorAssociationKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStudentDisciplineIncidentBehaviorAssociationKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStudentDisciplineIncidentBehaviorAssociationKey input)
        {
            if (input == null)
            {
                return false;
