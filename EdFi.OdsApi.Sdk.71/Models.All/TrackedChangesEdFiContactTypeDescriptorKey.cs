...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_contactTypeDescriptorKey")]
    public partial class TrackedChangesEdFiContactTypeDescriptorKey : IEquatable<TrackedChangesEdFiContactTypeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiContactTypeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiContactTypeDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiContactTypeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiContactTypeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiContactTypeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiContactTypeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiContactTypeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
