...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_publicationStatusDescriptor")]
    public partial class EdFiPublicationStatusDescriptor : IEquatable<EdFiPublicationStatusDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiPublicationStatusDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiPublicationStatusDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiPublicationStatusDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="publicationStatusDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiPublicationStatusDescriptor(string id = default(string), int publicationStatusDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiPublicationStatusDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiPublicationStatusDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiPublicationStatusDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "publicationStatusDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PublicationStatusDescriptorId: ").Append(PublicationStatusDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiPublicationStatusDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiPublicationStatusDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiPublicationStatusDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiPublicationStatusDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.PublicationStatusDescriptorId == input.PublicationStatusDescriptorId ||
                    this.PublicationStatusDescriptorId.Equals(input.PublicationStatusDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.PublicationStatusDescriptorId.GetHashCode();
