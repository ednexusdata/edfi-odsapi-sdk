...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_classroomPositionDescriptorKey")]
    public partial class TrackedChangesEdFiClassroomPositionDescriptorKey : IEquatable<TrackedChangesEdFiClassroomPositionDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiClassroomPositionDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiClassroomPositionDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiClassroomPositionDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiClassroomPositionDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiClassroomPositionDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiClassroomPositionDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiClassroomPositionDescriptorKey input)
        {
            if (input == null)
            {
                return false;
