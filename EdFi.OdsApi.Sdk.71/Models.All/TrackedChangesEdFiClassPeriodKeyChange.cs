...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_classPeriodKeyChange")]
    public partial class TrackedChangesEdFiClassPeriodKeyChange : IEquatable<TrackedChangesEdFiClassPeriodKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiClassPeriodKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiClassPeriodKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiClassPeriodKey oldKeyValues = default(TrackedChangesEdFiClassPeriodKey), TrackedChangesEdFiClassPeriodKey newKeyValues = default(TrackedChangesEdFiClassPeriodKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiClassPeriodKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiClassPeriodKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiClassPeriodKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiClassPeriodKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiClassPeriodKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiClassPeriodKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiClassPeriodKeyChange input)
        {
            if (input == null)
            {
                return false;
