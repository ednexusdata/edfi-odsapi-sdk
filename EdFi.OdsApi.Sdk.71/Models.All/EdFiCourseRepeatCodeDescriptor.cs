...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_courseRepeatCodeDescriptor")]
    public partial class EdFiCourseRepeatCodeDescriptor : IEquatable<EdFiCourseRepeatCodeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCourseRepeatCodeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiCourseRepeatCodeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCourseRepeatCodeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="courseRepeatCodeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiCourseRepeatCodeDescriptor(string id = default(string), int courseRepeatCodeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiCourseRepeatCodeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiCourseRepeatCodeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiCourseRepeatCodeDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "courseRepeatCodeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CourseRepeatCodeDescriptorId: ").Append(CourseRepeatCodeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiCourseRepeatCodeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiCourseRepeatCodeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiCourseRepeatCodeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiCourseRepeatCodeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CourseRepeatCodeDescriptorId == input.CourseRepeatCodeDescriptorId ||
                    this.CourseRepeatCodeDescriptorId.Equals(input.CourseRepeatCodeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.CourseRepeatCodeDescriptorId.GetHashCode();
