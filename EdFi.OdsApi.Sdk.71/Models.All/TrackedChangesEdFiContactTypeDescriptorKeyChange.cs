...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_contactTypeDescriptorKeyChange")]
    public partial class TrackedChangesEdFiContactTypeDescriptorKeyChange : IEquatable<TrackedChangesEdFiContactTypeDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiContactTypeDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiContactTypeDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiContactTypeDescriptorKey oldKeyValues = default(TrackedChangesEdFiContactTypeDescriptorKey), TrackedChangesEdFiContactTypeDescriptorKey newKeyValues = default(TrackedChangesEdFiContactTypeDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiContactTypeDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiContactTypeDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiContactTypeDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiContactTypeDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiContactTypeDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiContactTypeDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiContactTypeDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
