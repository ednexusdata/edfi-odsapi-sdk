...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_balanceSheetDimensionKeyChange")]
    public partial class TrackedChangesEdFiBalanceSheetDimensionKeyChange : IEquatable<TrackedChangesEdFiBalanceSheetDimensionKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiBalanceSheetDimensionKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiBalanceSheetDimensionKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiBalanceSheetDimensionKey oldKeyValues = default(TrackedChangesEdFiBalanceSheetDimensionKey), TrackedChangesEdFiBalanceSheetDimensionKey newKeyValues = default(TrackedChangesEdFiBalanceSheetDimensionKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiBalanceSheetDimensionKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiBalanceSheetDimensionKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiBalanceSheetDimensionKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiBalanceSheetDimensionKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiBalanceSheetDimensionKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiBalanceSheetDimensionKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiBalanceSheetDimensionKeyChange input)
        {
            if (input == null)
            {
                return false;
