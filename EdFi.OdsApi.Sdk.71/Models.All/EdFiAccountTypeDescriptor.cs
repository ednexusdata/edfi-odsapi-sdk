...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_accountTypeDescriptor")]
    public partial class EdFiAccountTypeDescriptor : IEquatable<EdFiAccountTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAccountTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiAccountTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAccountTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="accountTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiAccountTypeDescriptor(string id = default(string), int accountTypeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiAccountTypeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiAccountTypeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiAccountTypeDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.AccountTypeDescriptorId = accountTypeDescriptorId;
        ...
        [DataMember(Name = "accountTypeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiAccountTypeDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  AccountTypeDescriptorId: ").Append(AccountTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiAccountTypeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiAccountTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiAccountTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiAccountTypeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AccountTypeDescriptorId == input.AccountTypeDescriptorId ||
                    this.AccountTypeDescriptorId.Equals(input.AccountTypeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.AccountTypeDescriptorId.GetHashCode();
