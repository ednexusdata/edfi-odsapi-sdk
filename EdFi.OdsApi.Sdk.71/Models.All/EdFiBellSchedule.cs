...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiBellSchedule : IEquatable<EdFiBellSchedule>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // AlternateDayName (string) minLength
            if (this.AlternateDayName != null && this.AlternateDayName.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AlternateDayName, length must be greater than 1.", new [] { "AlternateDayName" });
            }
