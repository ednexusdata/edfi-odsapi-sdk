...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_operationalStatusDescriptor")]
    public partial class EdFiOperationalStatusDescriptor : IEquatable<EdFiOperationalStatusDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiOperationalStatusDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiOperationalStatusDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiOperationalStatusDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="operationalStatusDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiOperationalStatusDescriptor(string id = default(string), int operationalStatusDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiOperationalStatusDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiOperationalStatusDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiOperationalStatusDescriptor and cannot be null");
            }
        ...
        {
            return this.Equals(input as EdFiOperationalStatusDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiOperationalStatusDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiOperationalStatusDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiOperationalStatusDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.OperationalStatusDescriptorId == input.OperationalStatusDescriptorId ||
                    this.OperationalStatusDescriptorId.Equals(input.OperationalStatusDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.OperationalStatusDescriptorId.GetHashCode();
