...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_staffIdentificationSystemDescriptorKey")]
    public partial class TrackedChangesEdFiStaffIdentificationSystemDescriptorKey : IEquatable<TrackedChangesEdFiStaffIdentificationSystemDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiStaffIdentificationSystemDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiStaffIdentificationSystemDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiStaffIdentificationSystemDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStaffIdentificationSystemDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStaffIdentificationSystemDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStaffIdentificationSystemDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStaffIdentificationSystemDescriptorKey input)
        {
            if (input == null)
            {
                return false;
