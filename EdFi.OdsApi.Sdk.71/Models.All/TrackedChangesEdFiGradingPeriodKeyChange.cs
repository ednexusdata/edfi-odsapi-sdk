...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_gradingPeriodKeyChange")]
    public partial class TrackedChangesEdFiGradingPeriodKeyChange : IEquatable<TrackedChangesEdFiGradingPeriodKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiGradingPeriodKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiGradingPeriodKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiGradingPeriodKey oldKeyValues = default(TrackedChangesEdFiGradingPeriodKey), TrackedChangesEdFiGradingPeriodKey newKeyValues = default(TrackedChangesEdFiGradingPeriodKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiGradingPeriodKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiGradingPeriodKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiGradingPeriodKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiGradingPeriodKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiGradingPeriodKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiGradingPeriodKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiGradingPeriodKeyChange input)
        {
            if (input == null)
            {
                return false;
