...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_schoolFoodServiceProgramServiceDescriptor")]
    public partial class EdFiSchoolFoodServiceProgramServiceDescriptor : IEquatable<EdFiSchoolFoodServiceProgramServiceDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSchoolFoodServiceProgramServiceDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiSchoolFoodServiceProgramServiceDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSchoolFoodServiceProgramServiceDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="schoolFoodServiceProgramServiceDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiSchoolFoodServiceProgramServiceDescriptor(string id = default(string), int schoolFoodServiceProgramServiceDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiSchoolFoodServiceProgramServiceDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiSchoolFoodServiceProgramServiceDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiSchoolFoodServiceProgramServiceDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "schoolFoodServiceProgramServiceDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SchoolFoodServiceProgramServiceDescriptorId: ").Append(SchoolFoodServiceProgramServiceDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiSchoolFoodServiceProgramServiceDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiSchoolFoodServiceProgramServiceDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiSchoolFoodServiceProgramServiceDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiSchoolFoodServiceProgramServiceDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.SchoolFoodServiceProgramServiceDescriptorId == input.SchoolFoodServiceProgramServiceDescriptorId ||
                    this.SchoolFoodServiceProgramServiceDescriptorId.Equals(input.SchoolFoodServiceProgramServiceDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.SchoolFoodServiceProgramServiceDescriptorId.GetHashCode();
