...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_charterStatusDescriptor")]
    public partial class EdFiCharterStatusDescriptor : IEquatable<EdFiCharterStatusDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCharterStatusDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiCharterStatusDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCharterStatusDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="charterStatusDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiCharterStatusDescriptor(string id = default(string), int charterStatusDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiCharterStatusDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiCharterStatusDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiCharterStatusDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "charterStatusDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CharterStatusDescriptorId: ").Append(CharterStatusDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiCharterStatusDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiCharterStatusDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiCharterStatusDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiCharterStatusDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CharterStatusDescriptorId == input.CharterStatusDescriptorId ||
                    this.CharterStatusDescriptorId.Equals(input.CharterStatusDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.CharterStatusDescriptorId.GetHashCode();
