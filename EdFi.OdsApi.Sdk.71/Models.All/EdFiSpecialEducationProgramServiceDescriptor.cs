...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_specialEducationProgramServiceDescriptor")]
    public partial class EdFiSpecialEducationProgramServiceDescriptor : IEquatable<EdFiSpecialEducationProgramServiceDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSpecialEducationProgramServiceDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiSpecialEducationProgramServiceDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSpecialEducationProgramServiceDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="specialEducationProgramServiceDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiSpecialEducationProgramServiceDescriptor(string id = default(string), int specialEducationProgramServiceDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiSpecialEducationProgramServiceDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiSpecialEducationProgramServiceDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiSpecialEducationProgramServiceDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "specialEducationProgramServiceDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SpecialEducationProgramServiceDescriptorId: ").Append(SpecialEducationProgramServiceDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiSpecialEducationProgramServiceDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiSpecialEducationProgramServiceDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiSpecialEducationProgramServiceDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiSpecialEducationProgramServiceDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.SpecialEducationProgramServiceDescriptorId == input.SpecialEducationProgramServiceDescriptorId ||
                    this.SpecialEducationProgramServiceDescriptorId.Equals(input.SpecialEducationProgramServiceDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.SpecialEducationProgramServiceDescriptorId.GetHashCode();
