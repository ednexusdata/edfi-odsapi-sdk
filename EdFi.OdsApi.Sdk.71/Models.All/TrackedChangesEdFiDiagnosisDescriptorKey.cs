...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_diagnosisDescriptorKey")]
    public partial class TrackedChangesEdFiDiagnosisDescriptorKey : IEquatable<TrackedChangesEdFiDiagnosisDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiDiagnosisDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiDiagnosisDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiDiagnosisDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiDiagnosisDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiDiagnosisDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiDiagnosisDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiDiagnosisDescriptorKey input)
        {
            if (input == null)
            {
                return false;
