...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_educationOrganizationIdentificationSystemDescriptor")]
    public partial class EdFiEducationOrganizationIdentificationSystemDescriptor : IEquatable<EdFiEducationOrganizationIdentificationSystemDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiEducationOrganizationIdentificationSystemDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiEducationOrganizationIdentificationSystemDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiEducationOrganizationIdentificationSystemDescriptor" /> class.
        /// </summary>
        ...
        public EdFiEducationOrganizationIdentificationSystemDescriptor(string id = default(string), int educationOrganizationIdentificationSystemDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiEducationOrganizationIdentificationSystemDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiEducationOrganizationIdentificationSystemDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiEducationOrganizationIdentificationSystemDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "educationOrganizationIdentificationSystemDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  EducationOrganizationIdentificationSystemDescriptorId: ").Append(EducationOrganizationIdentificationSystemDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiEducationOrganizationIdentificationSystemDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiEducationOrganizationIdentificationSystemDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiEducationOrganizationIdentificationSystemDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiEducationOrganizationIdentificationSystemDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.EducationOrganizationIdentificationSystemDescriptorId == input.EducationOrganizationIdentificationSystemDescriptorId ||
                    this.EducationOrganizationIdentificationSystemDescriptorId.Equals(input.EducationOrganizationIdentificationSystemDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.EducationOrganizationIdentificationSystemDescriptorId.GetHashCode();
