...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_educationPlanDescriptor")]
    public partial class EdFiEducationPlanDescriptor : IEquatable<EdFiEducationPlanDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiEducationPlanDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiEducationPlanDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiEducationPlanDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="educationPlanDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiEducationPlanDescriptor(string id = default(string), int educationPlanDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiEducationPlanDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiEducationPlanDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiEducationPlanDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "educationPlanDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  EducationPlanDescriptorId: ").Append(EducationPlanDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiEducationPlanDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiEducationPlanDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiEducationPlanDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiEducationPlanDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.EducationPlanDescriptorId == input.EducationPlanDescriptorId ||
                    this.EducationPlanDescriptorId.Equals(input.EducationPlanDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.EducationPlanDescriptorId.GetHashCode();
