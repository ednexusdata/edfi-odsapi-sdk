...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_teachingCredentialBasisDescriptorKeyChange")]
    public partial class TrackedChangesEdFiTeachingCredentialBasisDescriptorKeyChange : IEquatable<TrackedChangesEdFiTeachingCredentialBasisDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiTeachingCredentialBasisDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiTeachingCredentialBasisDescriptorKey oldKeyValues = default(TrackedChangesEdFiTeachingCredentialBasisDescriptorKey), TrackedChangesEdFiTeachingCredentialBasisDescriptorKey newKeyValues = default(TrackedChangesEdFiTeachingCredentialBasisDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiTeachingCredentialBasisDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiTeachingCredentialBasisDescriptorKey NewKeyValues { get; set; }
        ...
        {
            return this.Equals(input as TrackedChangesEdFiTeachingCredentialBasisDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiTeachingCredentialBasisDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiTeachingCredentialBasisDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiTeachingCredentialBasisDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
