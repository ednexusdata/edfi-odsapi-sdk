...
{
    /// <summary>
    /// SampleStudentGraduationPlanAssociationCTEProgram
    /// </summary>
    [DataContract(Name = "sample_studentGraduationPlanAssociationCTEProgram")]
    public partial class SampleStudentGraduationPlanAssociationCTEProgram : IEquatable<SampleStudentGraduationPlanAssociationCTEProgram>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleStudentGraduationPlanAssociationCTEProgram" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SampleStudentGraduationPlanAssociationCTEProgram() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleStudentGraduationPlanAssociationCTEProgram" /> class.
        /// </summary>
        ...
        public SampleStudentGraduationPlanAssociationCTEProgram(string careerPathwayDescriptor = default(string), string cipCode = default(string), bool? cteProgramCompletionIndicator = default(bool?), bool? primaryCTEProgramIndicator = default(bool?))
        {
            // to ensure "careerPathwayDescriptor" is required (not null)
            if (careerPathwayDescriptor == null)
            {
                throw new ArgumentNullException("careerPathwayDescriptor is a required property for SampleStudentGraduationPlanAssociationCTEProgram and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SampleStudentGraduationPlanAssociationCTEProgram {\n");
        ...
        {
            return this.Equals(input as SampleStudentGraduationPlanAssociationCTEProgram);
        }

        /// <summary>
        /// Returns true if SampleStudentGraduationPlanAssociationCTEProgram instances are equal
        /// </summary>
        /// <param name="input">Instance of SampleStudentGraduationPlanAssociationCTEProgram to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SampleStudentGraduationPlanAssociationCTEProgram input)
        {
            if (input == null)
            {
                return false;
