...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_schoolTypeDescriptor")]
    public partial class EdFiSchoolTypeDescriptor : IEquatable<EdFiSchoolTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSchoolTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiSchoolTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSchoolTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="schoolTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiSchoolTypeDescriptor(string id = default(string), int schoolTypeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiSchoolTypeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiSchoolTypeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiSchoolTypeDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "schoolTypeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SchoolTypeDescriptorId: ").Append(SchoolTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiSchoolTypeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiSchoolTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiSchoolTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiSchoolTypeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.SchoolTypeDescriptorId == input.SchoolTypeDescriptorId ||
                    this.SchoolTypeDescriptorId.Equals(input.SchoolTypeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.SchoolTypeDescriptorId.GetHashCode();
