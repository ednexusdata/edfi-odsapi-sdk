...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// EdFiSexDescriptor
    /// </summary>
    [DataContract(Name = "edFi_sexDescriptor")]
    public partial class EdFiSexDescriptor : IEquatable<EdFiSexDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSexDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiSexDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSexDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="sexDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiSexDescriptor(string id = default(string), int sexDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiSexDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiSexDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiSexDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "sexDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SexDescriptorId: ").Append(SexDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiSexDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiSexDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiSexDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiSexDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.SexDescriptorId == input.SexDescriptorId ||
                    this.SexDescriptorId.Equals(input.SexDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.SexDescriptorId.GetHashCode();
