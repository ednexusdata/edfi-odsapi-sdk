...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_educationPlanDescriptorKey")]
    public partial class TrackedChangesEdFiEducationPlanDescriptorKey : IEquatable<TrackedChangesEdFiEducationPlanDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiEducationPlanDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiEducationPlanDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiEducationPlanDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiEducationPlanDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiEducationPlanDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiEducationPlanDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiEducationPlanDescriptorKey input)
        {
            if (input == null)
            {
                return false;
