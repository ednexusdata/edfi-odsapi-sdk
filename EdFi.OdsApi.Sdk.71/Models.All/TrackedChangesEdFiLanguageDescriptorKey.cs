...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_languageDescriptorKey")]
    public partial class TrackedChangesEdFiLanguageDescriptorKey : IEquatable<TrackedChangesEdFiLanguageDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiLanguageDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiLanguageDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiLanguageDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiLanguageDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiLanguageDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiLanguageDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiLanguageDescriptorKey input)
        {
            if (input == null)
            {
                return false;
