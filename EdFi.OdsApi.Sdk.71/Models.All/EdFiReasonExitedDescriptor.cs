...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_reasonExitedDescriptor")]
    public partial class EdFiReasonExitedDescriptor : IEquatable<EdFiReasonExitedDescriptor>, IValidatableObject
    {
        ...
        protected EdFiReasonExitedDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiReasonExitedDescriptor" /> class.
        /// </summary>
        ...
        public EdFiReasonExitedDescriptor(string id = default(string), int reasonExitedDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiReasonExitedDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiReasonExitedDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiReasonExitedDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "reasonExitedDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ReasonExitedDescriptorId: ").Append(ReasonExitedDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiReasonExitedDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiReasonExitedDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiReasonExitedDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiReasonExitedDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ReasonExitedDescriptorId == input.ReasonExitedDescriptorId ||
                    this.ReasonExitedDescriptorId.Equals(input.ReasonExitedDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ReasonExitedDescriptorId.GetHashCode();
