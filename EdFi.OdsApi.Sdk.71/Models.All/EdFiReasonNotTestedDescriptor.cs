...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_reasonNotTestedDescriptor")]
    public partial class EdFiReasonNotTestedDescriptor : IEquatable<EdFiReasonNotTestedDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiReasonNotTestedDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiReasonNotTestedDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiReasonNotTestedDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="reasonNotTestedDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiReasonNotTestedDescriptor(string id = default(string), int reasonNotTestedDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiReasonNotTestedDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiReasonNotTestedDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiReasonNotTestedDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "reasonNotTestedDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ReasonNotTestedDescriptorId: ").Append(ReasonNotTestedDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiReasonNotTestedDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiReasonNotTestedDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiReasonNotTestedDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiReasonNotTestedDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ReasonNotTestedDescriptorId == input.ReasonNotTestedDescriptorId ||
                    this.ReasonNotTestedDescriptorId.Equals(input.ReasonNotTestedDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ReasonNotTestedDescriptorId.GetHashCode();
