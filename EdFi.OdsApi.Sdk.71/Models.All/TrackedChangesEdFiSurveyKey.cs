...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TrackedChangesEdFiSurveyKey : IEquatable<TrackedChangesEdFiSurveyKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiSurveyKey(string _namespace = default(string), string surveyIdentifier = default(string))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSurveyKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSurveyKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSurveyKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSurveyKey input)
        {
            if (input == null)
            {
                return false;
