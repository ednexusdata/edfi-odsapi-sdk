...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_studentNeglectedOrDelinquentProgramAssociationKey")]
    public partial class TrackedChangesEdFiStudentNeglectedOrDelinquentProgramAssociationKey : IEquatable<TrackedChangesEdFiStudentNeglectedOrDelinquentProgramAssociationKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiStudentNeglectedOrDelinquentProgramAssociationKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiStudentNeglectedOrDelinquentProgramAssociationKey(DateTime beginDate = default(DateTime), long educationOrganizationId = default(long), long programEducationOrganizationId = default(long), string programName = default(string), string programTypeDescriptor = default(string), string studentUniqueId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiStudentNeglectedOrDelinquentProgramAssociationKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStudentNeglectedOrDelinquentProgramAssociationKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStudentNeglectedOrDelinquentProgramAssociationKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStudentNeglectedOrDelinquentProgramAssociationKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStudentNeglectedOrDelinquentProgramAssociationKey input)
        {
            if (input == null)
            {
                return false;
