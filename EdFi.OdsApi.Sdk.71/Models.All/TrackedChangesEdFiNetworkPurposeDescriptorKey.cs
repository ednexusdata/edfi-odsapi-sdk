...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_networkPurposeDescriptorKey")]
    public partial class TrackedChangesEdFiNetworkPurposeDescriptorKey : IEquatable<TrackedChangesEdFiNetworkPurposeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiNetworkPurposeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiNetworkPurposeDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiNetworkPurposeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiNetworkPurposeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiNetworkPurposeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiNetworkPurposeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiNetworkPurposeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
