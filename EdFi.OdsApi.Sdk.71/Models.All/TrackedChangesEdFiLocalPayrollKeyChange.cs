...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_localPayrollKeyChange")]
    public partial class TrackedChangesEdFiLocalPayrollKeyChange : IEquatable<TrackedChangesEdFiLocalPayrollKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiLocalPayrollKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiLocalPayrollKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiLocalPayrollKey oldKeyValues = default(TrackedChangesEdFiLocalPayrollKey), TrackedChangesEdFiLocalPayrollKey newKeyValues = default(TrackedChangesEdFiLocalPayrollKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiLocalPayrollKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiLocalPayrollKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiLocalPayrollKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiLocalPayrollKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiLocalPayrollKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiLocalPayrollKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiLocalPayrollKeyChange input)
        {
            if (input == null)
            {
                return false;
