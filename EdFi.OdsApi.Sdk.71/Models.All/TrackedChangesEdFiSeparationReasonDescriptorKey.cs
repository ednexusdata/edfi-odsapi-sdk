...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_separationReasonDescriptorKey")]
    public partial class TrackedChangesEdFiSeparationReasonDescriptorKey : IEquatable<TrackedChangesEdFiSeparationReasonDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiSeparationReasonDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiSeparationReasonDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiSeparationReasonDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSeparationReasonDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSeparationReasonDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSeparationReasonDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSeparationReasonDescriptorKey input)
        {
            if (input == null)
            {
                return false;
