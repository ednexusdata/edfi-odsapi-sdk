...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_fundDimensionKey")]
    public partial class TrackedChangesEdFiFundDimensionKey : IEquatable<TrackedChangesEdFiFundDimensionKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiFundDimensionKey(string code = default(string), int fiscalYear = default(int))
        {
            this.Code = code;
        ...
        {
            return this.Equals(input as TrackedChangesEdFiFundDimensionKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiFundDimensionKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiFundDimensionKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiFundDimensionKey input)
        {
            if (input == null)
            {
                return false;
