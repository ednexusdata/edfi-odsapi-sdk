...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiStudentSectionAssociationReference : IEquatable<EdFiStudentSectionAssociationReference>, IValidatableObject
    {
        ...
        public EdFiStudentSectionAssociationReference(DateTime beginDate = default(DateTime), string localCourseCode = default(string), long schoolId = default(long), int schoolYear = default(int), string sectionIdentifier = default(string), string sessionName = default(string), string studentUniqueId = default(string), Link link = default(Link))
        {
            ...
            {
                throw new ArgumentNullException("sectionIdentifier is a required property for EdFiStudentSectionAssociationReference and cannot be null");
            }
            this.SectionIdentifier = sectionIdentifier;
            // to ensure "sessionName" is required (not null)
            if (sessionName == null)
            {
                throw new ArgumentNullException("sessionName is a required property for EdFiStudentSectionAssociationReference and cannot be null");
            }
            this.SessionName = sessionName;
            // to ensure "studentUniqueId" is required (not null)
            if (studentUniqueId == null)
            {
                throw new ArgumentNullException("studentUniqueId is a required property for EdFiStudentSectionAssociationReference and cannot be null");
            }
