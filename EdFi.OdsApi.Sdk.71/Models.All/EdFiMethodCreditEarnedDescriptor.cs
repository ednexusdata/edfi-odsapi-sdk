...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_methodCreditEarnedDescriptor")]
    public partial class EdFiMethodCreditEarnedDescriptor : IEquatable<EdFiMethodCreditEarnedDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiMethodCreditEarnedDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiMethodCreditEarnedDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiMethodCreditEarnedDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="methodCreditEarnedDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiMethodCreditEarnedDescriptor(string id = default(string), int methodCreditEarnedDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiMethodCreditEarnedDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiMethodCreditEarnedDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiMethodCreditEarnedDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "methodCreditEarnedDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MethodCreditEarnedDescriptorId: ").Append(MethodCreditEarnedDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiMethodCreditEarnedDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiMethodCreditEarnedDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiMethodCreditEarnedDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiMethodCreditEarnedDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.MethodCreditEarnedDescriptorId == input.MethodCreditEarnedDescriptorId ||
                    this.MethodCreditEarnedDescriptorId.Equals(input.MethodCreditEarnedDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.MethodCreditEarnedDescriptorId.GetHashCode();
