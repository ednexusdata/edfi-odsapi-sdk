...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_studentProgramAssociationKeyChange")]
    public partial class TrackedChangesEdFiStudentProgramAssociationKeyChange : IEquatable<TrackedChangesEdFiStudentProgramAssociationKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiStudentProgramAssociationKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiStudentProgramAssociationKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiStudentProgramAssociationKey oldKeyValues = default(TrackedChangesEdFiStudentProgramAssociationKey), TrackedChangesEdFiStudentProgramAssociationKey newKeyValues = default(TrackedChangesEdFiStudentProgramAssociationKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiStudentProgramAssociationKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiStudentProgramAssociationKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiStudentProgramAssociationKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStudentProgramAssociationKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStudentProgramAssociationKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStudentProgramAssociationKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStudentProgramAssociationKeyChange input)
        {
            if (input == null)
            {
                return false;
