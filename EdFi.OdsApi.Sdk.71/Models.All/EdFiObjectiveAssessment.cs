...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiObjectiveAssessment : IEquatable<EdFiObjectiveAssessment>, IValidatableObject
    {
        ...
        public EdFiObjectiveAssessment(string id = default(string), string identificationCode = default(string), EdFiAssessmentReference assessmentReference = default(EdFiAssessmentReference), EdFiObjectiveAssessmentReference parentObjectiveAssessmentReference = default(EdFiObjectiveAssessmentReference), string academicSubjectDescriptor = default(string), List<EdFiObjectiveAssessmentAssessmentItem> assessmentItems = default(List<EdFiObjectiveAssessmentAssessmentItem>), string description = default(string), List<EdFiObjectiveAssessmentLearningStandard> learningStandards = default(List<EdFiObjectiveAssessmentLearningStandard>), double? maxRawScore = default(double?), string nomenclature = default(string), double? percentOfAssessment = default(double?), List<EdFiObjectiveAssessmentPerformanceLevel> performanceLevels = default(List<EdFiObjectiveAssessmentPerformanceLevel>), List<EdFiObjectiveAssessmentScore> scores = default(List<EdFiObjectiveAssessmentScore>), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
