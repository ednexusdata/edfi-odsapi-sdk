...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_localEducationAgencyKeyChange")]
    public partial class TrackedChangesEdFiLocalEducationAgencyKeyChange : IEquatable<TrackedChangesEdFiLocalEducationAgencyKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiLocalEducationAgencyKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiLocalEducationAgencyKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiLocalEducationAgencyKey oldKeyValues = default(TrackedChangesEdFiLocalEducationAgencyKey), TrackedChangesEdFiLocalEducationAgencyKey newKeyValues = default(TrackedChangesEdFiLocalEducationAgencyKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiLocalEducationAgencyKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiLocalEducationAgencyKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiLocalEducationAgencyKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiLocalEducationAgencyKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiLocalEducationAgencyKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiLocalEducationAgencyKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiLocalEducationAgencyKeyChange input)
        {
            if (input == null)
            {
                return false;
