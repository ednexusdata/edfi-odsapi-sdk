...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_disciplineActionLengthDifferenceReasonDescriptor")]
    public partial class EdFiDisciplineActionLengthDifferenceReasonDescriptor : IEquatable<EdFiDisciplineActionLengthDifferenceReasonDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiDisciplineActionLengthDifferenceReasonDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiDisciplineActionLengthDifferenceReasonDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiDisciplineActionLengthDifferenceReasonDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="disciplineActionLengthDifferenceReasonDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiDisciplineActionLengthDifferenceReasonDescriptor(string id = default(string), int disciplineActionLengthDifferenceReasonDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiDisciplineActionLengthDifferenceReasonDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiDisciplineActionLengthDifferenceReasonDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiDisciplineActionLengthDifferenceReasonDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "disciplineActionLengthDifferenceReasonDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DisciplineActionLengthDifferenceReasonDescriptorId: ").Append(DisciplineActionLengthDifferenceReasonDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiDisciplineActionLengthDifferenceReasonDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiDisciplineActionLengthDifferenceReasonDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiDisciplineActionLengthDifferenceReasonDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiDisciplineActionLengthDifferenceReasonDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.DisciplineActionLengthDifferenceReasonDescriptorId == input.DisciplineActionLengthDifferenceReasonDescriptorId ||
                    this.DisciplineActionLengthDifferenceReasonDescriptorId.Equals(input.DisciplineActionLengthDifferenceReasonDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.DisciplineActionLengthDifferenceReasonDescriptorId.GetHashCode();
