...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_objectDimensionReportingTag")]
    public partial class EdFiObjectDimensionReportingTag : IEquatable<EdFiObjectDimensionReportingTag>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiObjectDimensionReportingTag" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiObjectDimensionReportingTag() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiObjectDimensionReportingTag" /> class.
        /// </summary>
        /// <param name="reportingTagDescriptor">Optional tag for accountability reporting. (required).</param>
        public EdFiObjectDimensionReportingTag(string reportingTagDescriptor = default(string))
        {
            // to ensure "reportingTagDescriptor" is required (not null)
            if (reportingTagDescriptor == null)
            {
                throw new ArgumentNullException("reportingTagDescriptor is a required property for EdFiObjectDimensionReportingTag and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiObjectDimensionReportingTag {\n");
        ...
        {
            return this.Equals(input as EdFiObjectDimensionReportingTag);
        }

        /// <summary>
        /// Returns true if EdFiObjectDimensionReportingTag instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiObjectDimensionReportingTag to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiObjectDimensionReportingTag input)
        {
            if (input == null)
            {
                return false;
