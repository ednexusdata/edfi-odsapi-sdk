...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiStudentDisciplineIncidentBehaviorAssociationReference : IEquatable<EdFiStudentDisciplineIncidentBehaviorAssociationReference>, IValidatableObject
    {
        ...
        public EdFiStudentDisciplineIncidentBehaviorAssociationReference(string behaviorDescriptor = default(string), string incidentIdentifier = default(string), long schoolId = default(long), string studentUniqueId = default(string), Link link = default(Link))
        {
