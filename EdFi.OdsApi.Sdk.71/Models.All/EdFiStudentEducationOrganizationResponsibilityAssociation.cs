...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiStudentEducationOrganizationResponsibilityAssociation : IEquatable<EdFiStudentEducationOrganizationResponsibilityAssociation>, IValidatableObject
    {
        ...
        public EdFiStudentEducationOrganizationResponsibilityAssociation(string id = default(string), DateTime beginDate = default(DateTime), string responsibilityDescriptor = default(string), EdFiEducationOrganizationReference educationOrganizationReference = default(EdFiEducationOrganizationReference), EdFiStudentReference studentReference = default(EdFiStudentReference), DateTime? endDate = default(DateTime?), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
