...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_academicSubjectDescriptor")]
    public partial class EdFiAcademicSubjectDescriptor : IEquatable<EdFiAcademicSubjectDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAcademicSubjectDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiAcademicSubjectDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAcademicSubjectDescriptor" /> class.
        /// </summary>
        ...
        public EdFiAcademicSubjectDescriptor(string id = default(string), int academicSubjectDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiAcademicSubjectDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiAcademicSubjectDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiAcademicSubjectDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "academicSubjectDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AcademicSubjectDescriptorId: ").Append(AcademicSubjectDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiAcademicSubjectDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiAcademicSubjectDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiAcademicSubjectDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiAcademicSubjectDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AcademicSubjectDescriptorId == input.AcademicSubjectDescriptorId ||
                    this.AcademicSubjectDescriptorId.Equals(input.AcademicSubjectDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.AcademicSubjectDescriptorId.GetHashCode();
