...
{
    /// <summary>
    /// SampleArtMediumDescriptor
    /// </summary>
    [DataContract(Name = "sample_artMediumDescriptor")]
    public partial class SampleArtMediumDescriptor : IEquatable<SampleArtMediumDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleArtMediumDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SampleArtMediumDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleArtMediumDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="artMediumDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public SampleArtMediumDescriptor(string id = default(string), int artMediumDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for SampleArtMediumDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for SampleArtMediumDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for SampleArtMediumDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.ArtMediumDescriptorId = artMediumDescriptorId;
        ...
        [DataMember(Name = "artMediumDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SampleArtMediumDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  ArtMediumDescriptorId: ").Append(ArtMediumDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as SampleArtMediumDescriptor);
        }

        /// <summary>
        /// Returns true if SampleArtMediumDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of SampleArtMediumDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SampleArtMediumDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ArtMediumDescriptorId == input.ArtMediumDescriptorId ||
                    this.ArtMediumDescriptorId.Equals(input.ArtMediumDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ArtMediumDescriptorId.GetHashCode();
