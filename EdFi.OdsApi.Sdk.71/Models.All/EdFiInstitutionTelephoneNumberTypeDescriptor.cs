...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_institutionTelephoneNumberTypeDescriptor")]
    public partial class EdFiInstitutionTelephoneNumberTypeDescriptor : IEquatable<EdFiInstitutionTelephoneNumberTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiInstitutionTelephoneNumberTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiInstitutionTelephoneNumberTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiInstitutionTelephoneNumberTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="institutionTelephoneNumberTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiInstitutionTelephoneNumberTypeDescriptor(string id = default(string), int institutionTelephoneNumberTypeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiInstitutionTelephoneNumberTypeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiInstitutionTelephoneNumberTypeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiInstitutionTelephoneNumberTypeDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "institutionTelephoneNumberTypeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  InstitutionTelephoneNumberTypeDescriptorId: ").Append(InstitutionTelephoneNumberTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiInstitutionTelephoneNumberTypeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiInstitutionTelephoneNumberTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiInstitutionTelephoneNumberTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiInstitutionTelephoneNumberTypeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.InstitutionTelephoneNumberTypeDescriptorId == input.InstitutionTelephoneNumberTypeDescriptorId ||
                    this.InstitutionTelephoneNumberTypeDescriptorId.Equals(input.InstitutionTelephoneNumberTypeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.InstitutionTelephoneNumberTypeDescriptorId.GetHashCode();
