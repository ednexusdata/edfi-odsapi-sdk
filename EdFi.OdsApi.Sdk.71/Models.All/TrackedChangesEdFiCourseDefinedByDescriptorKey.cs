...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_courseDefinedByDescriptorKey")]
    public partial class TrackedChangesEdFiCourseDefinedByDescriptorKey : IEquatable<TrackedChangesEdFiCourseDefinedByDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCourseDefinedByDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCourseDefinedByDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCourseDefinedByDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCourseDefinedByDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCourseDefinedByDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCourseDefinedByDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCourseDefinedByDescriptorKey input)
        {
            if (input == null)
            {
                return false;
