...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiSurveyProgramAssociation : IEquatable<EdFiSurveyProgramAssociation>, IValidatableObject
    {
        ...
        public EdFiSurveyProgramAssociation(string id = default(string), EdFiProgramReference programReference = default(EdFiProgramReference), EdFiSurveyReference surveyReference = default(EdFiSurveyReference), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
