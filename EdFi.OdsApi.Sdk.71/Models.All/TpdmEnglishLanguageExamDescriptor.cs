...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "tpdm_englishLanguageExamDescriptor")]
    public partial class TpdmEnglishLanguageExamDescriptor : IEquatable<TpdmEnglishLanguageExamDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmEnglishLanguageExamDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmEnglishLanguageExamDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmEnglishLanguageExamDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="englishLanguageExamDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmEnglishLanguageExamDescriptor(string id = default(string), int englishLanguageExamDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for TpdmEnglishLanguageExamDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for TpdmEnglishLanguageExamDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for TpdmEnglishLanguageExamDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "englishLanguageExamDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  EnglishLanguageExamDescriptorId: ").Append(EnglishLanguageExamDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmEnglishLanguageExamDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmEnglishLanguageExamDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmEnglishLanguageExamDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmEnglishLanguageExamDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.EnglishLanguageExamDescriptorId == input.EnglishLanguageExamDescriptorId ||
                    this.EnglishLanguageExamDescriptorId.Equals(input.EnglishLanguageExamDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.EnglishLanguageExamDescriptorId.GetHashCode();
