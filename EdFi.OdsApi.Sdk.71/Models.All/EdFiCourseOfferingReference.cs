...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiCourseOfferingReference : IEquatable<EdFiCourseOfferingReference>, IValidatableObject
    {
        ...
        public EdFiCourseOfferingReference(string localCourseCode = default(string), long schoolId = default(long), int schoolYear = default(int), string sessionName = default(string), Link link = default(Link))
        {
            // to ensure "localCourseCode" is required (not null)
            if (localCourseCode == null)
            {
                throw new ArgumentNullException("localCourseCode is a required property for EdFiCourseOfferingReference and cannot be null");
            }
            ...
            if (sessionName == null)
            {
                throw new ArgumentNullException("sessionName is a required property for EdFiCourseOfferingReference and cannot be null");
            }
