...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_studentParticipationCodeDescriptorKey")]
    public partial class TrackedChangesEdFiStudentParticipationCodeDescriptorKey : IEquatable<TrackedChangesEdFiStudentParticipationCodeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiStudentParticipationCodeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiStudentParticipationCodeDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiStudentParticipationCodeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStudentParticipationCodeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStudentParticipationCodeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStudentParticipationCodeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStudentParticipationCodeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
