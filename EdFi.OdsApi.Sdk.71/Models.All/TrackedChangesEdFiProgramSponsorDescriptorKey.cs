...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_programSponsorDescriptorKey")]
    public partial class TrackedChangesEdFiProgramSponsorDescriptorKey : IEquatable<TrackedChangesEdFiProgramSponsorDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiProgramSponsorDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiProgramSponsorDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiProgramSponsorDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiProgramSponsorDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiProgramSponsorDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiProgramSponsorDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiProgramSponsorDescriptorKey input)
        {
            if (input == null)
            {
                return false;
