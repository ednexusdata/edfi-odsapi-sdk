...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_titleIPartASchoolDesignationDescriptor")]
    public partial class EdFiTitleIPartASchoolDesignationDescriptor : IEquatable<EdFiTitleIPartASchoolDesignationDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiTitleIPartASchoolDesignationDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiTitleIPartASchoolDesignationDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiTitleIPartASchoolDesignationDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="titleIPartASchoolDesignationDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiTitleIPartASchoolDesignationDescriptor(string id = default(string), int titleIPartASchoolDesignationDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiTitleIPartASchoolDesignationDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiTitleIPartASchoolDesignationDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiTitleIPartASchoolDesignationDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "titleIPartASchoolDesignationDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TitleIPartASchoolDesignationDescriptorId: ").Append(TitleIPartASchoolDesignationDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiTitleIPartASchoolDesignationDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiTitleIPartASchoolDesignationDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiTitleIPartASchoolDesignationDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiTitleIPartASchoolDesignationDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.TitleIPartASchoolDesignationDescriptorId == input.TitleIPartASchoolDesignationDescriptorId ||
                    this.TitleIPartASchoolDesignationDescriptorId.Equals(input.TitleIPartASchoolDesignationDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.TitleIPartASchoolDesignationDescriptorId.GetHashCode();
