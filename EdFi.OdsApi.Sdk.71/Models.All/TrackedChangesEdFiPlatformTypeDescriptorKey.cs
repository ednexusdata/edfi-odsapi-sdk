...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_platformTypeDescriptorKey")]
    public partial class TrackedChangesEdFiPlatformTypeDescriptorKey : IEquatable<TrackedChangesEdFiPlatformTypeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiPlatformTypeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiPlatformTypeDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiPlatformTypeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiPlatformTypeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiPlatformTypeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiPlatformTypeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiPlatformTypeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
