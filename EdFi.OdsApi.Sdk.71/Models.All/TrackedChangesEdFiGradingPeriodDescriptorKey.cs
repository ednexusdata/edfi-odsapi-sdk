...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_gradingPeriodDescriptorKey")]
    public partial class TrackedChangesEdFiGradingPeriodDescriptorKey : IEquatable<TrackedChangesEdFiGradingPeriodDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiGradingPeriodDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiGradingPeriodDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiGradingPeriodDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiGradingPeriodDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiGradingPeriodDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiGradingPeriodDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiGradingPeriodDescriptorKey input)
        {
            if (input == null)
            {
                return false;
