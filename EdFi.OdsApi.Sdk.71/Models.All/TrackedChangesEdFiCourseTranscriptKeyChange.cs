...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_courseTranscriptKeyChange")]
    public partial class TrackedChangesEdFiCourseTranscriptKeyChange : IEquatable<TrackedChangesEdFiCourseTranscriptKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCourseTranscriptKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCourseTranscriptKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiCourseTranscriptKey oldKeyValues = default(TrackedChangesEdFiCourseTranscriptKey), TrackedChangesEdFiCourseTranscriptKey newKeyValues = default(TrackedChangesEdFiCourseTranscriptKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiCourseTranscriptKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiCourseTranscriptKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCourseTranscriptKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCourseTranscriptKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCourseTranscriptKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCourseTranscriptKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCourseTranscriptKeyChange input)
        {
            if (input == null)
            {
                return false;
