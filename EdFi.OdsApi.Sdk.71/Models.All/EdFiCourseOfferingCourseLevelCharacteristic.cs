...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiCourseOfferingCourseLevelCharacteristic : IEquatable<EdFiCourseOfferingCourseLevelCharacteristic>, IValidatableObject
    {
        ...
        public EdFiCourseOfferingCourseLevelCharacteristic(string courseLevelCharacteristicDescriptor = default(string))
        {
            ...
            {
                throw new ArgumentNullException("courseLevelCharacteristicDescriptor is a required property for EdFiCourseOfferingCourseLevelCharacteristic and cannot be null");
            }
