...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TrackedChangesEdFiStudentSectionAttendanceEventKey : IEquatable<TrackedChangesEdFiStudentSectionAttendanceEventKey>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStudentSectionAttendanceEventKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStudentSectionAttendanceEventKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStudentSectionAttendanceEventKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStudentSectionAttendanceEventKey input)
        {
            if (input == null)
            {
                return false;
