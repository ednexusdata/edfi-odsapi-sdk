...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "tpdm_evaluationElementRatingLevelDescriptor")]
    public partial class TpdmEvaluationElementRatingLevelDescriptor : IEquatable<TpdmEvaluationElementRatingLevelDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmEvaluationElementRatingLevelDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmEvaluationElementRatingLevelDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmEvaluationElementRatingLevelDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="evaluationElementRatingLevelDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmEvaluationElementRatingLevelDescriptor(string id = default(string), int evaluationElementRatingLevelDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for TpdmEvaluationElementRatingLevelDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for TpdmEvaluationElementRatingLevelDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for TpdmEvaluationElementRatingLevelDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.EvaluationElementRatingLevelDescriptorId = evaluationElementRatingLevelDescriptorId;
        ...
        [DataMember(Name = "evaluationElementRatingLevelDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmEvaluationElementRatingLevelDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  EvaluationElementRatingLevelDescriptorId: ").Append(EvaluationElementRatingLevelDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmEvaluationElementRatingLevelDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmEvaluationElementRatingLevelDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmEvaluationElementRatingLevelDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmEvaluationElementRatingLevelDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.EvaluationElementRatingLevelDescriptorId == input.EvaluationElementRatingLevelDescriptorId ||
                    this.EvaluationElementRatingLevelDescriptorId.Equals(input.EvaluationElementRatingLevelDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.EvaluationElementRatingLevelDescriptorId.GetHashCode();
