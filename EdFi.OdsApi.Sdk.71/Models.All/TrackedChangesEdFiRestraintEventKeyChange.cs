...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_restraintEventKeyChange")]
    public partial class TrackedChangesEdFiRestraintEventKeyChange : IEquatable<TrackedChangesEdFiRestraintEventKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiRestraintEventKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiRestraintEventKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiRestraintEventKey oldKeyValues = default(TrackedChangesEdFiRestraintEventKey), TrackedChangesEdFiRestraintEventKey newKeyValues = default(TrackedChangesEdFiRestraintEventKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiRestraintEventKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiRestraintEventKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiRestraintEventKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiRestraintEventKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiRestraintEventKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiRestraintEventKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiRestraintEventKeyChange input)
        {
            if (input == null)
            {
                return false;
