...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_careerPathwayDescriptorKey")]
    public partial class TrackedChangesEdFiCareerPathwayDescriptorKey : IEquatable<TrackedChangesEdFiCareerPathwayDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCareerPathwayDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCareerPathwayDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCareerPathwayDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCareerPathwayDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCareerPathwayDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCareerPathwayDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCareerPathwayDescriptorKey input)
        {
            if (input == null)
            {
                return false;
