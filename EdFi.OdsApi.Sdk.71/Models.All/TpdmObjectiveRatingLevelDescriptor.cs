...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "tpdm_objectiveRatingLevelDescriptor")]
    public partial class TpdmObjectiveRatingLevelDescriptor : IEquatable<TpdmObjectiveRatingLevelDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmObjectiveRatingLevelDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmObjectiveRatingLevelDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmObjectiveRatingLevelDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="objectiveRatingLevelDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmObjectiveRatingLevelDescriptor(string id = default(string), int objectiveRatingLevelDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for TpdmObjectiveRatingLevelDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for TpdmObjectiveRatingLevelDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for TpdmObjectiveRatingLevelDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.ObjectiveRatingLevelDescriptorId = objectiveRatingLevelDescriptorId;
        ...
        [DataMember(Name = "objectiveRatingLevelDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmObjectiveRatingLevelDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  ObjectiveRatingLevelDescriptorId: ").Append(ObjectiveRatingLevelDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmObjectiveRatingLevelDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmObjectiveRatingLevelDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmObjectiveRatingLevelDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmObjectiveRatingLevelDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ObjectiveRatingLevelDescriptorId == input.ObjectiveRatingLevelDescriptorId ||
                    this.ObjectiveRatingLevelDescriptorId.Equals(input.ObjectiveRatingLevelDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ObjectiveRatingLevelDescriptorId.GetHashCode();
