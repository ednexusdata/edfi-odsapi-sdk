...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_calendarKeyChange")]
    public partial class TrackedChangesEdFiCalendarKeyChange : IEquatable<TrackedChangesEdFiCalendarKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCalendarKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCalendarKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiCalendarKey oldKeyValues = default(TrackedChangesEdFiCalendarKey), TrackedChangesEdFiCalendarKey newKeyValues = default(TrackedChangesEdFiCalendarKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiCalendarKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiCalendarKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCalendarKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCalendarKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCalendarKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCalendarKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCalendarKeyChange input)
        {
            if (input == null)
            {
                return false;
