...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TrackedChangesEdFiSurveyResponseStaffTargetAssociationKey : IEquatable<TrackedChangesEdFiSurveyResponseStaffTargetAssociationKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiSurveyResponseStaffTargetAssociationKey(string staffUniqueId = default(string), string _namespace = default(string), string surveyIdentifier = default(string), string surveyResponseIdentifier = default(string))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSurveyResponseStaffTargetAssociationKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSurveyResponseStaffTargetAssociationKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSurveyResponseStaffTargetAssociationKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSurveyResponseStaffTargetAssociationKey input)
        {
            if (input == null)
            {
                return false;
