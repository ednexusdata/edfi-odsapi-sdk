...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_interactivityStyleDescriptorKey")]
    public partial class TrackedChangesEdFiInteractivityStyleDescriptorKey : IEquatable<TrackedChangesEdFiInteractivityStyleDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiInteractivityStyleDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiInteractivityStyleDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiInteractivityStyleDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiInteractivityStyleDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiInteractivityStyleDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiInteractivityStyleDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiInteractivityStyleDescriptorKey input)
        {
            if (input == null)
            {
                return false;
