...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiCohort : IEquatable<EdFiCohort>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // CohortDescription (string) minLength
            if (this.CohortDescription != null && this.CohortDescription.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CohortDescription, length must be greater than 1.", new [] { "CohortDescription" });
            }
