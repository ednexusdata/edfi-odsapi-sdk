...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_populationServedDescriptor")]
    public partial class EdFiPopulationServedDescriptor : IEquatable<EdFiPopulationServedDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiPopulationServedDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiPopulationServedDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiPopulationServedDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="populationServedDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiPopulationServedDescriptor(string id = default(string), int populationServedDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiPopulationServedDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiPopulationServedDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiPopulationServedDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "populationServedDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PopulationServedDescriptorId: ").Append(PopulationServedDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiPopulationServedDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiPopulationServedDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiPopulationServedDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiPopulationServedDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.PopulationServedDescriptorId == input.PopulationServedDescriptorId ||
                    this.PopulationServedDescriptorId.Equals(input.PopulationServedDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.PopulationServedDescriptorId.GetHashCode();
