...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "tpdm_accreditationStatusDescriptor")]
    public partial class TpdmAccreditationStatusDescriptor : IEquatable<TpdmAccreditationStatusDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmAccreditationStatusDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmAccreditationStatusDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmAccreditationStatusDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="accreditationStatusDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmAccreditationStatusDescriptor(string id = default(string), int accreditationStatusDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for TpdmAccreditationStatusDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for TpdmAccreditationStatusDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for TpdmAccreditationStatusDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.AccreditationStatusDescriptorId = accreditationStatusDescriptorId;
        ...
        [DataMember(Name = "accreditationStatusDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmAccreditationStatusDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  AccreditationStatusDescriptorId: ").Append(AccreditationStatusDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmAccreditationStatusDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmAccreditationStatusDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmAccreditationStatusDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmAccreditationStatusDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AccreditationStatusDescriptorId == input.AccreditationStatusDescriptorId ||
                    this.AccreditationStatusDescriptorId.Equals(input.AccreditationStatusDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.AccreditationStatusDescriptorId.GetHashCode();
