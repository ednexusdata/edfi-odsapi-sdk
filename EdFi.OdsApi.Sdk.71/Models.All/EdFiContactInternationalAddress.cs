...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiContactInternationalAddress : IEquatable<EdFiContactInternationalAddress>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiContactInternationalAddress(string addressTypeDescriptor = default(string), string countryDescriptor = default(string), string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string), string addressLine4 = default(string), DateTime? beginDate = default(DateTime?), DateTime? endDate = default(DateTime?), string latitude = default(string), string longitude = default(string))
        {
        ...
        {
            return this.Equals(input as EdFiContactInternationalAddress);
        }

        /// <summary>
        /// Returns true if EdFiContactInternationalAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiContactInternationalAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiContactInternationalAddress input)
        {
            if (input == null)
            {
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.AddressLine4 != null && this.AddressLine4.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AddressLine4, length must be greater than 1.", new [] { "AddressLine4" });
            }
