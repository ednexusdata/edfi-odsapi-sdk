...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TpdmCandidateOtherName : IEquatable<TpdmCandidateOtherName>, IValidatableObject
    {
        ...
        public TpdmCandidateOtherName(string otherNameTypeDescriptor = default(string), string firstName = default(string), string generationCodeSuffix = default(string), string lastSurname = default(string), string middleName = default(string), string personalTitlePrefix = default(string))
        {
            ...
            {
                throw new ArgumentNullException("otherNameTypeDescriptor is a required property for TpdmCandidateOtherName and cannot be null");
            }
            this.OtherNameTypeDescriptor = otherNameTypeDescriptor;
            // to ensure "firstName" is required (not null)
            if (firstName == null)
            {
                throw new ArgumentNullException("firstName is a required property for TpdmCandidateOtherName and cannot be null");
            }
            this.FirstName = firstName;
            // to ensure "lastSurname" is required (not null)
            if (lastSurname == null)
            {
                throw new ArgumentNullException("lastSurname is a required property for TpdmCandidateOtherName and cannot be null");
            }
