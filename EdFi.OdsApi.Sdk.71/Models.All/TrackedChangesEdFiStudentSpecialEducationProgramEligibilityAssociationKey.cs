...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_studentSpecialEducationProgramEligibilityAssociationKey")]
    public partial class TrackedChangesEdFiStudentSpecialEducationProgramEligibilityAssociationKey : IEquatable<TrackedChangesEdFiStudentSpecialEducationProgramEligibilityAssociationKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiStudentSpecialEducationProgramEligibilityAssociationKey(DateTime consentToEvaluationReceivedDate = default(DateTime), long educationOrganizationId = default(long), string programName = default(string), string programTypeDescriptor = default(string), string studentUniqueId = default(string))
        {
        ...
        [DataMember(Name = "consentToEvaluationReceivedDate", EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStudentSpecialEducationProgramEligibilityAssociationKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStudentSpecialEducationProgramEligibilityAssociationKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStudentSpecialEducationProgramEligibilityAssociationKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStudentSpecialEducationProgramEligibilityAssociationKey input)
        {
            if (input == null)
            {
                return false;
