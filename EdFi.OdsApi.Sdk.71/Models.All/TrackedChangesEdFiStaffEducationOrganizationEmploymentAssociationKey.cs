...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_staffEducationOrganizationEmploymentAssociationKey")]
    public partial class TrackedChangesEdFiStaffEducationOrganizationEmploymentAssociationKey : IEquatable<TrackedChangesEdFiStaffEducationOrganizationEmploymentAssociationKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiStaffEducationOrganizationEmploymentAssociationKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiStaffEducationOrganizationEmploymentAssociationKey(string employmentStatusDescriptor = default(string), DateTime hireDate = default(DateTime), long educationOrganizationId = default(long), string staffUniqueId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiStaffEducationOrganizationEmploymentAssociationKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStaffEducationOrganizationEmploymentAssociationKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStaffEducationOrganizationEmploymentAssociationKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStaffEducationOrganizationEmploymentAssociationKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStaffEducationOrganizationEmploymentAssociationKey input)
        {
            if (input == null)
            {
                return false;
