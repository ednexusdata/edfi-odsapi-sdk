...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_locationKeyChange")]
    public partial class TrackedChangesEdFiLocationKeyChange : IEquatable<TrackedChangesEdFiLocationKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiLocationKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiLocationKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiLocationKey oldKeyValues = default(TrackedChangesEdFiLocationKey), TrackedChangesEdFiLocationKey newKeyValues = default(TrackedChangesEdFiLocationKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiLocationKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiLocationKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiLocationKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiLocationKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiLocationKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiLocationKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiLocationKeyChange input)
        {
            if (input == null)
            {
                return false;
