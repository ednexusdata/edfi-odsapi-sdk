...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_programSponsorDescriptorKeyChange")]
    public partial class TrackedChangesEdFiProgramSponsorDescriptorKeyChange : IEquatable<TrackedChangesEdFiProgramSponsorDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiProgramSponsorDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiProgramSponsorDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiProgramSponsorDescriptorKey oldKeyValues = default(TrackedChangesEdFiProgramSponsorDescriptorKey), TrackedChangesEdFiProgramSponsorDescriptorKey newKeyValues = default(TrackedChangesEdFiProgramSponsorDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiProgramSponsorDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiProgramSponsorDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiProgramSponsorDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiProgramSponsorDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiProgramSponsorDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiProgramSponsorDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiProgramSponsorDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
