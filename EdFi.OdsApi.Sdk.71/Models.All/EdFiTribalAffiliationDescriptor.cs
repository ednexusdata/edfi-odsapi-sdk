...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_tribalAffiliationDescriptor")]
    public partial class EdFiTribalAffiliationDescriptor : IEquatable<EdFiTribalAffiliationDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiTribalAffiliationDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiTribalAffiliationDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiTribalAffiliationDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="tribalAffiliationDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiTribalAffiliationDescriptor(string id = default(string), int tribalAffiliationDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiTribalAffiliationDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiTribalAffiliationDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiTribalAffiliationDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "tribalAffiliationDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TribalAffiliationDescriptorId: ").Append(TribalAffiliationDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiTribalAffiliationDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiTribalAffiliationDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiTribalAffiliationDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiTribalAffiliationDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.TribalAffiliationDescriptorId == input.TribalAffiliationDescriptorId ||
                    this.TribalAffiliationDescriptorId.Equals(input.TribalAffiliationDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.TribalAffiliationDescriptorId.GetHashCode();
