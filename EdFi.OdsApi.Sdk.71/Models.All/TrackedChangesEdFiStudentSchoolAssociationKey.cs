...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_studentSchoolAssociationKey")]
    public partial class TrackedChangesEdFiStudentSchoolAssociationKey : IEquatable<TrackedChangesEdFiStudentSchoolAssociationKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiStudentSchoolAssociationKey(DateTime entryDate = default(DateTime), long schoolId = default(long), string studentUniqueId = default(string))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStudentSchoolAssociationKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStudentSchoolAssociationKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStudentSchoolAssociationKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStudentSchoolAssociationKey input)
        {
            if (input == null)
            {
                return false;
