...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_assessmentItemResultDescriptorKey")]
    public partial class TrackedChangesEdFiAssessmentItemResultDescriptorKey : IEquatable<TrackedChangesEdFiAssessmentItemResultDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiAssessmentItemResultDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiAssessmentItemResultDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiAssessmentItemResultDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiAssessmentItemResultDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiAssessmentItemResultDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiAssessmentItemResultDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiAssessmentItemResultDescriptorKey input)
        {
            if (input == null)
            {
                return false;
