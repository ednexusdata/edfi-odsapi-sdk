...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TpdmAidTypeDescriptor : IEquatable<TpdmAidTypeDescriptor>, IValidatableObject
    {
        ...
        public TpdmAidTypeDescriptor(string id = default(string), int aidTypeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for TpdmAidTypeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for TpdmAidTypeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for TpdmAidTypeDescriptor and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AidTypeDescriptorId: ").Append(AidTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmAidTypeDescriptor);
        }
        ...
        public bool Equals(TpdmAidTypeDescriptor input)
        {
            ...
            return 
                ...
                (
                    this.AidTypeDescriptorId == input.AidTypeDescriptorId ||
                    this.AidTypeDescriptorId.Equals(input.AidTypeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.AidTypeDescriptorId.GetHashCode();
