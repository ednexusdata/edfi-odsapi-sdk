...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_titleIPartAProgramServiceDescriptor")]
    public partial class EdFiTitleIPartAProgramServiceDescriptor : IEquatable<EdFiTitleIPartAProgramServiceDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiTitleIPartAProgramServiceDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiTitleIPartAProgramServiceDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiTitleIPartAProgramServiceDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="titleIPartAProgramServiceDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiTitleIPartAProgramServiceDescriptor(string id = default(string), int titleIPartAProgramServiceDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiTitleIPartAProgramServiceDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiTitleIPartAProgramServiceDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiTitleIPartAProgramServiceDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.TitleIPartAProgramServiceDescriptorId = titleIPartAProgramServiceDescriptorId;
        ...
        [DataMember(Name = "titleIPartAProgramServiceDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiTitleIPartAProgramServiceDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  TitleIPartAProgramServiceDescriptorId: ").Append(TitleIPartAProgramServiceDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiTitleIPartAProgramServiceDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiTitleIPartAProgramServiceDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiTitleIPartAProgramServiceDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiTitleIPartAProgramServiceDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.TitleIPartAProgramServiceDescriptorId == input.TitleIPartAProgramServiceDescriptorId ||
                    this.TitleIPartAProgramServiceDescriptorId.Equals(input.TitleIPartAProgramServiceDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.TitleIPartAProgramServiceDescriptorId.GetHashCode();
