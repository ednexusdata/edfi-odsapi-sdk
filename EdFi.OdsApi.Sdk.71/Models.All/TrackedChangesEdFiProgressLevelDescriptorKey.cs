...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_progressLevelDescriptorKey")]
    public partial class TrackedChangesEdFiProgressLevelDescriptorKey : IEquatable<TrackedChangesEdFiProgressLevelDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiProgressLevelDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiProgressLevelDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiProgressLevelDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiProgressLevelDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiProgressLevelDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiProgressLevelDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiProgressLevelDescriptorKey input)
        {
            if (input == null)
            {
                return false;
