...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "tpdm_rubricRatingLevelDescriptor")]
    public partial class TpdmRubricRatingLevelDescriptor : IEquatable<TpdmRubricRatingLevelDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmRubricRatingLevelDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmRubricRatingLevelDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmRubricRatingLevelDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="rubricRatingLevelDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmRubricRatingLevelDescriptor(string id = default(string), int rubricRatingLevelDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for TpdmRubricRatingLevelDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for TpdmRubricRatingLevelDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for TpdmRubricRatingLevelDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.RubricRatingLevelDescriptorId = rubricRatingLevelDescriptorId;
        ...
        [DataMember(Name = "rubricRatingLevelDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmRubricRatingLevelDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  RubricRatingLevelDescriptorId: ").Append(RubricRatingLevelDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmRubricRatingLevelDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmRubricRatingLevelDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmRubricRatingLevelDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmRubricRatingLevelDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.RubricRatingLevelDescriptorId == input.RubricRatingLevelDescriptorId ||
                    this.RubricRatingLevelDescriptorId.Equals(input.RubricRatingLevelDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.RubricRatingLevelDescriptorId.GetHashCode();
