...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiCourseIdentificationCode : IEquatable<EdFiCourseIdentificationCode>, IValidatableObject
    {
        ...
        public EdFiCourseIdentificationCode(string courseIdentificationSystemDescriptor = default(string), string assigningOrganizationIdentificationCode = default(string), string courseCatalogURL = default(string), string identificationCode = default(string))
        {
            ...
            {
                throw new ArgumentNullException("courseIdentificationSystemDescriptor is a required property for EdFiCourseIdentificationCode and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("identificationCode is a required property for EdFiCourseIdentificationCode and cannot be null");
            }
