...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_separationDescriptor")]
    public partial class EdFiSeparationDescriptor : IEquatable<EdFiSeparationDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSeparationDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiSeparationDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSeparationDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="separationDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        [DataMember(Name = "separationDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SeparationDescriptorId: ").Append(SeparationDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiSeparationDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiSeparationDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiSeparationDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiSeparationDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.SeparationDescriptorId == input.SeparationDescriptorId ||
                    this.SeparationDescriptorId.Equals(input.SeparationDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.SeparationDescriptorId.GetHashCode();
