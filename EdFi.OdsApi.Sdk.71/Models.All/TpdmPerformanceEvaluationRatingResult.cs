...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TpdmPerformanceEvaluationRatingResult : IEquatable<TpdmPerformanceEvaluationRatingResult>, IValidatableObject
    {
        ...
        public TpdmPerformanceEvaluationRatingResult(double rating = default(double), string ratingResultTitle = default(string), string resultDatatypeTypeDescriptor = default(string))
        {
            ...
            {
                throw new ArgumentNullException("ratingResultTitle is a required property for TpdmPerformanceEvaluationRatingResult and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("resultDatatypeTypeDescriptor is a required property for TpdmPerformanceEvaluationRatingResult and cannot be null");
            }
