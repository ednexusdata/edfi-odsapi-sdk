...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_assignmentLateStatusDescriptorKey")]
    public partial class TrackedChangesEdFiAssignmentLateStatusDescriptorKey : IEquatable<TrackedChangesEdFiAssignmentLateStatusDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiAssignmentLateStatusDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiAssignmentLateStatusDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiAssignmentLateStatusDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiAssignmentLateStatusDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiAssignmentLateStatusDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiAssignmentLateStatusDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiAssignmentLateStatusDescriptorKey input)
        {
            if (input == null)
            {
                return false;
