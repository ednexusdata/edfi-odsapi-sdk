...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_assessmentItemKey")]
    public partial class TrackedChangesEdFiAssessmentItemKey : IEquatable<TrackedChangesEdFiAssessmentItemKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiAssessmentItemKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiAssessmentItemKey(string identificationCode = default(string), string assessmentIdentifier = default(string), string _namespace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiAssessmentItemKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiAssessmentItemKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiAssessmentItemKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiAssessmentItemKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiAssessmentItemKey input)
        {
            if (input == null)
            {
                return false;
