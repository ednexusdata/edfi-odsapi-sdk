...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_titleIPartASchoolDesignationDescriptorKey")]
    public partial class TrackedChangesEdFiTitleIPartASchoolDesignationDescriptorKey : IEquatable<TrackedChangesEdFiTitleIPartASchoolDesignationDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiTitleIPartASchoolDesignationDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiTitleIPartASchoolDesignationDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiTitleIPartASchoolDesignationDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiTitleIPartASchoolDesignationDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiTitleIPartASchoolDesignationDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiTitleIPartASchoolDesignationDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiTitleIPartASchoolDesignationDescriptorKey input)
        {
            if (input == null)
            {
                return false;
