...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_cohortTypeDescriptor")]
    public partial class EdFiCohortTypeDescriptor : IEquatable<EdFiCohortTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCohortTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiCohortTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCohortTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="cohortTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiCohortTypeDescriptor(string id = default(string), int cohortTypeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiCohortTypeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiCohortTypeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiCohortTypeDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "cohortTypeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CohortTypeDescriptorId: ").Append(CohortTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiCohortTypeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiCohortTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiCohortTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiCohortTypeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CohortTypeDescriptorId == input.CohortTypeDescriptorId ||
                    this.CohortTypeDescriptorId.Equals(input.CohortTypeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.CohortTypeDescriptorId.GetHashCode();
