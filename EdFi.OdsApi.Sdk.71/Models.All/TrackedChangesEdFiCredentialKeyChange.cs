...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_credentialKeyChange")]
    public partial class TrackedChangesEdFiCredentialKeyChange : IEquatable<TrackedChangesEdFiCredentialKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCredentialKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCredentialKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiCredentialKey oldKeyValues = default(TrackedChangesEdFiCredentialKey), TrackedChangesEdFiCredentialKey newKeyValues = default(TrackedChangesEdFiCredentialKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiCredentialKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiCredentialKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCredentialKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCredentialKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCredentialKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCredentialKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCredentialKeyChange input)
        {
            if (input == null)
            {
                return false;
