...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiLearningStandard : IEquatable<EdFiLearningStandard>, IValidatableObject
    {
        ...
        public EdFiLearningStandard(string id = default(string), List<EdFiLearningStandardAcademicSubject> academicSubjects = default(List<EdFiLearningStandardAcademicSubject>), List<EdFiLearningStandardGradeLevel> gradeLevels = default(List<EdFiLearningStandardGradeLevel>), string learningStandardId = default(string), EdFiLearningStandardReference parentLearningStandardReference = default(EdFiLearningStandardReference), EdFiLearningStandardContentStandard contentStandard = default(EdFiLearningStandardContentStandard), string courseTitle = default(string), string description = default(string), List<EdFiLearningStandardIdentificationCode> identificationCodes = default(List<EdFiLearningStandardIdentificationCode>), string learningStandardCategoryDescriptor = default(string), string learningStandardItemCode = default(string), string learningStandardScopeDescriptor = default(string), string _namespace = default(string), string successCriteria = default(string), string uri = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            ...
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiLearningStandard and cannot be null");
            }
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // LearningStandardId (string) minLength
            if (this.LearningStandardId != null && this.LearningStandardId.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for LearningStandardId, length must be greater than 1.", new [] { "LearningStandardId" });
            }
            ...
            // LearningStandardItemCode (string) minLength
            if (this.LearningStandardItemCode != null && this.LearningStandardItemCode.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for LearningStandardItemCode, length must be greater than 1.", new [] { "LearningStandardItemCode" });
            }
            ...
            // SuccessCriteria (string) minLength
            if (this.SuccessCriteria != null && this.SuccessCriteria.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SuccessCriteria, length must be greater than 1.", new [] { "SuccessCriteria" });
            }
