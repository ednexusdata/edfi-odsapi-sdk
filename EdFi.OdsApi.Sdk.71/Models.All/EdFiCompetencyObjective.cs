...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiCompetencyObjective : IEquatable<EdFiCompetencyObjective>, IValidatableObject
    {
        ...
        public EdFiCompetencyObjective(string id = default(string), string objective = default(string), string objectiveGradeLevelDescriptor = default(string), EdFiEducationOrganizationReference educationOrganizationReference = default(EdFiEducationOrganizationReference), string competencyObjectiveId = default(string), string description = default(string), string successCriteria = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // CompetencyObjectiveId (string) minLength
            if (this.CompetencyObjectiveId != null && this.CompetencyObjectiveId.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CompetencyObjectiveId, length must be greater than 1.", new [] { "CompetencyObjectiveId" });
            }
