...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_tpdm_evaluationElementKeyChange")]
    public partial class TrackedChangesTpdmEvaluationElementKeyChange : IEquatable<TrackedChangesTpdmEvaluationElementKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesTpdmEvaluationElementKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesTpdmEvaluationElementKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesTpdmEvaluationElementKey oldKeyValues = default(TrackedChangesTpdmEvaluationElementKey), TrackedChangesTpdmEvaluationElementKey newKeyValues = default(TrackedChangesTpdmEvaluationElementKey))
        {
            this.Id = id;
        ...
        public TrackedChangesTpdmEvaluationElementKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesTpdmEvaluationElementKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesTpdmEvaluationElementKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesTpdmEvaluationElementKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesTpdmEvaluationElementKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesTpdmEvaluationElementKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesTpdmEvaluationElementKeyChange input)
        {
            if (input == null)
            {
                return false;
