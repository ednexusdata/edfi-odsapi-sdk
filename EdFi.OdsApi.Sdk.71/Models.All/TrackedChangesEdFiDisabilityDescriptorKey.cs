...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_disabilityDescriptorKey")]
    public partial class TrackedChangesEdFiDisabilityDescriptorKey : IEquatable<TrackedChangesEdFiDisabilityDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiDisabilityDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiDisabilityDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiDisabilityDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiDisabilityDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiDisabilityDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiDisabilityDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiDisabilityDescriptorKey input)
        {
            if (input == null)
            {
                return false;
