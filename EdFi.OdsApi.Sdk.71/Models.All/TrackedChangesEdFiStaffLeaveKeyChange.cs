...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_staffLeaveKeyChange")]
    public partial class TrackedChangesEdFiStaffLeaveKeyChange : IEquatable<TrackedChangesEdFiStaffLeaveKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiStaffLeaveKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiStaffLeaveKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiStaffLeaveKey oldKeyValues = default(TrackedChangesEdFiStaffLeaveKey), TrackedChangesEdFiStaffLeaveKey newKeyValues = default(TrackedChangesEdFiStaffLeaveKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiStaffLeaveKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiStaffLeaveKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiStaffLeaveKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStaffLeaveKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStaffLeaveKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStaffLeaveKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStaffLeaveKeyChange input)
        {
            if (input == null)
            {
                return false;
