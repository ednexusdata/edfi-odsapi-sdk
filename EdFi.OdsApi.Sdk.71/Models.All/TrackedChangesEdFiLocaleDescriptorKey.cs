...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_localeDescriptorKey")]
    public partial class TrackedChangesEdFiLocaleDescriptorKey : IEquatable<TrackedChangesEdFiLocaleDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiLocaleDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiLocaleDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiLocaleDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiLocaleDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiLocaleDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiLocaleDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiLocaleDescriptorKey input)
        {
            if (input == null)
            {
                return false;
