...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TrackedChangesEdFiStaffProgramAssociationKey : IEquatable<TrackedChangesEdFiStaffProgramAssociationKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiStaffProgramAssociationKey(DateTime beginDate = default(DateTime), long programEducationOrganizationId = default(long), string programName = default(string), string programTypeDescriptor = default(string), string staffUniqueId = default(string))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStaffProgramAssociationKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStaffProgramAssociationKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStaffProgramAssociationKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStaffProgramAssociationKey input)
        {
            if (input == null)
            {
                return false;
