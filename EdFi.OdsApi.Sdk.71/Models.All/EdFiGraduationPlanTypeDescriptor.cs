...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_graduationPlanTypeDescriptor")]
    public partial class EdFiGraduationPlanTypeDescriptor : IEquatable<EdFiGraduationPlanTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiGraduationPlanTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiGraduationPlanTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiGraduationPlanTypeDescriptor" /> class.
        /// </summary>
        ...
        public EdFiGraduationPlanTypeDescriptor(string id = default(string), int graduationPlanTypeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiGraduationPlanTypeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiGraduationPlanTypeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiGraduationPlanTypeDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "graduationPlanTypeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  GraduationPlanTypeDescriptorId: ").Append(GraduationPlanTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiGraduationPlanTypeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiGraduationPlanTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiGraduationPlanTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiGraduationPlanTypeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.GraduationPlanTypeDescriptorId == input.GraduationPlanTypeDescriptorId ||
                    this.GraduationPlanTypeDescriptorId.Equals(input.GraduationPlanTypeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.GraduationPlanTypeDescriptorId.GetHashCode();
