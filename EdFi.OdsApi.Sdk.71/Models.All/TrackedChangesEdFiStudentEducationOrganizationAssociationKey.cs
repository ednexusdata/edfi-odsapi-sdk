...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_studentEducationOrganizationAssociationKey")]
    public partial class TrackedChangesEdFiStudentEducationOrganizationAssociationKey : IEquatable<TrackedChangesEdFiStudentEducationOrganizationAssociationKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiStudentEducationOrganizationAssociationKey(long educationOrganizationId = default(long), string studentUniqueId = default(string))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStudentEducationOrganizationAssociationKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStudentEducationOrganizationAssociationKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStudentEducationOrganizationAssociationKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStudentEducationOrganizationAssociationKey input)
        {
            if (input == null)
            {
                return false;
