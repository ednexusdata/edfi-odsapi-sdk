...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiStudentCompetencyObjectiveReference : IEquatable<EdFiStudentCompetencyObjectiveReference>, IValidatableObject
    {
        ...
        public EdFiStudentCompetencyObjectiveReference(string gradingPeriodDescriptor = default(string), long gradingPeriodSchoolId = default(long), int gradingPeriodSchoolYear = default(int), int gradingPeriodSequence = default(int), string objective = default(string), long objectiveEducationOrganizationId = default(long), string objectiveGradeLevelDescriptor = default(string), string studentUniqueId = default(string), Link link = default(Link))
        {
