...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_tpdm_financialAidKeyChange")]
    public partial class TrackedChangesTpdmFinancialAidKeyChange : IEquatable<TrackedChangesTpdmFinancialAidKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesTpdmFinancialAidKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesTpdmFinancialAidKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesTpdmFinancialAidKey oldKeyValues = default(TrackedChangesTpdmFinancialAidKey), TrackedChangesTpdmFinancialAidKey newKeyValues = default(TrackedChangesTpdmFinancialAidKey))
        {
            this.Id = id;
        ...
        public TrackedChangesTpdmFinancialAidKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesTpdmFinancialAidKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesTpdmFinancialAidKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesTpdmFinancialAidKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesTpdmFinancialAidKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesTpdmFinancialAidKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesTpdmFinancialAidKeyChange input)
        {
            if (input == null)
            {
                return false;
