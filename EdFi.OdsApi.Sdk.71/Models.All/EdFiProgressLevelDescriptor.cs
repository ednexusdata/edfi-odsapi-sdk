...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_progressLevelDescriptor")]
    public partial class EdFiProgressLevelDescriptor : IEquatable<EdFiProgressLevelDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiProgressLevelDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiProgressLevelDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiProgressLevelDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="progressLevelDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiProgressLevelDescriptor(string id = default(string), int progressLevelDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiProgressLevelDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiProgressLevelDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiProgressLevelDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "progressLevelDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ProgressLevelDescriptorId: ").Append(ProgressLevelDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiProgressLevelDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiProgressLevelDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiProgressLevelDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiProgressLevelDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ProgressLevelDescriptorId == input.ProgressLevelDescriptorId ||
                    this.ProgressLevelDescriptorId.Equals(input.ProgressLevelDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ProgressLevelDescriptorId.GetHashCode();
