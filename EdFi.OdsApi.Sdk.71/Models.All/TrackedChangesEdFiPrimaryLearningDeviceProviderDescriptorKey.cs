...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_primaryLearningDeviceProviderDescriptorKey")]
    public partial class TrackedChangesEdFiPrimaryLearningDeviceProviderDescriptorKey : IEquatable<TrackedChangesEdFiPrimaryLearningDeviceProviderDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiPrimaryLearningDeviceProviderDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiPrimaryLearningDeviceProviderDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiPrimaryLearningDeviceProviderDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiPrimaryLearningDeviceProviderDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiPrimaryLearningDeviceProviderDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiPrimaryLearningDeviceProviderDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiPrimaryLearningDeviceProviderDescriptorKey input)
        {
            if (input == null)
            {
                return false;
