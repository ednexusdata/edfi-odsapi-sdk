...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiBellScheduleGradeLevel : IEquatable<EdFiBellScheduleGradeLevel>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="EdFiBellScheduleGradeLevel" /> class.
        /// </summary>
        /// <param name="gradeLevelDescriptor">The grade levels the particular bell schedule applies to. (required).</param>
        public EdFiBellScheduleGradeLevel(string gradeLevelDescriptor = default(string))
        {
            ...
            {
                throw new ArgumentNullException("gradeLevelDescriptor is a required property for EdFiBellScheduleGradeLevel and cannot be null");
            }
