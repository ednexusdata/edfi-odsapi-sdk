...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiStudentEducationOrganizationAssociationDisability : IEquatable<EdFiStudentEducationOrganizationAssociationDisability>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // DisabilityDiagnosis (string) minLength
            if (this.DisabilityDiagnosis != null && this.DisabilityDiagnosis.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DisabilityDiagnosis, length must be greater than 1.", new [] { "DisabilityDiagnosis" });
            }
