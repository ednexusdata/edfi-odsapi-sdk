...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TrackedChangesEdFiSurveyResponseEducationOrganizationTargetAssociationKey : IEquatable<TrackedChangesEdFiSurveyResponseEducationOrganizationTargetAssociationKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiSurveyResponseEducationOrganizationTargetAssociationKey(long educationOrganizationId = default(long), string _namespace = default(string), string surveyIdentifier = default(string), string surveyResponseIdentifier = default(string))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSurveyResponseEducationOrganizationTargetAssociationKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSurveyResponseEducationOrganizationTargetAssociationKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSurveyResponseEducationOrganizationTargetAssociationKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSurveyResponseEducationOrganizationTargetAssociationKey input)
        {
            if (input == null)
            {
                return false;
