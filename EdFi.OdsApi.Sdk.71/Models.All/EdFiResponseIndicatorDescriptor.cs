...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_responseIndicatorDescriptor")]
    public partial class EdFiResponseIndicatorDescriptor : IEquatable<EdFiResponseIndicatorDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiResponseIndicatorDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiResponseIndicatorDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiResponseIndicatorDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="responseIndicatorDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiResponseIndicatorDescriptor(string id = default(string), int responseIndicatorDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiResponseIndicatorDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiResponseIndicatorDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiResponseIndicatorDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "responseIndicatorDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ResponseIndicatorDescriptorId: ").Append(ResponseIndicatorDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiResponseIndicatorDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiResponseIndicatorDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiResponseIndicatorDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiResponseIndicatorDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ResponseIndicatorDescriptorId == input.ResponseIndicatorDescriptorId ||
                    this.ResponseIndicatorDescriptorId.Equals(input.ResponseIndicatorDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ResponseIndicatorDescriptorId.GetHashCode();
