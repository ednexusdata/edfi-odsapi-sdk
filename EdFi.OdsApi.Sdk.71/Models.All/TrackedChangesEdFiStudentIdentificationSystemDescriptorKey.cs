...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_studentIdentificationSystemDescriptorKey")]
    public partial class TrackedChangesEdFiStudentIdentificationSystemDescriptorKey : IEquatable<TrackedChangesEdFiStudentIdentificationSystemDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiStudentIdentificationSystemDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiStudentIdentificationSystemDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiStudentIdentificationSystemDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStudentIdentificationSystemDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStudentIdentificationSystemDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStudentIdentificationSystemDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStudentIdentificationSystemDescriptorKey input)
        {
            if (input == null)
            {
                return false;
