...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TrackedChangesEdFiAcademicWeekKey : IEquatable<TrackedChangesEdFiAcademicWeekKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiAcademicWeekKey(string weekIdentifier = default(string), long schoolId = default(long))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiAcademicWeekKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiAcademicWeekKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiAcademicWeekKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiAcademicWeekKey input)
        {
            if (input == null)
            {
                return false;
