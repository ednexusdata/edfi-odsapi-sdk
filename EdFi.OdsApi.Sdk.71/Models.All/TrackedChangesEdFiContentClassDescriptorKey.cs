...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_contentClassDescriptorKey")]
    public partial class TrackedChangesEdFiContentClassDescriptorKey : IEquatable<TrackedChangesEdFiContentClassDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiContentClassDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiContentClassDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiContentClassDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiContentClassDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiContentClassDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiContentClassDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiContentClassDescriptorKey input)
        {
            if (input == null)
            {
                return false;
