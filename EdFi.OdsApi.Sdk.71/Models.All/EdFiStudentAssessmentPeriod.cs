...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_studentAssessmentPeriod")]
    public partial class EdFiStudentAssessmentPeriod : IEquatable<EdFiStudentAssessmentPeriod>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentAssessmentPeriod" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiStudentAssessmentPeriod() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentAssessmentPeriod" /> class.
        /// </summary>
        ...
        public EdFiStudentAssessmentPeriod(string assessmentPeriodDescriptor = default(string), DateTime? beginDate = default(DateTime?), DateTime? endDate = default(DateTime?))
        {
            // to ensure "assessmentPeriodDescriptor" is required (not null)
            if (assessmentPeriodDescriptor == null)
            {
                throw new ArgumentNullException("assessmentPeriodDescriptor is a required property for EdFiStudentAssessmentPeriod and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiStudentAssessmentPeriod {\n");
        ...
        {
            return this.Equals(input as EdFiStudentAssessmentPeriod);
        }

        /// <summary>
        /// Returns true if EdFiStudentAssessmentPeriod instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStudentAssessmentPeriod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStudentAssessmentPeriod input)
        {
            if (input == null)
            {
                return false;
