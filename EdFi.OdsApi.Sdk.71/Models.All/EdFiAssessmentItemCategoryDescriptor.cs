...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_assessmentItemCategoryDescriptor")]
    public partial class EdFiAssessmentItemCategoryDescriptor : IEquatable<EdFiAssessmentItemCategoryDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAssessmentItemCategoryDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiAssessmentItemCategoryDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAssessmentItemCategoryDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="assessmentItemCategoryDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiAssessmentItemCategoryDescriptor(string id = default(string), int assessmentItemCategoryDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiAssessmentItemCategoryDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiAssessmentItemCategoryDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiAssessmentItemCategoryDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "assessmentItemCategoryDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AssessmentItemCategoryDescriptorId: ").Append(AssessmentItemCategoryDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiAssessmentItemCategoryDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiAssessmentItemCategoryDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiAssessmentItemCategoryDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiAssessmentItemCategoryDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AssessmentItemCategoryDescriptorId == input.AssessmentItemCategoryDescriptorId ||
                    this.AssessmentItemCategoryDescriptorId.Equals(input.AssessmentItemCategoryDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.AssessmentItemCategoryDescriptorId.GetHashCode();
