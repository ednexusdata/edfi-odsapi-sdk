...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_interventionKeyChange")]
    public partial class TrackedChangesEdFiInterventionKeyChange : IEquatable<TrackedChangesEdFiInterventionKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiInterventionKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiInterventionKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiInterventionKey oldKeyValues = default(TrackedChangesEdFiInterventionKey), TrackedChangesEdFiInterventionKey newKeyValues = default(TrackedChangesEdFiInterventionKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiInterventionKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiInterventionKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiInterventionKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiInterventionKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiInterventionKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiInterventionKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiInterventionKeyChange input)
        {
            if (input == null)
            {
                return false;
