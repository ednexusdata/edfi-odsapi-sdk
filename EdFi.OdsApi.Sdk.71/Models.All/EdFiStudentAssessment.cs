    ...
    public partial class EdFiStudentAssessment : IEquatable<EdFiStudentAssessment>, IValidatableObject
    {
        ...
        public bool Equals(EdFiStudentAssessment input)
        {
            ...
            return 
                ...
                (
                    this.ReportedSchoolReference == input.ReportedSchoolReference ||
                    (this.ReportedSchoolReference != null &&
                    this.ReportedSchoolReference.Equals(input.ReportedSchoolReference))
                ) && 
                (
                ...
                (
                    this.ReportedSchoolIdentifier == input.ReportedSchoolIdentifier ||
                    (this.ReportedSchoolIdentifier != null &&
                    this.ReportedSchoolIdentifier.Equals(input.ReportedSchoolIdentifier))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.ReportedSchoolReference.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.ReportedSchoolIdentifier.GetHashCode();
                }
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.EventDescription != null && this.EventDescription.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for EventDescription, length must be greater than 1.", new [] { "EventDescription" });
            }
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ReportedSchoolIdentifier, length must be less than 60.", new [] { "ReportedSchoolIdentifier" });
            }

            // ReportedSchoolIdentifier (string) minLength
            if (this.ReportedSchoolIdentifier != null && this.ReportedSchoolIdentifier.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ReportedSchoolIdentifier, length must be greater than 1.", new [] { "ReportedSchoolIdentifier" });
            }
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SerialNumber, length must be greater than 1.", new [] { "SerialNumber" });
            }
