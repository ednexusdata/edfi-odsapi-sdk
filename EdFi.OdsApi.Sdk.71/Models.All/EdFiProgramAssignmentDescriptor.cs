...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_programAssignmentDescriptor")]
    public partial class EdFiProgramAssignmentDescriptor : IEquatable<EdFiProgramAssignmentDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiProgramAssignmentDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiProgramAssignmentDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiProgramAssignmentDescriptor" /> class.
        /// </summary>
        ...
        public EdFiProgramAssignmentDescriptor(string id = default(string), int programAssignmentDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiProgramAssignmentDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiProgramAssignmentDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiProgramAssignmentDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "programAssignmentDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ProgramAssignmentDescriptorId: ").Append(ProgramAssignmentDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiProgramAssignmentDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiProgramAssignmentDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiProgramAssignmentDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiProgramAssignmentDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ProgramAssignmentDescriptorId == input.ProgramAssignmentDescriptorId ||
                    this.ProgramAssignmentDescriptorId.Equals(input.ProgramAssignmentDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ProgramAssignmentDescriptorId.GetHashCode();
