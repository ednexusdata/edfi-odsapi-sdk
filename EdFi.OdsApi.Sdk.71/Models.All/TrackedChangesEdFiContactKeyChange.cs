...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_contactKeyChange")]
    public partial class TrackedChangesEdFiContactKeyChange : IEquatable<TrackedChangesEdFiContactKeyChange>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiContactKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiContactKey oldKeyValues = default(TrackedChangesEdFiContactKey), TrackedChangesEdFiContactKey newKeyValues = default(TrackedChangesEdFiContactKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiContactKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiContactKey NewKeyValues { get; set; }
        ...
        {
            return this.Equals(input as TrackedChangesEdFiContactKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiContactKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiContactKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiContactKeyChange input)
        {
            if (input == null)
            {
                return false;
