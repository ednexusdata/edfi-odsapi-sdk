...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_assessmentCategoryDescriptorKeyChange")]
    public partial class TrackedChangesEdFiAssessmentCategoryDescriptorKeyChange : IEquatable<TrackedChangesEdFiAssessmentCategoryDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiAssessmentCategoryDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiAssessmentCategoryDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiAssessmentCategoryDescriptorKey oldKeyValues = default(TrackedChangesEdFiAssessmentCategoryDescriptorKey), TrackedChangesEdFiAssessmentCategoryDescriptorKey newKeyValues = default(TrackedChangesEdFiAssessmentCategoryDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiAssessmentCategoryDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiAssessmentCategoryDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiAssessmentCategoryDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiAssessmentCategoryDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiAssessmentCategoryDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiAssessmentCategoryDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiAssessmentCategoryDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
