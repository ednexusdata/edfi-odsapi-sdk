...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_learningStandardKeyChange")]
    public partial class TrackedChangesEdFiLearningStandardKeyChange : IEquatable<TrackedChangesEdFiLearningStandardKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiLearningStandardKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiLearningStandardKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiLearningStandardKey oldKeyValues = default(TrackedChangesEdFiLearningStandardKey), TrackedChangesEdFiLearningStandardKey newKeyValues = default(TrackedChangesEdFiLearningStandardKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiLearningStandardKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiLearningStandardKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiLearningStandardKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiLearningStandardKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiLearningStandardKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiLearningStandardKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiLearningStandardKeyChange input)
        {
            if (input == null)
            {
                return false;
