...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiContact : IEquatable<EdFiContact>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiContact(string id = default(string), string contactUniqueId = default(string), EdFiPersonReference personReference = default(EdFiPersonReference), List<EdFiContactAddress> addresses = default(List<EdFiContactAddress>), List<EdFiContactElectronicMail> electronicMails = default(List<EdFiContactElectronicMail>), string firstName = default(string), string generationCodeSuffix = default(string), string highestCompletedLevelOfEducationDescriptor = default(string), List<EdFiContactInternationalAddress> internationalAddresses = default(List<EdFiContactInternationalAddress>), List<EdFiContactLanguage> languages = default(List<EdFiContactLanguage>), string lastSurname = default(string), string loginId = default(string), string maidenName = default(string), string middleName = default(string), List<EdFiContactOtherName> otherNames = default(List<EdFiContactOtherName>), List<EdFiContactPersonalIdentificationDocument> personalIdentificationDocuments = default(List<EdFiContactPersonalIdentificationDocument>), string personalTitlePrefix = default(string), string preferredFirstName = default(string), string preferredLastSurname = default(string), string sexDescriptor = default(string), List<EdFiContactTelephone> telephones = default(List<EdFiContactTelephone>), string etag = default(string), DateTime lastModifiedDate = default(DateTime), ContactExtensions ext = default(ContactExtensions))
        {
        ...
        public ContactExtensions Ext { get; set; }
        ...
        {
            return this.Equals(input as EdFiContact);
        }

        /// <summary>
        /// Returns true if EdFiContact instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiContact to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiContact input)
        {
            if (input == null)
            {
                return false;
