...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiCredential : IEquatable<EdFiCredential>, IValidatableObject
    {
        ...
        public EdFiCredential(string id = default(string), string credentialIdentifier = default(string), string stateOfIssueStateAbbreviationDescriptor = default(string), List<EdFiCredentialAcademicSubject> academicSubjects = default(List<EdFiCredentialAcademicSubject>), string credentialFieldDescriptor = default(string), string credentialTypeDescriptor = default(string), DateTime? effectiveDate = default(DateTime?), List<EdFiCredentialEndorsement> endorsements = default(List<EdFiCredentialEndorsement>), DateTime? expirationDate = default(DateTime?), List<EdFiCredentialGradeLevel> gradeLevels = default(List<EdFiCredentialGradeLevel>), DateTime issuanceDate = default(DateTime), string _namespace = default(string), string teachingCredentialBasisDescriptor = default(string), string teachingCredentialDescriptor = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime), CredentialExtensions ext = default(CredentialExtensions))
        {
            ...
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiCredential and cannot be null");
            }
