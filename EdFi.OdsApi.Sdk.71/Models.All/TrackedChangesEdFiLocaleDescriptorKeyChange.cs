...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_localeDescriptorKeyChange")]
    public partial class TrackedChangesEdFiLocaleDescriptorKeyChange : IEquatable<TrackedChangesEdFiLocaleDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiLocaleDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiLocaleDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiLocaleDescriptorKey oldKeyValues = default(TrackedChangesEdFiLocaleDescriptorKey), TrackedChangesEdFiLocaleDescriptorKey newKeyValues = default(TrackedChangesEdFiLocaleDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiLocaleDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiLocaleDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiLocaleDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiLocaleDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiLocaleDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiLocaleDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiLocaleDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
