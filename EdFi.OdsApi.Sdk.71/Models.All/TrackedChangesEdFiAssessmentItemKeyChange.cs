...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_assessmentItemKeyChange")]
    public partial class TrackedChangesEdFiAssessmentItemKeyChange : IEquatable<TrackedChangesEdFiAssessmentItemKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiAssessmentItemKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiAssessmentItemKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiAssessmentItemKey oldKeyValues = default(TrackedChangesEdFiAssessmentItemKey), TrackedChangesEdFiAssessmentItemKey newKeyValues = default(TrackedChangesEdFiAssessmentItemKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiAssessmentItemKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiAssessmentItemKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiAssessmentItemKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiAssessmentItemKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiAssessmentItemKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiAssessmentItemKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiAssessmentItemKeyChange input)
        {
            if (input == null)
            {
                return false;
