...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_evaluationDelayReasonDescriptor")]
    public partial class EdFiEvaluationDelayReasonDescriptor : IEquatable<EdFiEvaluationDelayReasonDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiEvaluationDelayReasonDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiEvaluationDelayReasonDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiEvaluationDelayReasonDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="evaluationDelayReasonDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiEvaluationDelayReasonDescriptor(string id = default(string), int evaluationDelayReasonDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiEvaluationDelayReasonDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiEvaluationDelayReasonDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiEvaluationDelayReasonDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.EvaluationDelayReasonDescriptorId = evaluationDelayReasonDescriptorId;
        ...
        [DataMember(Name = "evaluationDelayReasonDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiEvaluationDelayReasonDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  EvaluationDelayReasonDescriptorId: ").Append(EvaluationDelayReasonDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiEvaluationDelayReasonDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiEvaluationDelayReasonDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiEvaluationDelayReasonDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiEvaluationDelayReasonDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.EvaluationDelayReasonDescriptorId == input.EvaluationDelayReasonDescriptorId ||
                    this.EvaluationDelayReasonDescriptorId.Equals(input.EvaluationDelayReasonDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.EvaluationDelayReasonDescriptorId.GetHashCode();
