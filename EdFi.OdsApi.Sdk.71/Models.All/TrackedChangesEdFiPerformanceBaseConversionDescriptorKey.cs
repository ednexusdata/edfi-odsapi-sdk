...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_performanceBaseConversionDescriptorKey")]
    public partial class TrackedChangesEdFiPerformanceBaseConversionDescriptorKey : IEquatable<TrackedChangesEdFiPerformanceBaseConversionDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiPerformanceBaseConversionDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiPerformanceBaseConversionDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiPerformanceBaseConversionDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiPerformanceBaseConversionDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiPerformanceBaseConversionDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiPerformanceBaseConversionDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiPerformanceBaseConversionDescriptorKey input)
        {
            if (input == null)
            {
                return false;
