...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_networkPurposeDescriptor")]
    public partial class EdFiNetworkPurposeDescriptor : IEquatable<EdFiNetworkPurposeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiNetworkPurposeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiNetworkPurposeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiNetworkPurposeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="networkPurposeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiNetworkPurposeDescriptor(string id = default(string), int networkPurposeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiNetworkPurposeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiNetworkPurposeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiNetworkPurposeDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "networkPurposeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  NetworkPurposeDescriptorId: ").Append(NetworkPurposeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiNetworkPurposeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiNetworkPurposeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiNetworkPurposeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiNetworkPurposeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.NetworkPurposeDescriptorId == input.NetworkPurposeDescriptorId ||
                    this.NetworkPurposeDescriptorId.Equals(input.NetworkPurposeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.NetworkPurposeDescriptorId.GetHashCode();
