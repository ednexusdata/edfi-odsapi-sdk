...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_assessmentKeyChange")]
    public partial class TrackedChangesEdFiAssessmentKeyChange : IEquatable<TrackedChangesEdFiAssessmentKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiAssessmentKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiAssessmentKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiAssessmentKey oldKeyValues = default(TrackedChangesEdFiAssessmentKey), TrackedChangesEdFiAssessmentKey newKeyValues = default(TrackedChangesEdFiAssessmentKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiAssessmentKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiAssessmentKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiAssessmentKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiAssessmentKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiAssessmentKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiAssessmentKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiAssessmentKeyChange input)
        {
            if (input == null)
            {
                return false;
