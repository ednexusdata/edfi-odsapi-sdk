...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_disciplineIncidentParticipationCodeDescriptor")]
    public partial class EdFiDisciplineIncidentParticipationCodeDescriptor : IEquatable<EdFiDisciplineIncidentParticipationCodeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiDisciplineIncidentParticipationCodeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiDisciplineIncidentParticipationCodeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiDisciplineIncidentParticipationCodeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="disciplineIncidentParticipationCodeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiDisciplineIncidentParticipationCodeDescriptor(string id = default(string), int disciplineIncidentParticipationCodeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiDisciplineIncidentParticipationCodeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiDisciplineIncidentParticipationCodeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiDisciplineIncidentParticipationCodeDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.DisciplineIncidentParticipationCodeDescriptorId = disciplineIncidentParticipationCodeDescriptorId;
        ...
        [DataMember(Name = "disciplineIncidentParticipationCodeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiDisciplineIncidentParticipationCodeDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  DisciplineIncidentParticipationCodeDescriptorId: ").Append(DisciplineIncidentParticipationCodeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiDisciplineIncidentParticipationCodeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiDisciplineIncidentParticipationCodeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiDisciplineIncidentParticipationCodeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiDisciplineIncidentParticipationCodeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.DisciplineIncidentParticipationCodeDescriptorId == input.DisciplineIncidentParticipationCodeDescriptorId ||
                    this.DisciplineIncidentParticipationCodeDescriptorId.Equals(input.DisciplineIncidentParticipationCodeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.DisciplineIncidentParticipationCodeDescriptorId.GetHashCode();
