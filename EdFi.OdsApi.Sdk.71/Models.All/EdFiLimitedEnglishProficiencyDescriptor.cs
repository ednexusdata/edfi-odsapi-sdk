...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_limitedEnglishProficiencyDescriptor")]
    public partial class EdFiLimitedEnglishProficiencyDescriptor : IEquatable<EdFiLimitedEnglishProficiencyDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiLimitedEnglishProficiencyDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiLimitedEnglishProficiencyDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiLimitedEnglishProficiencyDescriptor" /> class.
        /// </summary>
        ...
        public EdFiLimitedEnglishProficiencyDescriptor(string id = default(string), int limitedEnglishProficiencyDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiLimitedEnglishProficiencyDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiLimitedEnglishProficiencyDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiLimitedEnglishProficiencyDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "limitedEnglishProficiencyDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  LimitedEnglishProficiencyDescriptorId: ").Append(LimitedEnglishProficiencyDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiLimitedEnglishProficiencyDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiLimitedEnglishProficiencyDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiLimitedEnglishProficiencyDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiLimitedEnglishProficiencyDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.LimitedEnglishProficiencyDescriptorId == input.LimitedEnglishProficiencyDescriptorId ||
                    this.LimitedEnglishProficiencyDescriptorId.Equals(input.LimitedEnglishProficiencyDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.LimitedEnglishProficiencyDescriptorId.GetHashCode();
