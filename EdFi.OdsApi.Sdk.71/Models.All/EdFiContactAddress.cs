...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// EdFiContactAddress
    /// </summary>
    [DataContract(Name = "edFi_contactAddress")]
    public partial class EdFiContactAddress : IEquatable<EdFiContactAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiContactAddress" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiContactAddress() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiContactAddress" /> class.
        /// </summary>
        ...
        /// <param name="periods">An unordered collection of contactAddressPeriods. The time periods for which the address is valid. For physical addresses, the periods in which the person lived at that address..</param>
        /// <param name="ext">ext.</param>
        public EdFiContactAddress(string addressTypeDescriptor = default(string), string stateAbbreviationDescriptor = default(string), string city = default(string), string postalCode = default(string), string streetNumberName = default(string), string localeDescriptor = default(string), string apartmentRoomSuiteNumber = default(string), string buildingSiteNumber = default(string), string congressionalDistrict = default(string), string countyFIPSCode = default(string), bool? doNotPublishIndicator = default(bool?), string latitude = default(string), string longitude = default(string), string nameOfCounty = default(string), List<EdFiContactAddressPeriod> periods = default(List<EdFiContactAddressPeriod>), ContactAddressExtensions ext = default(ContactAddressExtensions))
        {
            // to ensure "addressTypeDescriptor" is required (not null)
            if (addressTypeDescriptor == null)
            {
                throw new ArgumentNullException("addressTypeDescriptor is a required property for EdFiContactAddress and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("stateAbbreviationDescriptor is a required property for EdFiContactAddress and cannot be null");
            }
            this.StateAbbreviationDescriptor = stateAbbreviationDescriptor;
            // to ensure "city" is required (not null)
            if (city == null)
            {
                throw new ArgumentNullException("city is a required property for EdFiContactAddress and cannot be null");
            }
            this.City = city;
            // to ensure "postalCode" is required (not null)
            if (postalCode == null)
            {
                throw new ArgumentNullException("postalCode is a required property for EdFiContactAddress and cannot be null");
            }
            this.PostalCode = postalCode;
            // to ensure "streetNumberName" is required (not null)
            if (streetNumberName == null)
            {
                throw new ArgumentNullException("streetNumberName is a required property for EdFiContactAddress and cannot be null");
            }
        ...
        /// </summary>
        /// <value>An unordered collection of contactAddressPeriods. The time periods for which the address is valid. For physical addresses, the periods in which the person lived at that address.</value>
        [DataMember(Name = "periods", EmitDefaultValue = false)]
        public List<EdFiContactAddressPeriod> Periods { get; set; }

        /// <summary>
        /// Gets or Sets Ext
        /// </summary>
        [DataMember(Name = "_ext", EmitDefaultValue = false)]
        public ContactAddressExtensions Ext { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiContactAddress {\n");
        ...
        {
            return this.Equals(input as EdFiContactAddress);
        }

        /// <summary>
        /// Returns true if EdFiContactAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiContactAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiContactAddress input)
        {
            if (input == null)
            {
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for City, length must be greater than 2.", new [] { "City" });
            }
            ...
            // StreetNumberName (string) minLength
            if (this.StreetNumberName != null && this.StreetNumberName.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for StreetNumberName, length must be greater than 1.", new [] { "StreetNumberName" });
            }
            ...
            // ApartmentRoomSuiteNumber (string) minLength
            if (this.ApartmentRoomSuiteNumber != null && this.ApartmentRoomSuiteNumber.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ApartmentRoomSuiteNumber, length must be greater than 1.", new [] { "ApartmentRoomSuiteNumber" });
            }
            ...
            // BuildingSiteNumber (string) minLength
            if (this.BuildingSiteNumber != null && this.BuildingSiteNumber.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for BuildingSiteNumber, length must be greater than 1.", new [] { "BuildingSiteNumber" });
            }
            ...
            // CongressionalDistrict (string) minLength
            if (this.CongressionalDistrict != null && this.CongressionalDistrict.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CongressionalDistrict, length must be greater than 1.", new [] { "CongressionalDistrict" });
            }
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CountyFIPSCode, length must be greater than 3.", new [] { "CountyFIPSCode" });
            }
            ...
            // Latitude (string) minLength
            if (this.Latitude != null && this.Latitude.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Latitude, length must be greater than 1.", new [] { "Latitude" });
            }
            ...
            // Longitude (string) minLength
            if (this.Longitude != null && this.Longitude.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Longitude, length must be greater than 1.", new [] { "Longitude" });
            }
            ...
            // NameOfCounty (string) minLength
            if (this.NameOfCounty != null && this.NameOfCounty.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NameOfCounty, length must be greater than 1.", new [] { "NameOfCounty" });
            }
