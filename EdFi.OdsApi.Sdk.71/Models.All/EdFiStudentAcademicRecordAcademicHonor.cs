...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiStudentAcademicRecordAcademicHonor : IEquatable<EdFiStudentAcademicRecordAcademicHonor>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // HonorDescription (string) minLength
            if (this.HonorDescription != null && this.HonorDescription.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for HonorDescription, length must be greater than 1.", new [] { "HonorDescription" });
            }
