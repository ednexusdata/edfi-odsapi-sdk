...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_charterStatusDescriptorKey")]
    public partial class TrackedChangesEdFiCharterStatusDescriptorKey : IEquatable<TrackedChangesEdFiCharterStatusDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCharterStatusDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCharterStatusDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCharterStatusDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCharterStatusDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCharterStatusDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCharterStatusDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCharterStatusDescriptorKey input)
        {
            if (input == null)
            {
                return false;
