...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_languageInstructionProgramServiceDescriptorKey")]
    public partial class TrackedChangesEdFiLanguageInstructionProgramServiceDescriptorKey : IEquatable<TrackedChangesEdFiLanguageInstructionProgramServiceDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiLanguageInstructionProgramServiceDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiLanguageInstructionProgramServiceDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiLanguageInstructionProgramServiceDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiLanguageInstructionProgramServiceDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiLanguageInstructionProgramServiceDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiLanguageInstructionProgramServiceDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiLanguageInstructionProgramServiceDescriptorKey input)
        {
            if (input == null)
            {
                return false;
