...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_addressTypeDescriptorKey")]
    public partial class TrackedChangesEdFiAddressTypeDescriptorKey : IEquatable<TrackedChangesEdFiAddressTypeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiAddressTypeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiAddressTypeDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiAddressTypeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiAddressTypeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiAddressTypeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiAddressTypeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiAddressTypeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
