...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_disabilityDeterminationSourceTypeDescriptor")]
    public partial class EdFiDisabilityDeterminationSourceTypeDescriptor : IEquatable<EdFiDisabilityDeterminationSourceTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiDisabilityDeterminationSourceTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiDisabilityDeterminationSourceTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiDisabilityDeterminationSourceTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="disabilityDeterminationSourceTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiDisabilityDeterminationSourceTypeDescriptor(string id = default(string), int disabilityDeterminationSourceTypeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiDisabilityDeterminationSourceTypeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiDisabilityDeterminationSourceTypeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiDisabilityDeterminationSourceTypeDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "disabilityDeterminationSourceTypeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DisabilityDeterminationSourceTypeDescriptorId: ").Append(DisabilityDeterminationSourceTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiDisabilityDeterminationSourceTypeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiDisabilityDeterminationSourceTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiDisabilityDeterminationSourceTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiDisabilityDeterminationSourceTypeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.DisabilityDeterminationSourceTypeDescriptorId == input.DisabilityDeterminationSourceTypeDescriptorId ||
                    this.DisabilityDeterminationSourceTypeDescriptorId.Equals(input.DisabilityDeterminationSourceTypeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.DisabilityDeterminationSourceTypeDescriptorId.GetHashCode();
