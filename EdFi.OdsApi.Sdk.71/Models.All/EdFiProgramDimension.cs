...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_programDimension")]
    public partial class EdFiProgramDimension : IEquatable<EdFiProgramDimension>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiProgramDimension" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiProgramDimension() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiProgramDimension" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="code">The code representation of the account program dimension. (required).</param>
        /// <param name="fiscalYear">The fiscal year for which the account program dimension is valid. (required).</param>
        /// <param name="codeName">A description of the account program dimension..</param>
        /// <param name="reportingTags">An unordered collection of programDimensionReportingTags. Optional tag for accountability reporting..</param>
        /// <param name="etag">A unique system-generated value that identifies the version of the resource..</param>
        /// <param name="lastModifiedDate">The date and time the resource was last modified..</param>
        public EdFiProgramDimension(string id = default(string), string code = default(string), int fiscalYear = default(int), string codeName = default(string), List<EdFiProgramDimensionReportingTag> reportingTags = default(List<EdFiProgramDimensionReportingTag>), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "code" is required (not null)
            if (code == null)
            {
                throw new ArgumentNullException("code is a required property for EdFiProgramDimension and cannot be null");
            }
            this.Code = code;
        ...
        /// </summary>
        /// <value>A description of the account program dimension.</value>
        ...
        /// </summary>
        /// <value>An unordered collection of programDimensionReportingTags. Optional tag for accountability reporting.</value>
        [DataMember(Name = "reportingTags", EmitDefaultValue = false)]
        public List<EdFiProgramDimensionReportingTag> ReportingTags { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiProgramDimension {\n");
        ...
        {
            return this.Equals(input as EdFiProgramDimension);
        }

        /// <summary>
        /// Returns true if EdFiProgramDimension instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiProgramDimension to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiProgramDimension input)
        {
            if (input == null)
            {
                return false;
