...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_internetAccessDescriptor")]
    public partial class EdFiInternetAccessDescriptor : IEquatable<EdFiInternetAccessDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiInternetAccessDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiInternetAccessDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiInternetAccessDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="internetAccessDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiInternetAccessDescriptor(string id = default(string), int internetAccessDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiInternetAccessDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiInternetAccessDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiInternetAccessDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "internetAccessDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  InternetAccessDescriptorId: ").Append(InternetAccessDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiInternetAccessDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiInternetAccessDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiInternetAccessDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiInternetAccessDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.InternetAccessDescriptorId == input.InternetAccessDescriptorId ||
                    this.InternetAccessDescriptorId.Equals(input.InternetAccessDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.InternetAccessDescriptorId.GetHashCode();
