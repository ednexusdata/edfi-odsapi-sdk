...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_learningStandardEquivalenceStrengthDescriptorKey")]
    public partial class TrackedChangesEdFiLearningStandardEquivalenceStrengthDescriptorKey : IEquatable<TrackedChangesEdFiLearningStandardEquivalenceStrengthDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiLearningStandardEquivalenceStrengthDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiLearningStandardEquivalenceStrengthDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiLearningStandardEquivalenceStrengthDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiLearningStandardEquivalenceStrengthDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiLearningStandardEquivalenceStrengthDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiLearningStandardEquivalenceStrengthDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiLearningStandardEquivalenceStrengthDescriptorKey input)
        {
            if (input == null)
            {
                return false;
