...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_studentCompetencyObjectiveKeyChange")]
    public partial class TrackedChangesEdFiStudentCompetencyObjectiveKeyChange : IEquatable<TrackedChangesEdFiStudentCompetencyObjectiveKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiStudentCompetencyObjectiveKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiStudentCompetencyObjectiveKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiStudentCompetencyObjectiveKey oldKeyValues = default(TrackedChangesEdFiStudentCompetencyObjectiveKey), TrackedChangesEdFiStudentCompetencyObjectiveKey newKeyValues = default(TrackedChangesEdFiStudentCompetencyObjectiveKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiStudentCompetencyObjectiveKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiStudentCompetencyObjectiveKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiStudentCompetencyObjectiveKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStudentCompetencyObjectiveKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStudentCompetencyObjectiveKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStudentCompetencyObjectiveKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStudentCompetencyObjectiveKeyChange input)
        {
            if (input == null)
            {
                return false;
