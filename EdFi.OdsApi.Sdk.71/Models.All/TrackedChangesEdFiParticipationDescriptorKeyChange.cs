...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_participationDescriptorKeyChange")]
    public partial class TrackedChangesEdFiParticipationDescriptorKeyChange : IEquatable<TrackedChangesEdFiParticipationDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiParticipationDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiParticipationDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiParticipationDescriptorKey oldKeyValues = default(TrackedChangesEdFiParticipationDescriptorKey), TrackedChangesEdFiParticipationDescriptorKey newKeyValues = default(TrackedChangesEdFiParticipationDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiParticipationDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiParticipationDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiParticipationDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiParticipationDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiParticipationDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiParticipationDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiParticipationDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
