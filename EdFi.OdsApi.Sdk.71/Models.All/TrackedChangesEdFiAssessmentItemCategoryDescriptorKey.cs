...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_assessmentItemCategoryDescriptorKey")]
    public partial class TrackedChangesEdFiAssessmentItemCategoryDescriptorKey : IEquatable<TrackedChangesEdFiAssessmentItemCategoryDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiAssessmentItemCategoryDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiAssessmentItemCategoryDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiAssessmentItemCategoryDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiAssessmentItemCategoryDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiAssessmentItemCategoryDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiAssessmentItemCategoryDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiAssessmentItemCategoryDescriptorKey input)
        {
            if (input == null)
            {
                return false;
