...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_interventionEffectivenessRatingDescriptorKey")]
    public partial class TrackedChangesEdFiInterventionEffectivenessRatingDescriptorKey : IEquatable<TrackedChangesEdFiInterventionEffectivenessRatingDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiInterventionEffectivenessRatingDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiInterventionEffectivenessRatingDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiInterventionEffectivenessRatingDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiInterventionEffectivenessRatingDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiInterventionEffectivenessRatingDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiInterventionEffectivenessRatingDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiInterventionEffectivenessRatingDescriptorKey input)
        {
            if (input == null)
            {
                return false;
