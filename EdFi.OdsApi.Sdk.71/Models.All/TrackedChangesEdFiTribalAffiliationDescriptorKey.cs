...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_tribalAffiliationDescriptorKey")]
    public partial class TrackedChangesEdFiTribalAffiliationDescriptorKey : IEquatable<TrackedChangesEdFiTribalAffiliationDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiTribalAffiliationDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiTribalAffiliationDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiTribalAffiliationDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiTribalAffiliationDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiTribalAffiliationDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiTribalAffiliationDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiTribalAffiliationDescriptorKey input)
        {
            if (input == null)
            {
                return false;
