...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiFundDimension : IEquatable<EdFiFundDimension>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiFundDimension(string id = default(string), string code = default(string), int fiscalYear = default(int), string codeName = default(string), List<EdFiFundDimensionReportingTag> reportingTags = default(List<EdFiFundDimensionReportingTag>), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
        ...
        {
            return this.Equals(input as EdFiFundDimension);
        }

        /// <summary>
        /// Returns true if EdFiFundDimension instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiFundDimension to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiFundDimension input)
        {
            if (input == null)
            {
                return false;
