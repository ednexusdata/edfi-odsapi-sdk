...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_internetPerformanceInResidenceDescriptorKey")]
    public partial class TrackedChangesEdFiInternetPerformanceInResidenceDescriptorKey : IEquatable<TrackedChangesEdFiInternetPerformanceInResidenceDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiInternetPerformanceInResidenceDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiInternetPerformanceInResidenceDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiInternetPerformanceInResidenceDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiInternetPerformanceInResidenceDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiInternetPerformanceInResidenceDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiInternetPerformanceInResidenceDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiInternetPerformanceInResidenceDescriptorKey input)
        {
            if (input == null)
            {
                return false;
