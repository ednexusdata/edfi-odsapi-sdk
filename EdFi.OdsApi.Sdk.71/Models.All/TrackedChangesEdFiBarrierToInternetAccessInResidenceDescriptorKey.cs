...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_barrierToInternetAccessInResidenceDescriptorKey")]
    public partial class TrackedChangesEdFiBarrierToInternetAccessInResidenceDescriptorKey : IEquatable<TrackedChangesEdFiBarrierToInternetAccessInResidenceDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiBarrierToInternetAccessInResidenceDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiBarrierToInternetAccessInResidenceDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiBarrierToInternetAccessInResidenceDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiBarrierToInternetAccessInResidenceDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiBarrierToInternetAccessInResidenceDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiBarrierToInternetAccessInResidenceDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiBarrierToInternetAccessInResidenceDescriptorKey input)
        {
            if (input == null)
            {
                return false;
