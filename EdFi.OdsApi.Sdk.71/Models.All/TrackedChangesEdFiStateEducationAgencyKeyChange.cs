...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_stateEducationAgencyKeyChange")]
    public partial class TrackedChangesEdFiStateEducationAgencyKeyChange : IEquatable<TrackedChangesEdFiStateEducationAgencyKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiStateEducationAgencyKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiStateEducationAgencyKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiStateEducationAgencyKey oldKeyValues = default(TrackedChangesEdFiStateEducationAgencyKey), TrackedChangesEdFiStateEducationAgencyKey newKeyValues = default(TrackedChangesEdFiStateEducationAgencyKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiStateEducationAgencyKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiStateEducationAgencyKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiStateEducationAgencyKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStateEducationAgencyKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStateEducationAgencyKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStateEducationAgencyKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStateEducationAgencyKeyChange input)
        {
            if (input == null)
            {
                return false;
