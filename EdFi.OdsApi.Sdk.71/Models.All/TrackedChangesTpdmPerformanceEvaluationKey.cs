...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_tpdm_performanceEvaluationKey")]
    public partial class TrackedChangesTpdmPerformanceEvaluationKey : IEquatable<TrackedChangesTpdmPerformanceEvaluationKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesTpdmPerformanceEvaluationKey" /> class.
        /// </summary>
        ...
        public TrackedChangesTpdmPerformanceEvaluationKey(string evaluationPeriodDescriptor = default(string), string performanceEvaluationTypeDescriptor = default(string), string termDescriptor = default(string), string performanceEvaluationTitle = default(string), long educationOrganizationId = default(long), int schoolYear = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesTpdmPerformanceEvaluationKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesTpdmPerformanceEvaluationKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesTpdmPerformanceEvaluationKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesTpdmPerformanceEvaluationKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesTpdmPerformanceEvaluationKey input)
        {
            if (input == null)
            {
                return false;
