...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "tpdm_genderDescriptor")]
    public partial class TpdmGenderDescriptor : IEquatable<TpdmGenderDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmGenderDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmGenderDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmGenderDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="genderDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmGenderDescriptor(string id = default(string), int genderDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for TpdmGenderDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for TpdmGenderDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for TpdmGenderDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "genderDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  GenderDescriptorId: ").Append(GenderDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmGenderDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmGenderDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmGenderDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmGenderDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.GenderDescriptorId == input.GenderDescriptorId ||
                    this.GenderDescriptorId.Equals(input.GenderDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.GenderDescriptorId.GetHashCode();
