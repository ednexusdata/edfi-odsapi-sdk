...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_schoolChoiceImplementStatusDescriptorKey")]
    public partial class TrackedChangesEdFiSchoolChoiceImplementStatusDescriptorKey : IEquatable<TrackedChangesEdFiSchoolChoiceImplementStatusDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiSchoolChoiceImplementStatusDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiSchoolChoiceImplementStatusDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiSchoolChoiceImplementStatusDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSchoolChoiceImplementStatusDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSchoolChoiceImplementStatusDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSchoolChoiceImplementStatusDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSchoolChoiceImplementStatusDescriptorKey input)
        {
            if (input == null)
            {
                return false;
