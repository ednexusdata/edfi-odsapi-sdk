...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_methodCreditEarnedDescriptorKeyChange")]
    public partial class TrackedChangesEdFiMethodCreditEarnedDescriptorKeyChange : IEquatable<TrackedChangesEdFiMethodCreditEarnedDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiMethodCreditEarnedDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiMethodCreditEarnedDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiMethodCreditEarnedDescriptorKey oldKeyValues = default(TrackedChangesEdFiMethodCreditEarnedDescriptorKey), TrackedChangesEdFiMethodCreditEarnedDescriptorKey newKeyValues = default(TrackedChangesEdFiMethodCreditEarnedDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiMethodCreditEarnedDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiMethodCreditEarnedDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiMethodCreditEarnedDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiMethodCreditEarnedDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiMethodCreditEarnedDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiMethodCreditEarnedDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiMethodCreditEarnedDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
