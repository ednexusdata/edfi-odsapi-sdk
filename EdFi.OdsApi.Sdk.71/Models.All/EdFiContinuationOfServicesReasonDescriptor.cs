...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_continuationOfServicesReasonDescriptor")]
    public partial class EdFiContinuationOfServicesReasonDescriptor : IEquatable<EdFiContinuationOfServicesReasonDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiContinuationOfServicesReasonDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiContinuationOfServicesReasonDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiContinuationOfServicesReasonDescriptor" /> class.
        /// </summary>
        ...
        public EdFiContinuationOfServicesReasonDescriptor(string id = default(string), int continuationOfServicesReasonDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiContinuationOfServicesReasonDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiContinuationOfServicesReasonDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiContinuationOfServicesReasonDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "continuationOfServicesReasonDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ContinuationOfServicesReasonDescriptorId: ").Append(ContinuationOfServicesReasonDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiContinuationOfServicesReasonDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiContinuationOfServicesReasonDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiContinuationOfServicesReasonDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiContinuationOfServicesReasonDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ContinuationOfServicesReasonDescriptorId == input.ContinuationOfServicesReasonDescriptorId ||
                    this.ContinuationOfServicesReasonDescriptorId.Equals(input.ContinuationOfServicesReasonDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ContinuationOfServicesReasonDescriptorId.GetHashCode();
