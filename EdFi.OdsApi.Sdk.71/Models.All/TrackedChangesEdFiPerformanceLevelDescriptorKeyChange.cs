...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_performanceLevelDescriptorKeyChange")]
    public partial class TrackedChangesEdFiPerformanceLevelDescriptorKeyChange : IEquatable<TrackedChangesEdFiPerformanceLevelDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiPerformanceLevelDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiPerformanceLevelDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiPerformanceLevelDescriptorKey oldKeyValues = default(TrackedChangesEdFiPerformanceLevelDescriptorKey), TrackedChangesEdFiPerformanceLevelDescriptorKey newKeyValues = default(TrackedChangesEdFiPerformanceLevelDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiPerformanceLevelDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiPerformanceLevelDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiPerformanceLevelDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiPerformanceLevelDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiPerformanceLevelDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiPerformanceLevelDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiPerformanceLevelDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
