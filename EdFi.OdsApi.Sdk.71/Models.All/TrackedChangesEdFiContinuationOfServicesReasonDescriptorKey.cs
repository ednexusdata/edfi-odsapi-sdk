...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_continuationOfServicesReasonDescriptorKey")]
    public partial class TrackedChangesEdFiContinuationOfServicesReasonDescriptorKey : IEquatable<TrackedChangesEdFiContinuationOfServicesReasonDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiContinuationOfServicesReasonDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiContinuationOfServicesReasonDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiContinuationOfServicesReasonDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiContinuationOfServicesReasonDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiContinuationOfServicesReasonDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiContinuationOfServicesReasonDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiContinuationOfServicesReasonDescriptorKey input)
        {
            if (input == null)
            {
                return false;
