...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_levelOfEducationDescriptor")]
    public partial class EdFiLevelOfEducationDescriptor : IEquatable<EdFiLevelOfEducationDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiLevelOfEducationDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiLevelOfEducationDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiLevelOfEducationDescriptor" /> class.
        /// </summary>
        ...
        public EdFiLevelOfEducationDescriptor(string id = default(string), int levelOfEducationDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiLevelOfEducationDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiLevelOfEducationDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiLevelOfEducationDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "levelOfEducationDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  LevelOfEducationDescriptorId: ").Append(LevelOfEducationDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiLevelOfEducationDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiLevelOfEducationDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiLevelOfEducationDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiLevelOfEducationDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.LevelOfEducationDescriptorId == input.LevelOfEducationDescriptorId ||
                    this.LevelOfEducationDescriptorId.Equals(input.LevelOfEducationDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.LevelOfEducationDescriptorId.GetHashCode();
