...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_projectDimensionKeyChange")]
    public partial class TrackedChangesEdFiProjectDimensionKeyChange : IEquatable<TrackedChangesEdFiProjectDimensionKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiProjectDimensionKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiProjectDimensionKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiProjectDimensionKey oldKeyValues = default(TrackedChangesEdFiProjectDimensionKey), TrackedChangesEdFiProjectDimensionKey newKeyValues = default(TrackedChangesEdFiProjectDimensionKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiProjectDimensionKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiProjectDimensionKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiProjectDimensionKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiProjectDimensionKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiProjectDimensionKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiProjectDimensionKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiProjectDimensionKeyChange input)
        {
            if (input == null)
            {
                return false;
