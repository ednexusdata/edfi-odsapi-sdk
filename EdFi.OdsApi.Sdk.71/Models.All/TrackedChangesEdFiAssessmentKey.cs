...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_assessmentKey")]
    public partial class TrackedChangesEdFiAssessmentKey : IEquatable<TrackedChangesEdFiAssessmentKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiAssessmentKey(string assessmentIdentifier = default(string), string _namespace = default(string))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiAssessmentKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiAssessmentKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiAssessmentKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiAssessmentKey input)
        {
            if (input == null)
            {
                return false;
