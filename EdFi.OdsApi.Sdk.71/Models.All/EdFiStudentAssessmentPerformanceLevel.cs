...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiStudentAssessmentPerformanceLevel : IEquatable<EdFiStudentAssessmentPerformanceLevel>, IValidatableObject
    {
        ...
        public EdFiStudentAssessmentPerformanceLevel(string assessmentReportingMethodDescriptor = default(string), string performanceLevelDescriptor = default(string), string performanceLevelIndicatorName = default(string))
        {
            // to ensure "assessmentReportingMethodDescriptor" is required (not null)
            if (assessmentReportingMethodDescriptor == null)
            {
                throw new ArgumentNullException("assessmentReportingMethodDescriptor is a required property for EdFiStudentAssessmentPerformanceLevel and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("performanceLevelDescriptor is a required property for EdFiStudentAssessmentPerformanceLevel and cannot be null");
            }
