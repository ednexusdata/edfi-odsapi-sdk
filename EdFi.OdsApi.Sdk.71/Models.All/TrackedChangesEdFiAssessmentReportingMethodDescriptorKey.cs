...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_assessmentReportingMethodDescriptorKey")]
    public partial class TrackedChangesEdFiAssessmentReportingMethodDescriptorKey : IEquatable<TrackedChangesEdFiAssessmentReportingMethodDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiAssessmentReportingMethodDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiAssessmentReportingMethodDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiAssessmentReportingMethodDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiAssessmentReportingMethodDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiAssessmentReportingMethodDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiAssessmentReportingMethodDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiAssessmentReportingMethodDescriptorKey input)
        {
            if (input == null)
            {
                return false;
