...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_learningStandardScopeDescriptorKey")]
    public partial class TrackedChangesEdFiLearningStandardScopeDescriptorKey : IEquatable<TrackedChangesEdFiLearningStandardScopeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiLearningStandardScopeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiLearningStandardScopeDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiLearningStandardScopeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiLearningStandardScopeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiLearningStandardScopeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiLearningStandardScopeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiLearningStandardScopeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
