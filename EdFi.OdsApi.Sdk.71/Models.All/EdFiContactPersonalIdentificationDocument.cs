...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_contactPersonalIdentificationDocument")]
    public partial class EdFiContactPersonalIdentificationDocument : IEquatable<EdFiContactPersonalIdentificationDocument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiContactPersonalIdentificationDocument" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiContactPersonalIdentificationDocument() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiContactPersonalIdentificationDocument" /> class.
        /// </summary>
        ...
        public EdFiContactPersonalIdentificationDocument(string identificationDocumentUseDescriptor = default(string), string personalInformationVerificationDescriptor = default(string), string issuerCountryDescriptor = default(string), DateTime? documentExpirationDate = default(DateTime?), string documentTitle = default(string), string issuerDocumentIdentificationCode = default(string), string issuerName = default(string))
        {
            ...
            {
                throw new ArgumentNullException("personalInformationVerificationDescriptor is a required property for EdFiContactPersonalIdentificationDocument and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiContactPersonalIdentificationDocument {\n");
        ...
        {
            return this.Equals(input as EdFiContactPersonalIdentificationDocument);
        }

        /// <summary>
        /// Returns true if EdFiContactPersonalIdentificationDocument instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiContactPersonalIdentificationDocument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiContactPersonalIdentificationDocument input)
        {
            if (input == null)
            {
                return false;
