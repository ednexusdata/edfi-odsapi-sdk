...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_interventionPrescriptionKeyChange")]
    public partial class TrackedChangesEdFiInterventionPrescriptionKeyChange : IEquatable<TrackedChangesEdFiInterventionPrescriptionKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiInterventionPrescriptionKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiInterventionPrescriptionKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiInterventionPrescriptionKey oldKeyValues = default(TrackedChangesEdFiInterventionPrescriptionKey), TrackedChangesEdFiInterventionPrescriptionKey newKeyValues = default(TrackedChangesEdFiInterventionPrescriptionKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiInterventionPrescriptionKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiInterventionPrescriptionKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiInterventionPrescriptionKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiInterventionPrescriptionKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiInterventionPrescriptionKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiInterventionPrescriptionKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiInterventionPrescriptionKeyChange input)
        {
            if (input == null)
            {
                return false;
