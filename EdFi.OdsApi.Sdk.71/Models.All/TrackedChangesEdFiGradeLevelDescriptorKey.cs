...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_gradeLevelDescriptorKey")]
    public partial class TrackedChangesEdFiGradeLevelDescriptorKey : IEquatable<TrackedChangesEdFiGradeLevelDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiGradeLevelDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiGradeLevelDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiGradeLevelDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiGradeLevelDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiGradeLevelDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiGradeLevelDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiGradeLevelDescriptorKey input)
        {
            if (input == null)
            {
                return false;
