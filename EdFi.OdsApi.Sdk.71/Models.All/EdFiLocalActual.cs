...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// EdFiLocalActual
    /// </summary>
    [DataContract(Name = "edFi_localActual")]
    public partial class EdFiLocalActual : IEquatable<EdFiLocalActual>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiLocalActual" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiLocalActual() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiLocalActual" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiLocalActual {\n");
        ...
        {
            return this.Equals(input as EdFiLocalActual);
        }

        /// <summary>
        /// Returns true if EdFiLocalActual instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiLocalActual to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiLocalActual input)
        {
            if (input == null)
            {
                return false;
