...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_interactivityStyleDescriptor")]
    public partial class EdFiInteractivityStyleDescriptor : IEquatable<EdFiInteractivityStyleDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiInteractivityStyleDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiInteractivityStyleDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiInteractivityStyleDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="interactivityStyleDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiInteractivityStyleDescriptor(string id = default(string), int interactivityStyleDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiInteractivityStyleDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiInteractivityStyleDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiInteractivityStyleDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "interactivityStyleDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  InteractivityStyleDescriptorId: ").Append(InteractivityStyleDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiInteractivityStyleDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiInteractivityStyleDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiInteractivityStyleDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiInteractivityStyleDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.InteractivityStyleDescriptorId == input.InteractivityStyleDescriptorId ||
                    this.InteractivityStyleDescriptorId.Equals(input.InteractivityStyleDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.InteractivityStyleDescriptorId.GetHashCode();
