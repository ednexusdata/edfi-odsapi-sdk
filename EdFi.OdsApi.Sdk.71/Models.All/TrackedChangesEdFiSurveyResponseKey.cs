...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_surveyResponseKey")]
    public partial class TrackedChangesEdFiSurveyResponseKey : IEquatable<TrackedChangesEdFiSurveyResponseKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiSurveyResponseKey(string surveyResponseIdentifier = default(string), string _namespace = default(string), string surveyIdentifier = default(string))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSurveyResponseKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSurveyResponseKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSurveyResponseKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSurveyResponseKey input)
        {
            if (input == null)
            {
                return false;
