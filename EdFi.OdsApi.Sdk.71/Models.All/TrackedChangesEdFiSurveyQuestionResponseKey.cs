...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TrackedChangesEdFiSurveyQuestionResponseKey : IEquatable<TrackedChangesEdFiSurveyQuestionResponseKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiSurveyQuestionResponseKey(string _namespace = default(string), string questionCode = default(string), string surveyIdentifier = default(string), string surveyResponseIdentifier = default(string))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSurveyQuestionResponseKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSurveyQuestionResponseKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSurveyQuestionResponseKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSurveyQuestionResponseKey input)
        {
            if (input == null)
            {
                return false;
