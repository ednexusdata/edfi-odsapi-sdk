...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_identificationDocumentUseDescriptor")]
    public partial class EdFiIdentificationDocumentUseDescriptor : IEquatable<EdFiIdentificationDocumentUseDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiIdentificationDocumentUseDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiIdentificationDocumentUseDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiIdentificationDocumentUseDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="identificationDocumentUseDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiIdentificationDocumentUseDescriptor(string id = default(string), int identificationDocumentUseDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiIdentificationDocumentUseDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiIdentificationDocumentUseDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiIdentificationDocumentUseDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "identificationDocumentUseDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  IdentificationDocumentUseDescriptorId: ").Append(IdentificationDocumentUseDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiIdentificationDocumentUseDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiIdentificationDocumentUseDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiIdentificationDocumentUseDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiIdentificationDocumentUseDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.IdentificationDocumentUseDescriptorId == input.IdentificationDocumentUseDescriptorId ||
                    this.IdentificationDocumentUseDescriptorId.Equals(input.IdentificationDocumentUseDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.IdentificationDocumentUseDescriptorId.GetHashCode();
