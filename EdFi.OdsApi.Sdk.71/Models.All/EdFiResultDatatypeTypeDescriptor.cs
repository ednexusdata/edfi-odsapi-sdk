...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_resultDatatypeTypeDescriptor")]
    public partial class EdFiResultDatatypeTypeDescriptor : IEquatable<EdFiResultDatatypeTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiResultDatatypeTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiResultDatatypeTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiResultDatatypeTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="resultDatatypeTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiResultDatatypeTypeDescriptor(string id = default(string), int resultDatatypeTypeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiResultDatatypeTypeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiResultDatatypeTypeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiResultDatatypeTypeDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "resultDatatypeTypeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ResultDatatypeTypeDescriptorId: ").Append(ResultDatatypeTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiResultDatatypeTypeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiResultDatatypeTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiResultDatatypeTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiResultDatatypeTypeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ResultDatatypeTypeDescriptorId == input.ResultDatatypeTypeDescriptorId ||
                    this.ResultDatatypeTypeDescriptorId.Equals(input.ResultDatatypeTypeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ResultDatatypeTypeDescriptorId.GetHashCode();
