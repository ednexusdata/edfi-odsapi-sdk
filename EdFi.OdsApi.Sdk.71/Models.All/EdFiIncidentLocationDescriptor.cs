...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_incidentLocationDescriptor")]
    public partial class EdFiIncidentLocationDescriptor : IEquatable<EdFiIncidentLocationDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiIncidentLocationDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiIncidentLocationDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiIncidentLocationDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="incidentLocationDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiIncidentLocationDescriptor(string id = default(string), int incidentLocationDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiIncidentLocationDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiIncidentLocationDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiIncidentLocationDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "incidentLocationDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  IncidentLocationDescriptorId: ").Append(IncidentLocationDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiIncidentLocationDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiIncidentLocationDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiIncidentLocationDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiIncidentLocationDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.IncidentLocationDescriptorId == input.IncidentLocationDescriptorId ||
                    this.IncidentLocationDescriptorId.Equals(input.IncidentLocationDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.IncidentLocationDescriptorId.GetHashCode();
