...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_relationDescriptorKeyChange")]
    public partial class TrackedChangesEdFiRelationDescriptorKeyChange : IEquatable<TrackedChangesEdFiRelationDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiRelationDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiRelationDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiRelationDescriptorKey oldKeyValues = default(TrackedChangesEdFiRelationDescriptorKey), TrackedChangesEdFiRelationDescriptorKey newKeyValues = default(TrackedChangesEdFiRelationDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiRelationDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiRelationDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiRelationDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiRelationDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiRelationDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiRelationDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiRelationDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
