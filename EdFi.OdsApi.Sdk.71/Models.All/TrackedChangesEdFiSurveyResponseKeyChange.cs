...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_surveyResponseKeyChange")]
    public partial class TrackedChangesEdFiSurveyResponseKeyChange : IEquatable<TrackedChangesEdFiSurveyResponseKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiSurveyResponseKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiSurveyResponseKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiSurveyResponseKey oldKeyValues = default(TrackedChangesEdFiSurveyResponseKey), TrackedChangesEdFiSurveyResponseKey newKeyValues = default(TrackedChangesEdFiSurveyResponseKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiSurveyResponseKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiSurveyResponseKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiSurveyResponseKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSurveyResponseKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSurveyResponseKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSurveyResponseKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSurveyResponseKeyChange input)
        {
            if (input == null)
            {
                return false;
