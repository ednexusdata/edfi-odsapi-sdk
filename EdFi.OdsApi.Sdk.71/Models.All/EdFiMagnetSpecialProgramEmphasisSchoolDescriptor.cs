...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_magnetSpecialProgramEmphasisSchoolDescriptor")]
    public partial class EdFiMagnetSpecialProgramEmphasisSchoolDescriptor : IEquatable<EdFiMagnetSpecialProgramEmphasisSchoolDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiMagnetSpecialProgramEmphasisSchoolDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiMagnetSpecialProgramEmphasisSchoolDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiMagnetSpecialProgramEmphasisSchoolDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="magnetSpecialProgramEmphasisSchoolDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiMagnetSpecialProgramEmphasisSchoolDescriptor(string id = default(string), int magnetSpecialProgramEmphasisSchoolDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiMagnetSpecialProgramEmphasisSchoolDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiMagnetSpecialProgramEmphasisSchoolDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiMagnetSpecialProgramEmphasisSchoolDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "magnetSpecialProgramEmphasisSchoolDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MagnetSpecialProgramEmphasisSchoolDescriptorId: ").Append(MagnetSpecialProgramEmphasisSchoolDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiMagnetSpecialProgramEmphasisSchoolDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiMagnetSpecialProgramEmphasisSchoolDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiMagnetSpecialProgramEmphasisSchoolDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiMagnetSpecialProgramEmphasisSchoolDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.MagnetSpecialProgramEmphasisSchoolDescriptorId == input.MagnetSpecialProgramEmphasisSchoolDescriptorId ||
                    this.MagnetSpecialProgramEmphasisSchoolDescriptorId.Equals(input.MagnetSpecialProgramEmphasisSchoolDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.MagnetSpecialProgramEmphasisSchoolDescriptorId.GetHashCode();
