...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_serviceDescriptorKey")]
    public partial class TrackedChangesEdFiServiceDescriptorKey : IEquatable<TrackedChangesEdFiServiceDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiServiceDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiServiceDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiServiceDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiServiceDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiServiceDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiServiceDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiServiceDescriptorKey input)
        {
            if (input == null)
            {
                return false;
