...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_tpdm_evaluationKeyChange")]
    public partial class TrackedChangesTpdmEvaluationKeyChange : IEquatable<TrackedChangesTpdmEvaluationKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesTpdmEvaluationKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesTpdmEvaluationKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesTpdmEvaluationKey oldKeyValues = default(TrackedChangesTpdmEvaluationKey), TrackedChangesTpdmEvaluationKey newKeyValues = default(TrackedChangesTpdmEvaluationKey))
        {
            this.Id = id;
        ...
        public TrackedChangesTpdmEvaluationKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesTpdmEvaluationKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesTpdmEvaluationKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesTpdmEvaluationKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesTpdmEvaluationKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesTpdmEvaluationKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesTpdmEvaluationKeyChange input)
        {
            if (input == null)
            {
                return false;
