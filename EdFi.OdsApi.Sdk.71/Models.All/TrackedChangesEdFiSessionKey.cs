...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_sessionKey")]
    public partial class TrackedChangesEdFiSessionKey : IEquatable<TrackedChangesEdFiSessionKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiSessionKey(string sessionName = default(string), long schoolId = default(long), int schoolYear = default(int))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSessionKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSessionKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSessionKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSessionKey input)
        {
            if (input == null)
            {
                return false;
