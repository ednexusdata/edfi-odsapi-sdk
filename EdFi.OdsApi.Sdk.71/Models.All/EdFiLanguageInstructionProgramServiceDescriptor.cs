...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_languageInstructionProgramServiceDescriptor")]
    public partial class EdFiLanguageInstructionProgramServiceDescriptor : IEquatable<EdFiLanguageInstructionProgramServiceDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiLanguageInstructionProgramServiceDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiLanguageInstructionProgramServiceDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiLanguageInstructionProgramServiceDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="languageInstructionProgramServiceDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiLanguageInstructionProgramServiceDescriptor(string id = default(string), int languageInstructionProgramServiceDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiLanguageInstructionProgramServiceDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiLanguageInstructionProgramServiceDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiLanguageInstructionProgramServiceDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "languageInstructionProgramServiceDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  LanguageInstructionProgramServiceDescriptorId: ").Append(LanguageInstructionProgramServiceDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiLanguageInstructionProgramServiceDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiLanguageInstructionProgramServiceDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiLanguageInstructionProgramServiceDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiLanguageInstructionProgramServiceDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.LanguageInstructionProgramServiceDescriptorId == input.LanguageInstructionProgramServiceDescriptorId ||
                    this.LanguageInstructionProgramServiceDescriptorId.Equals(input.LanguageInstructionProgramServiceDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.LanguageInstructionProgramServiceDescriptorId.GetHashCode();
