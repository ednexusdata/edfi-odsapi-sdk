...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_otherNameTypeDescriptor")]
    public partial class EdFiOtherNameTypeDescriptor : IEquatable<EdFiOtherNameTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiOtherNameTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiOtherNameTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiOtherNameTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="otherNameTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiOtherNameTypeDescriptor(string id = default(string), int otherNameTypeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiOtherNameTypeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiOtherNameTypeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiOtherNameTypeDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "otherNameTypeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  OtherNameTypeDescriptorId: ").Append(OtherNameTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiOtherNameTypeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiOtherNameTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiOtherNameTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiOtherNameTypeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.OtherNameTypeDescriptorId == input.OtherNameTypeDescriptorId ||
                    this.OtherNameTypeDescriptorId.Equals(input.OtherNameTypeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.OtherNameTypeDescriptorId.GetHashCode();
