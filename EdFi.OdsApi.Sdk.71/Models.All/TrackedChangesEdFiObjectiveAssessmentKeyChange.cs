...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_objectiveAssessmentKeyChange")]
    public partial class TrackedChangesEdFiObjectiveAssessmentKeyChange : IEquatable<TrackedChangesEdFiObjectiveAssessmentKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiObjectiveAssessmentKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiObjectiveAssessmentKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiObjectiveAssessmentKey oldKeyValues = default(TrackedChangesEdFiObjectiveAssessmentKey), TrackedChangesEdFiObjectiveAssessmentKey newKeyValues = default(TrackedChangesEdFiObjectiveAssessmentKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiObjectiveAssessmentKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiObjectiveAssessmentKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiObjectiveAssessmentKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiObjectiveAssessmentKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiObjectiveAssessmentKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiObjectiveAssessmentKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiObjectiveAssessmentKeyChange input)
        {
            if (input == null)
            {
                return false;
