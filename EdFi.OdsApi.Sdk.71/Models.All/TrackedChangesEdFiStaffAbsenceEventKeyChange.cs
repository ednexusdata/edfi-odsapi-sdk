...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_staffAbsenceEventKeyChange")]
    public partial class TrackedChangesEdFiStaffAbsenceEventKeyChange : IEquatable<TrackedChangesEdFiStaffAbsenceEventKeyChange>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiStaffAbsenceEventKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiStaffAbsenceEventKey oldKeyValues = default(TrackedChangesEdFiStaffAbsenceEventKey), TrackedChangesEdFiStaffAbsenceEventKey newKeyValues = default(TrackedChangesEdFiStaffAbsenceEventKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiStaffAbsenceEventKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiStaffAbsenceEventKey NewKeyValues { get; set; }
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStaffAbsenceEventKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStaffAbsenceEventKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStaffAbsenceEventKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStaffAbsenceEventKeyChange input)
        {
            if (input == null)
            {
                return false;
