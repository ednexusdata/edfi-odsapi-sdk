...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiDescriptorMapping : IEquatable<EdFiDescriptorMapping>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="_namespace">The namespace of the descriptor value that is being mapped to another value. (required).</param>
        ...
        public EdFiDescriptorMapping(string id = default(string), string mappedNamespace = default(string), string mappedValue = default(string), string _namespace = default(string), string value = default(string), List<EdFiDescriptorMappingModelEntity> modelEntities = default(List<EdFiDescriptorMappingModelEntity>), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            ...
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiDescriptorMapping and cannot be null");
            }
        ...
        {
            return this.Equals(input as EdFiDescriptorMapping);
        }

        /// <summary>
        /// Returns true if EdFiDescriptorMapping instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiDescriptorMapping to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiDescriptorMapping input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ModelEntities == input.ModelEntities ||
                    this.ModelEntities != null &&
                    input.ModelEntities != null &&
                    this.ModelEntities.SequenceEqual(input.ModelEntities)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.ModelEntities.GetHashCode();
                }
                if (this.Etag != null)
                {
