...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_sectionKeyChange")]
    public partial class TrackedChangesEdFiSectionKeyChange : IEquatable<TrackedChangesEdFiSectionKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiSectionKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiSectionKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiSectionKey oldKeyValues = default(TrackedChangesEdFiSectionKey), TrackedChangesEdFiSectionKey newKeyValues = default(TrackedChangesEdFiSectionKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiSectionKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiSectionKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiSectionKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSectionKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSectionKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSectionKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSectionKeyChange input)
        {
            if (input == null)
            {
                return false;
