...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_staffLeaveEventCategoryDescriptor")]
    public partial class EdFiStaffLeaveEventCategoryDescriptor : IEquatable<EdFiStaffLeaveEventCategoryDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStaffLeaveEventCategoryDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiStaffLeaveEventCategoryDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStaffLeaveEventCategoryDescriptor" /> class.
        /// </summary>
        ...
        public EdFiStaffLeaveEventCategoryDescriptor(string id = default(string), int staffLeaveEventCategoryDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            ...
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiStaffLeaveEventCategoryDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiStaffLeaveEventCategoryDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiStaffLeaveEventCategoryDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "staffLeaveEventCategoryDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  StaffLeaveEventCategoryDescriptorId: ").Append(StaffLeaveEventCategoryDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiStaffLeaveEventCategoryDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiStaffLeaveEventCategoryDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStaffLeaveEventCategoryDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStaffLeaveEventCategoryDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.StaffLeaveEventCategoryDescriptorId == input.StaffLeaveEventCategoryDescriptorId ||
                    this.StaffLeaveEventCategoryDescriptorId.Equals(input.StaffLeaveEventCategoryDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.StaffLeaveEventCategoryDescriptorId.GetHashCode();
