...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevel : IEquatable<EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevel>, IValidatableObject
    {
        ...
        public EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevel(string assessmentReportingMethodDescriptor = default(string), string performanceLevelDescriptor = default(string), string performanceLevelIndicatorName = default(string))
        {
