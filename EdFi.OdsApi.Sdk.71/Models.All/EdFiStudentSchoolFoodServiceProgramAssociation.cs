...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiStudentSchoolFoodServiceProgramAssociation : IEquatable<EdFiStudentSchoolFoodServiceProgramAssociation>, IValidatableObject
    {
        ...
        public EdFiStudentSchoolFoodServiceProgramAssociation(string id = default(string), DateTime beginDate = default(DateTime), EdFiEducationOrganizationReference educationOrganizationReference = default(EdFiEducationOrganizationReference), EdFiProgramReference programReference = default(EdFiProgramReference), EdFiStudentReference studentReference = default(EdFiStudentReference), bool? directCertification = default(bool?), DateTime? endDate = default(DateTime?), List<EdFiGeneralStudentProgramAssociationProgramParticipationStatus> programParticipationStatuses = default(List<EdFiGeneralStudentProgramAssociationProgramParticipationStatus>), string reasonExitedDescriptor = default(string), List<EdFiStudentSchoolFoodServiceProgramAssociationSchoolFoodServiceProgramService> schoolFoodServiceProgramServices = default(List<EdFiStudentSchoolFoodServiceProgramAssociationSchoolFoodServiceProgramService>), bool? servedOutsideOfRegularSession = default(bool?), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
