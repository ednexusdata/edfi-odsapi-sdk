...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiStaffEducationOrganizationContactAssociationAddress : IEquatable<EdFiStaffEducationOrganizationContactAssociationAddress>, IValidatableObject
    {
        ...
        public EdFiStaffEducationOrganizationContactAssociationAddress(string addressTypeDescriptor = default(string), string localeDescriptor = default(string), string stateAbbreviationDescriptor = default(string), string apartmentRoomSuiteNumber = default(string), string buildingSiteNumber = default(string), string city = default(string), string congressionalDistrict = default(string), string countyFIPSCode = default(string), bool? doNotPublishIndicator = default(bool?), string latitude = default(string), string longitude = default(string), string nameOfCounty = default(string), string postalCode = default(string), string streetNumberName = default(string), List<EdFiStaffEducationOrganizationContactAssociationAddressPeriod> periods = default(List<EdFiStaffEducationOrganizationContactAssociationAddressPeriod>))
        {
            ...
            {
                throw new ArgumentNullException("addressTypeDescriptor is a required property for EdFiStaffEducationOrganizationContactAssociationAddress and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("stateAbbreviationDescriptor is a required property for EdFiStaffEducationOrganizationContactAssociationAddress and cannot be null");
            }
            this.StateAbbreviationDescriptor = stateAbbreviationDescriptor;
            // to ensure "city" is required (not null)
            if (city == null)
            {
                throw new ArgumentNullException("city is a required property for EdFiStaffEducationOrganizationContactAssociationAddress and cannot be null");
            }
            this.City = city;
            // to ensure "postalCode" is required (not null)
            if (postalCode == null)
            {
                throw new ArgumentNullException("postalCode is a required property for EdFiStaffEducationOrganizationContactAssociationAddress and cannot be null");
            }
            this.PostalCode = postalCode;
            // to ensure "streetNumberName" is required (not null)
            if (streetNumberName == null)
            {
                throw new ArgumentNullException("streetNumberName is a required property for EdFiStaffEducationOrganizationContactAssociationAddress and cannot be null");
            }
