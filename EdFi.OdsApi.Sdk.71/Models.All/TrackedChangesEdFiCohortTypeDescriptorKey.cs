...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_cohortTypeDescriptorKey")]
    public partial class TrackedChangesEdFiCohortTypeDescriptorKey : IEquatable<TrackedChangesEdFiCohortTypeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCohortTypeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCohortTypeDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCohortTypeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCohortTypeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCohortTypeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCohortTypeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCohortTypeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
