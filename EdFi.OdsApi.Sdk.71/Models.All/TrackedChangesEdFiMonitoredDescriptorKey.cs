...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_monitoredDescriptorKey")]
    public partial class TrackedChangesEdFiMonitoredDescriptorKey : IEquatable<TrackedChangesEdFiMonitoredDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiMonitoredDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiMonitoredDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiMonitoredDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiMonitoredDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiMonitoredDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiMonitoredDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiMonitoredDescriptorKey input)
        {
            if (input == null)
            {
                return false;
