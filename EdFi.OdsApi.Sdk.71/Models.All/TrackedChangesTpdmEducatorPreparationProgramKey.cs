...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_tpdm_educatorPreparationProgramKey")]
    public partial class TrackedChangesTpdmEducatorPreparationProgramKey : IEquatable<TrackedChangesTpdmEducatorPreparationProgramKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesTpdmEducatorPreparationProgramKey" /> class.
        /// </summary>
        ...
        public TrackedChangesTpdmEducatorPreparationProgramKey(string programTypeDescriptor = default(string), string programName = default(string), long educationOrganizationId = default(long))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesTpdmEducatorPreparationProgramKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesTpdmEducatorPreparationProgramKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesTpdmEducatorPreparationProgramKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesTpdmEducatorPreparationProgramKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesTpdmEducatorPreparationProgramKey input)
        {
            if (input == null)
            {
                return false;
