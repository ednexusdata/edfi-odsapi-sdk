...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_tpdm_educatorRoleDescriptorKey")]
    public partial class TrackedChangesTpdmEducatorRoleDescriptorKey : IEquatable<TrackedChangesTpdmEducatorRoleDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesTpdmEducatorRoleDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesTpdmEducatorRoleDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesTpdmEducatorRoleDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesTpdmEducatorRoleDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesTpdmEducatorRoleDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesTpdmEducatorRoleDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesTpdmEducatorRoleDescriptorKey input)
        {
            if (input == null)
            {
                return false;
