...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TrackedChangesEdFiStudentSectionAssociationKey : IEquatable<TrackedChangesEdFiStudentSectionAssociationKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiStudentSectionAssociationKey(DateTime beginDate = default(DateTime), string localCourseCode = default(string), long schoolId = default(long), int schoolYear = default(int), string sectionIdentifier = default(string), string sessionName = default(string), string studentUniqueId = default(string))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStudentSectionAssociationKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStudentSectionAssociationKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStudentSectionAssociationKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStudentSectionAssociationKey input)
        {
            if (input == null)
            {
                return false;
