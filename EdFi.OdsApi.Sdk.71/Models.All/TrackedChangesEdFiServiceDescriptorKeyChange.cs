...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_serviceDescriptorKeyChange")]
    public partial class TrackedChangesEdFiServiceDescriptorKeyChange : IEquatable<TrackedChangesEdFiServiceDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiServiceDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiServiceDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiServiceDescriptorKey oldKeyValues = default(TrackedChangesEdFiServiceDescriptorKey), TrackedChangesEdFiServiceDescriptorKey newKeyValues = default(TrackedChangesEdFiServiceDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiServiceDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiServiceDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiServiceDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiServiceDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiServiceDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiServiceDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiServiceDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
