...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_gunFreeSchoolsActReportingStatusDescriptorKey")]
    public partial class TrackedChangesEdFiGunFreeSchoolsActReportingStatusDescriptorKey : IEquatable<TrackedChangesEdFiGunFreeSchoolsActReportingStatusDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiGunFreeSchoolsActReportingStatusDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiGunFreeSchoolsActReportingStatusDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiGunFreeSchoolsActReportingStatusDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiGunFreeSchoolsActReportingStatusDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiGunFreeSchoolsActReportingStatusDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiGunFreeSchoolsActReportingStatusDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiGunFreeSchoolsActReportingStatusDescriptorKey input)
        {
            if (input == null)
            {
                return false;
