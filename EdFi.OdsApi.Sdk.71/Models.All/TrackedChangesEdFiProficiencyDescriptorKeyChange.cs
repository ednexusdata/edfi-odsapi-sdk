...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_proficiencyDescriptorKeyChange")]
    public partial class TrackedChangesEdFiProficiencyDescriptorKeyChange : IEquatable<TrackedChangesEdFiProficiencyDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiProficiencyDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiProficiencyDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiProficiencyDescriptorKey oldKeyValues = default(TrackedChangesEdFiProficiencyDescriptorKey), TrackedChangesEdFiProficiencyDescriptorKey newKeyValues = default(TrackedChangesEdFiProficiencyDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiProficiencyDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiProficiencyDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiProficiencyDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiProficiencyDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiProficiencyDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiProficiencyDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiProficiencyDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
