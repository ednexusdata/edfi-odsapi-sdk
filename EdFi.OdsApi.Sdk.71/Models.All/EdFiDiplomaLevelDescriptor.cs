...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_diplomaLevelDescriptor")]
    public partial class EdFiDiplomaLevelDescriptor : IEquatable<EdFiDiplomaLevelDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiDiplomaLevelDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiDiplomaLevelDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiDiplomaLevelDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="diplomaLevelDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiDiplomaLevelDescriptor(string id = default(string), int diplomaLevelDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiDiplomaLevelDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiDiplomaLevelDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiDiplomaLevelDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "diplomaLevelDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DiplomaLevelDescriptorId: ").Append(DiplomaLevelDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiDiplomaLevelDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiDiplomaLevelDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiDiplomaLevelDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiDiplomaLevelDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.DiplomaLevelDescriptorId == input.DiplomaLevelDescriptorId ||
                    this.DiplomaLevelDescriptorId.Equals(input.DiplomaLevelDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.DiplomaLevelDescriptorId.GetHashCode();
