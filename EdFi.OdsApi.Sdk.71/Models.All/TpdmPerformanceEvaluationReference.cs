...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TpdmPerformanceEvaluationReference : IEquatable<TpdmPerformanceEvaluationReference>, IValidatableObject
    {
        ...
        public TpdmPerformanceEvaluationReference(long educationOrganizationId = default(long), string evaluationPeriodDescriptor = default(string), string performanceEvaluationTitle = default(string), string performanceEvaluationTypeDescriptor = default(string), int schoolYear = default(int), string termDescriptor = default(string), Link link = default(Link))
        {
            this.EducationOrganizationId = educationOrganizationId;
            // to ensure "evaluationPeriodDescriptor" is required (not null)
            if (evaluationPeriodDescriptor == null)
            {
                throw new ArgumentNullException("evaluationPeriodDescriptor is a required property for TpdmPerformanceEvaluationReference and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("performanceEvaluationTitle is a required property for TpdmPerformanceEvaluationReference and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("performanceEvaluationTypeDescriptor is a required property for TpdmPerformanceEvaluationReference and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("termDescriptor is a required property for TpdmPerformanceEvaluationReference and cannot be null");
            }
