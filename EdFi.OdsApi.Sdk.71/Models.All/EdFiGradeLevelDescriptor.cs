...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_gradeLevelDescriptor")]
    public partial class EdFiGradeLevelDescriptor : IEquatable<EdFiGradeLevelDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiGradeLevelDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiGradeLevelDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiGradeLevelDescriptor" /> class.
        /// </summary>
        ...
        public EdFiGradeLevelDescriptor(string id = default(string), int gradeLevelDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiGradeLevelDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiGradeLevelDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiGradeLevelDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "gradeLevelDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  GradeLevelDescriptorId: ").Append(GradeLevelDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiGradeLevelDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiGradeLevelDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiGradeLevelDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiGradeLevelDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.GradeLevelDescriptorId == input.GradeLevelDescriptorId ||
                    this.GradeLevelDescriptorId.Equals(input.GradeLevelDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.GradeLevelDescriptorId.GetHashCode();
