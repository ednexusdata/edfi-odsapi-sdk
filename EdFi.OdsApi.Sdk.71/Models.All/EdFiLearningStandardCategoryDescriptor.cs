...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_learningStandardCategoryDescriptor")]
    public partial class EdFiLearningStandardCategoryDescriptor : IEquatable<EdFiLearningStandardCategoryDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiLearningStandardCategoryDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiLearningStandardCategoryDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiLearningStandardCategoryDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="learningStandardCategoryDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiLearningStandardCategoryDescriptor(string id = default(string), int learningStandardCategoryDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiLearningStandardCategoryDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiLearningStandardCategoryDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiLearningStandardCategoryDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "learningStandardCategoryDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  LearningStandardCategoryDescriptorId: ").Append(LearningStandardCategoryDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiLearningStandardCategoryDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiLearningStandardCategoryDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiLearningStandardCategoryDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiLearningStandardCategoryDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.LearningStandardCategoryDescriptorId == input.LearningStandardCategoryDescriptorId ||
                    this.LearningStandardCategoryDescriptorId.Equals(input.LearningStandardCategoryDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.LearningStandardCategoryDescriptorId.GetHashCode();
