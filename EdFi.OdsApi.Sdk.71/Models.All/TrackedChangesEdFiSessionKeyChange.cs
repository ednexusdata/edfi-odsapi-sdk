...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_sessionKeyChange")]
    public partial class TrackedChangesEdFiSessionKeyChange : IEquatable<TrackedChangesEdFiSessionKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiSessionKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiSessionKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiSessionKey oldKeyValues = default(TrackedChangesEdFiSessionKey), TrackedChangesEdFiSessionKey newKeyValues = default(TrackedChangesEdFiSessionKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiSessionKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiSessionKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiSessionKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSessionKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSessionKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSessionKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSessionKeyChange input)
        {
            if (input == null)
            {
                return false;
