...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_gunFreeSchoolsActReportingStatusDescriptor")]
    public partial class EdFiGunFreeSchoolsActReportingStatusDescriptor : IEquatable<EdFiGunFreeSchoolsActReportingStatusDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiGunFreeSchoolsActReportingStatusDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiGunFreeSchoolsActReportingStatusDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiGunFreeSchoolsActReportingStatusDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="gunFreeSchoolsActReportingStatusDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiGunFreeSchoolsActReportingStatusDescriptor(string id = default(string), int gunFreeSchoolsActReportingStatusDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiGunFreeSchoolsActReportingStatusDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiGunFreeSchoolsActReportingStatusDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiGunFreeSchoolsActReportingStatusDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "gunFreeSchoolsActReportingStatusDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  GunFreeSchoolsActReportingStatusDescriptorId: ").Append(GunFreeSchoolsActReportingStatusDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiGunFreeSchoolsActReportingStatusDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiGunFreeSchoolsActReportingStatusDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiGunFreeSchoolsActReportingStatusDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiGunFreeSchoolsActReportingStatusDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.GunFreeSchoolsActReportingStatusDescriptorId == input.GunFreeSchoolsActReportingStatusDescriptorId ||
                    this.GunFreeSchoolsActReportingStatusDescriptorId.Equals(input.GunFreeSchoolsActReportingStatusDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.GunFreeSchoolsActReportingStatusDescriptorId.GetHashCode();
