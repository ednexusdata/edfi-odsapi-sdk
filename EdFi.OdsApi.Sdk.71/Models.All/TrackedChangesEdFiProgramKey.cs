...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TrackedChangesEdFiProgramKey : IEquatable<TrackedChangesEdFiProgramKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiProgramKey(string programTypeDescriptor = default(string), string programName = default(string), long educationOrganizationId = default(long))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiProgramKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiProgramKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiProgramKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiProgramKey input)
        {
            if (input == null)
            {
                return false;
