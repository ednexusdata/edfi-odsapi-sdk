...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TrackedChangesEdFiClassPeriodKey : IEquatable<TrackedChangesEdFiClassPeriodKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiClassPeriodKey(string classPeriodName = default(string), long schoolId = default(long))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiClassPeriodKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiClassPeriodKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiClassPeriodKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiClassPeriodKey input)
        {
            if (input == null)
            {
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // ClassPeriodName (string) minLength
            if (this.ClassPeriodName != null && this.ClassPeriodName.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ClassPeriodName, length must be greater than 1.", new [] { "ClassPeriodName" });
            }
