...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_competencyLevelDescriptorKeyChange")]
    public partial class TrackedChangesEdFiCompetencyLevelDescriptorKeyChange : IEquatable<TrackedChangesEdFiCompetencyLevelDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCompetencyLevelDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCompetencyLevelDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiCompetencyLevelDescriptorKey oldKeyValues = default(TrackedChangesEdFiCompetencyLevelDescriptorKey), TrackedChangesEdFiCompetencyLevelDescriptorKey newKeyValues = default(TrackedChangesEdFiCompetencyLevelDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiCompetencyLevelDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiCompetencyLevelDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCompetencyLevelDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCompetencyLevelDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCompetencyLevelDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCompetencyLevelDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCompetencyLevelDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
