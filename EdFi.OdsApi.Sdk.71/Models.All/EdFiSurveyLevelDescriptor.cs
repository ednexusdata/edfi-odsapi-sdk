...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_surveyLevelDescriptor")]
    public partial class EdFiSurveyLevelDescriptor : IEquatable<EdFiSurveyLevelDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSurveyLevelDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiSurveyLevelDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSurveyLevelDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="surveyLevelDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiSurveyLevelDescriptor(string id = default(string), int surveyLevelDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiSurveyLevelDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiSurveyLevelDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiSurveyLevelDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "surveyLevelDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiSurveyLevelDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  SurveyLevelDescriptorId: ").Append(SurveyLevelDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiSurveyLevelDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiSurveyLevelDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiSurveyLevelDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiSurveyLevelDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.SurveyLevelDescriptorId == input.SurveyLevelDescriptorId ||
                    this.SurveyLevelDescriptorId.Equals(input.SurveyLevelDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.SurveyLevelDescriptorId.GetHashCode();
