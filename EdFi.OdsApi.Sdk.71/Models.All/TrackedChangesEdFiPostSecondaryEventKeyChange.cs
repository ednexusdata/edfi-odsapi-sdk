...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_postSecondaryEventKeyChange")]
    public partial class TrackedChangesEdFiPostSecondaryEventKeyChange : IEquatable<TrackedChangesEdFiPostSecondaryEventKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiPostSecondaryEventKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiPostSecondaryEventKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiPostSecondaryEventKey oldKeyValues = default(TrackedChangesEdFiPostSecondaryEventKey), TrackedChangesEdFiPostSecondaryEventKey newKeyValues = default(TrackedChangesEdFiPostSecondaryEventKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiPostSecondaryEventKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiPostSecondaryEventKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiPostSecondaryEventKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiPostSecondaryEventKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiPostSecondaryEventKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiPostSecondaryEventKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiPostSecondaryEventKeyChange input)
        {
            if (input == null)
            {
                return false;
