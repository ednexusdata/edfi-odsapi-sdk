...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_reasonNotTestedDescriptorKeyChange")]
    public partial class TrackedChangesEdFiReasonNotTestedDescriptorKeyChange : IEquatable<TrackedChangesEdFiReasonNotTestedDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiReasonNotTestedDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiReasonNotTestedDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiReasonNotTestedDescriptorKey oldKeyValues = default(TrackedChangesEdFiReasonNotTestedDescriptorKey), TrackedChangesEdFiReasonNotTestedDescriptorKey newKeyValues = default(TrackedChangesEdFiReasonNotTestedDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiReasonNotTestedDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiReasonNotTestedDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiReasonNotTestedDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiReasonNotTestedDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiReasonNotTestedDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiReasonNotTestedDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiReasonNotTestedDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
