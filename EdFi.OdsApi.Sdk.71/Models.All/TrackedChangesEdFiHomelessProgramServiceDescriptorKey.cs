...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_homelessProgramServiceDescriptorKey")]
    public partial class TrackedChangesEdFiHomelessProgramServiceDescriptorKey : IEquatable<TrackedChangesEdFiHomelessProgramServiceDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiHomelessProgramServiceDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiHomelessProgramServiceDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiHomelessProgramServiceDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiHomelessProgramServiceDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiHomelessProgramServiceDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiHomelessProgramServiceDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiHomelessProgramServiceDescriptorKey input)
        {
            if (input == null)
            {
                return false;
