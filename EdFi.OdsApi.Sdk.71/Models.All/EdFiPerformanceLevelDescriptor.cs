...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_performanceLevelDescriptor")]
    public partial class EdFiPerformanceLevelDescriptor : IEquatable<EdFiPerformanceLevelDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiPerformanceLevelDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiPerformanceLevelDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiPerformanceLevelDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="performanceLevelDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiPerformanceLevelDescriptor(string id = default(string), int performanceLevelDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiPerformanceLevelDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiPerformanceLevelDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiPerformanceLevelDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "performanceLevelDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PerformanceLevelDescriptorId: ").Append(PerformanceLevelDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiPerformanceLevelDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiPerformanceLevelDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiPerformanceLevelDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiPerformanceLevelDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.PerformanceLevelDescriptorId == input.PerformanceLevelDescriptorId ||
                    this.PerformanceLevelDescriptorId.Equals(input.PerformanceLevelDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.PerformanceLevelDescriptorId.GetHashCode();
