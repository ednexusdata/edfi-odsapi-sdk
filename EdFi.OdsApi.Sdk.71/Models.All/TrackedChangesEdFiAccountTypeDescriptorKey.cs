...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_accountTypeDescriptorKey")]
    public partial class TrackedChangesEdFiAccountTypeDescriptorKey : IEquatable<TrackedChangesEdFiAccountTypeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiAccountTypeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiAccountTypeDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiAccountTypeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiAccountTypeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiAccountTypeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiAccountTypeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiAccountTypeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
