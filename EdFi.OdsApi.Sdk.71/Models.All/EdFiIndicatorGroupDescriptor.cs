...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_indicatorGroupDescriptor")]
    public partial class EdFiIndicatorGroupDescriptor : IEquatable<EdFiIndicatorGroupDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiIndicatorGroupDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiIndicatorGroupDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiIndicatorGroupDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="indicatorGroupDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiIndicatorGroupDescriptor(string id = default(string), int indicatorGroupDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiIndicatorGroupDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiIndicatorGroupDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiIndicatorGroupDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.IndicatorGroupDescriptorId = indicatorGroupDescriptorId;
        ...
        [DataMember(Name = "indicatorGroupDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiIndicatorGroupDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  IndicatorGroupDescriptorId: ").Append(IndicatorGroupDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiIndicatorGroupDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiIndicatorGroupDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiIndicatorGroupDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiIndicatorGroupDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.IndicatorGroupDescriptorId == input.IndicatorGroupDescriptorId ||
                    this.IndicatorGroupDescriptorId.Equals(input.IndicatorGroupDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.IndicatorGroupDescriptorId.GetHashCode();
