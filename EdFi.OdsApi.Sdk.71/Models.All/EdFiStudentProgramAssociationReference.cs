...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_studentProgramAssociationReference")]
    public partial class EdFiStudentProgramAssociationReference : IEquatable<EdFiStudentProgramAssociationReference>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiStudentProgramAssociationReference(DateTime beginDate = default(DateTime), long educationOrganizationId = default(long), long programEducationOrganizationId = default(long), string programName = default(string), string programTypeDescriptor = default(string), string studentUniqueId = default(string), Link link = default(Link))
        {
            ...
            if (programName == null)
            {
                throw new ArgumentNullException("programName is a required property for EdFiStudentProgramAssociationReference and cannot be null");
            }
            this.ProgramName = programName;
            // to ensure "programTypeDescriptor" is required (not null)
            if (programTypeDescriptor == null)
            {
                throw new ArgumentNullException("programTypeDescriptor is a required property for EdFiStudentProgramAssociationReference and cannot be null");
            }
            this.ProgramTypeDescriptor = programTypeDescriptor;
            // to ensure "studentUniqueId" is required (not null)
            if (studentUniqueId == null)
            {
                throw new ArgumentNullException("studentUniqueId is a required property for EdFiStudentProgramAssociationReference and cannot be null");
            }
