...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_interventionClassDescriptor")]
    public partial class EdFiInterventionClassDescriptor : IEquatable<EdFiInterventionClassDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiInterventionClassDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiInterventionClassDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiInterventionClassDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="interventionClassDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiInterventionClassDescriptor(string id = default(string), int interventionClassDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiInterventionClassDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiInterventionClassDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiInterventionClassDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "interventionClassDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  InterventionClassDescriptorId: ").Append(InterventionClassDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiInterventionClassDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiInterventionClassDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiInterventionClassDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiInterventionClassDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.InterventionClassDescriptorId == input.InterventionClassDescriptorId ||
                    this.InterventionClassDescriptorId.Equals(input.InterventionClassDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.InterventionClassDescriptorId.GetHashCode();
