...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_courseAttemptResultDescriptor")]
    public partial class EdFiCourseAttemptResultDescriptor : IEquatable<EdFiCourseAttemptResultDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCourseAttemptResultDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiCourseAttemptResultDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCourseAttemptResultDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="courseAttemptResultDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiCourseAttemptResultDescriptor(string id = default(string), int courseAttemptResultDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiCourseAttemptResultDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiCourseAttemptResultDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiCourseAttemptResultDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "courseAttemptResultDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CourseAttemptResultDescriptorId: ").Append(CourseAttemptResultDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiCourseAttemptResultDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiCourseAttemptResultDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiCourseAttemptResultDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiCourseAttemptResultDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CourseAttemptResultDescriptorId == input.CourseAttemptResultDescriptorId ||
                    this.CourseAttemptResultDescriptorId.Equals(input.CourseAttemptResultDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.CourseAttemptResultDescriptorId.GetHashCode();
