...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_telephoneNumberTypeDescriptor")]
    public partial class EdFiTelephoneNumberTypeDescriptor : IEquatable<EdFiTelephoneNumberTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiTelephoneNumberTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiTelephoneNumberTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiTelephoneNumberTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="telephoneNumberTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiTelephoneNumberTypeDescriptor(string id = default(string), int telephoneNumberTypeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiTelephoneNumberTypeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiTelephoneNumberTypeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiTelephoneNumberTypeDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "telephoneNumberTypeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TelephoneNumberTypeDescriptorId: ").Append(TelephoneNumberTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiTelephoneNumberTypeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiTelephoneNumberTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiTelephoneNumberTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiTelephoneNumberTypeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.TelephoneNumberTypeDescriptorId == input.TelephoneNumberTypeDescriptorId ||
                    this.TelephoneNumberTypeDescriptorId.Equals(input.TelephoneNumberTypeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.TelephoneNumberTypeDescriptorId.GetHashCode();
