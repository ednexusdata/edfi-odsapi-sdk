...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_evaluationDelayReasonDescriptorKey")]
    public partial class TrackedChangesEdFiEvaluationDelayReasonDescriptorKey : IEquatable<TrackedChangesEdFiEvaluationDelayReasonDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiEvaluationDelayReasonDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiEvaluationDelayReasonDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiEvaluationDelayReasonDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiEvaluationDelayReasonDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiEvaluationDelayReasonDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiEvaluationDelayReasonDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiEvaluationDelayReasonDescriptorKey input)
        {
            if (input == null)
            {
                return false;
