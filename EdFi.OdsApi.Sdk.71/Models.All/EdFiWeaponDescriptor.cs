...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_weaponDescriptor")]
    public partial class EdFiWeaponDescriptor : IEquatable<EdFiWeaponDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiWeaponDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiWeaponDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiWeaponDescriptor" /> class.
        /// </summary>
        ...
        public EdFiWeaponDescriptor(string id = default(string), int weaponDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiWeaponDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiWeaponDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiWeaponDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "weaponDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  WeaponDescriptorId: ").Append(WeaponDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiWeaponDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiWeaponDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiWeaponDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiWeaponDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.WeaponDescriptorId == input.WeaponDescriptorId ||
                    this.WeaponDescriptorId.Equals(input.WeaponDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.WeaponDescriptorId.GetHashCode();
