...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_surveyLevelDescriptorKey")]
    public partial class TrackedChangesEdFiSurveyLevelDescriptorKey : IEquatable<TrackedChangesEdFiSurveyLevelDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiSurveyLevelDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiSurveyLevelDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiSurveyLevelDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSurveyLevelDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSurveyLevelDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSurveyLevelDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSurveyLevelDescriptorKey input)
        {
            if (input == null)
            {
                return false;
