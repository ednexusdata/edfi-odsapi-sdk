...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_calendarTypeDescriptorKey")]
    public partial class TrackedChangesEdFiCalendarTypeDescriptorKey : IEquatable<TrackedChangesEdFiCalendarTypeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCalendarTypeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCalendarTypeDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCalendarTypeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCalendarTypeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCalendarTypeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCalendarTypeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCalendarTypeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
