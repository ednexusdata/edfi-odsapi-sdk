...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiObjectiveAssessmentPerformanceLevel : IEquatable<EdFiObjectiveAssessmentPerformanceLevel>, IValidatableObject
    {
        ...
        public EdFiObjectiveAssessmentPerformanceLevel(string assessmentReportingMethodDescriptor = default(string), string performanceLevelDescriptor = default(string), string resultDatatypeTypeDescriptor = default(string), string maximumScore = default(string), string minimumScore = default(string), string performanceLevelIndicatorName = default(string))
        {
            // to ensure "assessmentReportingMethodDescriptor" is required (not null)
            if (assessmentReportingMethodDescriptor == null)
            {
                throw new ArgumentNullException("assessmentReportingMethodDescriptor is a required property for EdFiObjectiveAssessmentPerformanceLevel and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("performanceLevelDescriptor is a required property for EdFiObjectiveAssessmentPerformanceLevel and cannot be null");
            }
