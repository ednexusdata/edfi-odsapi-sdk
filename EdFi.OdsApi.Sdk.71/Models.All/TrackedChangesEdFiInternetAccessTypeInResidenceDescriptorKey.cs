...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_internetAccessTypeInResidenceDescriptorKey")]
    public partial class TrackedChangesEdFiInternetAccessTypeInResidenceDescriptorKey : IEquatable<TrackedChangesEdFiInternetAccessTypeInResidenceDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiInternetAccessTypeInResidenceDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiInternetAccessTypeInResidenceDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiInternetAccessTypeInResidenceDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiInternetAccessTypeInResidenceDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiInternetAccessTypeInResidenceDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiInternetAccessTypeInResidenceDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiInternetAccessTypeInResidenceDescriptorKey input)
        {
            if (input == null)
            {
                return false;
