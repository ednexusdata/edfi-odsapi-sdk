...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_tpdm_evaluationRatingKey")]
    public partial class TrackedChangesTpdmEvaluationRatingKey : IEquatable<TrackedChangesTpdmEvaluationRatingKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesTpdmEvaluationRatingKey" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesTpdmEvaluationRatingKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesTpdmEvaluationRatingKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesTpdmEvaluationRatingKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesTpdmEvaluationRatingKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesTpdmEvaluationRatingKey input)
        {
            if (input == null)
            {
                return false;
