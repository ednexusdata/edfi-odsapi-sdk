...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_incidentLocationDescriptorKey")]
    public partial class TrackedChangesEdFiIncidentLocationDescriptorKey : IEquatable<TrackedChangesEdFiIncidentLocationDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiIncidentLocationDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiIncidentLocationDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiIncidentLocationDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiIncidentLocationDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiIncidentLocationDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiIncidentLocationDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiIncidentLocationDescriptorKey input)
        {
            if (input == null)
            {
                return false;
