...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiProgramReference : IEquatable<EdFiProgramReference>, IValidatableObject
    {
        ...
        public EdFiProgramReference(long educationOrganizationId = default(long), string programName = default(string), string programTypeDescriptor = default(string), Link link = default(Link))
        {
