...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_cohortScopeDescriptor")]
    public partial class EdFiCohortScopeDescriptor : IEquatable<EdFiCohortScopeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCohortScopeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiCohortScopeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCohortScopeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="cohortScopeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        [DataMember(Name = "cohortScopeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CohortScopeDescriptorId: ").Append(CohortScopeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiCohortScopeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiCohortScopeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiCohortScopeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiCohortScopeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CohortScopeDescriptorId == input.CohortScopeDescriptorId ||
                    this.CohortScopeDescriptorId.Equals(input.CohortScopeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.CohortScopeDescriptorId.GetHashCode();
