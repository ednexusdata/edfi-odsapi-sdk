...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_attemptStatusDescriptorKeyChange")]
    public partial class TrackedChangesEdFiAttemptStatusDescriptorKeyChange : IEquatable<TrackedChangesEdFiAttemptStatusDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiAttemptStatusDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiAttemptStatusDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiAttemptStatusDescriptorKey oldKeyValues = default(TrackedChangesEdFiAttemptStatusDescriptorKey), TrackedChangesEdFiAttemptStatusDescriptorKey newKeyValues = default(TrackedChangesEdFiAttemptStatusDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiAttemptStatusDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiAttemptStatusDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiAttemptStatusDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiAttemptStatusDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiAttemptStatusDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiAttemptStatusDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiAttemptStatusDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
