...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiSchoolYearType : IEquatable<EdFiSchoolYearType>, IValidatableObject
    {
        ...
        public EdFiSchoolYearType(string id = default(string), int schoolYear = default(int), bool currentSchoolYear = default(bool), string schoolYearDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
