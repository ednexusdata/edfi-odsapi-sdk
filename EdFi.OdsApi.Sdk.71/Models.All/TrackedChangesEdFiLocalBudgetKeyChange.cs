...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_localBudgetKeyChange")]
    public partial class TrackedChangesEdFiLocalBudgetKeyChange : IEquatable<TrackedChangesEdFiLocalBudgetKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiLocalBudgetKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiLocalBudgetKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiLocalBudgetKey oldKeyValues = default(TrackedChangesEdFiLocalBudgetKey), TrackedChangesEdFiLocalBudgetKey newKeyValues = default(TrackedChangesEdFiLocalBudgetKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiLocalBudgetKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiLocalBudgetKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiLocalBudgetKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiLocalBudgetKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiLocalBudgetKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiLocalBudgetKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiLocalBudgetKeyChange input)
        {
            if (input == null)
            {
                return false;
