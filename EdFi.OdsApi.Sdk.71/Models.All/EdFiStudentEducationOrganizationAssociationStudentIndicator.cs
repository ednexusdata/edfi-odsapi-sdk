...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiStudentEducationOrganizationAssociationStudentIndicator : IEquatable<EdFiStudentEducationOrganizationAssociationStudentIndicator>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // IndicatorName (string) minLength
            if (this.IndicatorName != null && this.IndicatorName.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for IndicatorName, length must be greater than 1.", new [] { "IndicatorName" });
            }
            ...
            // DesignatedBy (string) minLength
            if (this.DesignatedBy != null && this.DesignatedBy.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DesignatedBy, length must be greater than 1.", new [] { "DesignatedBy" });
            }
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Indicator, length must be greater than 1.", new [] { "Indicator" });
            }
            ...
            // IndicatorGroup (string) minLength
            if (this.IndicatorGroup != null && this.IndicatorGroup.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for IndicatorGroup, length must be greater than 1.", new [] { "IndicatorGroup" });
            }
