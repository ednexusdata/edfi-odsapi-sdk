...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_behaviorDescriptor")]
    public partial class EdFiBehaviorDescriptor : IEquatable<EdFiBehaviorDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiBehaviorDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiBehaviorDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiBehaviorDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="behaviorDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiBehaviorDescriptor(string id = default(string), int behaviorDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiBehaviorDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiBehaviorDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiBehaviorDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "behaviorDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  BehaviorDescriptorId: ").Append(BehaviorDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiBehaviorDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiBehaviorDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiBehaviorDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiBehaviorDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.BehaviorDescriptorId == input.BehaviorDescriptorId ||
                    this.BehaviorDescriptorId.Equals(input.BehaviorDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.BehaviorDescriptorId.GetHashCode();
