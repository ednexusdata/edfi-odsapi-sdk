...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_gradebookEntryTypeDescriptor")]
    public partial class EdFiGradebookEntryTypeDescriptor : IEquatable<EdFiGradebookEntryTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiGradebookEntryTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiGradebookEntryTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiGradebookEntryTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="gradebookEntryTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiGradebookEntryTypeDescriptor(string id = default(string), int gradebookEntryTypeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiGradebookEntryTypeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiGradebookEntryTypeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiGradebookEntryTypeDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "gradebookEntryTypeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  GradebookEntryTypeDescriptorId: ").Append(GradebookEntryTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiGradebookEntryTypeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiGradebookEntryTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiGradebookEntryTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiGradebookEntryTypeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.GradebookEntryTypeDescriptorId == input.GradebookEntryTypeDescriptorId ||
                    this.GradebookEntryTypeDescriptorId.Equals(input.GradebookEntryTypeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.GradebookEntryTypeDescriptorId.GetHashCode();
