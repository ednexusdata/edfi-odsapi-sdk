...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_assessmentReportingMethodDescriptor")]
    public partial class EdFiAssessmentReportingMethodDescriptor : IEquatable<EdFiAssessmentReportingMethodDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAssessmentReportingMethodDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiAssessmentReportingMethodDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAssessmentReportingMethodDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="assessmentReportingMethodDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiAssessmentReportingMethodDescriptor(string id = default(string), int assessmentReportingMethodDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiAssessmentReportingMethodDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiAssessmentReportingMethodDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiAssessmentReportingMethodDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "assessmentReportingMethodDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AssessmentReportingMethodDescriptorId: ").Append(AssessmentReportingMethodDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiAssessmentReportingMethodDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiAssessmentReportingMethodDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiAssessmentReportingMethodDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiAssessmentReportingMethodDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AssessmentReportingMethodDescriptorId == input.AssessmentReportingMethodDescriptorId ||
                    this.AssessmentReportingMethodDescriptorId.Equals(input.AssessmentReportingMethodDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.AssessmentReportingMethodDescriptorId.GetHashCode();
