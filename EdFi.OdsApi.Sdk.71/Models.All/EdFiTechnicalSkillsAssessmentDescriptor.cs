...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_technicalSkillsAssessmentDescriptor")]
    public partial class EdFiTechnicalSkillsAssessmentDescriptor : IEquatable<EdFiTechnicalSkillsAssessmentDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiTechnicalSkillsAssessmentDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiTechnicalSkillsAssessmentDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiTechnicalSkillsAssessmentDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="technicalSkillsAssessmentDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiTechnicalSkillsAssessmentDescriptor(string id = default(string), int technicalSkillsAssessmentDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiTechnicalSkillsAssessmentDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiTechnicalSkillsAssessmentDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiTechnicalSkillsAssessmentDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "technicalSkillsAssessmentDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TechnicalSkillsAssessmentDescriptorId: ").Append(TechnicalSkillsAssessmentDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiTechnicalSkillsAssessmentDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiTechnicalSkillsAssessmentDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiTechnicalSkillsAssessmentDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiTechnicalSkillsAssessmentDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.TechnicalSkillsAssessmentDescriptorId == input.TechnicalSkillsAssessmentDescriptorId ||
                    this.TechnicalSkillsAssessmentDescriptorId.Equals(input.TechnicalSkillsAssessmentDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.TechnicalSkillsAssessmentDescriptorId.GetHashCode();
