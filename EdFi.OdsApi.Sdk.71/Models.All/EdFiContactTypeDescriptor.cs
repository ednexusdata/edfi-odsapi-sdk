...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_contactTypeDescriptor")]
    public partial class EdFiContactTypeDescriptor : IEquatable<EdFiContactTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiContactTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiContactTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiContactTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="contactTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiContactTypeDescriptor(string id = default(string), int contactTypeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiContactTypeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiContactTypeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiContactTypeDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "contactTypeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ContactTypeDescriptorId: ").Append(ContactTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiContactTypeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiContactTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiContactTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiContactTypeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ContactTypeDescriptorId == input.ContactTypeDescriptorId ||
                    this.ContactTypeDescriptorId.Equals(input.ContactTypeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ContactTypeDescriptorId.GetHashCode();
