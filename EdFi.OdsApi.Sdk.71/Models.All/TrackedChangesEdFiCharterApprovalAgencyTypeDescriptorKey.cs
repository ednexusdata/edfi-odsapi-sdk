...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_charterApprovalAgencyTypeDescriptorKey")]
    public partial class TrackedChangesEdFiCharterApprovalAgencyTypeDescriptorKey : IEquatable<TrackedChangesEdFiCharterApprovalAgencyTypeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCharterApprovalAgencyTypeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCharterApprovalAgencyTypeDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCharterApprovalAgencyTypeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCharterApprovalAgencyTypeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCharterApprovalAgencyTypeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCharterApprovalAgencyTypeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCharterApprovalAgencyTypeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
