...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_indicatorDescriptorKeyChange")]
    public partial class TrackedChangesEdFiIndicatorDescriptorKeyChange : IEquatable<TrackedChangesEdFiIndicatorDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiIndicatorDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiIndicatorDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiIndicatorDescriptorKey oldKeyValues = default(TrackedChangesEdFiIndicatorDescriptorKey), TrackedChangesEdFiIndicatorDescriptorKey newKeyValues = default(TrackedChangesEdFiIndicatorDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiIndicatorDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiIndicatorDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiIndicatorDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiIndicatorDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiIndicatorDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiIndicatorDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiIndicatorDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
