...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TrackedChangesEdFiStudentAssessmentKey : IEquatable<TrackedChangesEdFiStudentAssessmentKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiStudentAssessmentKey(string studentAssessmentIdentifier = default(string), string assessmentIdentifier = default(string), string _namespace = default(string), string studentUniqueId = default(string))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStudentAssessmentKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStudentAssessmentKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStudentAssessmentKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStudentAssessmentKey input)
        {
            if (input == null)
            {
                return false;
