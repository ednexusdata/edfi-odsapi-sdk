...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_neglectedOrDelinquentProgramDescriptorKey")]
    public partial class TrackedChangesEdFiNeglectedOrDelinquentProgramDescriptorKey : IEquatable<TrackedChangesEdFiNeglectedOrDelinquentProgramDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiNeglectedOrDelinquentProgramDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiNeglectedOrDelinquentProgramDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiNeglectedOrDelinquentProgramDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiNeglectedOrDelinquentProgramDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiNeglectedOrDelinquentProgramDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiNeglectedOrDelinquentProgramDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiNeglectedOrDelinquentProgramDescriptorKey input)
        {
            if (input == null)
            {
                return false;
