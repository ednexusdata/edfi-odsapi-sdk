...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiReportCardReference : IEquatable<EdFiReportCardReference>, IValidatableObject
    {
        ...
        public EdFiReportCardReference(long educationOrganizationId = default(long), string gradingPeriodDescriptor = default(string), long gradingPeriodSchoolId = default(long), int gradingPeriodSchoolYear = default(int), int gradingPeriodSequence = default(int), string studentUniqueId = default(string), Link link = default(Link))
        {
