...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_schoolChoiceBasisDescriptor")]
    public partial class EdFiSchoolChoiceBasisDescriptor : IEquatable<EdFiSchoolChoiceBasisDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSchoolChoiceBasisDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiSchoolChoiceBasisDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSchoolChoiceBasisDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="schoolChoiceBasisDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiSchoolChoiceBasisDescriptor(string id = default(string), int schoolChoiceBasisDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiSchoolChoiceBasisDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiSchoolChoiceBasisDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiSchoolChoiceBasisDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.SchoolChoiceBasisDescriptorId = schoolChoiceBasisDescriptorId;
        ...
        [DataMember(Name = "schoolChoiceBasisDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiSchoolChoiceBasisDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  SchoolChoiceBasisDescriptorId: ").Append(SchoolChoiceBasisDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiSchoolChoiceBasisDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiSchoolChoiceBasisDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiSchoolChoiceBasisDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiSchoolChoiceBasisDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.SchoolChoiceBasisDescriptorId == input.SchoolChoiceBasisDescriptorId ||
                    this.SchoolChoiceBasisDescriptorId.Equals(input.SchoolChoiceBasisDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.SchoolChoiceBasisDescriptorId.GetHashCode();
