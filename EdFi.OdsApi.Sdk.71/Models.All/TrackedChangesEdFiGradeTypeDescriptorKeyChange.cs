...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_gradeTypeDescriptorKeyChange")]
    public partial class TrackedChangesEdFiGradeTypeDescriptorKeyChange : IEquatable<TrackedChangesEdFiGradeTypeDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiGradeTypeDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiGradeTypeDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiGradeTypeDescriptorKey oldKeyValues = default(TrackedChangesEdFiGradeTypeDescriptorKey), TrackedChangesEdFiGradeTypeDescriptorKey newKeyValues = default(TrackedChangesEdFiGradeTypeDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiGradeTypeDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiGradeTypeDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiGradeTypeDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiGradeTypeDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiGradeTypeDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiGradeTypeDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiGradeTypeDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
