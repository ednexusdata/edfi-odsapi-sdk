...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_courseRepeatCodeDescriptorKey")]
    public partial class TrackedChangesEdFiCourseRepeatCodeDescriptorKey : IEquatable<TrackedChangesEdFiCourseRepeatCodeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCourseRepeatCodeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCourseRepeatCodeDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCourseRepeatCodeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCourseRepeatCodeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCourseRepeatCodeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCourseRepeatCodeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCourseRepeatCodeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
