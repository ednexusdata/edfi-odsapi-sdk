...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiStudentCohortAssociation : IEquatable<EdFiStudentCohortAssociation>, IValidatableObject
    {
        ...
        public EdFiStudentCohortAssociation(string id = default(string), DateTime beginDate = default(DateTime), EdFiCohortReference cohortReference = default(EdFiCohortReference), EdFiStudentReference studentReference = default(EdFiStudentReference), DateTime? endDate = default(DateTime?), List<EdFiStudentCohortAssociationSection> sections = default(List<EdFiStudentCohortAssociationSection>), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
