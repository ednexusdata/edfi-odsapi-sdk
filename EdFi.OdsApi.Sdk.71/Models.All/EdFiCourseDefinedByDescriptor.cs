...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_courseDefinedByDescriptor")]
    public partial class EdFiCourseDefinedByDescriptor : IEquatable<EdFiCourseDefinedByDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCourseDefinedByDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiCourseDefinedByDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCourseDefinedByDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="courseDefinedByDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiCourseDefinedByDescriptor(string id = default(string), int courseDefinedByDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiCourseDefinedByDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiCourseDefinedByDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiCourseDefinedByDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "courseDefinedByDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CourseDefinedByDescriptorId: ").Append(CourseDefinedByDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiCourseDefinedByDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiCourseDefinedByDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiCourseDefinedByDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiCourseDefinedByDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CourseDefinedByDescriptorId == input.CourseDefinedByDescriptorId ||
                    this.CourseDefinedByDescriptorId.Equals(input.CourseDefinedByDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.CourseDefinedByDescriptorId.GetHashCode();
