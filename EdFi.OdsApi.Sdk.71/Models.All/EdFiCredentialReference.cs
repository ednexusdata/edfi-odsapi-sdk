...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiCredentialReference : IEquatable<EdFiCredentialReference>, IValidatableObject
    {
        ...
        public EdFiCredentialReference(string credentialIdentifier = default(string), string stateOfIssueStateAbbreviationDescriptor = default(string), Link link = default(Link))
        {
            ...
            {
                throw new ArgumentNullException("credentialIdentifier is a required property for EdFiCredentialReference and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("stateOfIssueStateAbbreviationDescriptor is a required property for EdFiCredentialReference and cannot be null");
            }
