...
{
    /// <summary>
    /// SampleMembershipTypeDescriptor
    /// </summary>
    [DataContract(Name = "sample_membershipTypeDescriptor")]
    public partial class SampleMembershipTypeDescriptor : IEquatable<SampleMembershipTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleMembershipTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SampleMembershipTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleMembershipTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="membershipTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public SampleMembershipTypeDescriptor(string id = default(string), int membershipTypeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for SampleMembershipTypeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for SampleMembershipTypeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for SampleMembershipTypeDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.MembershipTypeDescriptorId = membershipTypeDescriptorId;
        ...
        [DataMember(Name = "membershipTypeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SampleMembershipTypeDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  MembershipTypeDescriptorId: ").Append(MembershipTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as SampleMembershipTypeDescriptor);
        }

        /// <summary>
        /// Returns true if SampleMembershipTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of SampleMembershipTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SampleMembershipTypeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.MembershipTypeDescriptorId == input.MembershipTypeDescriptorId ||
                    this.MembershipTypeDescriptorId.Equals(input.MembershipTypeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.MembershipTypeDescriptorId.GetHashCode();
