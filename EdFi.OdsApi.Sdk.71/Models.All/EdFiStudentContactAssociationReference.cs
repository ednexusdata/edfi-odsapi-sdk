...
{
    /// <summary>
    /// EdFiStudentContactAssociationReference
    /// </summary>
    [DataContract(Name = "edFi_studentContactAssociationReference")]
    public partial class EdFiStudentContactAssociationReference : IEquatable<EdFiStudentContactAssociationReference>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentContactAssociationReference" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiStudentContactAssociationReference() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentContactAssociationReference" /> class.
        /// </summary>
        ...
        public EdFiStudentContactAssociationReference(string contactUniqueId = default(string), string studentUniqueId = default(string), Link link = default(Link))
        {
            // to ensure "contactUniqueId" is required (not null)
            if (contactUniqueId == null)
            {
                throw new ArgumentNullException("contactUniqueId is a required property for EdFiStudentContactAssociationReference and cannot be null");
            }
            this.ContactUniqueId = contactUniqueId;
            // to ensure "studentUniqueId" is required (not null)
            if (studentUniqueId == null)
            {
                throw new ArgumentNullException("studentUniqueId is a required property for EdFiStudentContactAssociationReference and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiStudentContactAssociationReference {\n");
        ...
        {
            return this.Equals(input as EdFiStudentContactAssociationReference);
        }

        /// <summary>
        /// Returns true if EdFiStudentContactAssociationReference instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStudentContactAssociationReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStudentContactAssociationReference input)
        {
            if (input == null)
            {
                return false;
