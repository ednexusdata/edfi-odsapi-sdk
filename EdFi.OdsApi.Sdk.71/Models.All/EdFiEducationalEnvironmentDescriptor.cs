...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_educationalEnvironmentDescriptor")]
    public partial class EdFiEducationalEnvironmentDescriptor : IEquatable<EdFiEducationalEnvironmentDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiEducationalEnvironmentDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiEducationalEnvironmentDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiEducationalEnvironmentDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="educationalEnvironmentDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiEducationalEnvironmentDescriptor(string id = default(string), int educationalEnvironmentDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiEducationalEnvironmentDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiEducationalEnvironmentDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiEducationalEnvironmentDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "educationalEnvironmentDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  EducationalEnvironmentDescriptorId: ").Append(EducationalEnvironmentDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiEducationalEnvironmentDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiEducationalEnvironmentDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiEducationalEnvironmentDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiEducationalEnvironmentDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.EducationalEnvironmentDescriptorId == input.EducationalEnvironmentDescriptorId ||
                    this.EducationalEnvironmentDescriptorId.Equals(input.EducationalEnvironmentDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.EducationalEnvironmentDescriptorId.GetHashCode();
