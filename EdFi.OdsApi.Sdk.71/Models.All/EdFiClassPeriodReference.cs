...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiClassPeriodReference : IEquatable<EdFiClassPeriodReference>, IValidatableObject
    {
        ...
        public EdFiClassPeriodReference(string classPeriodName = default(string), long schoolId = default(long), Link link = default(Link))
        {
            // to ensure "classPeriodName" is required (not null)
            if (classPeriodName == null)
            {
                throw new ArgumentNullException("classPeriodName is a required property for EdFiClassPeriodReference and cannot be null");
            }
