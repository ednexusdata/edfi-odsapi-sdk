...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiContactTelephone : IEquatable<EdFiContactTelephone>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiContactTelephone(string telephoneNumberTypeDescriptor = default(string), string telephoneNumber = default(string), bool? doNotPublishIndicator = default(bool?), int? orderOfPriority = default(int?), bool? textMessageCapabilityIndicator = default(bool?))
        {
        ...
        {
            return this.Equals(input as EdFiContactTelephone);
        }

        /// <summary>
        /// Returns true if EdFiContactTelephone instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiContactTelephone to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiContactTelephone input)
        {
            if (input == null)
            {
                return false;
