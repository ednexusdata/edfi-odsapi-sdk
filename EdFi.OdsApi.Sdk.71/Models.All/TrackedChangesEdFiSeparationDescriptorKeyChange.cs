...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_separationDescriptorKeyChange")]
    public partial class TrackedChangesEdFiSeparationDescriptorKeyChange : IEquatable<TrackedChangesEdFiSeparationDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiSeparationDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiSeparationDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiSeparationDescriptorKey oldKeyValues = default(TrackedChangesEdFiSeparationDescriptorKey), TrackedChangesEdFiSeparationDescriptorKey newKeyValues = default(TrackedChangesEdFiSeparationDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiSeparationDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiSeparationDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiSeparationDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSeparationDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSeparationDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSeparationDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSeparationDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
