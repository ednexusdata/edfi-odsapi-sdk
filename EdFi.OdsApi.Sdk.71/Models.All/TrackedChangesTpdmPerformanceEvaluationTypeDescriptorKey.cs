...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_tpdm_performanceEvaluationTypeDescriptorKey")]
    public partial class TrackedChangesTpdmPerformanceEvaluationTypeDescriptorKey : IEquatable<TrackedChangesTpdmPerformanceEvaluationTypeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesTpdmPerformanceEvaluationTypeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesTpdmPerformanceEvaluationTypeDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesTpdmPerformanceEvaluationTypeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesTpdmPerformanceEvaluationTypeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesTpdmPerformanceEvaluationTypeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesTpdmPerformanceEvaluationTypeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesTpdmPerformanceEvaluationTypeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
