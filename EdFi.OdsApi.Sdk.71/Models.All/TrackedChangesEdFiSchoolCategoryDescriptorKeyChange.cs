...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_schoolCategoryDescriptorKeyChange")]
    public partial class TrackedChangesEdFiSchoolCategoryDescriptorKeyChange : IEquatable<TrackedChangesEdFiSchoolCategoryDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiSchoolCategoryDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiSchoolCategoryDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiSchoolCategoryDescriptorKey oldKeyValues = default(TrackedChangesEdFiSchoolCategoryDescriptorKey), TrackedChangesEdFiSchoolCategoryDescriptorKey newKeyValues = default(TrackedChangesEdFiSchoolCategoryDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiSchoolCategoryDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiSchoolCategoryDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiSchoolCategoryDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSchoolCategoryDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSchoolCategoryDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSchoolCategoryDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSchoolCategoryDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
