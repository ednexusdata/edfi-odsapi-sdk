...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_functionDimensionKeyChange")]
    public partial class TrackedChangesEdFiFunctionDimensionKeyChange : IEquatable<TrackedChangesEdFiFunctionDimensionKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiFunctionDimensionKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiFunctionDimensionKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiFunctionDimensionKey oldKeyValues = default(TrackedChangesEdFiFunctionDimensionKey), TrackedChangesEdFiFunctionDimensionKey newKeyValues = default(TrackedChangesEdFiFunctionDimensionKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiFunctionDimensionKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiFunctionDimensionKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiFunctionDimensionKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiFunctionDimensionKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiFunctionDimensionKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiFunctionDimensionKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiFunctionDimensionKeyChange input)
        {
            if (input == null)
            {
                return false;
