...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "tpdm_performanceEvaluationTypeDescriptor")]
    public partial class TpdmPerformanceEvaluationTypeDescriptor : IEquatable<TpdmPerformanceEvaluationTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmPerformanceEvaluationTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmPerformanceEvaluationTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmPerformanceEvaluationTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="performanceEvaluationTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmPerformanceEvaluationTypeDescriptor(string id = default(string), int performanceEvaluationTypeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for TpdmPerformanceEvaluationTypeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for TpdmPerformanceEvaluationTypeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for TpdmPerformanceEvaluationTypeDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.PerformanceEvaluationTypeDescriptorId = performanceEvaluationTypeDescriptorId;
        ...
        [DataMember(Name = "performanceEvaluationTypeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmPerformanceEvaluationTypeDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  PerformanceEvaluationTypeDescriptorId: ").Append(PerformanceEvaluationTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmPerformanceEvaluationTypeDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmPerformanceEvaluationTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmPerformanceEvaluationTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmPerformanceEvaluationTypeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.PerformanceEvaluationTypeDescriptorId == input.PerformanceEvaluationTypeDescriptorId ||
                    this.PerformanceEvaluationTypeDescriptorId.Equals(input.PerformanceEvaluationTypeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.PerformanceEvaluationTypeDescriptorId.GetHashCode();
