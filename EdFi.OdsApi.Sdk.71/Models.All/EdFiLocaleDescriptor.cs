...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_localeDescriptor")]
    public partial class EdFiLocaleDescriptor : IEquatable<EdFiLocaleDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiLocaleDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiLocaleDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiLocaleDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="localeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiLocaleDescriptor(string id = default(string), int localeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiLocaleDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiLocaleDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiLocaleDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "localeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  LocaleDescriptorId: ").Append(LocaleDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiLocaleDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiLocaleDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiLocaleDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiLocaleDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.LocaleDescriptorId == input.LocaleDescriptorId ||
                    this.LocaleDescriptorId.Equals(input.LocaleDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.LocaleDescriptorId.GetHashCode();
