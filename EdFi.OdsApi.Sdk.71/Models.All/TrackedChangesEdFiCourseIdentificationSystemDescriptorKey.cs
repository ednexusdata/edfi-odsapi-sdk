...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_courseIdentificationSystemDescriptorKey")]
    public partial class TrackedChangesEdFiCourseIdentificationSystemDescriptorKey : IEquatable<TrackedChangesEdFiCourseIdentificationSystemDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCourseIdentificationSystemDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCourseIdentificationSystemDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCourseIdentificationSystemDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCourseIdentificationSystemDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCourseIdentificationSystemDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCourseIdentificationSystemDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCourseIdentificationSystemDescriptorKey input)
        {
            if (input == null)
            {
                return false;
