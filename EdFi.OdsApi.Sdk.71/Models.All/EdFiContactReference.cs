...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiContactReference : IEquatable<EdFiContactReference>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiContactReference(string contactUniqueId = default(string), Link link = default(Link))
        {
        ...
        {
            return this.Equals(input as EdFiContactReference);
        }

        /// <summary>
        /// Returns true if EdFiContactReference instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiContactReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiContactReference input)
        {
            if (input == null)
            {
                return false;
