...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_termDescriptorKey")]
    public partial class TrackedChangesEdFiTermDescriptorKey : IEquatable<TrackedChangesEdFiTermDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiTermDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiTermDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiTermDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiTermDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiTermDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiTermDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiTermDescriptorKey input)
        {
            if (input == null)
            {
                return false;
