...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiEducationOrganizationIndicator : IEquatable<EdFiEducationOrganizationIndicator>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // IndicatorValue (string) minLength
            if (this.IndicatorValue != null && this.IndicatorValue.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for IndicatorValue, length must be greater than 1.", new [] { "IndicatorValue" });
            }
