...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_educationContentKeyChange")]
    public partial class TrackedChangesEdFiEducationContentKeyChange : IEquatable<TrackedChangesEdFiEducationContentKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiEducationContentKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiEducationContentKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiEducationContentKey oldKeyValues = default(TrackedChangesEdFiEducationContentKey), TrackedChangesEdFiEducationContentKey newKeyValues = default(TrackedChangesEdFiEducationContentKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiEducationContentKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiEducationContentKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiEducationContentKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiEducationContentKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiEducationContentKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiEducationContentKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiEducationContentKeyChange input)
        {
            if (input == null)
            {
                return false;
