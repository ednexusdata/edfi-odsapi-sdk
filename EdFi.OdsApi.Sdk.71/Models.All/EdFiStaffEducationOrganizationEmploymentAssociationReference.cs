...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiStaffEducationOrganizationEmploymentAssociationReference : IEquatable<EdFiStaffEducationOrganizationEmploymentAssociationReference>, IValidatableObject
    {
        ...
        public EdFiStaffEducationOrganizationEmploymentAssociationReference(long educationOrganizationId = default(long), string employmentStatusDescriptor = default(string), DateTime hireDate = default(DateTime), string staffUniqueId = default(string), Link link = default(Link))
        {
