...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_questionFormDescriptorKey")]
    public partial class TrackedChangesEdFiQuestionFormDescriptorKey : IEquatable<TrackedChangesEdFiQuestionFormDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiQuestionFormDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiQuestionFormDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiQuestionFormDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiQuestionFormDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiQuestionFormDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiQuestionFormDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiQuestionFormDescriptorKey input)
        {
            if (input == null)
            {
                return false;
