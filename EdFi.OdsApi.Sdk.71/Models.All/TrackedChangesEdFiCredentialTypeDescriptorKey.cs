...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_credentialTypeDescriptorKey")]
    public partial class TrackedChangesEdFiCredentialTypeDescriptorKey : IEquatable<TrackedChangesEdFiCredentialTypeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCredentialTypeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCredentialTypeDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCredentialTypeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCredentialTypeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCredentialTypeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCredentialTypeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCredentialTypeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
