...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_creditTypeDescriptorKey")]
    public partial class TrackedChangesEdFiCreditTypeDescriptorKey : IEquatable<TrackedChangesEdFiCreditTypeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCreditTypeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCreditTypeDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCreditTypeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCreditTypeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCreditTypeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCreditTypeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCreditTypeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
