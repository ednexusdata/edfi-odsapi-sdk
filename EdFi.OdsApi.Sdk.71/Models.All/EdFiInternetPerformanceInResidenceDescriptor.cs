...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_internetPerformanceInResidenceDescriptor")]
    public partial class EdFiInternetPerformanceInResidenceDescriptor : IEquatable<EdFiInternetPerformanceInResidenceDescriptor>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiInternetPerformanceInResidenceDescriptor(string id = default(string), int internetPerformanceInResidenceDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            ...
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiInternetPerformanceInResidenceDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiInternetPerformanceInResidenceDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiInternetPerformanceInResidenceDescriptor and cannot be null");
            }
