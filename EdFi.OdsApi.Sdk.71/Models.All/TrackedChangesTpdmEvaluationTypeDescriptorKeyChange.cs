...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_tpdm_evaluationTypeDescriptorKeyChange")]
    public partial class TrackedChangesTpdmEvaluationTypeDescriptorKeyChange : IEquatable<TrackedChangesTpdmEvaluationTypeDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesTpdmEvaluationTypeDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesTpdmEvaluationTypeDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesTpdmEvaluationTypeDescriptorKey oldKeyValues = default(TrackedChangesTpdmEvaluationTypeDescriptorKey), TrackedChangesTpdmEvaluationTypeDescriptorKey newKeyValues = default(TrackedChangesTpdmEvaluationTypeDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesTpdmEvaluationTypeDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesTpdmEvaluationTypeDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesTpdmEvaluationTypeDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesTpdmEvaluationTypeDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesTpdmEvaluationTypeDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesTpdmEvaluationTypeDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesTpdmEvaluationTypeDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
