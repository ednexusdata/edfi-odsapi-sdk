...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_citizenshipStatusDescriptor")]
    public partial class EdFiCitizenshipStatusDescriptor : IEquatable<EdFiCitizenshipStatusDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCitizenshipStatusDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiCitizenshipStatusDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCitizenshipStatusDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="citizenshipStatusDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiCitizenshipStatusDescriptor(string id = default(string), int citizenshipStatusDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiCitizenshipStatusDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiCitizenshipStatusDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiCitizenshipStatusDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "citizenshipStatusDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CitizenshipStatusDescriptorId: ").Append(CitizenshipStatusDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiCitizenshipStatusDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiCitizenshipStatusDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiCitizenshipStatusDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiCitizenshipStatusDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CitizenshipStatusDescriptorId == input.CitizenshipStatusDescriptorId ||
                    this.CitizenshipStatusDescriptorId.Equals(input.CitizenshipStatusDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.CitizenshipStatusDescriptorId.GetHashCode();
