...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_localAccountKeyChange")]
    public partial class TrackedChangesEdFiLocalAccountKeyChange : IEquatable<TrackedChangesEdFiLocalAccountKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiLocalAccountKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiLocalAccountKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiLocalAccountKey oldKeyValues = default(TrackedChangesEdFiLocalAccountKey), TrackedChangesEdFiLocalAccountKey newKeyValues = default(TrackedChangesEdFiLocalAccountKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiLocalAccountKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiLocalAccountKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiLocalAccountKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiLocalAccountKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiLocalAccountKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiLocalAccountKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiLocalAccountKeyChange input)
        {
            if (input == null)
            {
                return false;
