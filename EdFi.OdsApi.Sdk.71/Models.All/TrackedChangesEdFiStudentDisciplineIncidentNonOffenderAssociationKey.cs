...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TrackedChangesEdFiStudentDisciplineIncidentNonOffenderAssociationKey : IEquatable<TrackedChangesEdFiStudentDisciplineIncidentNonOffenderAssociationKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiStudentDisciplineIncidentNonOffenderAssociationKey(string incidentIdentifier = default(string), long schoolId = default(long), string studentUniqueId = default(string))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStudentDisciplineIncidentNonOffenderAssociationKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStudentDisciplineIncidentNonOffenderAssociationKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStudentDisciplineIncidentNonOffenderAssociationKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStudentDisciplineIncidentNonOffenderAssociationKey input)
        {
            if (input == null)
            {
                return false;
