...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_disabilityDesignationDescriptorKey")]
    public partial class TrackedChangesEdFiDisabilityDesignationDescriptorKey : IEquatable<TrackedChangesEdFiDisabilityDesignationDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiDisabilityDesignationDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiDisabilityDesignationDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiDisabilityDesignationDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiDisabilityDesignationDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiDisabilityDesignationDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiDisabilityDesignationDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiDisabilityDesignationDescriptorKey input)
        {
            if (input == null)
            {
                return false;
