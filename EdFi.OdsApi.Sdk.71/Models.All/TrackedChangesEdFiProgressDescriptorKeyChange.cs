...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_progressDescriptorKeyChange")]
    public partial class TrackedChangesEdFiProgressDescriptorKeyChange : IEquatable<TrackedChangesEdFiProgressDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiProgressDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiProgressDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiProgressDescriptorKey oldKeyValues = default(TrackedChangesEdFiProgressDescriptorKey), TrackedChangesEdFiProgressDescriptorKey newKeyValues = default(TrackedChangesEdFiProgressDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiProgressDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiProgressDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiProgressDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiProgressDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiProgressDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiProgressDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiProgressDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
