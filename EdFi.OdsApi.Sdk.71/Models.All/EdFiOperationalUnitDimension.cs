...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_operationalUnitDimension")]
    public partial class EdFiOperationalUnitDimension : IEquatable<EdFiOperationalUnitDimension>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiOperationalUnitDimension" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiOperationalUnitDimension() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiOperationalUnitDimension" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="code">The code representation of the account operational unit dimension. (required).</param>
        /// <param name="fiscalYear">The fiscal year for which the account operational unit dimension is valid. (required).</param>
        ...
        public EdFiOperationalUnitDimension(string id = default(string), string code = default(string), int fiscalYear = default(int), string codeName = default(string), List<EdFiOperationalUnitDimensionReportingTag> reportingTags = default(List<EdFiOperationalUnitDimensionReportingTag>), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "code" is required (not null)
            if (code == null)
            {
                throw new ArgumentNullException("code is a required property for EdFiOperationalUnitDimension and cannot be null");
            }
            this.Code = code;
        ...
        public List<EdFiOperationalUnitDimensionReportingTag> ReportingTags { get; set; }
        ...
        {
            return this.Equals(input as EdFiOperationalUnitDimension);
        }

        /// <summary>
        /// Returns true if EdFiOperationalUnitDimension instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiOperationalUnitDimension to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiOperationalUnitDimension input)
        {
            if (input == null)
            {
                return false;
