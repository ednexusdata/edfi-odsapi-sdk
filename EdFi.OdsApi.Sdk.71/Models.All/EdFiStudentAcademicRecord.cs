...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiStudentAcademicRecord : IEquatable<EdFiStudentAcademicRecord>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.CumulativeAttemptedCredits < (double?)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CumulativeAttemptedCredits, must be a value greater than or equal to 0.", new [] { "CumulativeAttemptedCredits" });
            }
            ...
            if (this.CumulativeEarnedCredits < (double?)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CumulativeEarnedCredits, must be a value greater than or equal to 0.", new [] { "CumulativeEarnedCredits" });
            }
            ...
            if (this.SessionAttemptedCredits < (double?)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SessionAttemptedCredits, must be a value greater than or equal to 0.", new [] { "SessionAttemptedCredits" });
            }
            ...
            if (this.SessionEarnedCredits < (double?)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SessionEarnedCredits, must be a value greater than or equal to 0.", new [] { "SessionEarnedCredits" });
            }
