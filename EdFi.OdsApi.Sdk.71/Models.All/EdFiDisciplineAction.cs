...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiDisciplineAction : IEquatable<EdFiDisciplineAction>, IValidatableObject
    {
        ...
        public EdFiDisciplineAction(string id = default(string), string disciplineActionIdentifier = default(string), DateTime disciplineDate = default(DateTime), List<EdFiDisciplineActionDiscipline> disciplines = default(List<EdFiDisciplineActionDiscipline>), EdFiSchoolReference assignmentSchoolReference = default(EdFiSchoolReference), EdFiSchoolReference responsibilitySchoolReference = default(EdFiSchoolReference), EdFiStudentReference studentReference = default(EdFiStudentReference), double? actualDisciplineActionLength = default(double?), double? disciplineActionLength = default(double?), string disciplineActionLengthDifferenceReasonDescriptor = default(string), bool? iepPlacementMeetingIndicator = default(bool?), bool? relatedToZeroTolerancePolicy = default(bool?), List<EdFiDisciplineActionStaff> staffs = default(List<EdFiDisciplineActionStaff>), List<EdFiDisciplineActionStudentDisciplineIncidentBehaviorAssociation> studentDisciplineIncidentBehaviorAssociations = default(List<EdFiDisciplineActionStudentDisciplineIncidentBehaviorAssociation>), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DisciplineActionIdentifier, length must be less than 36.", new [] { "DisciplineActionIdentifier" });
            }

            // DisciplineActionIdentifier (string) minLength
            if (this.DisciplineActionIdentifier != null && this.DisciplineActionIdentifier.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DisciplineActionIdentifier, length must be greater than 1.", new [] { "DisciplineActionIdentifier" });
            }

            // ActualDisciplineActionLength (double?) minimum
            if (this.ActualDisciplineActionLength < (double?)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ActualDisciplineActionLength, must be a value greater than or equal to 0.", new [] { "ActualDisciplineActionLength" });
            }

            // DisciplineActionLength (double?) minimum
            if (this.DisciplineActionLength < (double?)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DisciplineActionLength, must be a value greater than or equal to 0.", new [] { "DisciplineActionLength" });
            }
