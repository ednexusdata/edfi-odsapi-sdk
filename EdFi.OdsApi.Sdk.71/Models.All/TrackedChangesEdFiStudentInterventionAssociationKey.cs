...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TrackedChangesEdFiStudentInterventionAssociationKey : IEquatable<TrackedChangesEdFiStudentInterventionAssociationKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiStudentInterventionAssociationKey(long educationOrganizationId = default(long), string interventionIdentificationCode = default(string), string studentUniqueId = default(string))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStudentInterventionAssociationKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStudentInterventionAssociationKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStudentInterventionAssociationKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStudentInterventionAssociationKey input)
        {
            if (input == null)
            {
                return false;
