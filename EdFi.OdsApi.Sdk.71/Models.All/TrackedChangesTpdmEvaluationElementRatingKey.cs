...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_tpdm_evaluationElementRatingKey")]
    public partial class TrackedChangesTpdmEvaluationElementRatingKey : IEquatable<TrackedChangesTpdmEvaluationElementRatingKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesTpdmEvaluationElementRatingKey" /> class.
        /// </summary>
        ...
        /// <param name="evaluationDate">The date for the person&#39;s evaluation..</param>
        ...
        public TrackedChangesTpdmEvaluationElementRatingKey(long educationOrganizationId = default(long), string evaluationElementTitle = default(string), string evaluationObjectiveTitle = default(string), string evaluationPeriodDescriptor = default(string), string evaluationTitle = default(string), string performanceEvaluationTitle = default(string), string performanceEvaluationTypeDescriptor = default(string), int schoolYear = default(int), string termDescriptor = default(string), DateTime evaluationDate = default(DateTime), string personId = default(string), string sourceSystemDescriptor = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesTpdmEvaluationElementRatingKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesTpdmEvaluationElementRatingKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesTpdmEvaluationElementRatingKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesTpdmEvaluationElementRatingKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesTpdmEvaluationElementRatingKey input)
        {
            if (input == null)
            {
                return false;
