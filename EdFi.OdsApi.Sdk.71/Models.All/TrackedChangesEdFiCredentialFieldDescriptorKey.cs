...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_credentialFieldDescriptorKey")]
    public partial class TrackedChangesEdFiCredentialFieldDescriptorKey : IEquatable<TrackedChangesEdFiCredentialFieldDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCredentialFieldDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCredentialFieldDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCredentialFieldDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCredentialFieldDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCredentialFieldDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCredentialFieldDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCredentialFieldDescriptorKey input)
        {
            if (input == null)
            {
                return false;
