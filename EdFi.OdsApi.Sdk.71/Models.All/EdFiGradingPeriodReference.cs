...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiGradingPeriodReference : IEquatable<EdFiGradingPeriodReference>, IValidatableObject
    {
        ...
        public EdFiGradingPeriodReference(string gradingPeriodDescriptor = default(string), int periodSequence = default(int), long schoolId = default(long), int schoolYear = default(int), Link link = default(Link))
        {
        ...
        [DataMember(Name = "periodSequence", IsRequired = true, EmitDefaultValue = true)]
