...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiContactElectronicMail : IEquatable<EdFiContactElectronicMail>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiContactElectronicMail(string electronicMailTypeDescriptor = default(string), string electronicMailAddress = default(string), bool? doNotPublishIndicator = default(bool?), bool? primaryEmailAddressIndicator = default(bool?))
        {
        ...
        {
            return this.Equals(input as EdFiContactElectronicMail);
        }

        /// <summary>
        /// Returns true if EdFiContactElectronicMail instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiContactElectronicMail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiContactElectronicMail input)
        {
            if (input == null)
            {
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ElectronicMailAddress, length must be greater than 7.", new [] { "ElectronicMailAddress" });
            }
