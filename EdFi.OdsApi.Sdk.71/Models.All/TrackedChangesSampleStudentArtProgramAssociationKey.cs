...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_sample_studentArtProgramAssociationKey")]
    public partial class TrackedChangesSampleStudentArtProgramAssociationKey : IEquatable<TrackedChangesSampleStudentArtProgramAssociationKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesSampleStudentArtProgramAssociationKey" /> class.
        /// </summary>
        ...
        public TrackedChangesSampleStudentArtProgramAssociationKey(DateTime beginDate = default(DateTime), long educationOrganizationId = default(long), long programEducationOrganizationId = default(long), string programName = default(string), string programTypeDescriptor = default(string), string studentUniqueId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesSampleStudentArtProgramAssociationKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesSampleStudentArtProgramAssociationKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesSampleStudentArtProgramAssociationKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesSampleStudentArtProgramAssociationKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesSampleStudentArtProgramAssociationKey input)
        {
            if (input == null)
            {
                return false;
