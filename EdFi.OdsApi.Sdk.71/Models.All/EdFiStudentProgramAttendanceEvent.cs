...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiStudentProgramAttendanceEvent : IEquatable<EdFiStudentProgramAttendanceEvent>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ProgramAttendanceDuration, must be a value less than or equal to 1440.", new [] { "ProgramAttendanceDuration" });
            }

            // ProgramAttendanceDuration (int?) minimum
            if (this.ProgramAttendanceDuration < (int?)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ProgramAttendanceDuration, must be a value greater than or equal to 0.", new [] { "ProgramAttendanceDuration" });
            }
