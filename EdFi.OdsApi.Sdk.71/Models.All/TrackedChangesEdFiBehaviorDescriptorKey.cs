...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_behaviorDescriptorKey")]
    public partial class TrackedChangesEdFiBehaviorDescriptorKey : IEquatable<TrackedChangesEdFiBehaviorDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiBehaviorDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiBehaviorDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiBehaviorDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiBehaviorDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiBehaviorDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiBehaviorDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiBehaviorDescriptorKey input)
        {
            if (input == null)
            {
                return false;
