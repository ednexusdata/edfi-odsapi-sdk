...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// EdFiVisaDescriptor
    /// </summary>
    [DataContract(Name = "edFi_visaDescriptor")]
    public partial class EdFiVisaDescriptor : IEquatable<EdFiVisaDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiVisaDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiVisaDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiVisaDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="visaDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiVisaDescriptor(string id = default(string), int visaDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiVisaDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiVisaDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiVisaDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "visaDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  VisaDescriptorId: ").Append(VisaDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiVisaDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiVisaDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiVisaDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiVisaDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.VisaDescriptorId == input.VisaDescriptorId ||
                    this.VisaDescriptorId.Equals(input.VisaDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.VisaDescriptorId.GetHashCode();
