...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_behaviorDescriptorKeyChange")]
    public partial class TrackedChangesEdFiBehaviorDescriptorKeyChange : IEquatable<TrackedChangesEdFiBehaviorDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiBehaviorDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiBehaviorDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiBehaviorDescriptorKey oldKeyValues = default(TrackedChangesEdFiBehaviorDescriptorKey), TrackedChangesEdFiBehaviorDescriptorKey newKeyValues = default(TrackedChangesEdFiBehaviorDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiBehaviorDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiBehaviorDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiBehaviorDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiBehaviorDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiBehaviorDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiBehaviorDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiBehaviorDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
