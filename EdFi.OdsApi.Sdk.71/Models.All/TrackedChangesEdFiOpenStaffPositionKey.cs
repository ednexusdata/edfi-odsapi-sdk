...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TrackedChangesEdFiOpenStaffPositionKey : IEquatable<TrackedChangesEdFiOpenStaffPositionKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiOpenStaffPositionKey(string requisitionNumber = default(string), long educationOrganizationId = default(long))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiOpenStaffPositionKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiOpenStaffPositionKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiOpenStaffPositionKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiOpenStaffPositionKey input)
        {
            if (input == null)
            {
                return false;
