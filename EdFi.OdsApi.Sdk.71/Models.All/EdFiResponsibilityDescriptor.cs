...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_responsibilityDescriptor")]
    public partial class EdFiResponsibilityDescriptor : IEquatable<EdFiResponsibilityDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiResponsibilityDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiResponsibilityDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiResponsibilityDescriptor" /> class.
        /// </summary>
        ...
        public EdFiResponsibilityDescriptor(string id = default(string), int responsibilityDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiResponsibilityDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiResponsibilityDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiResponsibilityDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "responsibilityDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ResponsibilityDescriptorId: ").Append(ResponsibilityDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiResponsibilityDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiResponsibilityDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiResponsibilityDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiResponsibilityDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ResponsibilityDescriptorId == input.ResponsibilityDescriptorId ||
                    this.ResponsibilityDescriptorId.Equals(input.ResponsibilityDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ResponsibilityDescriptorId.GetHashCode();
