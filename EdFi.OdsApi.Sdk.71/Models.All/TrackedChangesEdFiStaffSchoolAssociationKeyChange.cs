...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_staffSchoolAssociationKeyChange")]
    public partial class TrackedChangesEdFiStaffSchoolAssociationKeyChange : IEquatable<TrackedChangesEdFiStaffSchoolAssociationKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiStaffSchoolAssociationKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiStaffSchoolAssociationKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiStaffSchoolAssociationKey oldKeyValues = default(TrackedChangesEdFiStaffSchoolAssociationKey), TrackedChangesEdFiStaffSchoolAssociationKey newKeyValues = default(TrackedChangesEdFiStaffSchoolAssociationKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiStaffSchoolAssociationKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiStaffSchoolAssociationKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiStaffSchoolAssociationKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStaffSchoolAssociationKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStaffSchoolAssociationKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStaffSchoolAssociationKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStaffSchoolAssociationKeyChange input)
        {
            if (input == null)
            {
                return false;
