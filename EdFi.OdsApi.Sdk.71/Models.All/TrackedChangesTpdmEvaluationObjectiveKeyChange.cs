...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_tpdm_evaluationObjectiveKeyChange")]
    public partial class TrackedChangesTpdmEvaluationObjectiveKeyChange : IEquatable<TrackedChangesTpdmEvaluationObjectiveKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesTpdmEvaluationObjectiveKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesTpdmEvaluationObjectiveKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesTpdmEvaluationObjectiveKey oldKeyValues = default(TrackedChangesTpdmEvaluationObjectiveKey), TrackedChangesTpdmEvaluationObjectiveKey newKeyValues = default(TrackedChangesTpdmEvaluationObjectiveKey))
        {
            this.Id = id;
        ...
        public TrackedChangesTpdmEvaluationObjectiveKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesTpdmEvaluationObjectiveKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesTpdmEvaluationObjectiveKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesTpdmEvaluationObjectiveKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesTpdmEvaluationObjectiveKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesTpdmEvaluationObjectiveKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesTpdmEvaluationObjectiveKeyChange input)
        {
            if (input == null)
            {
                return false;
