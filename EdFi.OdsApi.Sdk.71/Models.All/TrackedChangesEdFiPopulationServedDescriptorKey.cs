...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_populationServedDescriptorKey")]
    public partial class TrackedChangesEdFiPopulationServedDescriptorKey : IEquatable<TrackedChangesEdFiPopulationServedDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiPopulationServedDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiPopulationServedDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiPopulationServedDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiPopulationServedDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiPopulationServedDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiPopulationServedDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiPopulationServedDescriptorKey input)
        {
            if (input == null)
            {
                return false;
