...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_sectionAttendanceTakenEventKeyChange")]
    public partial class TrackedChangesEdFiSectionAttendanceTakenEventKeyChange : IEquatable<TrackedChangesEdFiSectionAttendanceTakenEventKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiSectionAttendanceTakenEventKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiSectionAttendanceTakenEventKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiSectionAttendanceTakenEventKey oldKeyValues = default(TrackedChangesEdFiSectionAttendanceTakenEventKey), TrackedChangesEdFiSectionAttendanceTakenEventKey newKeyValues = default(TrackedChangesEdFiSectionAttendanceTakenEventKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiSectionAttendanceTakenEventKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiSectionAttendanceTakenEventKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiSectionAttendanceTakenEventKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSectionAttendanceTakenEventKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSectionAttendanceTakenEventKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSectionAttendanceTakenEventKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSectionAttendanceTakenEventKeyChange input)
        {
            if (input == null)
            {
                return false;
