...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_populationServedDescriptorKeyChange")]
    public partial class TrackedChangesEdFiPopulationServedDescriptorKeyChange : IEquatable<TrackedChangesEdFiPopulationServedDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiPopulationServedDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiPopulationServedDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiPopulationServedDescriptorKey oldKeyValues = default(TrackedChangesEdFiPopulationServedDescriptorKey), TrackedChangesEdFiPopulationServedDescriptorKey newKeyValues = default(TrackedChangesEdFiPopulationServedDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiPopulationServedDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiPopulationServedDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiPopulationServedDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiPopulationServedDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiPopulationServedDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiPopulationServedDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiPopulationServedDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
