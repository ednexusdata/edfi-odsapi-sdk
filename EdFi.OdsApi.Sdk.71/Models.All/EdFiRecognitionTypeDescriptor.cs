...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_recognitionTypeDescriptor")]
    public partial class EdFiRecognitionTypeDescriptor : IEquatable<EdFiRecognitionTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiRecognitionTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiRecognitionTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiRecognitionTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="recognitionTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiRecognitionTypeDescriptor(string id = default(string), int recognitionTypeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiRecognitionTypeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiRecognitionTypeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiRecognitionTypeDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "recognitionTypeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RecognitionTypeDescriptorId: ").Append(RecognitionTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiRecognitionTypeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiRecognitionTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiRecognitionTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiRecognitionTypeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.RecognitionTypeDescriptorId == input.RecognitionTypeDescriptorId ||
                    this.RecognitionTypeDescriptorId.Equals(input.RecognitionTypeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.RecognitionTypeDescriptorId.GetHashCode();
