...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// EdFiLocalPayroll
    /// </summary>
    [DataContract(Name = "edFi_localPayroll")]
    public partial class EdFiLocalPayroll : IEquatable<EdFiLocalPayroll>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiLocalPayroll" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiLocalPayroll() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiLocalPayroll" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiLocalPayroll {\n");
        ...
        {
            return this.Equals(input as EdFiLocalPayroll);
        }

        /// <summary>
        /// Returns true if EdFiLocalPayroll instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiLocalPayroll to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiLocalPayroll input)
        {
            if (input == null)
            {
                return false;
