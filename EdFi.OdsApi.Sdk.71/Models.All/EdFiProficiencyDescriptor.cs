...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_proficiencyDescriptor")]
    public partial class EdFiProficiencyDescriptor : IEquatable<EdFiProficiencyDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiProficiencyDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiProficiencyDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiProficiencyDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="proficiencyDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        [DataMember(Name = "proficiencyDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ProficiencyDescriptorId: ").Append(ProficiencyDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiProficiencyDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiProficiencyDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiProficiencyDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiProficiencyDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ProficiencyDescriptorId == input.ProficiencyDescriptorId ||
                    this.ProficiencyDescriptorId.Equals(input.ProficiencyDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ProficiencyDescriptorId.GetHashCode();
