...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_licenseTypeDescriptorKey")]
    public partial class TrackedChangesEdFiLicenseTypeDescriptorKey : IEquatable<TrackedChangesEdFiLicenseTypeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiLicenseTypeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiLicenseTypeDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiLicenseTypeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiLicenseTypeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiLicenseTypeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiLicenseTypeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiLicenseTypeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
