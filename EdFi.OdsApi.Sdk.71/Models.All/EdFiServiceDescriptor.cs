...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_serviceDescriptor")]
    public partial class EdFiServiceDescriptor : IEquatable<EdFiServiceDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiServiceDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiServiceDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiServiceDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="serviceDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiServiceDescriptor(string id = default(string), int serviceDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiServiceDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiServiceDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiServiceDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "serviceDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ServiceDescriptorId: ").Append(ServiceDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiServiceDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiServiceDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiServiceDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiServiceDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ServiceDescriptorId == input.ServiceDescriptorId ||
                    this.ServiceDescriptorId.Equals(input.ServiceDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ServiceDescriptorId.GetHashCode();
