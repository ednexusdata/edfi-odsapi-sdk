...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_competencyLevelDescriptor")]
    public partial class EdFiCompetencyLevelDescriptor : IEquatable<EdFiCompetencyLevelDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCompetencyLevelDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiCompetencyLevelDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCompetencyLevelDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="competencyLevelDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiCompetencyLevelDescriptor(string id = default(string), int competencyLevelDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiCompetencyLevelDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiCompetencyLevelDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiCompetencyLevelDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "competencyLevelDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CompetencyLevelDescriptorId: ").Append(CompetencyLevelDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiCompetencyLevelDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiCompetencyLevelDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiCompetencyLevelDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiCompetencyLevelDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CompetencyLevelDescriptorId == input.CompetencyLevelDescriptorId ||
                    this.CompetencyLevelDescriptorId.Equals(input.CompetencyLevelDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.CompetencyLevelDescriptorId.GetHashCode();
