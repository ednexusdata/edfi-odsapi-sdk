...
{
    /// <summary>
    /// SampleFavoriteBookCategoryDescriptor
    /// </summary>
    [DataContract(Name = "sample_favoriteBookCategoryDescriptor")]
    public partial class SampleFavoriteBookCategoryDescriptor : IEquatable<SampleFavoriteBookCategoryDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleFavoriteBookCategoryDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SampleFavoriteBookCategoryDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleFavoriteBookCategoryDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="favoriteBookCategoryDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public SampleFavoriteBookCategoryDescriptor(string id = default(string), int favoriteBookCategoryDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for SampleFavoriteBookCategoryDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for SampleFavoriteBookCategoryDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for SampleFavoriteBookCategoryDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.FavoriteBookCategoryDescriptorId = favoriteBookCategoryDescriptorId;
        ...
        [DataMember(Name = "favoriteBookCategoryDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SampleFavoriteBookCategoryDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  FavoriteBookCategoryDescriptorId: ").Append(FavoriteBookCategoryDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as SampleFavoriteBookCategoryDescriptor);
        }

        /// <summary>
        /// Returns true if SampleFavoriteBookCategoryDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of SampleFavoriteBookCategoryDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SampleFavoriteBookCategoryDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.FavoriteBookCategoryDescriptorId == input.FavoriteBookCategoryDescriptorId ||
                    this.FavoriteBookCategoryDescriptorId.Equals(input.FavoriteBookCategoryDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.FavoriteBookCategoryDescriptorId.GetHashCode();
