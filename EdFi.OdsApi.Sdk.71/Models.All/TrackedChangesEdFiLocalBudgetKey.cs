...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_localBudgetKey")]
    public partial class TrackedChangesEdFiLocalBudgetKey : IEquatable<TrackedChangesEdFiLocalBudgetKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiLocalBudgetKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiLocalBudgetKey(DateTime asOfDate = default(DateTime), string accountIdentifier = default(string), long educationOrganizationId = default(long), int fiscalYear = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiLocalBudgetKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiLocalBudgetKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiLocalBudgetKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiLocalBudgetKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiLocalBudgetKey input)
        {
            if (input == null)
            {
                return false;
