...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_tpdm_genderDescriptorKeyChange")]
    public partial class TrackedChangesTpdmGenderDescriptorKeyChange : IEquatable<TrackedChangesTpdmGenderDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesTpdmGenderDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesTpdmGenderDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesTpdmGenderDescriptorKey oldKeyValues = default(TrackedChangesTpdmGenderDescriptorKey), TrackedChangesTpdmGenderDescriptorKey newKeyValues = default(TrackedChangesTpdmGenderDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesTpdmGenderDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesTpdmGenderDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesTpdmGenderDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesTpdmGenderDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesTpdmGenderDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesTpdmGenderDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesTpdmGenderDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
