...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_sexDescriptorKey")]
    public partial class TrackedChangesEdFiSexDescriptorKey : IEquatable<TrackedChangesEdFiSexDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiSexDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiSexDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiSexDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSexDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSexDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSexDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSexDescriptorKey input)
        {
            if (input == null)
            {
                return false;
