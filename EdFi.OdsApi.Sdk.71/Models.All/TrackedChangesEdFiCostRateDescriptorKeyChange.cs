...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_costRateDescriptorKeyChange")]
    public partial class TrackedChangesEdFiCostRateDescriptorKeyChange : IEquatable<TrackedChangesEdFiCostRateDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCostRateDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCostRateDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiCostRateDescriptorKey oldKeyValues = default(TrackedChangesEdFiCostRateDescriptorKey), TrackedChangesEdFiCostRateDescriptorKey newKeyValues = default(TrackedChangesEdFiCostRateDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiCostRateDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiCostRateDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCostRateDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCostRateDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCostRateDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCostRateDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCostRateDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
