...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiAssessment : IEquatable<EdFiAssessment>, IValidatableObject
    {
        ...
        public EdFiAssessment(string id = default(string), List<EdFiAssessmentAcademicSubject> academicSubjects = default(List<EdFiAssessmentAcademicSubject>), string assessmentIdentifier = default(string), string _namespace = default(string), EdFiEducationOrganizationReference educationOrganizationReference = default(EdFiEducationOrganizationReference), bool? adaptiveAssessment = default(bool?), List<EdFiAssessmentAssessedGradeLevel> assessedGradeLevels = default(List<EdFiAssessmentAssessedGradeLevel>), string assessmentCategoryDescriptor = default(string), string assessmentFamily = default(string), string assessmentForm = default(string), string assessmentTitle = default(string), int? assessmentVersion = default(int?), EdFiAssessmentContentStandard contentStandard = default(EdFiAssessmentContentStandard), List<EdFiAssessmentIdentificationCode> identificationCodes = default(List<EdFiAssessmentIdentificationCode>), List<EdFiAssessmentLanguage> languages = default(List<EdFiAssessmentLanguage>), double? maxRawScore = default(double?), string nomenclature = default(string), List<EdFiAssessmentPerformanceLevel> performanceLevels = default(List<EdFiAssessmentPerformanceLevel>), List<EdFiAssessmentPeriod> periods = default(List<EdFiAssessmentPeriod>), List<EdFiAssessmentPlatformType> platformTypes = default(List<EdFiAssessmentPlatformType>), List<EdFiAssessmentProgram> programs = default(List<EdFiAssessmentProgram>), DateTime? revisionDate = default(DateTime?), List<EdFiAssessmentScore> scores = default(List<EdFiAssessmentScore>), List<EdFiAssessmentSection> sections = default(List<EdFiAssessmentSection>), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            ...
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiAssessment and cannot be null");
            }
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // AssessmentFamily (string) minLength
            if (this.AssessmentFamily != null && this.AssessmentFamily.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AssessmentFamily, length must be greater than 1.", new [] { "AssessmentFamily" });
            }
            ...
            // AssessmentForm (string) minLength
            if (this.AssessmentForm != null && this.AssessmentForm.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AssessmentForm, length must be greater than 1.", new [] { "AssessmentForm" });
            }
            ...
            // AssessmentTitle (string) minLength
            if (this.AssessmentTitle != null && this.AssessmentTitle.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AssessmentTitle, length must be greater than 1.", new [] { "AssessmentTitle" });
            }
