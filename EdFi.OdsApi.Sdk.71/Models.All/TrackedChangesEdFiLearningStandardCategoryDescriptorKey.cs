...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_learningStandardCategoryDescriptorKey")]
    public partial class TrackedChangesEdFiLearningStandardCategoryDescriptorKey : IEquatable<TrackedChangesEdFiLearningStandardCategoryDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiLearningStandardCategoryDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiLearningStandardCategoryDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiLearningStandardCategoryDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiLearningStandardCategoryDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiLearningStandardCategoryDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiLearningStandardCategoryDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiLearningStandardCategoryDescriptorKey input)
        {
            if (input == null)
            {
                return false;
