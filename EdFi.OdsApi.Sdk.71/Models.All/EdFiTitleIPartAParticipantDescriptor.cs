...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_titleIPartAParticipantDescriptor")]
    public partial class EdFiTitleIPartAParticipantDescriptor : IEquatable<EdFiTitleIPartAParticipantDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiTitleIPartAParticipantDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiTitleIPartAParticipantDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiTitleIPartAParticipantDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="titleIPartAParticipantDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiTitleIPartAParticipantDescriptor(string id = default(string), int titleIPartAParticipantDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiTitleIPartAParticipantDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiTitleIPartAParticipantDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiTitleIPartAParticipantDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "titleIPartAParticipantDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TitleIPartAParticipantDescriptorId: ").Append(TitleIPartAParticipantDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiTitleIPartAParticipantDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiTitleIPartAParticipantDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiTitleIPartAParticipantDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiTitleIPartAParticipantDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.TitleIPartAParticipantDescriptorId == input.TitleIPartAParticipantDescriptorId ||
                    this.TitleIPartAParticipantDescriptorId.Equals(input.TitleIPartAParticipantDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.TitleIPartAParticipantDescriptorId.GetHashCode();
