...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_restraintEventReasonDescriptor")]
    public partial class EdFiRestraintEventReasonDescriptor : IEquatable<EdFiRestraintEventReasonDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiRestraintEventReasonDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiRestraintEventReasonDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiRestraintEventReasonDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="restraintEventReasonDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiRestraintEventReasonDescriptor(string id = default(string), int restraintEventReasonDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiRestraintEventReasonDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiRestraintEventReasonDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiRestraintEventReasonDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "restraintEventReasonDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RestraintEventReasonDescriptorId: ").Append(RestraintEventReasonDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiRestraintEventReasonDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiRestraintEventReasonDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiRestraintEventReasonDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiRestraintEventReasonDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.RestraintEventReasonDescriptorId == input.RestraintEventReasonDescriptorId ||
                    this.RestraintEventReasonDescriptorId.Equals(input.RestraintEventReasonDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.RestraintEventReasonDescriptorId.GetHashCode();
