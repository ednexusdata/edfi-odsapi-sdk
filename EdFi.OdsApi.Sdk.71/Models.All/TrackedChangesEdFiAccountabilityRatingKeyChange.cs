...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_accountabilityRatingKeyChange")]
    public partial class TrackedChangesEdFiAccountabilityRatingKeyChange : IEquatable<TrackedChangesEdFiAccountabilityRatingKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiAccountabilityRatingKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiAccountabilityRatingKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiAccountabilityRatingKey oldKeyValues = default(TrackedChangesEdFiAccountabilityRatingKey), TrackedChangesEdFiAccountabilityRatingKey newKeyValues = default(TrackedChangesEdFiAccountabilityRatingKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiAccountabilityRatingKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiAccountabilityRatingKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiAccountabilityRatingKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiAccountabilityRatingKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiAccountabilityRatingKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiAccountabilityRatingKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiAccountabilityRatingKeyChange input)
        {
            if (input == null)
            {
                return false;
