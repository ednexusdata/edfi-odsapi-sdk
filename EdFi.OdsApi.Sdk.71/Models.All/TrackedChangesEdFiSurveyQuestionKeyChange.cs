...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_surveyQuestionKeyChange")]
    public partial class TrackedChangesEdFiSurveyQuestionKeyChange : IEquatable<TrackedChangesEdFiSurveyQuestionKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiSurveyQuestionKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiSurveyQuestionKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiSurveyQuestionKey oldKeyValues = default(TrackedChangesEdFiSurveyQuestionKey), TrackedChangesEdFiSurveyQuestionKey newKeyValues = default(TrackedChangesEdFiSurveyQuestionKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiSurveyQuestionKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiSurveyQuestionKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiSurveyQuestionKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSurveyQuestionKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSurveyQuestionKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSurveyQuestionKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSurveyQuestionKeyChange input)
        {
            if (input == null)
            {
                return false;
