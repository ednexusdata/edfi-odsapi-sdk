...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// SampleStaffPet
    /// </summary>
    [DataContract(Name = "sample_staffPet")]
    public partial class SampleStaffPet : IEquatable<SampleStaffPet>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleStaffPet" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SampleStaffPet() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleStaffPet" /> class.
        /// </summary>
        ...
        public SampleStaffPet(string petName = default(string), bool? isFixed = default(bool?))
        {
            // to ensure "petName" is required (not null)
            if (petName == null)
            {
                throw new ArgumentNullException("petName is a required property for SampleStaffPet and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SampleStaffPet {\n");
        ...
        {
            return this.Equals(input as SampleStaffPet);
        }

        /// <summary>
        /// Returns true if SampleStaffPet instances are equal
        /// </summary>
        /// <param name="input">Instance of SampleStaffPet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SampleStaffPet input)
        {
            if (input == null)
            {
                return false;
