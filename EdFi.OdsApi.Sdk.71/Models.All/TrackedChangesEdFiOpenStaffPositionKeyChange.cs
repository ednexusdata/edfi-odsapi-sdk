...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_openStaffPositionKeyChange")]
    public partial class TrackedChangesEdFiOpenStaffPositionKeyChange : IEquatable<TrackedChangesEdFiOpenStaffPositionKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiOpenStaffPositionKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiOpenStaffPositionKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiOpenStaffPositionKey oldKeyValues = default(TrackedChangesEdFiOpenStaffPositionKey), TrackedChangesEdFiOpenStaffPositionKey newKeyValues = default(TrackedChangesEdFiOpenStaffPositionKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiOpenStaffPositionKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiOpenStaffPositionKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiOpenStaffPositionKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiOpenStaffPositionKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiOpenStaffPositionKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiOpenStaffPositionKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiOpenStaffPositionKeyChange input)
        {
            if (input == null)
            {
                return false;
