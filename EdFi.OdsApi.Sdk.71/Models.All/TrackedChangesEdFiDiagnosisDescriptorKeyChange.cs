...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_diagnosisDescriptorKeyChange")]
    public partial class TrackedChangesEdFiDiagnosisDescriptorKeyChange : IEquatable<TrackedChangesEdFiDiagnosisDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiDiagnosisDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiDiagnosisDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiDiagnosisDescriptorKey oldKeyValues = default(TrackedChangesEdFiDiagnosisDescriptorKey), TrackedChangesEdFiDiagnosisDescriptorKey newKeyValues = default(TrackedChangesEdFiDiagnosisDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiDiagnosisDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiDiagnosisDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiDiagnosisDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiDiagnosisDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiDiagnosisDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiDiagnosisDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiDiagnosisDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
