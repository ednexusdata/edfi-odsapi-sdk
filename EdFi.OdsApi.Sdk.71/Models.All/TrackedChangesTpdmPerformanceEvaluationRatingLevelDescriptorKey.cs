...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_tpdm_performanceEvaluationRatingLevelDescriptorKey")]
    public partial class TrackedChangesTpdmPerformanceEvaluationRatingLevelDescriptorKey : IEquatable<TrackedChangesTpdmPerformanceEvaluationRatingLevelDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesTpdmPerformanceEvaluationRatingLevelDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesTpdmPerformanceEvaluationRatingLevelDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesTpdmPerformanceEvaluationRatingLevelDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesTpdmPerformanceEvaluationRatingLevelDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesTpdmPerformanceEvaluationRatingLevelDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesTpdmPerformanceEvaluationRatingLevelDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesTpdmPerformanceEvaluationRatingLevelDescriptorKey input)
        {
            if (input == null)
            {
                return false;
