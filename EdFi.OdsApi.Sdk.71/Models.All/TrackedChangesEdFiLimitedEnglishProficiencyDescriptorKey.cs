...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_limitedEnglishProficiencyDescriptorKey")]
    public partial class TrackedChangesEdFiLimitedEnglishProficiencyDescriptorKey : IEquatable<TrackedChangesEdFiLimitedEnglishProficiencyDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiLimitedEnglishProficiencyDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiLimitedEnglishProficiencyDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiLimitedEnglishProficiencyDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiLimitedEnglishProficiencyDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiLimitedEnglishProficiencyDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiLimitedEnglishProficiencyDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiLimitedEnglishProficiencyDescriptorKey input)
        {
            if (input == null)
            {
                return false;
