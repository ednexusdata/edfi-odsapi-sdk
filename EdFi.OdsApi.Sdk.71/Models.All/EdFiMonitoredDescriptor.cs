...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_monitoredDescriptor")]
    public partial class EdFiMonitoredDescriptor : IEquatable<EdFiMonitoredDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiMonitoredDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiMonitoredDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiMonitoredDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="monitoredDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiMonitoredDescriptor(string id = default(string), int monitoredDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiMonitoredDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiMonitoredDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiMonitoredDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "monitoredDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MonitoredDescriptorId: ").Append(MonitoredDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiMonitoredDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiMonitoredDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiMonitoredDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiMonitoredDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.MonitoredDescriptorId == input.MonitoredDescriptorId ||
                    this.MonitoredDescriptorId.Equals(input.MonitoredDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.MonitoredDescriptorId.GetHashCode();
