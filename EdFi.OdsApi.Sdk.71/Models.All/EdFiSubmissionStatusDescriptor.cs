...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_submissionStatusDescriptor")]
    public partial class EdFiSubmissionStatusDescriptor : IEquatable<EdFiSubmissionStatusDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSubmissionStatusDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiSubmissionStatusDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSubmissionStatusDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="submissionStatusDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiSubmissionStatusDescriptor(string id = default(string), int submissionStatusDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiSubmissionStatusDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiSubmissionStatusDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiSubmissionStatusDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.SubmissionStatusDescriptorId = submissionStatusDescriptorId;
        ...
        [DataMember(Name = "submissionStatusDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiSubmissionStatusDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  SubmissionStatusDescriptorId: ").Append(SubmissionStatusDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiSubmissionStatusDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiSubmissionStatusDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiSubmissionStatusDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiSubmissionStatusDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.SubmissionStatusDescriptorId == input.SubmissionStatusDescriptorId ||
                    this.SubmissionStatusDescriptorId.Equals(input.SubmissionStatusDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.SubmissionStatusDescriptorId.GetHashCode();
