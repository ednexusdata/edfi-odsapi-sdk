...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "tpdm_evaluationPeriodDescriptor")]
    public partial class TpdmEvaluationPeriodDescriptor : IEquatable<TpdmEvaluationPeriodDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmEvaluationPeriodDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmEvaluationPeriodDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmEvaluationPeriodDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="evaluationPeriodDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmEvaluationPeriodDescriptor(string id = default(string), int evaluationPeriodDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for TpdmEvaluationPeriodDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for TpdmEvaluationPeriodDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for TpdmEvaluationPeriodDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.EvaluationPeriodDescriptorId = evaluationPeriodDescriptorId;
        ...
        [DataMember(Name = "evaluationPeriodDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmEvaluationPeriodDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  EvaluationPeriodDescriptorId: ").Append(EvaluationPeriodDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmEvaluationPeriodDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmEvaluationPeriodDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmEvaluationPeriodDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmEvaluationPeriodDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.EvaluationPeriodDescriptorId == input.EvaluationPeriodDescriptorId ||
                    this.EvaluationPeriodDescriptorId.Equals(input.EvaluationPeriodDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.EvaluationPeriodDescriptorId.GetHashCode();
