...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_exitWithdrawTypeDescriptor")]
    public partial class EdFiExitWithdrawTypeDescriptor : IEquatable<EdFiExitWithdrawTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiExitWithdrawTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiExitWithdrawTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiExitWithdrawTypeDescriptor" /> class.
        /// </summary>
        ...
        public EdFiExitWithdrawTypeDescriptor(string id = default(string), int exitWithdrawTypeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiExitWithdrawTypeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiExitWithdrawTypeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiExitWithdrawTypeDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "exitWithdrawTypeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ExitWithdrawTypeDescriptorId: ").Append(ExitWithdrawTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiExitWithdrawTypeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiExitWithdrawTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiExitWithdrawTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiExitWithdrawTypeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ExitWithdrawTypeDescriptorId == input.ExitWithdrawTypeDescriptorId ||
                    this.ExitWithdrawTypeDescriptorId.Equals(input.ExitWithdrawTypeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ExitWithdrawTypeDescriptorId.GetHashCode();
