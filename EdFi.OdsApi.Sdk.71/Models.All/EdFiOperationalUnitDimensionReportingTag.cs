...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_operationalUnitDimensionReportingTag")]
    public partial class EdFiOperationalUnitDimensionReportingTag : IEquatable<EdFiOperationalUnitDimensionReportingTag>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiOperationalUnitDimensionReportingTag" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiOperationalUnitDimensionReportingTag() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiOperationalUnitDimensionReportingTag" /> class.
        /// </summary>
        /// <param name="reportingTagDescriptor">Optional tag for accountability reporting. (required).</param>
        public EdFiOperationalUnitDimensionReportingTag(string reportingTagDescriptor = default(string))
        {
            // to ensure "reportingTagDescriptor" is required (not null)
            if (reportingTagDescriptor == null)
            {
                throw new ArgumentNullException("reportingTagDescriptor is a required property for EdFiOperationalUnitDimensionReportingTag and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiOperationalUnitDimensionReportingTag {\n");
        ...
        {
            return this.Equals(input as EdFiOperationalUnitDimensionReportingTag);
        }

        /// <summary>
        /// Returns true if EdFiOperationalUnitDimensionReportingTag instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiOperationalUnitDimensionReportingTag to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiOperationalUnitDimensionReportingTag input)
        {
            if (input == null)
            {
                return false;
