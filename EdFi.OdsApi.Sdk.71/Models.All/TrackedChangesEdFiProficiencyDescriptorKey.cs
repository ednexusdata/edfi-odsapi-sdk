...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_proficiencyDescriptorKey")]
    public partial class TrackedChangesEdFiProficiencyDescriptorKey : IEquatable<TrackedChangesEdFiProficiencyDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiProficiencyDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiProficiencyDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiProficiencyDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiProficiencyDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiProficiencyDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiProficiencyDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiProficiencyDescriptorKey input)
        {
            if (input == null)
            {
                return false;
