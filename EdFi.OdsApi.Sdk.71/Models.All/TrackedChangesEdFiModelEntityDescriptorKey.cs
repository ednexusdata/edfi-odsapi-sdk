...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_modelEntityDescriptorKey")]
    public partial class TrackedChangesEdFiModelEntityDescriptorKey : IEquatable<TrackedChangesEdFiModelEntityDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiModelEntityDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiModelEntityDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiModelEntityDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiModelEntityDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiModelEntityDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiModelEntityDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiModelEntityDescriptorKey input)
        {
            if (input == null)
            {
                return false;
