...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_functionDimensionDelete")]
    public partial class TrackedChangesEdFiFunctionDimensionDelete : IEquatable<TrackedChangesEdFiFunctionDimensionDelete>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiFunctionDimensionDelete(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiFunctionDimensionKey keyValues = default(TrackedChangesEdFiFunctionDimensionKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiFunctionDimensionKey KeyValues { get; set; }
        ...
        {
            return this.Equals(input as TrackedChangesEdFiFunctionDimensionDelete);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiFunctionDimensionDelete instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiFunctionDimensionDelete to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiFunctionDimensionDelete input)
        {
            if (input == null)
            {
                return false;
