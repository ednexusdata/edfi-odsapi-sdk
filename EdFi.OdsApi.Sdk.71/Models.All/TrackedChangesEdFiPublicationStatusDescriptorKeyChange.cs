...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_publicationStatusDescriptorKeyChange")]
    public partial class TrackedChangesEdFiPublicationStatusDescriptorKeyChange : IEquatable<TrackedChangesEdFiPublicationStatusDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiPublicationStatusDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiPublicationStatusDescriptorKey oldKeyValues = default(TrackedChangesEdFiPublicationStatusDescriptorKey), TrackedChangesEdFiPublicationStatusDescriptorKey newKeyValues = default(TrackedChangesEdFiPublicationStatusDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiPublicationStatusDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiPublicationStatusDescriptorKey NewKeyValues { get; set; }
        ...
        {
            return this.Equals(input as TrackedChangesEdFiPublicationStatusDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiPublicationStatusDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiPublicationStatusDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiPublicationStatusDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
