...
{
    /// <summary>
    /// TrackedChangesSampleArtMediumDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_sample_artMediumDescriptorKey")]
    public partial class TrackedChangesSampleArtMediumDescriptorKey : IEquatable<TrackedChangesSampleArtMediumDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesSampleArtMediumDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesSampleArtMediumDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesSampleArtMediumDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesSampleArtMediumDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesSampleArtMediumDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesSampleArtMediumDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesSampleArtMediumDescriptorKey input)
        {
            if (input == null)
            {
                return false;
