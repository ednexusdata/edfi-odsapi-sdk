...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiSurveyResponseEducationOrganizationTargetAssociation : IEquatable<EdFiSurveyResponseEducationOrganizationTargetAssociation>, IValidatableObject
    {
        ...
        public EdFiSurveyResponseEducationOrganizationTargetAssociation(string id = default(string), EdFiEducationOrganizationReference educationOrganizationReference = default(EdFiEducationOrganizationReference), EdFiSurveyResponseReference surveyResponseReference = default(EdFiSurveyResponseReference), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
