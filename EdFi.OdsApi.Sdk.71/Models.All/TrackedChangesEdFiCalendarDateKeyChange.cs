...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_calendarDateKeyChange")]
    public partial class TrackedChangesEdFiCalendarDateKeyChange : IEquatable<TrackedChangesEdFiCalendarDateKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCalendarDateKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCalendarDateKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiCalendarDateKey oldKeyValues = default(TrackedChangesEdFiCalendarDateKey), TrackedChangesEdFiCalendarDateKey newKeyValues = default(TrackedChangesEdFiCalendarDateKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiCalendarDateKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiCalendarDateKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCalendarDateKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCalendarDateKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCalendarDateKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCalendarDateKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCalendarDateKeyChange input)
        {
            if (input == null)
            {
                return false;
