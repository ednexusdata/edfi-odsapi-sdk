...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_calendarEventDescriptor")]
    public partial class EdFiCalendarEventDescriptor : IEquatable<EdFiCalendarEventDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCalendarEventDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiCalendarEventDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCalendarEventDescriptor" /> class.
        /// </summary>
        ...
        public EdFiCalendarEventDescriptor(string id = default(string), int calendarEventDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiCalendarEventDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiCalendarEventDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiCalendarEventDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "calendarEventDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CalendarEventDescriptorId: ").Append(CalendarEventDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiCalendarEventDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiCalendarEventDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiCalendarEventDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiCalendarEventDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CalendarEventDescriptorId == input.CalendarEventDescriptorId ||
                    this.CalendarEventDescriptorId.Equals(input.CalendarEventDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.CalendarEventDescriptorId.GetHashCode();
