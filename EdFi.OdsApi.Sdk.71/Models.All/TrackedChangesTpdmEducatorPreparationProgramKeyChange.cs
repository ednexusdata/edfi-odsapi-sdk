...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_tpdm_educatorPreparationProgramKeyChange")]
    public partial class TrackedChangesTpdmEducatorPreparationProgramKeyChange : IEquatable<TrackedChangesTpdmEducatorPreparationProgramKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesTpdmEducatorPreparationProgramKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesTpdmEducatorPreparationProgramKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesTpdmEducatorPreparationProgramKey oldKeyValues = default(TrackedChangesTpdmEducatorPreparationProgramKey), TrackedChangesTpdmEducatorPreparationProgramKey newKeyValues = default(TrackedChangesTpdmEducatorPreparationProgramKey))
        {
            this.Id = id;
        ...
        public TrackedChangesTpdmEducatorPreparationProgramKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesTpdmEducatorPreparationProgramKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesTpdmEducatorPreparationProgramKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesTpdmEducatorPreparationProgramKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesTpdmEducatorPreparationProgramKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesTpdmEducatorPreparationProgramKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesTpdmEducatorPreparationProgramKeyChange input)
        {
            if (input == null)
            {
                return false;
