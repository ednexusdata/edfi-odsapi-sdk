...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_communityOrganizationKeyChange")]
    public partial class TrackedChangesEdFiCommunityOrganizationKeyChange : IEquatable<TrackedChangesEdFiCommunityOrganizationKeyChange>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiCommunityOrganizationKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiCommunityOrganizationKey oldKeyValues = default(TrackedChangesEdFiCommunityOrganizationKey), TrackedChangesEdFiCommunityOrganizationKey newKeyValues = default(TrackedChangesEdFiCommunityOrganizationKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiCommunityOrganizationKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiCommunityOrganizationKey NewKeyValues { get; set; }
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCommunityOrganizationKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCommunityOrganizationKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCommunityOrganizationKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCommunityOrganizationKeyChange input)
        {
            if (input == null)
            {
                return false;
