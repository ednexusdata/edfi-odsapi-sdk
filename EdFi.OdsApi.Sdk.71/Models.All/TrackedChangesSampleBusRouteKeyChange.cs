...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_sample_busRouteKeyChange")]
    public partial class TrackedChangesSampleBusRouteKeyChange : IEquatable<TrackedChangesSampleBusRouteKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesSampleBusRouteKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesSampleBusRouteKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesSampleBusRouteKey oldKeyValues = default(TrackedChangesSampleBusRouteKey), TrackedChangesSampleBusRouteKey newKeyValues = default(TrackedChangesSampleBusRouteKey))
        {
            this.Id = id;
        ...
        public TrackedChangesSampleBusRouteKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesSampleBusRouteKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesSampleBusRouteKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesSampleBusRouteKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesSampleBusRouteKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesSampleBusRouteKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesSampleBusRouteKeyChange input)
        {
            if (input == null)
            {
                return false;
