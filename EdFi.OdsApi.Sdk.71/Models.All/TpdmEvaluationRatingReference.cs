...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TpdmEvaluationRatingReference : IEquatable<TpdmEvaluationRatingReference>, IValidatableObject
    {
        ...
        public TpdmEvaluationRatingReference(long educationOrganizationId = default(long), DateTime evaluationDate = default(DateTime), string evaluationPeriodDescriptor = default(string), string evaluationTitle = default(string), string performanceEvaluationTitle = default(string), string performanceEvaluationTypeDescriptor = default(string), string personId = default(string), int schoolYear = default(int), string sourceSystemDescriptor = default(string), string termDescriptor = default(string), Link link = default(Link))
        {
            ...
            {
                throw new ArgumentNullException("evaluationPeriodDescriptor is a required property for TpdmEvaluationRatingReference and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("evaluationTitle is a required property for TpdmEvaluationRatingReference and cannot be null");
            }
            this.EvaluationTitle = evaluationTitle;
            // to ensure "performanceEvaluationTitle" is required (not null)
            if (performanceEvaluationTitle == null)
            {
                throw new ArgumentNullException("performanceEvaluationTitle is a required property for TpdmEvaluationRatingReference and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("performanceEvaluationTypeDescriptor is a required property for TpdmEvaluationRatingReference and cannot be null");
            }
            this.PerformanceEvaluationTypeDescriptor = performanceEvaluationTypeDescriptor;
            // to ensure "personId" is required (not null)
            if (personId == null)
            {
                throw new ArgumentNullException("personId is a required property for TpdmEvaluationRatingReference and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("sourceSystemDescriptor is a required property for TpdmEvaluationRatingReference and cannot be null");
            }
            this.SourceSystemDescriptor = sourceSystemDescriptor;
            // to ensure "termDescriptor" is required (not null)
            if (termDescriptor == null)
            {
                throw new ArgumentNullException("termDescriptor is a required property for TpdmEvaluationRatingReference and cannot be null");
            }
