...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_balanceSheetDimensionKey")]
    public partial class TrackedChangesEdFiBalanceSheetDimensionKey : IEquatable<TrackedChangesEdFiBalanceSheetDimensionKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiBalanceSheetDimensionKey(string code = default(string), int fiscalYear = default(int))
        {
            this.Code = code;
        ...
        {
            return this.Equals(input as TrackedChangesEdFiBalanceSheetDimensionKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiBalanceSheetDimensionKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiBalanceSheetDimensionKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiBalanceSheetDimensionKey input)
        {
            if (input == null)
            {
                return false;
