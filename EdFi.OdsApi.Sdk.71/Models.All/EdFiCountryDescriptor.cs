...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_countryDescriptor")]
    public partial class EdFiCountryDescriptor : IEquatable<EdFiCountryDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCountryDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiCountryDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCountryDescriptor" /> class.
        /// </summary>
        ...
        public EdFiCountryDescriptor(string id = default(string), int countryDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiCountryDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiCountryDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiCountryDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "countryDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CountryDescriptorId: ").Append(CountryDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiCountryDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiCountryDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiCountryDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiCountryDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CountryDescriptorId == input.CountryDescriptorId ||
                    this.CountryDescriptorId.Equals(input.CountryDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.CountryDescriptorId.GetHashCode();
