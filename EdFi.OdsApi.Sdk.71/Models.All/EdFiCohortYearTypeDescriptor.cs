...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_cohortYearTypeDescriptor")]
    public partial class EdFiCohortYearTypeDescriptor : IEquatable<EdFiCohortYearTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCohortYearTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiCohortYearTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCohortYearTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="cohortYearTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiCohortYearTypeDescriptor(string id = default(string), int cohortYearTypeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiCohortYearTypeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiCohortYearTypeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiCohortYearTypeDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "cohortYearTypeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CohortYearTypeDescriptorId: ").Append(CohortYearTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiCohortYearTypeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiCohortYearTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiCohortYearTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiCohortYearTypeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CohortYearTypeDescriptorId == input.CohortYearTypeDescriptorId ||
                    this.CohortYearTypeDescriptorId.Equals(input.CohortYearTypeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.CohortYearTypeDescriptorId.GetHashCode();
