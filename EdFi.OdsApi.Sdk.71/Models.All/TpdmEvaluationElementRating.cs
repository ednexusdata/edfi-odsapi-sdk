...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TpdmEvaluationElementRating : IEquatable<TpdmEvaluationElementRating>, IValidatableObject
    {
        ...
        public TpdmEvaluationElementRating(string id = default(string), TpdmEvaluationElementReference evaluationElementReference = default(TpdmEvaluationElementReference), TpdmEvaluationObjectiveRatingReference evaluationObjectiveRatingReference = default(TpdmEvaluationObjectiveRatingReference), string areaOfRefinement = default(string), string areaOfReinforcement = default(string), string comments = default(string), string evaluationElementRatingLevelDescriptor = default(string), string feedback = default(string), List<TpdmEvaluationElementRatingResult> results = default(List<TpdmEvaluationElementRatingResult>), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            ...
            {
                throw new ArgumentNullException("evaluationObjectiveRatingReference is a required property for TpdmEvaluationElementRating and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "evaluationObjectiveRatingReference", IsRequired = true, EmitDefaultValue = true)]
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // AreaOfRefinement (string) minLength
            if (this.AreaOfRefinement != null && this.AreaOfRefinement.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AreaOfRefinement, length must be greater than 1.", new [] { "AreaOfRefinement" });
            }
            ...
            // AreaOfReinforcement (string) minLength
            if (this.AreaOfReinforcement != null && this.AreaOfReinforcement.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AreaOfReinforcement, length must be greater than 1.", new [] { "AreaOfReinforcement" });
            }
            ...
            if (this.Feedback != null && this.Feedback.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Feedback, length must be greater than 1.", new [] { "Feedback" });
            }
