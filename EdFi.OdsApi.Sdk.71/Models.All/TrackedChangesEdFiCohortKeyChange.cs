...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_cohortKeyChange")]
    public partial class TrackedChangesEdFiCohortKeyChange : IEquatable<TrackedChangesEdFiCohortKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCohortKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCohortKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiCohortKey oldKeyValues = default(TrackedChangesEdFiCohortKey), TrackedChangesEdFiCohortKey newKeyValues = default(TrackedChangesEdFiCohortKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiCohortKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiCohortKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCohortKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCohortKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCohortKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCohortKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCohortKeyChange input)
        {
            if (input == null)
            {
                return false;
