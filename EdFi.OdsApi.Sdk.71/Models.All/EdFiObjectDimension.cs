...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// EdFiObjectDimension
    /// </summary>
    [DataContract(Name = "edFi_objectDimension")]
    public partial class EdFiObjectDimension : IEquatable<EdFiObjectDimension>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiObjectDimension" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiObjectDimension() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiObjectDimension" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="code">The code representation of the account object dimension. (required).</param>
        /// <param name="fiscalYear">The fiscal year for which the account object dimension is valid. (required).</param>
        /// <param name="codeName">A description of the account object dimension..</param>
        /// <param name="reportingTags">An unordered collection of objectDimensionReportingTags. Optional tag for accountability reporting..</param>
        /// <param name="etag">A unique system-generated value that identifies the version of the resource..</param>
        /// <param name="lastModifiedDate">The date and time the resource was last modified..</param>
        public EdFiObjectDimension(string id = default(string), string code = default(string), int fiscalYear = default(int), string codeName = default(string), List<EdFiObjectDimensionReportingTag> reportingTags = default(List<EdFiObjectDimensionReportingTag>), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "code" is required (not null)
            if (code == null)
            {
                throw new ArgumentNullException("code is a required property for EdFiObjectDimension and cannot be null");
            }
            this.Code = code;
        ...
        /// </summary>
        /// <value>A description of the account object dimension.</value>
        ...
        /// </summary>
        /// <value>An unordered collection of objectDimensionReportingTags. Optional tag for accountability reporting.</value>
        [DataMember(Name = "reportingTags", EmitDefaultValue = false)]
        public List<EdFiObjectDimensionReportingTag> ReportingTags { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiObjectDimension {\n");
        ...
        {
            return this.Equals(input as EdFiObjectDimension);
        }

        /// <summary>
        /// Returns true if EdFiObjectDimension instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiObjectDimension to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiObjectDimension input)
        {
            if (input == null)
            {
                return false;
