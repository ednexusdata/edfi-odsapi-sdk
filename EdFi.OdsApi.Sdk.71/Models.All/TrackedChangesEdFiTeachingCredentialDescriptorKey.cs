...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_teachingCredentialDescriptorKey")]
    public partial class TrackedChangesEdFiTeachingCredentialDescriptorKey : IEquatable<TrackedChangesEdFiTeachingCredentialDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiTeachingCredentialDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiTeachingCredentialDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiTeachingCredentialDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiTeachingCredentialDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiTeachingCredentialDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiTeachingCredentialDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiTeachingCredentialDescriptorKey input)
        {
            if (input == null)
            {
                return false;
