...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_educationOrganizationIdentificationSystemDescriptorKey")]
    public partial class TrackedChangesEdFiEducationOrganizationIdentificationSystemDescriptorKey : IEquatable<TrackedChangesEdFiEducationOrganizationIdentificationSystemDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiEducationOrganizationIdentificationSystemDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiEducationOrganizationIdentificationSystemDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiEducationOrganizationIdentificationSystemDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiEducationOrganizationIdentificationSystemDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiEducationOrganizationIdentificationSystemDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiEducationOrganizationIdentificationSystemDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiEducationOrganizationIdentificationSystemDescriptorKey input)
        {
            if (input == null)
            {
                return false;
