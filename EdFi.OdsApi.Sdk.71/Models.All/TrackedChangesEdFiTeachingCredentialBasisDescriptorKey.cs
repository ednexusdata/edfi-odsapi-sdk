...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_teachingCredentialBasisDescriptorKey")]
    public partial class TrackedChangesEdFiTeachingCredentialBasisDescriptorKey : IEquatable<TrackedChangesEdFiTeachingCredentialBasisDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiTeachingCredentialBasisDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiTeachingCredentialBasisDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiTeachingCredentialBasisDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiTeachingCredentialBasisDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiTeachingCredentialBasisDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiTeachingCredentialBasisDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiTeachingCredentialBasisDescriptorKey input)
        {
            if (input == null)
            {
                return false;
