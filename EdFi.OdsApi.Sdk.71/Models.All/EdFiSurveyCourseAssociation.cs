...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiSurveyCourseAssociation : IEquatable<EdFiSurveyCourseAssociation>, IValidatableObject
    {
        ...
        public EdFiSurveyCourseAssociation(string id = default(string), EdFiCourseReference courseReference = default(EdFiCourseReference), EdFiSurveyReference surveyReference = default(EdFiSurveyReference), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
