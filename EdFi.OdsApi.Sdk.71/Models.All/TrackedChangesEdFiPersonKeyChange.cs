...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_personKeyChange")]
    public partial class TrackedChangesEdFiPersonKeyChange : IEquatable<TrackedChangesEdFiPersonKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiPersonKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiPersonKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiPersonKey oldKeyValues = default(TrackedChangesEdFiPersonKey), TrackedChangesEdFiPersonKey newKeyValues = default(TrackedChangesEdFiPersonKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiPersonKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiPersonKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiPersonKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiPersonKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiPersonKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiPersonKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiPersonKeyChange input)
        {
            if (input == null)
            {
                return false;
