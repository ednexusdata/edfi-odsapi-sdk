...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_localActualKey")]
    public partial class TrackedChangesEdFiLocalActualKey : IEquatable<TrackedChangesEdFiLocalActualKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiLocalActualKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiLocalActualKey(DateTime asOfDate = default(DateTime), string accountIdentifier = default(string), long educationOrganizationId = default(long), int fiscalYear = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiLocalActualKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiLocalActualKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiLocalActualKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiLocalActualKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiLocalActualKey input)
        {
            if (input == null)
            {
                return false;
