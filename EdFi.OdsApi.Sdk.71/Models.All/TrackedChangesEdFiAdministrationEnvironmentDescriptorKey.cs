...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_administrationEnvironmentDescriptorKey")]
    public partial class TrackedChangesEdFiAdministrationEnvironmentDescriptorKey : IEquatable<TrackedChangesEdFiAdministrationEnvironmentDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiAdministrationEnvironmentDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiAdministrationEnvironmentDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiAdministrationEnvironmentDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiAdministrationEnvironmentDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiAdministrationEnvironmentDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiAdministrationEnvironmentDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiAdministrationEnvironmentDescriptorKey input)
        {
            if (input == null)
            {
                return false;
