...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_schoolKeyChange")]
    public partial class TrackedChangesEdFiSchoolKeyChange : IEquatable<TrackedChangesEdFiSchoolKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiSchoolKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiSchoolKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiSchoolKey oldKeyValues = default(TrackedChangesEdFiSchoolKey), TrackedChangesEdFiSchoolKey newKeyValues = default(TrackedChangesEdFiSchoolKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiSchoolKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiSchoolKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiSchoolKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSchoolKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSchoolKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSchoolKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSchoolKeyChange input)
        {
            if (input == null)
            {
                return false;
