...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_accommodationDescriptor")]
    public partial class EdFiAccommodationDescriptor : IEquatable<EdFiAccommodationDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAccommodationDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiAccommodationDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAccommodationDescriptor" /> class.
        /// </summary>
        ...
        public EdFiAccommodationDescriptor(string id = default(string), int accommodationDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiAccommodationDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiAccommodationDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiAccommodationDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "accommodationDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AccommodationDescriptorId: ").Append(AccommodationDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiAccommodationDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiAccommodationDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiAccommodationDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiAccommodationDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AccommodationDescriptorId == input.AccommodationDescriptorId ||
                    this.AccommodationDescriptorId.Equals(input.AccommodationDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.AccommodationDescriptorId.GetHashCode();
