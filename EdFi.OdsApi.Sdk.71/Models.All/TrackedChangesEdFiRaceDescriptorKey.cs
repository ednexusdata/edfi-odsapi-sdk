...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_raceDescriptorKey")]
    public partial class TrackedChangesEdFiRaceDescriptorKey : IEquatable<TrackedChangesEdFiRaceDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiRaceDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiRaceDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiRaceDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiRaceDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiRaceDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiRaceDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiRaceDescriptorKey input)
        {
            if (input == null)
            {
                return false;
