...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_languageDescriptorKeyChange")]
    public partial class TrackedChangesEdFiLanguageDescriptorKeyChange : IEquatable<TrackedChangesEdFiLanguageDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiLanguageDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiLanguageDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiLanguageDescriptorKey oldKeyValues = default(TrackedChangesEdFiLanguageDescriptorKey), TrackedChangesEdFiLanguageDescriptorKey newKeyValues = default(TrackedChangesEdFiLanguageDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiLanguageDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiLanguageDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiLanguageDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiLanguageDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiLanguageDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiLanguageDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiLanguageDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
