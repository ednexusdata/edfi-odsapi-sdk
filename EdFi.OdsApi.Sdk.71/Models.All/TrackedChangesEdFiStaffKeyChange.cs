...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_staffKeyChange")]
    public partial class TrackedChangesEdFiStaffKeyChange : IEquatable<TrackedChangesEdFiStaffKeyChange>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiStaffKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiStaffKey oldKeyValues = default(TrackedChangesEdFiStaffKey), TrackedChangesEdFiStaffKey newKeyValues = default(TrackedChangesEdFiStaffKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiStaffKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiStaffKey NewKeyValues { get; set; }
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStaffKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStaffKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStaffKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStaffKeyChange input)
        {
            if (input == null)
            {
                return false;
