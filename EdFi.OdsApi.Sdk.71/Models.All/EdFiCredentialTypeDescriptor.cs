...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_credentialTypeDescriptor")]
    public partial class EdFiCredentialTypeDescriptor : IEquatable<EdFiCredentialTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCredentialTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiCredentialTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCredentialTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="credentialTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiCredentialTypeDescriptor(string id = default(string), int credentialTypeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiCredentialTypeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiCredentialTypeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiCredentialTypeDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "credentialTypeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CredentialTypeDescriptorId: ").Append(CredentialTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiCredentialTypeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiCredentialTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiCredentialTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiCredentialTypeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CredentialTypeDescriptorId == input.CredentialTypeDescriptorId ||
                    this.CredentialTypeDescriptorId.Equals(input.CredentialTypeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.CredentialTypeDescriptorId.GetHashCode();
