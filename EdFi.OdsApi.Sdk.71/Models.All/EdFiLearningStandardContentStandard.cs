...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiLearningStandardContentStandard : IEquatable<EdFiLearningStandardContentStandard>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this._Version != null && this._Version.Length > 50)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for _Version, length must be less than 50.", new [] { "_Version" });
            }
