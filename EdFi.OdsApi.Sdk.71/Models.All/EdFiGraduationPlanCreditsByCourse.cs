...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiGraduationPlanCreditsByCourse : IEquatable<EdFiGraduationPlanCreditsByCourse>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // CourseSetName (string) minLength
            if (this.CourseSetName != null && this.CourseSetName.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CourseSetName, length must be greater than 1.", new [] { "CourseSetName" });
            }
