...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_bellScheduleKeyChange")]
    public partial class TrackedChangesEdFiBellScheduleKeyChange : IEquatable<TrackedChangesEdFiBellScheduleKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiBellScheduleKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiBellScheduleKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiBellScheduleKey oldKeyValues = default(TrackedChangesEdFiBellScheduleKey), TrackedChangesEdFiBellScheduleKey newKeyValues = default(TrackedChangesEdFiBellScheduleKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiBellScheduleKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiBellScheduleKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiBellScheduleKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiBellScheduleKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiBellScheduleKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiBellScheduleKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiBellScheduleKeyChange input)
        {
            if (input == null)
            {
                return false;
