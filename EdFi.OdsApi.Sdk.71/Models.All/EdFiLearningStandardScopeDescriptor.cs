...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_learningStandardScopeDescriptor")]
    public partial class EdFiLearningStandardScopeDescriptor : IEquatable<EdFiLearningStandardScopeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiLearningStandardScopeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiLearningStandardScopeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiLearningStandardScopeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="learningStandardScopeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiLearningStandardScopeDescriptor(string id = default(string), int learningStandardScopeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiLearningStandardScopeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiLearningStandardScopeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiLearningStandardScopeDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.LearningStandardScopeDescriptorId = learningStandardScopeDescriptorId;
        ...
        [DataMember(Name = "learningStandardScopeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiLearningStandardScopeDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  LearningStandardScopeDescriptorId: ").Append(LearningStandardScopeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiLearningStandardScopeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiLearningStandardScopeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiLearningStandardScopeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiLearningStandardScopeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.LearningStandardScopeDescriptorId == input.LearningStandardScopeDescriptorId ||
                    this.LearningStandardScopeDescriptorId.Equals(input.LearningStandardScopeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.LearningStandardScopeDescriptorId.GetHashCode();
