...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_institutionTelephoneNumberTypeDescriptorKey")]
    public partial class TrackedChangesEdFiInstitutionTelephoneNumberTypeDescriptorKey : IEquatable<TrackedChangesEdFiInstitutionTelephoneNumberTypeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiInstitutionTelephoneNumberTypeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiInstitutionTelephoneNumberTypeDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiInstitutionTelephoneNumberTypeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiInstitutionTelephoneNumberTypeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiInstitutionTelephoneNumberTypeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiInstitutionTelephoneNumberTypeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiInstitutionTelephoneNumberTypeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
