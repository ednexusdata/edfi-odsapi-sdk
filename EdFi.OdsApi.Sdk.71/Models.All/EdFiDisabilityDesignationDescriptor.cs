...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_disabilityDesignationDescriptor")]
    public partial class EdFiDisabilityDesignationDescriptor : IEquatable<EdFiDisabilityDesignationDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiDisabilityDesignationDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiDisabilityDesignationDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiDisabilityDesignationDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="disabilityDesignationDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiDisabilityDesignationDescriptor(string id = default(string), int disabilityDesignationDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiDisabilityDesignationDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiDisabilityDesignationDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiDisabilityDesignationDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "disabilityDesignationDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DisabilityDesignationDescriptorId: ").Append(DisabilityDesignationDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiDisabilityDesignationDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiDisabilityDesignationDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiDisabilityDesignationDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiDisabilityDesignationDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.DisabilityDesignationDescriptorId == input.DisabilityDesignationDescriptorId ||
                    this.DisabilityDesignationDescriptorId.Equals(input.DisabilityDesignationDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.DisabilityDesignationDescriptorId.GetHashCode();
