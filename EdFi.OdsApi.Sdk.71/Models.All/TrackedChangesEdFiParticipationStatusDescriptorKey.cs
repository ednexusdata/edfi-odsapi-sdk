...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_participationStatusDescriptorKey")]
    public partial class TrackedChangesEdFiParticipationStatusDescriptorKey : IEquatable<TrackedChangesEdFiParticipationStatusDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiParticipationStatusDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiParticipationStatusDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiParticipationStatusDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiParticipationStatusDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiParticipationStatusDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiParticipationStatusDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiParticipationStatusDescriptorKey input)
        {
            if (input == null)
            {
                return false;
