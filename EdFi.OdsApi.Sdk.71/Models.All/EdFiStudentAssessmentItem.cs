...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiStudentAssessmentItem : IEquatable<EdFiStudentAssessmentItem>, IValidatableObject
    {
        ...
        /// <param name="timeAssessed">The overall time a student actually spent during the assessment item..</param>
        /// <param name="assessmentItemReference">assessmentItemReference (required).</param>
        public EdFiStudentAssessmentItem(string assessmentItemResultDescriptor = default(string), string responseIndicatorDescriptor = default(string), string assessmentResponse = default(string), string descriptiveFeedback = default(string), int? itemNumber = default(int?), double? rawScoreResult = default(double?), string timeAssessed = default(string), EdFiAssessmentItemReference assessmentItemReference = default(EdFiAssessmentItemReference))
        {
        ...
        /// </summary>
        /// <value>The overall time a student actually spent during the assessment item.</value>
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AssessmentResponse, length must be less than 255.", new [] { "AssessmentResponse" });
            }

            // AssessmentResponse (string) minLength
            if (this.AssessmentResponse != null && this.AssessmentResponse.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AssessmentResponse, length must be greater than 1.", new [] { "AssessmentResponse" });
            }
            ...
            // DescriptiveFeedback (string) minLength
            if (this.DescriptiveFeedback != null && this.DescriptiveFeedback.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DescriptiveFeedback, length must be greater than 1.", new [] { "DescriptiveFeedback" });
            }
