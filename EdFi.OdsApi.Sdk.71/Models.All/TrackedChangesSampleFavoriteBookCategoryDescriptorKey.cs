...
{
    /// <summary>
    /// TrackedChangesSampleFavoriteBookCategoryDescriptorKey
    /// </summary>
    [DataContract(Name = "trackedChanges_sample_favoriteBookCategoryDescriptorKey")]
    public partial class TrackedChangesSampleFavoriteBookCategoryDescriptorKey : IEquatable<TrackedChangesSampleFavoriteBookCategoryDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesSampleFavoriteBookCategoryDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesSampleFavoriteBookCategoryDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesSampleFavoriteBookCategoryDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesSampleFavoriteBookCategoryDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesSampleFavoriteBookCategoryDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesSampleFavoriteBookCategoryDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesSampleFavoriteBookCategoryDescriptorKey input)
        {
            if (input == null)
            {
                return false;
