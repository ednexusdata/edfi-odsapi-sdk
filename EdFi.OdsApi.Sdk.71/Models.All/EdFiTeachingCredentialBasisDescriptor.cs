...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_teachingCredentialBasisDescriptor")]
    public partial class EdFiTeachingCredentialBasisDescriptor : IEquatable<EdFiTeachingCredentialBasisDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiTeachingCredentialBasisDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiTeachingCredentialBasisDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiTeachingCredentialBasisDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="teachingCredentialBasisDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiTeachingCredentialBasisDescriptor(string id = default(string), int teachingCredentialBasisDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiTeachingCredentialBasisDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiTeachingCredentialBasisDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiTeachingCredentialBasisDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "teachingCredentialBasisDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TeachingCredentialBasisDescriptorId: ").Append(TeachingCredentialBasisDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiTeachingCredentialBasisDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiTeachingCredentialBasisDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiTeachingCredentialBasisDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiTeachingCredentialBasisDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.TeachingCredentialBasisDescriptorId == input.TeachingCredentialBasisDescriptorId ||
                    this.TeachingCredentialBasisDescriptorId.Equals(input.TeachingCredentialBasisDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.TeachingCredentialBasisDescriptorId.GetHashCode();
