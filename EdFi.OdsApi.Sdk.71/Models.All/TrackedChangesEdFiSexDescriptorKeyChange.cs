...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_sexDescriptorKeyChange")]
    public partial class TrackedChangesEdFiSexDescriptorKeyChange : IEquatable<TrackedChangesEdFiSexDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiSexDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiSexDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiSexDescriptorKey oldKeyValues = default(TrackedChangesEdFiSexDescriptorKey), TrackedChangesEdFiSexDescriptorKey newKeyValues = default(TrackedChangesEdFiSexDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiSexDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiSexDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiSexDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSexDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSexDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSexDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSexDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
