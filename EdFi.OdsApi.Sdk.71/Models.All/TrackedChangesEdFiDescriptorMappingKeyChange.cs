...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_descriptorMappingKeyChange")]
    public partial class TrackedChangesEdFiDescriptorMappingKeyChange : IEquatable<TrackedChangesEdFiDescriptorMappingKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiDescriptorMappingKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiDescriptorMappingKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiDescriptorMappingKey oldKeyValues = default(TrackedChangesEdFiDescriptorMappingKey), TrackedChangesEdFiDescriptorMappingKey newKeyValues = default(TrackedChangesEdFiDescriptorMappingKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiDescriptorMappingKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiDescriptorMappingKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiDescriptorMappingKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiDescriptorMappingKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiDescriptorMappingKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiDescriptorMappingKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiDescriptorMappingKeyChange input)
        {
            if (input == null)
            {
                return false;
