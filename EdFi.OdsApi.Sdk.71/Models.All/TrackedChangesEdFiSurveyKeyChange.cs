...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_surveyKeyChange")]
    public partial class TrackedChangesEdFiSurveyKeyChange : IEquatable<TrackedChangesEdFiSurveyKeyChange>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiSurveyKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiSurveyKey oldKeyValues = default(TrackedChangesEdFiSurveyKey), TrackedChangesEdFiSurveyKey newKeyValues = default(TrackedChangesEdFiSurveyKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiSurveyKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiSurveyKey NewKeyValues { get; set; }
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSurveyKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSurveyKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSurveyKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSurveyKeyChange input)
        {
            if (input == null)
            {
                return false;
