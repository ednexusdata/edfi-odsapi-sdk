...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_disciplineIncidentParticipationCodeDescriptorKey")]
    public partial class TrackedChangesEdFiDisciplineIncidentParticipationCodeDescriptorKey : IEquatable<TrackedChangesEdFiDisciplineIncidentParticipationCodeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiDisciplineIncidentParticipationCodeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiDisciplineIncidentParticipationCodeDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiDisciplineIncidentParticipationCodeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiDisciplineIncidentParticipationCodeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiDisciplineIncidentParticipationCodeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiDisciplineIncidentParticipationCodeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiDisciplineIncidentParticipationCodeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
