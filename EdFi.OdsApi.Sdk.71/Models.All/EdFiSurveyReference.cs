...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiSurveyReference : IEquatable<EdFiSurveyReference>, IValidatableObject
    {
        ...
        public EdFiSurveyReference(string _namespace = default(string), string surveyIdentifier = default(string), Link link = default(Link))
        {
            ...
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiSurveyReference and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "surveyIdentifier" is required (not null)
            if (surveyIdentifier == null)
            {
                throw new ArgumentNullException("surveyIdentifier is a required property for EdFiSurveyReference and cannot be null");
            }
