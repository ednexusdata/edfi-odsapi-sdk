...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_educationOrganizationCategoryDescriptorKey")]
    public partial class TrackedChangesEdFiEducationOrganizationCategoryDescriptorKey : IEquatable<TrackedChangesEdFiEducationOrganizationCategoryDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiEducationOrganizationCategoryDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiEducationOrganizationCategoryDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiEducationOrganizationCategoryDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiEducationOrganizationCategoryDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiEducationOrganizationCategoryDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiEducationOrganizationCategoryDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiEducationOrganizationCategoryDescriptorKey input)
        {
            if (input == null)
            {
                return false;
