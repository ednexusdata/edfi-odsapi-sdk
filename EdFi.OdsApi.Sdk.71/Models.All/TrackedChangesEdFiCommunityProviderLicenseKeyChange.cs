...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_communityProviderLicenseKeyChange")]
    public partial class TrackedChangesEdFiCommunityProviderLicenseKeyChange : IEquatable<TrackedChangesEdFiCommunityProviderLicenseKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCommunityProviderLicenseKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCommunityProviderLicenseKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiCommunityProviderLicenseKey oldKeyValues = default(TrackedChangesEdFiCommunityProviderLicenseKey), TrackedChangesEdFiCommunityProviderLicenseKey newKeyValues = default(TrackedChangesEdFiCommunityProviderLicenseKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiCommunityProviderLicenseKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiCommunityProviderLicenseKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCommunityProviderLicenseKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCommunityProviderLicenseKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCommunityProviderLicenseKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCommunityProviderLicenseKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCommunityProviderLicenseKeyChange input)
        {
            if (input == null)
            {
                return false;
