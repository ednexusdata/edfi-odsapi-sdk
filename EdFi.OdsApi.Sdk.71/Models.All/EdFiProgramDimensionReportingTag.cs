...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_programDimensionReportingTag")]
    public partial class EdFiProgramDimensionReportingTag : IEquatable<EdFiProgramDimensionReportingTag>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiProgramDimensionReportingTag" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiProgramDimensionReportingTag() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiProgramDimensionReportingTag" /> class.
        /// </summary>
        /// <param name="reportingTagDescriptor">Optional tag for accountability reporting. (required).</param>
        public EdFiProgramDimensionReportingTag(string reportingTagDescriptor = default(string))
        {
            // to ensure "reportingTagDescriptor" is required (not null)
            if (reportingTagDescriptor == null)
            {
                throw new ArgumentNullException("reportingTagDescriptor is a required property for EdFiProgramDimensionReportingTag and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiProgramDimensionReportingTag {\n");
        ...
        {
            return this.Equals(input as EdFiProgramDimensionReportingTag);
        }

        /// <summary>
        /// Returns true if EdFiProgramDimensionReportingTag instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiProgramDimensionReportingTag to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiProgramDimensionReportingTag input)
        {
            if (input == null)
            {
                return false;
