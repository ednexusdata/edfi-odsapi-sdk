...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_schoolChoiceImplementStatusDescriptor")]
    public partial class EdFiSchoolChoiceImplementStatusDescriptor : IEquatable<EdFiSchoolChoiceImplementStatusDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSchoolChoiceImplementStatusDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiSchoolChoiceImplementStatusDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSchoolChoiceImplementStatusDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="schoolChoiceImplementStatusDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiSchoolChoiceImplementStatusDescriptor(string id = default(string), int schoolChoiceImplementStatusDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiSchoolChoiceImplementStatusDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiSchoolChoiceImplementStatusDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiSchoolChoiceImplementStatusDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "schoolChoiceImplementStatusDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SchoolChoiceImplementStatusDescriptorId: ").Append(SchoolChoiceImplementStatusDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiSchoolChoiceImplementStatusDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiSchoolChoiceImplementStatusDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiSchoolChoiceImplementStatusDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiSchoolChoiceImplementStatusDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.SchoolChoiceImplementStatusDescriptorId == input.SchoolChoiceImplementStatusDescriptorId ||
                    this.SchoolChoiceImplementStatusDescriptorId.Equals(input.SchoolChoiceImplementStatusDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.SchoolChoiceImplementStatusDescriptorId.GetHashCode();
