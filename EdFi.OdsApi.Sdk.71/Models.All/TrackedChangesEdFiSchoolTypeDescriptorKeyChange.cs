...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_schoolTypeDescriptorKeyChange")]
    public partial class TrackedChangesEdFiSchoolTypeDescriptorKeyChange : IEquatable<TrackedChangesEdFiSchoolTypeDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiSchoolTypeDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiSchoolTypeDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiSchoolTypeDescriptorKey oldKeyValues = default(TrackedChangesEdFiSchoolTypeDescriptorKey), TrackedChangesEdFiSchoolTypeDescriptorKey newKeyValues = default(TrackedChangesEdFiSchoolTypeDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiSchoolTypeDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiSchoolTypeDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiSchoolTypeDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSchoolTypeDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSchoolTypeDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSchoolTypeDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSchoolTypeDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
