...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "tpdm_educatorRoleDescriptor")]
    public partial class TpdmEducatorRoleDescriptor : IEquatable<TpdmEducatorRoleDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmEducatorRoleDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmEducatorRoleDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmEducatorRoleDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="educatorRoleDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmEducatorRoleDescriptor(string id = default(string), int educatorRoleDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for TpdmEducatorRoleDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for TpdmEducatorRoleDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for TpdmEducatorRoleDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.EducatorRoleDescriptorId = educatorRoleDescriptorId;
        ...
        [DataMember(Name = "educatorRoleDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmEducatorRoleDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  EducatorRoleDescriptorId: ").Append(EducatorRoleDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmEducatorRoleDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmEducatorRoleDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmEducatorRoleDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmEducatorRoleDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.EducatorRoleDescriptorId == input.EducatorRoleDescriptorId ||
                    this.EducatorRoleDescriptorId.Equals(input.EducatorRoleDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.EducatorRoleDescriptorId.GetHashCode();
