...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_gradingPeriodDescriptorKeyChange")]
    public partial class TrackedChangesEdFiGradingPeriodDescriptorKeyChange : IEquatable<TrackedChangesEdFiGradingPeriodDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiGradingPeriodDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiGradingPeriodDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiGradingPeriodDescriptorKey oldKeyValues = default(TrackedChangesEdFiGradingPeriodDescriptorKey), TrackedChangesEdFiGradingPeriodDescriptorKey newKeyValues = default(TrackedChangesEdFiGradingPeriodDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiGradingPeriodDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiGradingPeriodDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiGradingPeriodDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiGradingPeriodDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiGradingPeriodDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiGradingPeriodDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiGradingPeriodDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
