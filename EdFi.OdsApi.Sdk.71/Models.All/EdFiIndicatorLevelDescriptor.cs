...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_indicatorLevelDescriptor")]
    public partial class EdFiIndicatorLevelDescriptor : IEquatable<EdFiIndicatorLevelDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiIndicatorLevelDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiIndicatorLevelDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiIndicatorLevelDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="indicatorLevelDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiIndicatorLevelDescriptor(string id = default(string), int indicatorLevelDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiIndicatorLevelDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiIndicatorLevelDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiIndicatorLevelDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.IndicatorLevelDescriptorId = indicatorLevelDescriptorId;
        ...
        [DataMember(Name = "indicatorLevelDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiIndicatorLevelDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  IndicatorLevelDescriptorId: ").Append(IndicatorLevelDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiIndicatorLevelDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiIndicatorLevelDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiIndicatorLevelDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiIndicatorLevelDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.IndicatorLevelDescriptorId == input.IndicatorLevelDescriptorId ||
                    this.IndicatorLevelDescriptorId.Equals(input.IndicatorLevelDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.IndicatorLevelDescriptorId.GetHashCode();
