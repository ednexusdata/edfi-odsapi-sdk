...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "tpdm_evaluationRatingLevelDescriptor")]
    public partial class TpdmEvaluationRatingLevelDescriptor : IEquatable<TpdmEvaluationRatingLevelDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmEvaluationRatingLevelDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmEvaluationRatingLevelDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmEvaluationRatingLevelDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="evaluationRatingLevelDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmEvaluationRatingLevelDescriptor(string id = default(string), int evaluationRatingLevelDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for TpdmEvaluationRatingLevelDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for TpdmEvaluationRatingLevelDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for TpdmEvaluationRatingLevelDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.EvaluationRatingLevelDescriptorId = evaluationRatingLevelDescriptorId;
        ...
        [DataMember(Name = "evaluationRatingLevelDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmEvaluationRatingLevelDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  EvaluationRatingLevelDescriptorId: ").Append(EvaluationRatingLevelDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmEvaluationRatingLevelDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmEvaluationRatingLevelDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmEvaluationRatingLevelDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmEvaluationRatingLevelDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.EvaluationRatingLevelDescriptorId == input.EvaluationRatingLevelDescriptorId ||
                    this.EvaluationRatingLevelDescriptorId.Equals(input.EvaluationRatingLevelDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.EvaluationRatingLevelDescriptorId.GetHashCode();
