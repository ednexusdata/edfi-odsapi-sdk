...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_providerCategoryDescriptorKeyChange")]
    public partial class TrackedChangesEdFiProviderCategoryDescriptorKeyChange : IEquatable<TrackedChangesEdFiProviderCategoryDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiProviderCategoryDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiProviderCategoryDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiProviderCategoryDescriptorKey oldKeyValues = default(TrackedChangesEdFiProviderCategoryDescriptorKey), TrackedChangesEdFiProviderCategoryDescriptorKey newKeyValues = default(TrackedChangesEdFiProviderCategoryDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiProviderCategoryDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiProviderCategoryDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiProviderCategoryDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiProviderCategoryDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiProviderCategoryDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiProviderCategoryDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiProviderCategoryDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
