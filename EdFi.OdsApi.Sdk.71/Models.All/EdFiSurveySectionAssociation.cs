...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiSurveySectionAssociation : IEquatable<EdFiSurveySectionAssociation>, IValidatableObject
    {
        ...
        public EdFiSurveySectionAssociation(string id = default(string), EdFiSectionReference sectionReference = default(EdFiSectionReference), EdFiSurveyReference surveyReference = default(EdFiSurveyReference), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
