...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiSurvey : IEquatable<EdFiSurvey>, IValidatableObject
    {
        ...
        public EdFiSurvey(string id = default(string), string _namespace = default(string), string surveyIdentifier = default(string), EdFiEducationOrganizationReference educationOrganizationReference = default(EdFiEducationOrganizationReference), EdFiSchoolYearTypeReference schoolYearTypeReference = default(EdFiSchoolYearTypeReference), EdFiSessionReference sessionReference = default(EdFiSessionReference), int? numberAdministered = default(int?), string surveyCategoryDescriptor = default(string), string surveyTitle = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            ...
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiSurvey and cannot be null");
            }
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // SurveyTitle (string) minLength
            if (this.SurveyTitle != null && this.SurveyTitle.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SurveyTitle, length must be greater than 1.", new [] { "SurveyTitle" });
            }
