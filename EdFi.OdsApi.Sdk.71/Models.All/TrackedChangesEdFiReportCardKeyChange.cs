...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_reportCardKeyChange")]
    public partial class TrackedChangesEdFiReportCardKeyChange : IEquatable<TrackedChangesEdFiReportCardKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiReportCardKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiReportCardKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiReportCardKey oldKeyValues = default(TrackedChangesEdFiReportCardKey), TrackedChangesEdFiReportCardKey newKeyValues = default(TrackedChangesEdFiReportCardKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiReportCardKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiReportCardKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiReportCardKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiReportCardKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiReportCardKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiReportCardKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiReportCardKeyChange input)
        {
            if (input == null)
            {
                return false;
