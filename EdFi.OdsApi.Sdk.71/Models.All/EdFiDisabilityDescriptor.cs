...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_disabilityDescriptor")]
    public partial class EdFiDisabilityDescriptor : IEquatable<EdFiDisabilityDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiDisabilityDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiDisabilityDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiDisabilityDescriptor" /> class.
        /// </summary>
        ...
        [DataMember(Name = "disabilityDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DisabilityDescriptorId: ").Append(DisabilityDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiDisabilityDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiDisabilityDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiDisabilityDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiDisabilityDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.DisabilityDescriptorId == input.DisabilityDescriptorId ||
                    this.DisabilityDescriptorId.Equals(input.DisabilityDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.DisabilityDescriptorId.GetHashCode();
