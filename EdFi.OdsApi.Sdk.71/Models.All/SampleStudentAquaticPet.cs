...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "sample_studentAquaticPet")]
    public partial class SampleStudentAquaticPet : IEquatable<SampleStudentAquaticPet>, IValidatableObject
    {
        /// <summary>
        ...
        public SampleStudentAquaticPet(int mimimumTankVolume = default(int), string petName = default(string), bool? isFixed = default(bool?))
        {
            ...
            if (petName == null)
            {
                throw new ArgumentNullException("petName is a required property for SampleStudentAquaticPet and cannot be null");
            }
        ...
        [DataMember(Name = "mimimumTankVolume", IsRequired = true, EmitDefaultValue = true)]
