...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TrackedChangesEdFiGradingPeriodKey : IEquatable<TrackedChangesEdFiGradingPeriodKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiGradingPeriodKey(string gradingPeriodDescriptor = default(string), int periodSequence = default(int), long schoolId = default(long), int schoolYear = default(int))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiGradingPeriodKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiGradingPeriodKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiGradingPeriodKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiGradingPeriodKey input)
        {
            if (input == null)
            {
                return false;
