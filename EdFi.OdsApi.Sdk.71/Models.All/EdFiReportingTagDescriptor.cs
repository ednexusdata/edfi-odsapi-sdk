...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_reportingTagDescriptor")]
    public partial class EdFiReportingTagDescriptor : IEquatable<EdFiReportingTagDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiReportingTagDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiReportingTagDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiReportingTagDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="reportingTagDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiReportingTagDescriptor(string id = default(string), int reportingTagDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiReportingTagDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiReportingTagDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiReportingTagDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.ReportingTagDescriptorId = reportingTagDescriptorId;
        ...
        [DataMember(Name = "reportingTagDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiReportingTagDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  ReportingTagDescriptorId: ").Append(ReportingTagDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiReportingTagDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiReportingTagDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiReportingTagDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiReportingTagDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ReportingTagDescriptorId == input.ReportingTagDescriptorId ||
                    this.ReportingTagDescriptorId.Equals(input.ReportingTagDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ReportingTagDescriptorId.GetHashCode();
