...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_contentClassDescriptorKeyChange")]
    public partial class TrackedChangesEdFiContentClassDescriptorKeyChange : IEquatable<TrackedChangesEdFiContentClassDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiContentClassDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiContentClassDescriptorKey oldKeyValues = default(TrackedChangesEdFiContentClassDescriptorKey), TrackedChangesEdFiContentClassDescriptorKey newKeyValues = default(TrackedChangesEdFiContentClassDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiContentClassDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiContentClassDescriptorKey NewKeyValues { get; set; }
        ...
        {
            return this.Equals(input as TrackedChangesEdFiContentClassDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiContentClassDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiContentClassDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiContentClassDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
