...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_personalInformationVerificationDescriptorKey")]
    public partial class TrackedChangesEdFiPersonalInformationVerificationDescriptorKey : IEquatable<TrackedChangesEdFiPersonalInformationVerificationDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiPersonalInformationVerificationDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiPersonalInformationVerificationDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiPersonalInformationVerificationDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiPersonalInformationVerificationDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiPersonalInformationVerificationDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiPersonalInformationVerificationDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiPersonalInformationVerificationDescriptorKey input)
        {
            if (input == null)
            {
                return false;
