...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_homelessPrimaryNighttimeResidenceDescriptor")]
    public partial class EdFiHomelessPrimaryNighttimeResidenceDescriptor : IEquatable<EdFiHomelessPrimaryNighttimeResidenceDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiHomelessPrimaryNighttimeResidenceDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiHomelessPrimaryNighttimeResidenceDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiHomelessPrimaryNighttimeResidenceDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="homelessPrimaryNighttimeResidenceDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiHomelessPrimaryNighttimeResidenceDescriptor(string id = default(string), int homelessPrimaryNighttimeResidenceDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiHomelessPrimaryNighttimeResidenceDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiHomelessPrimaryNighttimeResidenceDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiHomelessPrimaryNighttimeResidenceDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "homelessPrimaryNighttimeResidenceDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  HomelessPrimaryNighttimeResidenceDescriptorId: ").Append(HomelessPrimaryNighttimeResidenceDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiHomelessPrimaryNighttimeResidenceDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiHomelessPrimaryNighttimeResidenceDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiHomelessPrimaryNighttimeResidenceDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiHomelessPrimaryNighttimeResidenceDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.HomelessPrimaryNighttimeResidenceDescriptorId == input.HomelessPrimaryNighttimeResidenceDescriptorId ||
                    this.HomelessPrimaryNighttimeResidenceDescriptorId.Equals(input.HomelessPrimaryNighttimeResidenceDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.HomelessPrimaryNighttimeResidenceDescriptorId.GetHashCode();
