...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_objectDimensionKeyChange")]
    public partial class TrackedChangesEdFiObjectDimensionKeyChange : IEquatable<TrackedChangesEdFiObjectDimensionKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiObjectDimensionKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiObjectDimensionKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiObjectDimensionKey oldKeyValues = default(TrackedChangesEdFiObjectDimensionKey), TrackedChangesEdFiObjectDimensionKey newKeyValues = default(TrackedChangesEdFiObjectDimensionKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiObjectDimensionKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiObjectDimensionKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiObjectDimensionKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiObjectDimensionKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiObjectDimensionKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiObjectDimensionKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiObjectDimensionKeyChange input)
        {
            if (input == null)
            {
                return false;
