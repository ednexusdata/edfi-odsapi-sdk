...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TpdmEvaluationElementRatingResult : IEquatable<TpdmEvaluationElementRatingResult>, IValidatableObject
    {
        ...
        public TpdmEvaluationElementRatingResult(double rating = default(double), string ratingResultTitle = default(string), string resultDatatypeTypeDescriptor = default(string))
        {
            ...
            {
                throw new ArgumentNullException("ratingResultTitle is a required property for TpdmEvaluationElementRatingResult and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("resultDatatypeTypeDescriptor is a required property for TpdmEvaluationElementRatingResult and cannot be null");
            }
