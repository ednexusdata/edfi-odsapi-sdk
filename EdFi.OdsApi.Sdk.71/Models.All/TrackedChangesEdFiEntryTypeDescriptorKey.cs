...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TrackedChangesEdFiEntryTypeDescriptorKey : IEquatable<TrackedChangesEdFiEntryTypeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiEntryTypeDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiEntryTypeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiEntryTypeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiEntryTypeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiEntryTypeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
