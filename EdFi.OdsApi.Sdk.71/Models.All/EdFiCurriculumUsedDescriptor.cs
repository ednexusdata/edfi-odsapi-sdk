...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_curriculumUsedDescriptor")]
    public partial class EdFiCurriculumUsedDescriptor : IEquatable<EdFiCurriculumUsedDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCurriculumUsedDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiCurriculumUsedDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCurriculumUsedDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="curriculumUsedDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiCurriculumUsedDescriptor(string id = default(string), int curriculumUsedDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiCurriculumUsedDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiCurriculumUsedDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiCurriculumUsedDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "curriculumUsedDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CurriculumUsedDescriptorId: ").Append(CurriculumUsedDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiCurriculumUsedDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiCurriculumUsedDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiCurriculumUsedDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiCurriculumUsedDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CurriculumUsedDescriptorId == input.CurriculumUsedDescriptorId ||
                    this.CurriculumUsedDescriptorId.Equals(input.CurriculumUsedDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.CurriculumUsedDescriptorId.GetHashCode();
