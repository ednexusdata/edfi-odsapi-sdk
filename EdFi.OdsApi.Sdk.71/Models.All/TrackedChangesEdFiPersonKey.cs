...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TrackedChangesEdFiPersonKey : IEquatable<TrackedChangesEdFiPersonKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiPersonKey(string sourceSystemDescriptor = default(string), string personId = default(string))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiPersonKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiPersonKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiPersonKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiPersonKey input)
        {
            if (input == null)
            {
                return false;
