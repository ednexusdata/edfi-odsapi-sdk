...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TpdmEducatorPreparationProgramReference : IEquatable<TpdmEducatorPreparationProgramReference>, IValidatableObject
    {
        ...
        public TpdmEducatorPreparationProgramReference(long educationOrganizationId = default(long), string programName = default(string), string programTypeDescriptor = default(string), Link link = default(Link))
        {
