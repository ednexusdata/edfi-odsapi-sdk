...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_monitoredDescriptorKeyChange")]
    public partial class TrackedChangesEdFiMonitoredDescriptorKeyChange : IEquatable<TrackedChangesEdFiMonitoredDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiMonitoredDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiMonitoredDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiMonitoredDescriptorKey oldKeyValues = default(TrackedChangesEdFiMonitoredDescriptorKey), TrackedChangesEdFiMonitoredDescriptorKey newKeyValues = default(TrackedChangesEdFiMonitoredDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiMonitoredDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiMonitoredDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiMonitoredDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiMonitoredDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiMonitoredDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiMonitoredDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiMonitoredDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
