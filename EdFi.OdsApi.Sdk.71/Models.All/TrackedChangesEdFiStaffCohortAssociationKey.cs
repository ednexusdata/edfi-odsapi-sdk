...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TrackedChangesEdFiStaffCohortAssociationKey : IEquatable<TrackedChangesEdFiStaffCohortAssociationKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiStaffCohortAssociationKey(DateTime beginDate = default(DateTime), string cohortIdentifier = default(string), long educationOrganizationId = default(long), string staffUniqueId = default(string))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStaffCohortAssociationKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStaffCohortAssociationKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStaffCohortAssociationKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStaffCohortAssociationKey input)
        {
            if (input == null)
            {
                return false;
