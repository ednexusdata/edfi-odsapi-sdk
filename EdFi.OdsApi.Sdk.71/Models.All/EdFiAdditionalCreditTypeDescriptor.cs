...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_additionalCreditTypeDescriptor")]
    public partial class EdFiAdditionalCreditTypeDescriptor : IEquatable<EdFiAdditionalCreditTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAdditionalCreditTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiAdditionalCreditTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAdditionalCreditTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="additionalCreditTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiAdditionalCreditTypeDescriptor(string id = default(string), int additionalCreditTypeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiAdditionalCreditTypeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiAdditionalCreditTypeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiAdditionalCreditTypeDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "additionalCreditTypeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AdditionalCreditTypeDescriptorId: ").Append(AdditionalCreditTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiAdditionalCreditTypeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiAdditionalCreditTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiAdditionalCreditTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiAdditionalCreditTypeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AdditionalCreditTypeDescriptorId == input.AdditionalCreditTypeDescriptorId ||
                    this.AdditionalCreditTypeDescriptorId.Equals(input.AdditionalCreditTypeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.AdditionalCreditTypeDescriptorId.GetHashCode();
