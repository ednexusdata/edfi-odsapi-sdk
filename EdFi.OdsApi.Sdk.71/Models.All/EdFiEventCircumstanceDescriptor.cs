...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_eventCircumstanceDescriptor")]
    public partial class EdFiEventCircumstanceDescriptor : IEquatable<EdFiEventCircumstanceDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiEventCircumstanceDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiEventCircumstanceDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiEventCircumstanceDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="eventCircumstanceDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiEventCircumstanceDescriptor(string id = default(string), int eventCircumstanceDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiEventCircumstanceDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiEventCircumstanceDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiEventCircumstanceDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "eventCircumstanceDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  EventCircumstanceDescriptorId: ").Append(EventCircumstanceDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiEventCircumstanceDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiEventCircumstanceDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiEventCircumstanceDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiEventCircumstanceDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.EventCircumstanceDescriptorId == input.EventCircumstanceDescriptorId ||
                    this.EventCircumstanceDescriptorId.Equals(input.EventCircumstanceDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.EventCircumstanceDescriptorId.GetHashCode();
