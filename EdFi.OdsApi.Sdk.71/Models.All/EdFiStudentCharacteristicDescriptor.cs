...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_studentCharacteristicDescriptor")]
    public partial class EdFiStudentCharacteristicDescriptor : IEquatable<EdFiStudentCharacteristicDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentCharacteristicDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiStudentCharacteristicDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentCharacteristicDescriptor" /> class.
        /// </summary>
        ...
        public EdFiStudentCharacteristicDescriptor(string id = default(string), int studentCharacteristicDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiStudentCharacteristicDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiStudentCharacteristicDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiStudentCharacteristicDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "studentCharacteristicDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  StudentCharacteristicDescriptorId: ").Append(StudentCharacteristicDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiStudentCharacteristicDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiStudentCharacteristicDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStudentCharacteristicDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStudentCharacteristicDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.StudentCharacteristicDescriptorId == input.StudentCharacteristicDescriptorId ||
                    this.StudentCharacteristicDescriptorId.Equals(input.StudentCharacteristicDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.StudentCharacteristicDescriptorId.GetHashCode();
