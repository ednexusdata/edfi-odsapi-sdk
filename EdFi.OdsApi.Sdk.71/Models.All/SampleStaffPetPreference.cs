...
{
    /// <summary>
    /// SampleStaffPetPreference
    /// </summary>
    [DataContract(Name = "sample_staffPetPreference")]
    public partial class SampleStaffPetPreference : IEquatable<SampleStaffPetPreference>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleStaffPetPreference" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SampleStaffPetPreference() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleStaffPetPreference" /> class.
        /// </summary>
        ...
        public SampleStaffPetPreference(int maximumWeight = default(int), int minimumWeight = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SampleStaffPetPreference {\n");
        ...
        {
            return this.Equals(input as SampleStaffPetPreference);
        }

        /// <summary>
        /// Returns true if SampleStaffPetPreference instances are equal
        /// </summary>
        /// <param name="input">Instance of SampleStaffPetPreference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SampleStaffPetPreference input)
        {
            if (input == null)
            {
                return false;
