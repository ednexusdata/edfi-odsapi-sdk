...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_chartOfAccountKeyChange")]
    public partial class TrackedChangesEdFiChartOfAccountKeyChange : IEquatable<TrackedChangesEdFiChartOfAccountKeyChange>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiChartOfAccountKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiChartOfAccountKey oldKeyValues = default(TrackedChangesEdFiChartOfAccountKey), TrackedChangesEdFiChartOfAccountKey newKeyValues = default(TrackedChangesEdFiChartOfAccountKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiChartOfAccountKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiChartOfAccountKey NewKeyValues { get; set; }
        ...
        {
            return this.Equals(input as TrackedChangesEdFiChartOfAccountKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiChartOfAccountKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiChartOfAccountKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiChartOfAccountKeyChange input)
        {
            if (input == null)
            {
                return false;
