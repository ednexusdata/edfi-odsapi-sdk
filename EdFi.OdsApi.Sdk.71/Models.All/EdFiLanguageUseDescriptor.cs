...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_languageUseDescriptor")]
    public partial class EdFiLanguageUseDescriptor : IEquatable<EdFiLanguageUseDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiLanguageUseDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiLanguageUseDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiLanguageUseDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="languageUseDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiLanguageUseDescriptor(string id = default(string), int languageUseDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiLanguageUseDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiLanguageUseDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiLanguageUseDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "languageUseDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  LanguageUseDescriptorId: ").Append(LanguageUseDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiLanguageUseDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiLanguageUseDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiLanguageUseDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiLanguageUseDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.LanguageUseDescriptorId == input.LanguageUseDescriptorId ||
                    this.LanguageUseDescriptorId.Equals(input.LanguageUseDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.LanguageUseDescriptorId.GetHashCode();
