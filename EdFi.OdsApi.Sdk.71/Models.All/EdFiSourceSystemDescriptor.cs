...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_sourceSystemDescriptor")]
    public partial class EdFiSourceSystemDescriptor : IEquatable<EdFiSourceSystemDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSourceSystemDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiSourceSystemDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSourceSystemDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="sourceSystemDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiSourceSystemDescriptor(string id = default(string), int sourceSystemDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiSourceSystemDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiSourceSystemDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiSourceSystemDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.SourceSystemDescriptorId = sourceSystemDescriptorId;
        ...
        [DataMember(Name = "sourceSystemDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiSourceSystemDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  SourceSystemDescriptorId: ").Append(SourceSystemDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiSourceSystemDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiSourceSystemDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiSourceSystemDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiSourceSystemDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.SourceSystemDescriptorId == input.SourceSystemDescriptorId ||
                    this.SourceSystemDescriptorId.Equals(input.SourceSystemDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.SourceSystemDescriptorId.GetHashCode();
