...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_tpdm_genderDescriptorKey")]
    public partial class TrackedChangesTpdmGenderDescriptorKey : IEquatable<TrackedChangesTpdmGenderDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesTpdmGenderDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesTpdmGenderDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesTpdmGenderDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesTpdmGenderDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesTpdmGenderDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesTpdmGenderDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesTpdmGenderDescriptorKey input)
        {
            if (input == null)
            {
                return false;
