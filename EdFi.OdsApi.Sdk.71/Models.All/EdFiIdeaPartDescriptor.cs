...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_ideaPartDescriptor")]
    public partial class EdFiIdeaPartDescriptor : IEquatable<EdFiIdeaPartDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiIdeaPartDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiIdeaPartDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiIdeaPartDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="ideaPartDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiIdeaPartDescriptor(string id = default(string), int ideaPartDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiIdeaPartDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiIdeaPartDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiIdeaPartDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.IdeaPartDescriptorId = ideaPartDescriptorId;
        ...
        [DataMember(Name = "ideaPartDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiIdeaPartDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  IdeaPartDescriptorId: ").Append(IdeaPartDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiIdeaPartDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiIdeaPartDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiIdeaPartDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiIdeaPartDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.IdeaPartDescriptorId == input.IdeaPartDescriptorId ||
                    this.IdeaPartDescriptorId.Equals(input.IdeaPartDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.IdeaPartDescriptorId.GetHashCode();
