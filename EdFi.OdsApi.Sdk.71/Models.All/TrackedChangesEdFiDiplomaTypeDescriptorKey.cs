...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_diplomaTypeDescriptorKey")]
    public partial class TrackedChangesEdFiDiplomaTypeDescriptorKey : IEquatable<TrackedChangesEdFiDiplomaTypeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiDiplomaTypeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiDiplomaTypeDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiDiplomaTypeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiDiplomaTypeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiDiplomaTypeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiDiplomaTypeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiDiplomaTypeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
