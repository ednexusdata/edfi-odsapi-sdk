...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_attendanceEventCategoryDescriptor")]
    public partial class EdFiAttendanceEventCategoryDescriptor : IEquatable<EdFiAttendanceEventCategoryDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAttendanceEventCategoryDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiAttendanceEventCategoryDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAttendanceEventCategoryDescriptor" /> class.
        /// </summary>
        ...
        public EdFiAttendanceEventCategoryDescriptor(string id = default(string), int attendanceEventCategoryDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiAttendanceEventCategoryDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiAttendanceEventCategoryDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiAttendanceEventCategoryDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "attendanceEventCategoryDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AttendanceEventCategoryDescriptorId: ").Append(AttendanceEventCategoryDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiAttendanceEventCategoryDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiAttendanceEventCategoryDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiAttendanceEventCategoryDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiAttendanceEventCategoryDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AttendanceEventCategoryDescriptorId == input.AttendanceEventCategoryDescriptorId ||
                    this.AttendanceEventCategoryDescriptorId.Equals(input.AttendanceEventCategoryDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.AttendanceEventCategoryDescriptorId.GetHashCode();
