...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_disciplineDescriptorKey")]
    public partial class TrackedChangesEdFiDisciplineDescriptorKey : IEquatable<TrackedChangesEdFiDisciplineDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiDisciplineDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiDisciplineDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiDisciplineDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiDisciplineDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiDisciplineDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiDisciplineDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiDisciplineDescriptorKey input)
        {
            if (input == null)
            {
                return false;
