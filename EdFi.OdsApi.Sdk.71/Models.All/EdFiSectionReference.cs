...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiSectionReference : IEquatable<EdFiSectionReference>, IValidatableObject
    {
        ...
        public EdFiSectionReference(string localCourseCode = default(string), long schoolId = default(long), int schoolYear = default(int), string sectionIdentifier = default(string), string sessionName = default(string), Link link = default(Link))
        {
