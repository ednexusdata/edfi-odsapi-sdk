...
{
    /// <summary>
    /// SampleBusRouteTelephone
    /// </summary>
    [DataContract(Name = "sample_busRouteTelephone")]
    public partial class SampleBusRouteTelephone : IEquatable<SampleBusRouteTelephone>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleBusRouteTelephone" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SampleBusRouteTelephone() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SampleBusRouteTelephone" /> class.
        /// </summary>
        ...
        public SampleBusRouteTelephone(string telephoneNumberTypeDescriptor = default(string), string telephoneNumber = default(string), bool? doNotPublishIndicator = default(bool?), int? orderOfPriority = default(int?), bool? textMessageCapabilityIndicator = default(bool?))
        {
            // to ensure "telephoneNumberTypeDescriptor" is required (not null)
            if (telephoneNumberTypeDescriptor == null)
            {
                throw new ArgumentNullException("telephoneNumberTypeDescriptor is a required property for SampleBusRouteTelephone and cannot be null");
            }
            this.TelephoneNumberTypeDescriptor = telephoneNumberTypeDescriptor;
            // to ensure "telephoneNumber" is required (not null)
            if (telephoneNumber == null)
            {
                throw new ArgumentNullException("telephoneNumber is a required property for SampleBusRouteTelephone and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SampleBusRouteTelephone {\n");
        ...
        {
            return this.Equals(input as SampleBusRouteTelephone);
        }

        /// <summary>
        /// Returns true if SampleBusRouteTelephone instances are equal
        /// </summary>
        /// <param name="input">Instance of SampleBusRouteTelephone to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SampleBusRouteTelephone input)
        {
            if (input == null)
            {
                return false;
