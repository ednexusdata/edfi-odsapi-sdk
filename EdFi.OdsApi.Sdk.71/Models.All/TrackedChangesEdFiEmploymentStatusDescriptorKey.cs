...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_employmentStatusDescriptorKey")]
    public partial class TrackedChangesEdFiEmploymentStatusDescriptorKey : IEquatable<TrackedChangesEdFiEmploymentStatusDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiEmploymentStatusDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiEmploymentStatusDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiEmploymentStatusDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiEmploymentStatusDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiEmploymentStatusDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiEmploymentStatusDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiEmploymentStatusDescriptorKey input)
        {
            if (input == null)
            {
                return false;
