...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_localEncumbranceKeyChange")]
    public partial class TrackedChangesEdFiLocalEncumbranceKeyChange : IEquatable<TrackedChangesEdFiLocalEncumbranceKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiLocalEncumbranceKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiLocalEncumbranceKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiLocalEncumbranceKey oldKeyValues = default(TrackedChangesEdFiLocalEncumbranceKey), TrackedChangesEdFiLocalEncumbranceKey newKeyValues = default(TrackedChangesEdFiLocalEncumbranceKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiLocalEncumbranceKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiLocalEncumbranceKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiLocalEncumbranceKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiLocalEncumbranceKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiLocalEncumbranceKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiLocalEncumbranceKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiLocalEncumbranceKeyChange input)
        {
            if (input == null)
            {
                return false;
