...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TrackedChangesEdFiSurveyCourseAssociationKey : IEquatable<TrackedChangesEdFiSurveyCourseAssociationKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiSurveyCourseAssociationKey(string courseCode = default(string), long educationOrganizationId = default(long), string _namespace = default(string), string surveyIdentifier = default(string))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSurveyCourseAssociationKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSurveyCourseAssociationKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSurveyCourseAssociationKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSurveyCourseAssociationKey input)
        {
            if (input == null)
            {
                return false;
