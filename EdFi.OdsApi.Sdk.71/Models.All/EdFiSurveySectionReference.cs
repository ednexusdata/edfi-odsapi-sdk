...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiSurveySectionReference : IEquatable<EdFiSurveySectionReference>, IValidatableObject
    {
        ...
        public EdFiSurveySectionReference(string _namespace = default(string), string surveyIdentifier = default(string), string surveySectionTitle = default(string), Link link = default(Link))
        {
            ...
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiSurveySectionReference and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "surveyIdentifier" is required (not null)
            if (surveyIdentifier == null)
            {
                throw new ArgumentNullException("surveyIdentifier is a required property for EdFiSurveySectionReference and cannot be null");
            }
            this.SurveyIdentifier = surveyIdentifier;
            // to ensure "surveySectionTitle" is required (not null)
            if (surveySectionTitle == null)
            {
                throw new ArgumentNullException("surveySectionTitle is a required property for EdFiSurveySectionReference and cannot be null");
            }
