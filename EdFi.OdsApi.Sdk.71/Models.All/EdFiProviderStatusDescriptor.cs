...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_providerStatusDescriptor")]
    public partial class EdFiProviderStatusDescriptor : IEquatable<EdFiProviderStatusDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiProviderStatusDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiProviderStatusDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiProviderStatusDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="providerStatusDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiProviderStatusDescriptor(string id = default(string), int providerStatusDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiProviderStatusDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiProviderStatusDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiProviderStatusDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "providerStatusDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ProviderStatusDescriptorId: ").Append(ProviderStatusDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiProviderStatusDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiProviderStatusDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiProviderStatusDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiProviderStatusDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ProviderStatusDescriptorId == input.ProviderStatusDescriptorId ||
                    this.ProviderStatusDescriptorId.Equals(input.ProviderStatusDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ProviderStatusDescriptorId.GetHashCode();
