...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_languageUseDescriptorKey")]
    public partial class TrackedChangesEdFiLanguageUseDescriptorKey : IEquatable<TrackedChangesEdFiLanguageUseDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiLanguageUseDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiLanguageUseDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiLanguageUseDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiLanguageUseDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiLanguageUseDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiLanguageUseDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiLanguageUseDescriptorKey input)
        {
            if (input == null)
            {
                return false;
