...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_costRateDescriptorKey")]
    public partial class TrackedChangesEdFiCostRateDescriptorKey : IEquatable<TrackedChangesEdFiCostRateDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCostRateDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCostRateDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCostRateDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCostRateDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCostRateDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCostRateDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCostRateDescriptorKey input)
        {
            if (input == null)
            {
                return false;
