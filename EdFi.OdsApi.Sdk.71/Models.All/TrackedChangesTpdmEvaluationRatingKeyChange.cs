...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_tpdm_evaluationRatingKeyChange")]
    public partial class TrackedChangesTpdmEvaluationRatingKeyChange : IEquatable<TrackedChangesTpdmEvaluationRatingKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesTpdmEvaluationRatingKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesTpdmEvaluationRatingKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesTpdmEvaluationRatingKey oldKeyValues = default(TrackedChangesTpdmEvaluationRatingKey), TrackedChangesTpdmEvaluationRatingKey newKeyValues = default(TrackedChangesTpdmEvaluationRatingKey))
        {
            this.Id = id;
        ...
        public TrackedChangesTpdmEvaluationRatingKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesTpdmEvaluationRatingKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesTpdmEvaluationRatingKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesTpdmEvaluationRatingKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesTpdmEvaluationRatingKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesTpdmEvaluationRatingKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesTpdmEvaluationRatingKeyChange input)
        {
            if (input == null)
            {
                return false;
