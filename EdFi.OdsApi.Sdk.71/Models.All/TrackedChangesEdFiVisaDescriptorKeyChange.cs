...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_visaDescriptorKeyChange")]
    public partial class TrackedChangesEdFiVisaDescriptorKeyChange : IEquatable<TrackedChangesEdFiVisaDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiVisaDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiVisaDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiVisaDescriptorKey oldKeyValues = default(TrackedChangesEdFiVisaDescriptorKey), TrackedChangesEdFiVisaDescriptorKey newKeyValues = default(TrackedChangesEdFiVisaDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiVisaDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiVisaDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiVisaDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiVisaDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiVisaDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiVisaDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiVisaDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
