...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_technicalSkillsAssessmentDescriptorKey")]
    public partial class TrackedChangesEdFiTechnicalSkillsAssessmentDescriptorKey : IEquatable<TrackedChangesEdFiTechnicalSkillsAssessmentDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiTechnicalSkillsAssessmentDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiTechnicalSkillsAssessmentDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiTechnicalSkillsAssessmentDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiTechnicalSkillsAssessmentDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiTechnicalSkillsAssessmentDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiTechnicalSkillsAssessmentDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiTechnicalSkillsAssessmentDescriptorKey input)
        {
            if (input == null)
            {
                return false;
