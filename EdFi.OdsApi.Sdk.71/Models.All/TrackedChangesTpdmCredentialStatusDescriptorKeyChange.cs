...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_tpdm_credentialStatusDescriptorKeyChange")]
    public partial class TrackedChangesTpdmCredentialStatusDescriptorKeyChange : IEquatable<TrackedChangesTpdmCredentialStatusDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesTpdmCredentialStatusDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesTpdmCredentialStatusDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesTpdmCredentialStatusDescriptorKey oldKeyValues = default(TrackedChangesTpdmCredentialStatusDescriptorKey), TrackedChangesTpdmCredentialStatusDescriptorKey newKeyValues = default(TrackedChangesTpdmCredentialStatusDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesTpdmCredentialStatusDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesTpdmCredentialStatusDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesTpdmCredentialStatusDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesTpdmCredentialStatusDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesTpdmCredentialStatusDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesTpdmCredentialStatusDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesTpdmCredentialStatusDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
