...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_programTypeDescriptor")]
    public partial class EdFiProgramTypeDescriptor : IEquatable<EdFiProgramTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiProgramTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiProgramTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiProgramTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="programTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiProgramTypeDescriptor(string id = default(string), int programTypeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiProgramTypeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiProgramTypeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiProgramTypeDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "programTypeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ProgramTypeDescriptorId: ").Append(ProgramTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiProgramTypeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiProgramTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiProgramTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiProgramTypeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ProgramTypeDescriptorId == input.ProgramTypeDescriptorId ||
                    this.ProgramTypeDescriptorId.Equals(input.ProgramTypeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ProgramTypeDescriptorId.GetHashCode();
