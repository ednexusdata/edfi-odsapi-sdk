...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TrackedChangesEdFiCourseKey : IEquatable<TrackedChangesEdFiCourseKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiCourseKey(string courseCode = default(string), long educationOrganizationId = default(long))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCourseKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCourseKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCourseKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCourseKey input)
        {
            if (input == null)
            {
                return false;
