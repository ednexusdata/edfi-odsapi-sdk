...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_electronicMailTypeDescriptor")]
    public partial class EdFiElectronicMailTypeDescriptor : IEquatable<EdFiElectronicMailTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiElectronicMailTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiElectronicMailTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiElectronicMailTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="electronicMailTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiElectronicMailTypeDescriptor(string id = default(string), int electronicMailTypeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiElectronicMailTypeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiElectronicMailTypeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiElectronicMailTypeDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "electronicMailTypeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ElectronicMailTypeDescriptorId: ").Append(ElectronicMailTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiElectronicMailTypeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiElectronicMailTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiElectronicMailTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiElectronicMailTypeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ElectronicMailTypeDescriptorId == input.ElectronicMailTypeDescriptorId ||
                    this.ElectronicMailTypeDescriptorId.Equals(input.ElectronicMailTypeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ElectronicMailTypeDescriptorId.GetHashCode();
