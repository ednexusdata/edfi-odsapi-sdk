...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "tpdm_credentialStatusDescriptor")]
    public partial class TpdmCredentialStatusDescriptor : IEquatable<TpdmCredentialStatusDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmCredentialStatusDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmCredentialStatusDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmCredentialStatusDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="credentialStatusDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmCredentialStatusDescriptor(string id = default(string), int credentialStatusDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for TpdmCredentialStatusDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for TpdmCredentialStatusDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for TpdmCredentialStatusDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.CredentialStatusDescriptorId = credentialStatusDescriptorId;
        ...
        [DataMember(Name = "credentialStatusDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmCredentialStatusDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  CredentialStatusDescriptorId: ").Append(CredentialStatusDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmCredentialStatusDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmCredentialStatusDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmCredentialStatusDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmCredentialStatusDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CredentialStatusDescriptorId == input.CredentialStatusDescriptorId ||
                    this.CredentialStatusDescriptorId.Equals(input.CredentialStatusDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.CredentialStatusDescriptorId.GetHashCode();
