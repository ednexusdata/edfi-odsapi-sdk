...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiStudentAcademicRecordReference : IEquatable<EdFiStudentAcademicRecordReference>, IValidatableObject
    {
        ...
        public EdFiStudentAcademicRecordReference(long educationOrganizationId = default(long), int schoolYear = default(int), string studentUniqueId = default(string), string termDescriptor = default(string), Link link = default(Link))
        {
