...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_magnetSpecialProgramEmphasisSchoolDescriptorKey")]
    public partial class TrackedChangesEdFiMagnetSpecialProgramEmphasisSchoolDescriptorKey : IEquatable<TrackedChangesEdFiMagnetSpecialProgramEmphasisSchoolDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiMagnetSpecialProgramEmphasisSchoolDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiMagnetSpecialProgramEmphasisSchoolDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiMagnetSpecialProgramEmphasisSchoolDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiMagnetSpecialProgramEmphasisSchoolDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiMagnetSpecialProgramEmphasisSchoolDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiMagnetSpecialProgramEmphasisSchoolDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiMagnetSpecialProgramEmphasisSchoolDescriptorKey input)
        {
            if (input == null)
            {
                return false;
