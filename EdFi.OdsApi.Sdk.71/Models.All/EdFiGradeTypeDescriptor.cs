...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_gradeTypeDescriptor")]
    public partial class EdFiGradeTypeDescriptor : IEquatable<EdFiGradeTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiGradeTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiGradeTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiGradeTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="gradeTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        [DataMember(Name = "gradeTypeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  GradeTypeDescriptorId: ").Append(GradeTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiGradeTypeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiGradeTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiGradeTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiGradeTypeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.GradeTypeDescriptorId == input.GradeTypeDescriptorId ||
                    this.GradeTypeDescriptorId.Equals(input.GradeTypeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.GradeTypeDescriptorId.GetHashCode();
