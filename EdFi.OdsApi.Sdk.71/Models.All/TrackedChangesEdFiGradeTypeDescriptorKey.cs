...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_gradeTypeDescriptorKey")]
    public partial class TrackedChangesEdFiGradeTypeDescriptorKey : IEquatable<TrackedChangesEdFiGradeTypeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiGradeTypeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiGradeTypeDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiGradeTypeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiGradeTypeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiGradeTypeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiGradeTypeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiGradeTypeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
