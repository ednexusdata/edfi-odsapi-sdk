...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_questionFormDescriptor")]
    public partial class EdFiQuestionFormDescriptor : IEquatable<EdFiQuestionFormDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiQuestionFormDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiQuestionFormDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiQuestionFormDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="questionFormDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        [DataMember(Name = "questionFormDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiQuestionFormDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  QuestionFormDescriptorId: ").Append(QuestionFormDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiQuestionFormDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiQuestionFormDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiQuestionFormDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiQuestionFormDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.QuestionFormDescriptorId == input.QuestionFormDescriptorId ||
                    this.QuestionFormDescriptorId.Equals(input.QuestionFormDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.QuestionFormDescriptorId.GetHashCode();
