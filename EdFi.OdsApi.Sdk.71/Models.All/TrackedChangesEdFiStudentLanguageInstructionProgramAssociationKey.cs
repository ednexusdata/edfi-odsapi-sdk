...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_studentLanguageInstructionProgramAssociationKey")]
    public partial class TrackedChangesEdFiStudentLanguageInstructionProgramAssociationKey : IEquatable<TrackedChangesEdFiStudentLanguageInstructionProgramAssociationKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiStudentLanguageInstructionProgramAssociationKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiStudentLanguageInstructionProgramAssociationKey(DateTime beginDate = default(DateTime), long educationOrganizationId = default(long), long programEducationOrganizationId = default(long), string programName = default(string), string programTypeDescriptor = default(string), string studentUniqueId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiStudentLanguageInstructionProgramAssociationKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStudentLanguageInstructionProgramAssociationKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStudentLanguageInstructionProgramAssociationKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStudentLanguageInstructionProgramAssociationKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStudentLanguageInstructionProgramAssociationKey input)
        {
            if (input == null)
            {
                return false;
