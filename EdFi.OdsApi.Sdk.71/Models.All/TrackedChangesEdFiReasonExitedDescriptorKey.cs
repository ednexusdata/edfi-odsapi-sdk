...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_reasonExitedDescriptorKey")]
    public partial class TrackedChangesEdFiReasonExitedDescriptorKey : IEquatable<TrackedChangesEdFiReasonExitedDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiReasonExitedDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiReasonExitedDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiReasonExitedDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiReasonExitedDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiReasonExitedDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiReasonExitedDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiReasonExitedDescriptorKey input)
        {
            if (input == null)
            {
                return false;
