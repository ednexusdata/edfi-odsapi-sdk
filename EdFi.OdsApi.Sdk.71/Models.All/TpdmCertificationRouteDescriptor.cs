...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "tpdm_certificationRouteDescriptor")]
    public partial class TpdmCertificationRouteDescriptor : IEquatable<TpdmCertificationRouteDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmCertificationRouteDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmCertificationRouteDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmCertificationRouteDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="certificationRouteDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmCertificationRouteDescriptor(string id = default(string), int certificationRouteDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for TpdmCertificationRouteDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for TpdmCertificationRouteDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for TpdmCertificationRouteDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.CertificationRouteDescriptorId = certificationRouteDescriptorId;
        ...
        [DataMember(Name = "certificationRouteDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmCertificationRouteDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  CertificationRouteDescriptorId: ").Append(CertificationRouteDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmCertificationRouteDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmCertificationRouteDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmCertificationRouteDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmCertificationRouteDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CertificationRouteDescriptorId == input.CertificationRouteDescriptorId ||
                    this.CertificationRouteDescriptorId.Equals(input.CertificationRouteDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.CertificationRouteDescriptorId.GetHashCode();
