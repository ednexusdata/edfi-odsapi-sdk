...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_studentKeyChange")]
    public partial class TrackedChangesEdFiStudentKeyChange : IEquatable<TrackedChangesEdFiStudentKeyChange>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiStudentKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiStudentKey oldKeyValues = default(TrackedChangesEdFiStudentKey), TrackedChangesEdFiStudentKey newKeyValues = default(TrackedChangesEdFiStudentKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiStudentKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiStudentKey NewKeyValues { get; set; }
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStudentKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStudentKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStudentKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStudentKeyChange input)
        {
            if (input == null)
            {
                return false;
