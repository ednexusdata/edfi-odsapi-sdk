...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_localContractedStaffKeyChange")]
    public partial class TrackedChangesEdFiLocalContractedStaffKeyChange : IEquatable<TrackedChangesEdFiLocalContractedStaffKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiLocalContractedStaffKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiLocalContractedStaffKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiLocalContractedStaffKey oldKeyValues = default(TrackedChangesEdFiLocalContractedStaffKey), TrackedChangesEdFiLocalContractedStaffKey newKeyValues = default(TrackedChangesEdFiLocalContractedStaffKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiLocalContractedStaffKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiLocalContractedStaffKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiLocalContractedStaffKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiLocalContractedStaffKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiLocalContractedStaffKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiLocalContractedStaffKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiLocalContractedStaffKeyChange input)
        {
            if (input == null)
            {
                return false;
