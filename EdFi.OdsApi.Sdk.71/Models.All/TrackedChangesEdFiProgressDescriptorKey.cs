...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_progressDescriptorKey")]
    public partial class TrackedChangesEdFiProgressDescriptorKey : IEquatable<TrackedChangesEdFiProgressDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiProgressDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiProgressDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiProgressDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiProgressDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiProgressDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiProgressDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiProgressDescriptorKey input)
        {
            if (input == null)
            {
                return false;
