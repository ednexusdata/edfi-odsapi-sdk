...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_schoolTypeDescriptorKey")]
    public partial class TrackedChangesEdFiSchoolTypeDescriptorKey : IEquatable<TrackedChangesEdFiSchoolTypeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiSchoolTypeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiSchoolTypeDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiSchoolTypeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSchoolTypeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSchoolTypeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSchoolTypeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSchoolTypeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
