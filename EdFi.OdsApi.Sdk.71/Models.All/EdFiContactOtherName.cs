...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiContactOtherName : IEquatable<EdFiContactOtherName>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiContactOtherName(string otherNameTypeDescriptor = default(string), string firstName = default(string), string generationCodeSuffix = default(string), string lastSurname = default(string), string middleName = default(string), string personalTitlePrefix = default(string))
        {
        ...
        {
            return this.Equals(input as EdFiContactOtherName);
        }

        /// <summary>
        /// Returns true if EdFiContactOtherName instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiContactOtherName to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiContactOtherName input)
        {
            if (input == null)
            {
                return false;
