...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiStaffProgramAssociation : IEquatable<EdFiStaffProgramAssociation>, IValidatableObject
    {
        ...
        public EdFiStaffProgramAssociation(string id = default(string), DateTime beginDate = default(DateTime), EdFiProgramReference programReference = default(EdFiProgramReference), EdFiStaffReference staffReference = default(EdFiStaffReference), DateTime? endDate = default(DateTime?), bool? studentRecordAccess = default(bool?), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            this.BeginDate = beginDate;
            // to ensure "programReference" is required (not null)
            if (programReference == null)
            {
                throw new ArgumentNullException("programReference is a required property for EdFiStaffProgramAssociation and cannot be null");
            }
            this.ProgramReference = programReference;
            // to ensure "staffReference" is required (not null)
            if (staffReference == null)
            {
                throw new ArgumentNullException("staffReference is a required property for EdFiStaffProgramAssociation and cannot be null");
            }
