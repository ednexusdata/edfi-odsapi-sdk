...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_licenseStatusDescriptor")]
    public partial class EdFiLicenseStatusDescriptor : IEquatable<EdFiLicenseStatusDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiLicenseStatusDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiLicenseStatusDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiLicenseStatusDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="licenseStatusDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiLicenseStatusDescriptor(string id = default(string), int licenseStatusDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiLicenseStatusDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiLicenseStatusDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiLicenseStatusDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "licenseStatusDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  LicenseStatusDescriptorId: ").Append(LicenseStatusDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiLicenseStatusDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiLicenseStatusDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiLicenseStatusDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiLicenseStatusDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.LicenseStatusDescriptorId == input.LicenseStatusDescriptorId ||
                    this.LicenseStatusDescriptorId.Equals(input.LicenseStatusDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.LicenseStatusDescriptorId.GetHashCode();
