...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_staffSectionAssociationKeyChange")]
    public partial class TrackedChangesEdFiStaffSectionAssociationKeyChange : IEquatable<TrackedChangesEdFiStaffSectionAssociationKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiStaffSectionAssociationKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiStaffSectionAssociationKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiStaffSectionAssociationKey oldKeyValues = default(TrackedChangesEdFiStaffSectionAssociationKey), TrackedChangesEdFiStaffSectionAssociationKey newKeyValues = default(TrackedChangesEdFiStaffSectionAssociationKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiStaffSectionAssociationKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiStaffSectionAssociationKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiStaffSectionAssociationKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStaffSectionAssociationKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStaffSectionAssociationKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStaffSectionAssociationKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStaffSectionAssociationKeyChange input)
        {
            if (input == null)
            {
                return false;
