...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_termDescriptorKeyChange")]
    public partial class TrackedChangesEdFiTermDescriptorKeyChange : IEquatable<TrackedChangesEdFiTermDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiTermDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiTermDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiTermDescriptorKey oldKeyValues = default(TrackedChangesEdFiTermDescriptorKey), TrackedChangesEdFiTermDescriptorKey newKeyValues = default(TrackedChangesEdFiTermDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiTermDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiTermDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiTermDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiTermDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiTermDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiTermDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiTermDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
