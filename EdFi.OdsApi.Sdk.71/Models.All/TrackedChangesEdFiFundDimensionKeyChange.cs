...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_fundDimensionKeyChange")]
    public partial class TrackedChangesEdFiFundDimensionKeyChange : IEquatable<TrackedChangesEdFiFundDimensionKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiFundDimensionKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiFundDimensionKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiFundDimensionKey oldKeyValues = default(TrackedChangesEdFiFundDimensionKey), TrackedChangesEdFiFundDimensionKey newKeyValues = default(TrackedChangesEdFiFundDimensionKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiFundDimensionKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiFundDimensionKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiFundDimensionKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiFundDimensionKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiFundDimensionKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiFundDimensionKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiFundDimensionKeyChange input)
        {
            if (input == null)
            {
                return false;
