...
{
    /// <summary>
    /// TrackedChangesSampleBusKeyChange
    /// </summary>
    [DataContract(Name = "trackedChanges_sample_busKeyChange")]
    public partial class TrackedChangesSampleBusKeyChange : IEquatable<TrackedChangesSampleBusKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesSampleBusKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesSampleBusKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesSampleBusKey oldKeyValues = default(TrackedChangesSampleBusKey), TrackedChangesSampleBusKey newKeyValues = default(TrackedChangesSampleBusKey))
        {
            this.Id = id;
        ...
        public TrackedChangesSampleBusKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesSampleBusKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesSampleBusKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesSampleBusKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesSampleBusKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesSampleBusKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesSampleBusKeyChange input)
        {
            if (input == null)
            {
                return false;
