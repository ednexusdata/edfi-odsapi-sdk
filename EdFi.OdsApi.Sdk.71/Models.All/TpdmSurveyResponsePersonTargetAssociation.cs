...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TpdmSurveyResponsePersonTargetAssociation : IEquatable<TpdmSurveyResponsePersonTargetAssociation>, IValidatableObject
    {
        ...
        public TpdmSurveyResponsePersonTargetAssociation(string id = default(string), EdFiPersonReference personReference = default(EdFiPersonReference), EdFiSurveyResponseReference surveyResponseReference = default(EdFiSurveyResponseReference), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
