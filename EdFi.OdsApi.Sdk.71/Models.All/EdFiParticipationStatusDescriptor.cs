...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_participationStatusDescriptor")]
    public partial class EdFiParticipationStatusDescriptor : IEquatable<EdFiParticipationStatusDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiParticipationStatusDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiParticipationStatusDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiParticipationStatusDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="participationStatusDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiParticipationStatusDescriptor(string id = default(string), int participationStatusDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiParticipationStatusDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiParticipationStatusDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiParticipationStatusDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.ParticipationStatusDescriptorId = participationStatusDescriptorId;
        ...
        [DataMember(Name = "participationStatusDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiParticipationStatusDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  ParticipationStatusDescriptorId: ").Append(ParticipationStatusDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiParticipationStatusDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiParticipationStatusDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiParticipationStatusDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiParticipationStatusDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ParticipationStatusDescriptorId == input.ParticipationStatusDescriptorId ||
                    this.ParticipationStatusDescriptorId.Equals(input.ParticipationStatusDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ParticipationStatusDescriptorId.GetHashCode();
