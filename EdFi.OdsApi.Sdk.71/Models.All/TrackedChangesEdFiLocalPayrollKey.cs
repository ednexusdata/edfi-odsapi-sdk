...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_localPayrollKey")]
    public partial class TrackedChangesEdFiLocalPayrollKey : IEquatable<TrackedChangesEdFiLocalPayrollKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiLocalPayrollKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiLocalPayrollKey(DateTime asOfDate = default(DateTime), string accountIdentifier = default(string), long educationOrganizationId = default(long), int fiscalYear = default(int), string staffUniqueId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiLocalPayrollKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiLocalPayrollKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiLocalPayrollKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiLocalPayrollKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiLocalPayrollKey input)
        {
            if (input == null)
            {
                return false;
