...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_assignmentLateStatusDescriptor")]
    public partial class EdFiAssignmentLateStatusDescriptor : IEquatable<EdFiAssignmentLateStatusDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAssignmentLateStatusDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiAssignmentLateStatusDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAssignmentLateStatusDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="assignmentLateStatusDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiAssignmentLateStatusDescriptor(string id = default(string), int assignmentLateStatusDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiAssignmentLateStatusDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiAssignmentLateStatusDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiAssignmentLateStatusDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.AssignmentLateStatusDescriptorId = assignmentLateStatusDescriptorId;
        ...
        [DataMember(Name = "assignmentLateStatusDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiAssignmentLateStatusDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  AssignmentLateStatusDescriptorId: ").Append(AssignmentLateStatusDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiAssignmentLateStatusDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiAssignmentLateStatusDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiAssignmentLateStatusDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiAssignmentLateStatusDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AssignmentLateStatusDescriptorId == input.AssignmentLateStatusDescriptorId ||
                    this.AssignmentLateStatusDescriptorId.Equals(input.AssignmentLateStatusDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.AssignmentLateStatusDescriptorId.GetHashCode();
