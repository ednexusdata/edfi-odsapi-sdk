...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_participationDescriptor")]
    public partial class EdFiParticipationDescriptor : IEquatable<EdFiParticipationDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiParticipationDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiParticipationDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiParticipationDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="participationDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiParticipationDescriptor(string id = default(string), int participationDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiParticipationDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiParticipationDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiParticipationDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "participationDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ParticipationDescriptorId: ").Append(ParticipationDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiParticipationDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiParticipationDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiParticipationDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiParticipationDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ParticipationDescriptorId == input.ParticipationDescriptorId ||
                    this.ParticipationDescriptorId.Equals(input.ParticipationDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ParticipationDescriptorId.GetHashCode();
