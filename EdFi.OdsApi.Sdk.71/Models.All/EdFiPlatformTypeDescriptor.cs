...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_platformTypeDescriptor")]
    public partial class EdFiPlatformTypeDescriptor : IEquatable<EdFiPlatformTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiPlatformTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiPlatformTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiPlatformTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="platformTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiPlatformTypeDescriptor(string id = default(string), int platformTypeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiPlatformTypeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiPlatformTypeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiPlatformTypeDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.PlatformTypeDescriptorId = platformTypeDescriptorId;
        ...
        [DataMember(Name = "platformTypeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiPlatformTypeDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  PlatformTypeDescriptorId: ").Append(PlatformTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiPlatformTypeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiPlatformTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiPlatformTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiPlatformTypeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.PlatformTypeDescriptorId == input.PlatformTypeDescriptorId ||
                    this.PlatformTypeDescriptorId.Equals(input.PlatformTypeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.PlatformTypeDescriptorId.GetHashCode();
