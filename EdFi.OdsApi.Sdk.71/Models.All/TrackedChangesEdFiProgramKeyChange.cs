...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_programKeyChange")]
    public partial class TrackedChangesEdFiProgramKeyChange : IEquatable<TrackedChangesEdFiProgramKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiProgramKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiProgramKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiProgramKey oldKeyValues = default(TrackedChangesEdFiProgramKey), TrackedChangesEdFiProgramKey newKeyValues = default(TrackedChangesEdFiProgramKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiProgramKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiProgramKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiProgramKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiProgramKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiProgramKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiProgramKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiProgramKeyChange input)
        {
            if (input == null)
            {
                return false;
