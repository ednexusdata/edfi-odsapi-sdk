...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_credentialFieldDescriptor")]
    public partial class EdFiCredentialFieldDescriptor : IEquatable<EdFiCredentialFieldDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCredentialFieldDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiCredentialFieldDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCredentialFieldDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="credentialFieldDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiCredentialFieldDescriptor(string id = default(string), int credentialFieldDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiCredentialFieldDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiCredentialFieldDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiCredentialFieldDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "credentialFieldDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CredentialFieldDescriptorId: ").Append(CredentialFieldDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiCredentialFieldDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiCredentialFieldDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiCredentialFieldDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiCredentialFieldDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CredentialFieldDescriptorId == input.CredentialFieldDescriptorId ||
                    this.CredentialFieldDescriptorId.Equals(input.CredentialFieldDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.CredentialFieldDescriptorId.GetHashCode();
