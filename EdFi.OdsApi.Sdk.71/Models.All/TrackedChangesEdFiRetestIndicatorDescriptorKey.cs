...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_retestIndicatorDescriptorKey")]
    public partial class TrackedChangesEdFiRetestIndicatorDescriptorKey : IEquatable<TrackedChangesEdFiRetestIndicatorDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiRetestIndicatorDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiRetestIndicatorDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiRetestIndicatorDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiRetestIndicatorDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiRetestIndicatorDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiRetestIndicatorDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiRetestIndicatorDescriptorKey input)
        {
            if (input == null)
            {
                return false;
