...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_attemptStatusDescriptorKey")]
    public partial class TrackedChangesEdFiAttemptStatusDescriptorKey : IEquatable<TrackedChangesEdFiAttemptStatusDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiAttemptStatusDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiAttemptStatusDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiAttemptStatusDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiAttemptStatusDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiAttemptStatusDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiAttemptStatusDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiAttemptStatusDescriptorKey input)
        {
            if (input == null)
            {
                return false;
