...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_primaryLearningDeviceAwayFromSchoolDescriptorKey")]
    public partial class TrackedChangesEdFiPrimaryLearningDeviceAwayFromSchoolDescriptorKey : IEquatable<TrackedChangesEdFiPrimaryLearningDeviceAwayFromSchoolDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiPrimaryLearningDeviceAwayFromSchoolDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiPrimaryLearningDeviceAwayFromSchoolDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiPrimaryLearningDeviceAwayFromSchoolDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiPrimaryLearningDeviceAwayFromSchoolDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiPrimaryLearningDeviceAwayFromSchoolDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiPrimaryLearningDeviceAwayFromSchoolDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiPrimaryLearningDeviceAwayFromSchoolDescriptorKey input)
        {
            if (input == null)
            {
                return false;
