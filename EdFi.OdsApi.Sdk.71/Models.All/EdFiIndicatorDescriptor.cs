...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_indicatorDescriptor")]
    public partial class EdFiIndicatorDescriptor : IEquatable<EdFiIndicatorDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiIndicatorDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiIndicatorDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiIndicatorDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="indicatorDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiIndicatorDescriptor(string id = default(string), int indicatorDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiIndicatorDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiIndicatorDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiIndicatorDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.IndicatorDescriptorId = indicatorDescriptorId;
        ...
        [DataMember(Name = "indicatorDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiIndicatorDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  IndicatorDescriptorId: ").Append(IndicatorDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiIndicatorDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiIndicatorDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiIndicatorDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiIndicatorDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.IndicatorDescriptorId == input.IndicatorDescriptorId ||
                    this.IndicatorDescriptorId.Equals(input.IndicatorDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.IndicatorDescriptorId.GetHashCode();
