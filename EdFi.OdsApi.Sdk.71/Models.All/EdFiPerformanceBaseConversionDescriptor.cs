...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_performanceBaseConversionDescriptor")]
    public partial class EdFiPerformanceBaseConversionDescriptor : IEquatable<EdFiPerformanceBaseConversionDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiPerformanceBaseConversionDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiPerformanceBaseConversionDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiPerformanceBaseConversionDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="performanceBaseConversionDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiPerformanceBaseConversionDescriptor(string id = default(string), int performanceBaseConversionDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiPerformanceBaseConversionDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiPerformanceBaseConversionDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiPerformanceBaseConversionDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "performanceBaseConversionDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PerformanceBaseConversionDescriptorId: ").Append(PerformanceBaseConversionDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiPerformanceBaseConversionDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiPerformanceBaseConversionDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiPerformanceBaseConversionDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiPerformanceBaseConversionDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.PerformanceBaseConversionDescriptorId == input.PerformanceBaseConversionDescriptorId ||
                    this.PerformanceBaseConversionDescriptorId.Equals(input.PerformanceBaseConversionDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.PerformanceBaseConversionDescriptorId.GetHashCode();
