...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_tpdm_evaluationElementRatingLevelDescriptorKey")]
    public partial class TrackedChangesTpdmEvaluationElementRatingLevelDescriptorKey : IEquatable<TrackedChangesTpdmEvaluationElementRatingLevelDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesTpdmEvaluationElementRatingLevelDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesTpdmEvaluationElementRatingLevelDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesTpdmEvaluationElementRatingLevelDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesTpdmEvaluationElementRatingLevelDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesTpdmEvaluationElementRatingLevelDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesTpdmEvaluationElementRatingLevelDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesTpdmEvaluationElementRatingLevelDescriptorKey input)
        {
            if (input == null)
            {
                return false;
