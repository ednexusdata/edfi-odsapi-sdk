...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_repeatIdentifierDescriptor")]
    public partial class EdFiRepeatIdentifierDescriptor : IEquatable<EdFiRepeatIdentifierDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiRepeatIdentifierDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiRepeatIdentifierDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiRepeatIdentifierDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="repeatIdentifierDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiRepeatIdentifierDescriptor(string id = default(string), int repeatIdentifierDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiRepeatIdentifierDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiRepeatIdentifierDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiRepeatIdentifierDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "repeatIdentifierDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RepeatIdentifierDescriptorId: ").Append(RepeatIdentifierDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiRepeatIdentifierDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiRepeatIdentifierDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiRepeatIdentifierDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiRepeatIdentifierDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.RepeatIdentifierDescriptorId == input.RepeatIdentifierDescriptorId ||
                    this.RepeatIdentifierDescriptorId.Equals(input.RepeatIdentifierDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.RepeatIdentifierDescriptorId.GetHashCode();
