...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_entryTypeDescriptor")]
    public partial class EdFiEntryTypeDescriptor : IEquatable<EdFiEntryTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiEntryTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiEntryTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiEntryTypeDescriptor" /> class.
        /// </summary>
        ...
        public EdFiEntryTypeDescriptor(string id = default(string), int entryTypeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiEntryTypeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiEntryTypeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiEntryTypeDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "entryTypeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  EntryTypeDescriptorId: ").Append(EntryTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiEntryTypeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiEntryTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiEntryTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiEntryTypeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.EntryTypeDescriptorId == input.EntryTypeDescriptorId ||
                    this.EntryTypeDescriptorId.Equals(input.EntryTypeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.EntryTypeDescriptorId.GetHashCode();
