...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_ancestryEthnicOriginDescriptor")]
    public partial class EdFiAncestryEthnicOriginDescriptor : IEquatable<EdFiAncestryEthnicOriginDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAncestryEthnicOriginDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiAncestryEthnicOriginDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAncestryEthnicOriginDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="ancestryEthnicOriginDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiAncestryEthnicOriginDescriptor(string id = default(string), int ancestryEthnicOriginDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiAncestryEthnicOriginDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiAncestryEthnicOriginDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiAncestryEthnicOriginDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.AncestryEthnicOriginDescriptorId = ancestryEthnicOriginDescriptorId;
        ...
        [DataMember(Name = "ancestryEthnicOriginDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiAncestryEthnicOriginDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  AncestryEthnicOriginDescriptorId: ").Append(AncestryEthnicOriginDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiAncestryEthnicOriginDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiAncestryEthnicOriginDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiAncestryEthnicOriginDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiAncestryEthnicOriginDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AncestryEthnicOriginDescriptorId == input.AncestryEthnicOriginDescriptorId ||
                    this.AncestryEthnicOriginDescriptorId.Equals(input.AncestryEthnicOriginDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.AncestryEthnicOriginDescriptorId.GetHashCode();
