...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_gradebookEntryKeyChange")]
    public partial class TrackedChangesEdFiGradebookEntryKeyChange : IEquatable<TrackedChangesEdFiGradebookEntryKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiGradebookEntryKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiGradebookEntryKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiGradebookEntryKey oldKeyValues = default(TrackedChangesEdFiGradebookEntryKey), TrackedChangesEdFiGradebookEntryKey newKeyValues = default(TrackedChangesEdFiGradebookEntryKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiGradebookEntryKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiGradebookEntryKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiGradebookEntryKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiGradebookEntryKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiGradebookEntryKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiGradebookEntryKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiGradebookEntryKeyChange input)
        {
            if (input == null)
            {
                return false;
