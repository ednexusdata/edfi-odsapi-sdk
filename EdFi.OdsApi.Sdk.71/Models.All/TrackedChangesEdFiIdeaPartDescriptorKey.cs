...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_ideaPartDescriptorKey")]
    public partial class TrackedChangesEdFiIdeaPartDescriptorKey : IEquatable<TrackedChangesEdFiIdeaPartDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiIdeaPartDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiIdeaPartDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiIdeaPartDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiIdeaPartDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiIdeaPartDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiIdeaPartDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiIdeaPartDescriptorKey input)
        {
            if (input == null)
            {
                return false;
