...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_educationOrganizationAssociationTypeDescriptor")]
    public partial class EdFiEducationOrganizationAssociationTypeDescriptor : IEquatable<EdFiEducationOrganizationAssociationTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiEducationOrganizationAssociationTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiEducationOrganizationAssociationTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiEducationOrganizationAssociationTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="educationOrganizationAssociationTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiEducationOrganizationAssociationTypeDescriptor(string id = default(string), int educationOrganizationAssociationTypeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiEducationOrganizationAssociationTypeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiEducationOrganizationAssociationTypeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiEducationOrganizationAssociationTypeDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.EducationOrganizationAssociationTypeDescriptorId = educationOrganizationAssociationTypeDescriptorId;
        ...
        [DataMember(Name = "educationOrganizationAssociationTypeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiEducationOrganizationAssociationTypeDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  EducationOrganizationAssociationTypeDescriptorId: ").Append(EducationOrganizationAssociationTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiEducationOrganizationAssociationTypeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiEducationOrganizationAssociationTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiEducationOrganizationAssociationTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiEducationOrganizationAssociationTypeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.EducationOrganizationAssociationTypeDescriptorId == input.EducationOrganizationAssociationTypeDescriptorId ||
                    this.EducationOrganizationAssociationTypeDescriptorId.Equals(input.EducationOrganizationAssociationTypeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.EducationOrganizationAssociationTypeDescriptorId.GetHashCode();
