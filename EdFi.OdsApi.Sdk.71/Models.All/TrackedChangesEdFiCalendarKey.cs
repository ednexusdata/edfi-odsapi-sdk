...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_calendarKey")]
    public partial class TrackedChangesEdFiCalendarKey : IEquatable<TrackedChangesEdFiCalendarKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiCalendarKey(string calendarCode = default(string), long schoolId = default(long), int schoolYear = default(int))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCalendarKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCalendarKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCalendarKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCalendarKey input)
        {
            if (input == null)
            {
                return false;
