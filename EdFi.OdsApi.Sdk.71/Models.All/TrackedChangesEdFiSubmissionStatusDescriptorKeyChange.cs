...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_submissionStatusDescriptorKeyChange")]
    public partial class TrackedChangesEdFiSubmissionStatusDescriptorKeyChange : IEquatable<TrackedChangesEdFiSubmissionStatusDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiSubmissionStatusDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiSubmissionStatusDescriptorKey oldKeyValues = default(TrackedChangesEdFiSubmissionStatusDescriptorKey), TrackedChangesEdFiSubmissionStatusDescriptorKey newKeyValues = default(TrackedChangesEdFiSubmissionStatusDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiSubmissionStatusDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiSubmissionStatusDescriptorKey NewKeyValues { get; set; }
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSubmissionStatusDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSubmissionStatusDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSubmissionStatusDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSubmissionStatusDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
