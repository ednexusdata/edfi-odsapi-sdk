...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_charterApprovalAgencyTypeDescriptor")]
    public partial class EdFiCharterApprovalAgencyTypeDescriptor : IEquatable<EdFiCharterApprovalAgencyTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCharterApprovalAgencyTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiCharterApprovalAgencyTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCharterApprovalAgencyTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="charterApprovalAgencyTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiCharterApprovalAgencyTypeDescriptor(string id = default(string), int charterApprovalAgencyTypeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiCharterApprovalAgencyTypeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiCharterApprovalAgencyTypeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiCharterApprovalAgencyTypeDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "charterApprovalAgencyTypeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CharterApprovalAgencyTypeDescriptorId: ").Append(CharterApprovalAgencyTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiCharterApprovalAgencyTypeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiCharterApprovalAgencyTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiCharterApprovalAgencyTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiCharterApprovalAgencyTypeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CharterApprovalAgencyTypeDescriptorId == input.CharterApprovalAgencyTypeDescriptorId ||
                    this.CharterApprovalAgencyTypeDescriptorId.Equals(input.CharterApprovalAgencyTypeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.CharterApprovalAgencyTypeDescriptorId.GetHashCode();
