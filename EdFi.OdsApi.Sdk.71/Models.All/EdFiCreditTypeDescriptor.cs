...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_creditTypeDescriptor")]
    public partial class EdFiCreditTypeDescriptor : IEquatable<EdFiCreditTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCreditTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiCreditTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCreditTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="creditTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        [DataMember(Name = "creditTypeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CreditTypeDescriptorId: ").Append(CreditTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiCreditTypeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiCreditTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiCreditTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiCreditTypeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CreditTypeDescriptorId == input.CreditTypeDescriptorId ||
                    this.CreditTypeDescriptorId.Equals(input.CreditTypeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.CreditTypeDescriptorId.GetHashCode();
