...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_indicatorLevelDescriptorDelete")]
    public partial class TrackedChangesEdFiIndicatorLevelDescriptorDelete : IEquatable<TrackedChangesEdFiIndicatorLevelDescriptorDelete>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiIndicatorLevelDescriptorDelete(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiIndicatorLevelDescriptorKey keyValues = default(TrackedChangesEdFiIndicatorLevelDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiIndicatorLevelDescriptorKey KeyValues { get; set; }
        ...
        {
            return this.Equals(input as TrackedChangesEdFiIndicatorLevelDescriptorDelete);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiIndicatorLevelDescriptorDelete instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiIndicatorLevelDescriptorDelete to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiIndicatorLevelDescriptorDelete input)
        {
            if (input == null)
            {
                return false;
