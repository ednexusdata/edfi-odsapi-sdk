...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_surveyLevelDescriptorKeyChange")]
    public partial class TrackedChangesEdFiSurveyLevelDescriptorKeyChange : IEquatable<TrackedChangesEdFiSurveyLevelDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiSurveyLevelDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiSurveyLevelDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiSurveyLevelDescriptorKey oldKeyValues = default(TrackedChangesEdFiSurveyLevelDescriptorKey), TrackedChangesEdFiSurveyLevelDescriptorKey newKeyValues = default(TrackedChangesEdFiSurveyLevelDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiSurveyLevelDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiSurveyLevelDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiSurveyLevelDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSurveyLevelDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSurveyLevelDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSurveyLevelDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSurveyLevelDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
