...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_gradePointAverageTypeDescriptor")]
    public partial class EdFiGradePointAverageTypeDescriptor : IEquatable<EdFiGradePointAverageTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiGradePointAverageTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiGradePointAverageTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiGradePointAverageTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="gradePointAverageTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiGradePointAverageTypeDescriptor(string id = default(string), int gradePointAverageTypeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiGradePointAverageTypeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiGradePointAverageTypeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiGradePointAverageTypeDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.GradePointAverageTypeDescriptorId = gradePointAverageTypeDescriptorId;
        ...
        [DataMember(Name = "gradePointAverageTypeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiGradePointAverageTypeDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  GradePointAverageTypeDescriptorId: ").Append(GradePointAverageTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiGradePointAverageTypeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiGradePointAverageTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiGradePointAverageTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiGradePointAverageTypeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.GradePointAverageTypeDescriptorId == input.GradePointAverageTypeDescriptorId ||
                    this.GradePointAverageTypeDescriptorId.Equals(input.GradePointAverageTypeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.GradePointAverageTypeDescriptorId.GetHashCode();
