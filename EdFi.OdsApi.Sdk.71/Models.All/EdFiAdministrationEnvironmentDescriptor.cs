...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_administrationEnvironmentDescriptor")]
    public partial class EdFiAdministrationEnvironmentDescriptor : IEquatable<EdFiAdministrationEnvironmentDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAdministrationEnvironmentDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiAdministrationEnvironmentDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAdministrationEnvironmentDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="administrationEnvironmentDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiAdministrationEnvironmentDescriptor(string id = default(string), int administrationEnvironmentDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiAdministrationEnvironmentDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiAdministrationEnvironmentDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiAdministrationEnvironmentDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "administrationEnvironmentDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AdministrationEnvironmentDescriptorId: ").Append(AdministrationEnvironmentDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiAdministrationEnvironmentDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiAdministrationEnvironmentDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiAdministrationEnvironmentDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiAdministrationEnvironmentDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AdministrationEnvironmentDescriptorId == input.AdministrationEnvironmentDescriptorId ||
                    this.AdministrationEnvironmentDescriptorId.Equals(input.AdministrationEnvironmentDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.AdministrationEnvironmentDescriptorId.GetHashCode();
