...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiStudentInterventionAttendanceEvent : IEquatable<EdFiStudentInterventionAttendanceEvent>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for InterventionDuration, must be a value less than or equal to 1440.", new [] { "InterventionDuration" });
            }

            // InterventionDuration (int?) minimum
            if (this.InterventionDuration < (int?)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for InterventionDuration, must be a value greater than or equal to 0.", new [] { "InterventionDuration" });
            }
