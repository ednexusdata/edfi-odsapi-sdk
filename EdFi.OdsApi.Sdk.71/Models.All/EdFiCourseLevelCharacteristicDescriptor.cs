...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiCourseLevelCharacteristicDescriptor : IEquatable<EdFiCourseLevelCharacteristicDescriptor>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="courseLevelCharacteristicDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiCourseLevelCharacteristicDescriptor(string id = default(string), int courseLevelCharacteristicDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            ...
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiCourseLevelCharacteristicDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "courseLevelCharacteristicDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CourseLevelCharacteristicDescriptorId: ").Append(CourseLevelCharacteristicDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiCourseLevelCharacteristicDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiCourseLevelCharacteristicDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiCourseLevelCharacteristicDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiCourseLevelCharacteristicDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CourseLevelCharacteristicDescriptorId == input.CourseLevelCharacteristicDescriptorId ||
                    this.CourseLevelCharacteristicDescriptorId.Equals(input.CourseLevelCharacteristicDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.CourseLevelCharacteristicDescriptorId.GetHashCode();
