...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiCalendarDateReference : IEquatable<EdFiCalendarDateReference>, IValidatableObject
    {
        ...
        public EdFiCalendarDateReference(string calendarCode = default(string), DateTime date = default(DateTime), long schoolId = default(long), int schoolYear = default(int), Link link = default(Link))
        {
