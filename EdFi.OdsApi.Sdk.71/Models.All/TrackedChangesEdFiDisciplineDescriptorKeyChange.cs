...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_disciplineDescriptorKeyChange")]
    public partial class TrackedChangesEdFiDisciplineDescriptorKeyChange : IEquatable<TrackedChangesEdFiDisciplineDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiDisciplineDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiDisciplineDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiDisciplineDescriptorKey oldKeyValues = default(TrackedChangesEdFiDisciplineDescriptorKey), TrackedChangesEdFiDisciplineDescriptorKey newKeyValues = default(TrackedChangesEdFiDisciplineDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiDisciplineDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiDisciplineDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiDisciplineDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiDisciplineDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiDisciplineDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiDisciplineDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiDisciplineDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
