...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiSurveyQuestionResponseChoice : IEquatable<EdFiSurveyQuestionResponseChoice>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NumericValue, must be a value less than or equal to 100.", new [] { "NumericValue" });
            }

            // NumericValue (int?) minimum
            if (this.NumericValue < (int?)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NumericValue, must be a value greater than or equal to 0.", new [] { "NumericValue" });
            }
            ...
            // TextValue (string) minLength
            if (this.TextValue != null && this.TextValue.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TextValue, length must be greater than 1.", new [] { "TextValue" });
            }
