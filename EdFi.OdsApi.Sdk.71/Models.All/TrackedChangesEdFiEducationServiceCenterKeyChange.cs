...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_educationServiceCenterKeyChange")]
    public partial class TrackedChangesEdFiEducationServiceCenterKeyChange : IEquatable<TrackedChangesEdFiEducationServiceCenterKeyChange>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiEducationServiceCenterKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiEducationServiceCenterKey oldKeyValues = default(TrackedChangesEdFiEducationServiceCenterKey), TrackedChangesEdFiEducationServiceCenterKey newKeyValues = default(TrackedChangesEdFiEducationServiceCenterKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiEducationServiceCenterKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiEducationServiceCenterKey NewKeyValues { get; set; }
        ...
        {
            return this.Equals(input as TrackedChangesEdFiEducationServiceCenterKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiEducationServiceCenterKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiEducationServiceCenterKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiEducationServiceCenterKeyChange input)
        {
            if (input == null)
            {
                return false;
