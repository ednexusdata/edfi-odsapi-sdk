...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_surveySectionResponseEducationOrganizationTargetAssociationKey")]
    public partial class TrackedChangesEdFiSurveySectionResponseEducationOrganizationTargetAssociationKey : IEquatable<TrackedChangesEdFiSurveySectionResponseEducationOrganizationTargetAssociationKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiSurveySectionResponseEducationOrganizationTargetAssociationKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiSurveySectionResponseEducationOrganizationTargetAssociationKey(long educationOrganizationId = default(long), string _namespace = default(string), string surveyIdentifier = default(string), string surveyResponseIdentifier = default(string), string surveySectionTitle = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiSurveySectionResponseEducationOrganizationTargetAssociationKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSurveySectionResponseEducationOrganizationTargetAssociationKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSurveySectionResponseEducationOrganizationTargetAssociationKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSurveySectionResponseEducationOrganizationTargetAssociationKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSurveySectionResponseEducationOrganizationTargetAssociationKey input)
        {
            if (input == null)
            {
                return false;
