...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_disciplineActionLengthDifferenceReasonDescriptorKey")]
    public partial class TrackedChangesEdFiDisciplineActionLengthDifferenceReasonDescriptorKey : IEquatable<TrackedChangesEdFiDisciplineActionLengthDifferenceReasonDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiDisciplineActionLengthDifferenceReasonDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiDisciplineActionLengthDifferenceReasonDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiDisciplineActionLengthDifferenceReasonDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiDisciplineActionLengthDifferenceReasonDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiDisciplineActionLengthDifferenceReasonDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiDisciplineActionLengthDifferenceReasonDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiDisciplineActionLengthDifferenceReasonDescriptorKey input)
        {
            if (input == null)
            {
                return false;
