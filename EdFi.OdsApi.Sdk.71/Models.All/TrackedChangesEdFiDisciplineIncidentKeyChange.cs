...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_disciplineIncidentKeyChange")]
    public partial class TrackedChangesEdFiDisciplineIncidentKeyChange : IEquatable<TrackedChangesEdFiDisciplineIncidentKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiDisciplineIncidentKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiDisciplineIncidentKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiDisciplineIncidentKey oldKeyValues = default(TrackedChangesEdFiDisciplineIncidentKey), TrackedChangesEdFiDisciplineIncidentKey newKeyValues = default(TrackedChangesEdFiDisciplineIncidentKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiDisciplineIncidentKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiDisciplineIncidentKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiDisciplineIncidentKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiDisciplineIncidentKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiDisciplineIncidentKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiDisciplineIncidentKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiDisciplineIncidentKeyChange input)
        {
            if (input == null)
            {
                return false;
