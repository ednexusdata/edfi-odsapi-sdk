...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_administrativeFundingControlDescriptor")]
    public partial class EdFiAdministrativeFundingControlDescriptor : IEquatable<EdFiAdministrativeFundingControlDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAdministrativeFundingControlDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiAdministrativeFundingControlDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAdministrativeFundingControlDescriptor" /> class.
        /// </summary>
        ...
        public EdFiAdministrativeFundingControlDescriptor(string id = default(string), int administrativeFundingControlDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiAdministrativeFundingControlDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiAdministrativeFundingControlDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiAdministrativeFundingControlDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "administrativeFundingControlDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AdministrativeFundingControlDescriptorId: ").Append(AdministrativeFundingControlDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiAdministrativeFundingControlDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiAdministrativeFundingControlDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiAdministrativeFundingControlDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiAdministrativeFundingControlDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AdministrativeFundingControlDescriptorId == input.AdministrativeFundingControlDescriptorId ||
                    this.AdministrativeFundingControlDescriptorId.Equals(input.AdministrativeFundingControlDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.AdministrativeFundingControlDescriptorId.GetHashCode();
