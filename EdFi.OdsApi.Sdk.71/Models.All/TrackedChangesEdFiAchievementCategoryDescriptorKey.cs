...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_achievementCategoryDescriptorKey")]
    public partial class TrackedChangesEdFiAchievementCategoryDescriptorKey : IEquatable<TrackedChangesEdFiAchievementCategoryDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiAchievementCategoryDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiAchievementCategoryDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiAchievementCategoryDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiAchievementCategoryDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiAchievementCategoryDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiAchievementCategoryDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiAchievementCategoryDescriptorKey input)
        {
            if (input == null)
            {
                return false;
