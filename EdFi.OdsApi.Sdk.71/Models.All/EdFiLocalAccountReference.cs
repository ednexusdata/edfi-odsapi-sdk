...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiLocalAccountReference : IEquatable<EdFiLocalAccountReference>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiLocalAccountReference(string accountIdentifier = default(string), long educationOrganizationId = default(long), int fiscalYear = default(int), Link link = default(Link))
        {
        ...
        {
            return this.Equals(input as EdFiLocalAccountReference);
        }

        /// <summary>
        /// Returns true if EdFiLocalAccountReference instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiLocalAccountReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiLocalAccountReference input)
        {
            if (input == null)
            {
                return false;
