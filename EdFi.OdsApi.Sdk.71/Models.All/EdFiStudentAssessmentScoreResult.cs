...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiStudentAssessmentScoreResult : IEquatable<EdFiStudentAssessmentScoreResult>, IValidatableObject
    {
        ...
        public EdFiStudentAssessmentScoreResult(string assessmentReportingMethodDescriptor = default(string), string resultDatatypeTypeDescriptor = default(string), string result = default(string))
        {
            ...
            {
                throw new ArgumentNullException("assessmentReportingMethodDescriptor is a required property for EdFiStudentAssessmentScoreResult and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("resultDatatypeTypeDescriptor is a required property for EdFiStudentAssessmentScoreResult and cannot be null");
            }
            this.ResultDatatypeTypeDescriptor = resultDatatypeTypeDescriptor;
            // to ensure "result" is required (not null)
            if (result == null)
            {
                throw new ArgumentNullException("result is a required property for EdFiStudentAssessmentScoreResult and cannot be null");
            }
            this.Result = result;
        }
