...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_courseLevelCharacteristicDescriptorKey")]
    public partial class TrackedChangesEdFiCourseLevelCharacteristicDescriptorKey : IEquatable<TrackedChangesEdFiCourseLevelCharacteristicDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCourseLevelCharacteristicDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCourseLevelCharacteristicDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCourseLevelCharacteristicDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCourseLevelCharacteristicDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCourseLevelCharacteristicDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCourseLevelCharacteristicDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCourseLevelCharacteristicDescriptorKey input)
        {
            if (input == null)
            {
                return false;
