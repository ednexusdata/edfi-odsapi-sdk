...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_studentCohortAssociationKey")]
    public partial class TrackedChangesEdFiStudentCohortAssociationKey : IEquatable<TrackedChangesEdFiStudentCohortAssociationKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiStudentCohortAssociationKey(DateTime beginDate = default(DateTime), string cohortIdentifier = default(string), long educationOrganizationId = default(long), string studentUniqueId = default(string))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStudentCohortAssociationKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStudentCohortAssociationKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStudentCohortAssociationKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStudentCohortAssociationKey input)
        {
            if (input == null)
            {
                return false;
