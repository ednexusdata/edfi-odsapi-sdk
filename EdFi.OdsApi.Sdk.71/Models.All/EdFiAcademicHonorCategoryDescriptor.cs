...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_academicHonorCategoryDescriptor")]
    public partial class EdFiAcademicHonorCategoryDescriptor : IEquatable<EdFiAcademicHonorCategoryDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAcademicHonorCategoryDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiAcademicHonorCategoryDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAcademicHonorCategoryDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="academicHonorCategoryDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiAcademicHonorCategoryDescriptor(string id = default(string), int academicHonorCategoryDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiAcademicHonorCategoryDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiAcademicHonorCategoryDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiAcademicHonorCategoryDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "academicHonorCategoryDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AcademicHonorCategoryDescriptorId: ").Append(AcademicHonorCategoryDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiAcademicHonorCategoryDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiAcademicHonorCategoryDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiAcademicHonorCategoryDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiAcademicHonorCategoryDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AcademicHonorCategoryDescriptorId == input.AcademicHonorCategoryDescriptorId ||
                    this.AcademicHonorCategoryDescriptorId.Equals(input.AcademicHonorCategoryDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.AcademicHonorCategoryDescriptorId.GetHashCode();
