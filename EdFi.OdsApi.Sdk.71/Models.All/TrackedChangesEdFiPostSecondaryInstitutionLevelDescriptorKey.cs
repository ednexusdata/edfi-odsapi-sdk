...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_postSecondaryInstitutionLevelDescriptorKey")]
    public partial class TrackedChangesEdFiPostSecondaryInstitutionLevelDescriptorKey : IEquatable<TrackedChangesEdFiPostSecondaryInstitutionLevelDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiPostSecondaryInstitutionLevelDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiPostSecondaryInstitutionLevelDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiPostSecondaryInstitutionLevelDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiPostSecondaryInstitutionLevelDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiPostSecondaryInstitutionLevelDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiPostSecondaryInstitutionLevelDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiPostSecondaryInstitutionLevelDescriptorKey input)
        {
            if (input == null)
            {
                return false;
