...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_studentParticipationCodeDescriptor")]
    public partial class EdFiStudentParticipationCodeDescriptor : IEquatable<EdFiStudentParticipationCodeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentParticipationCodeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiStudentParticipationCodeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentParticipationCodeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="studentParticipationCodeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiStudentParticipationCodeDescriptor(string id = default(string), int studentParticipationCodeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiStudentParticipationCodeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiStudentParticipationCodeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiStudentParticipationCodeDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "studentParticipationCodeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  StudentParticipationCodeDescriptorId: ").Append(StudentParticipationCodeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiStudentParticipationCodeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiStudentParticipationCodeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStudentParticipationCodeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStudentParticipationCodeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.StudentParticipationCodeDescriptorId == input.StudentParticipationCodeDescriptorId ||
                    this.StudentParticipationCodeDescriptorId.Equals(input.StudentParticipationCodeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.StudentParticipationCodeDescriptorId.GetHashCode();
