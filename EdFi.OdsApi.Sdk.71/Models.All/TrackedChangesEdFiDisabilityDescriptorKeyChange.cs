...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_disabilityDescriptorKeyChange")]
    public partial class TrackedChangesEdFiDisabilityDescriptorKeyChange : IEquatable<TrackedChangesEdFiDisabilityDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiDisabilityDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiDisabilityDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiDisabilityDescriptorKey oldKeyValues = default(TrackedChangesEdFiDisabilityDescriptorKey), TrackedChangesEdFiDisabilityDescriptorKey newKeyValues = default(TrackedChangesEdFiDisabilityDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiDisabilityDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiDisabilityDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiDisabilityDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiDisabilityDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiDisabilityDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiDisabilityDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiDisabilityDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
