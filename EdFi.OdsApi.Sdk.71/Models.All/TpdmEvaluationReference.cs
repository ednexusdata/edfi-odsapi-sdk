...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TpdmEvaluationReference : IEquatable<TpdmEvaluationReference>, IValidatableObject
    {
        ...
        public TpdmEvaluationReference(long educationOrganizationId = default(long), string evaluationPeriodDescriptor = default(string), string evaluationTitle = default(string), string performanceEvaluationTitle = default(string), string performanceEvaluationTypeDescriptor = default(string), int schoolYear = default(int), string termDescriptor = default(string), Link link = default(Link))
        {
            ...
            {
                throw new ArgumentNullException("evaluationTitle is a required property for TpdmEvaluationReference and cannot be null");
            }
            this.EvaluationTitle = evaluationTitle;
            // to ensure "performanceEvaluationTitle" is required (not null)
            if (performanceEvaluationTitle == null)
            {
                throw new ArgumentNullException("performanceEvaluationTitle is a required property for TpdmEvaluationReference and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("performanceEvaluationTypeDescriptor is a required property for TpdmEvaluationReference and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("termDescriptor is a required property for TpdmEvaluationReference and cannot be null");
            }
