...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TrackedChangesEdFiStaffSectionAssociationKey : IEquatable<TrackedChangesEdFiStaffSectionAssociationKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiStaffSectionAssociationKey(string localCourseCode = default(string), long schoolId = default(long), int schoolYear = default(int), string sectionIdentifier = default(string), string sessionName = default(string), string staffUniqueId = default(string))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStaffSectionAssociationKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStaffSectionAssociationKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStaffSectionAssociationKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStaffSectionAssociationKey input)
        {
            if (input == null)
            {
                return false;
