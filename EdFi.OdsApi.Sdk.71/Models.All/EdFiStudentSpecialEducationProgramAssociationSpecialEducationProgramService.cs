...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiStudentSpecialEducationProgramAssociationSpecialEducationProgramService : IEquatable<EdFiStudentSpecialEducationProgramAssociationSpecialEducationProgramService>, IValidatableObject
    {
        ...
        public EdFiStudentSpecialEducationProgramAssociationSpecialEducationProgramService(string specialEducationProgramServiceDescriptor = default(string), bool? primaryIndicator = default(bool?), DateTime? serviceBeginDate = default(DateTime?), DateTime? serviceEndDate = default(DateTime?), List<EdFiStudentSpecialEducationProgramAssociationSpecialEducationProgramServiceProvider> providers = default(List<EdFiStudentSpecialEducationProgramAssociationSpecialEducationProgramServiceProvider>))
        {
            ...
            {
                throw new ArgumentNullException("specialEducationProgramServiceDescriptor is a required property for EdFiStudentSpecialEducationProgramAssociationSpecialEducationProgramService and cannot be null");
            }
        ...
        [DataMember(Name = "specialEducationProgramServiceDescriptor", IsRequired = true, EmitDefaultValue = true)]
