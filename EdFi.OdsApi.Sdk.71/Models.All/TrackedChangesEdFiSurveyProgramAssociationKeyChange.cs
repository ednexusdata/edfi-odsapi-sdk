...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_surveyProgramAssociationKeyChange")]
    public partial class TrackedChangesEdFiSurveyProgramAssociationKeyChange : IEquatable<TrackedChangesEdFiSurveyProgramAssociationKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiSurveyProgramAssociationKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiSurveyProgramAssociationKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiSurveyProgramAssociationKey oldKeyValues = default(TrackedChangesEdFiSurveyProgramAssociationKey), TrackedChangesEdFiSurveyProgramAssociationKey newKeyValues = default(TrackedChangesEdFiSurveyProgramAssociationKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiSurveyProgramAssociationKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiSurveyProgramAssociationKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiSurveyProgramAssociationKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSurveyProgramAssociationKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSurveyProgramAssociationKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSurveyProgramAssociationKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSurveyProgramAssociationKeyChange input)
        {
            if (input == null)
            {
                return false;
