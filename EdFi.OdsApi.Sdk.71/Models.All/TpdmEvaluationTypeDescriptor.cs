...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "tpdm_evaluationTypeDescriptor")]
    public partial class TpdmEvaluationTypeDescriptor : IEquatable<TpdmEvaluationTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmEvaluationTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmEvaluationTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmEvaluationTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="evaluationTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public TpdmEvaluationTypeDescriptor(string id = default(string), int evaluationTypeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for TpdmEvaluationTypeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for TpdmEvaluationTypeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for TpdmEvaluationTypeDescriptor and cannot be null");
            }
            this.ShortDescription = shortDescription;
            this.Id = id;
            this.EvaluationTypeDescriptorId = evaluationTypeDescriptorId;
        ...
        [DataMember(Name = "evaluationTypeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmEvaluationTypeDescriptor {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  EvaluationTypeDescriptorId: ").Append(EvaluationTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as TpdmEvaluationTypeDescriptor);
        }

        /// <summary>
        /// Returns true if TpdmEvaluationTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmEvaluationTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmEvaluationTypeDescriptor input)
        {
            if (input == null)
            {
                return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.EvaluationTypeDescriptorId.GetHashCode();
