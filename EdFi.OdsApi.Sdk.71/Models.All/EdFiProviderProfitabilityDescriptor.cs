...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_providerProfitabilityDescriptor")]
    public partial class EdFiProviderProfitabilityDescriptor : IEquatable<EdFiProviderProfitabilityDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiProviderProfitabilityDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiProviderProfitabilityDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiProviderProfitabilityDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="providerProfitabilityDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiProviderProfitabilityDescriptor(string id = default(string), int providerProfitabilityDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiProviderProfitabilityDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiProviderProfitabilityDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiProviderProfitabilityDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "providerProfitabilityDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ProviderProfitabilityDescriptorId: ").Append(ProviderProfitabilityDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiProviderProfitabilityDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiProviderProfitabilityDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiProviderProfitabilityDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiProviderProfitabilityDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ProviderProfitabilityDescriptorId == input.ProviderProfitabilityDescriptorId ||
                    this.ProviderProfitabilityDescriptorId.Equals(input.ProviderProfitabilityDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ProviderProfitabilityDescriptorId.GetHashCode();
