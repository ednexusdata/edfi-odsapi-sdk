...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_communityProviderKeyChange")]
    public partial class TrackedChangesEdFiCommunityProviderKeyChange : IEquatable<TrackedChangesEdFiCommunityProviderKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCommunityProviderKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCommunityProviderKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiCommunityProviderKey oldKeyValues = default(TrackedChangesEdFiCommunityProviderKey), TrackedChangesEdFiCommunityProviderKey newKeyValues = default(TrackedChangesEdFiCommunityProviderKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiCommunityProviderKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiCommunityProviderKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCommunityProviderKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCommunityProviderKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCommunityProviderKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCommunityProviderKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCommunityProviderKeyChange input)
        {
            if (input == null)
            {
                return false;
