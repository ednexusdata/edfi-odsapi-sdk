...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_interventionStudyKeyChange")]
    public partial class TrackedChangesEdFiInterventionStudyKeyChange : IEquatable<TrackedChangesEdFiInterventionStudyKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiInterventionStudyKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiInterventionStudyKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiInterventionStudyKey oldKeyValues = default(TrackedChangesEdFiInterventionStudyKey), TrackedChangesEdFiInterventionStudyKey newKeyValues = default(TrackedChangesEdFiInterventionStudyKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiInterventionStudyKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiInterventionStudyKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiInterventionStudyKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiInterventionStudyKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiInterventionStudyKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiInterventionStudyKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiInterventionStudyKeyChange input)
        {
            if (input == null)
            {
                return false;
