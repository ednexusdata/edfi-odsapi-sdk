...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_calendarTypeDescriptorKeyChange")]
    public partial class TrackedChangesEdFiCalendarTypeDescriptorKeyChange : IEquatable<TrackedChangesEdFiCalendarTypeDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCalendarTypeDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCalendarTypeDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiCalendarTypeDescriptorKey oldKeyValues = default(TrackedChangesEdFiCalendarTypeDescriptorKey), TrackedChangesEdFiCalendarTypeDescriptorKey newKeyValues = default(TrackedChangesEdFiCalendarTypeDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiCalendarTypeDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiCalendarTypeDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCalendarTypeDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCalendarTypeDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCalendarTypeDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCalendarTypeDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCalendarTypeDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
