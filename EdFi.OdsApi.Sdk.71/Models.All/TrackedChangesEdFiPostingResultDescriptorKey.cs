...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_postingResultDescriptorKey")]
    public partial class TrackedChangesEdFiPostingResultDescriptorKey : IEquatable<TrackedChangesEdFiPostingResultDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiPostingResultDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiPostingResultDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiPostingResultDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiPostingResultDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiPostingResultDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiPostingResultDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiPostingResultDescriptorKey input)
        {
            if (input == null)
            {
                return false;
