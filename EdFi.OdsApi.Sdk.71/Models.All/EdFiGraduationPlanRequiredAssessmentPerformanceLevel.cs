...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiGraduationPlanRequiredAssessmentPerformanceLevel : IEquatable<EdFiGraduationPlanRequiredAssessmentPerformanceLevel>, IValidatableObject
    {
        ...
        public EdFiGraduationPlanRequiredAssessmentPerformanceLevel(string assessmentReportingMethodDescriptor = default(string), string performanceLevelDescriptor = default(string), string resultDatatypeTypeDescriptor = default(string), string maximumScore = default(string), string minimumScore = default(string), string performanceLevelIndicatorName = default(string))
        {
            // to ensure "assessmentReportingMethodDescriptor" is required (not null)
            if (assessmentReportingMethodDescriptor == null)
            {
                throw new ArgumentNullException("assessmentReportingMethodDescriptor is a required property for EdFiGraduationPlanRequiredAssessmentPerformanceLevel and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("performanceLevelDescriptor is a required property for EdFiGraduationPlanRequiredAssessmentPerformanceLevel and cannot be null");
            }
        ...
        public bool Equals(EdFiGraduationPlanRequiredAssessmentPerformanceLevel input)
        {
            ...
            return 
                ...
                (
                    this.PerformanceLevelIndicatorName == input.PerformanceLevelIndicatorName ||
                    (this.PerformanceLevelIndicatorName != null &&
                    this.PerformanceLevelIndicatorName.Equals(input.PerformanceLevelIndicatorName))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.PerformanceLevelIndicatorName.GetHashCode();
                }
                return hashCode;
            }
        }
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PerformanceLevelIndicatorName, length must be less than 60.", new [] { "PerformanceLevelIndicatorName" });
            }

            // PerformanceLevelIndicatorName (string) minLength
            if (this.PerformanceLevelIndicatorName != null && this.PerformanceLevelIndicatorName.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PerformanceLevelIndicatorName, length must be greater than 1.", new [] { "PerformanceLevelIndicatorName" });
            }
