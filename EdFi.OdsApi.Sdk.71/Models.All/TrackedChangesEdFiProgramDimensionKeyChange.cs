...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_programDimensionKeyChange")]
    public partial class TrackedChangesEdFiProgramDimensionKeyChange : IEquatable<TrackedChangesEdFiProgramDimensionKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiProgramDimensionKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiProgramDimensionKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiProgramDimensionKey oldKeyValues = default(TrackedChangesEdFiProgramDimensionKey), TrackedChangesEdFiProgramDimensionKey newKeyValues = default(TrackedChangesEdFiProgramDimensionKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiProgramDimensionKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiProgramDimensionKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiProgramDimensionKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiProgramDimensionKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiProgramDimensionKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiProgramDimensionKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiProgramDimensionKeyChange input)
        {
            if (input == null)
            {
                return false;
