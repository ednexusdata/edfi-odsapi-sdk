...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_postSecondaryInstitutionKeyChange")]
    public partial class TrackedChangesEdFiPostSecondaryInstitutionKeyChange : IEquatable<TrackedChangesEdFiPostSecondaryInstitutionKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiPostSecondaryInstitutionKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiPostSecondaryInstitutionKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiPostSecondaryInstitutionKey oldKeyValues = default(TrackedChangesEdFiPostSecondaryInstitutionKey), TrackedChangesEdFiPostSecondaryInstitutionKey newKeyValues = default(TrackedChangesEdFiPostSecondaryInstitutionKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiPostSecondaryInstitutionKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiPostSecondaryInstitutionKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiPostSecondaryInstitutionKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiPostSecondaryInstitutionKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiPostSecondaryInstitutionKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiPostSecondaryInstitutionKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiPostSecondaryInstitutionKeyChange input)
        {
            if (input == null)
            {
                return false;
