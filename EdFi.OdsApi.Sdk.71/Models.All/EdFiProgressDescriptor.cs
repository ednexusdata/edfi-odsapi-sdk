...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_progressDescriptor")]
    public partial class EdFiProgressDescriptor : IEquatable<EdFiProgressDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiProgressDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiProgressDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiProgressDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="progressDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiProgressDescriptor(string id = default(string), int progressDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiProgressDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiProgressDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiProgressDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "progressDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ProgressDescriptorId: ").Append(ProgressDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiProgressDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiProgressDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiProgressDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiProgressDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ProgressDescriptorId == input.ProgressDescriptorId ||
                    this.ProgressDescriptorId.Equals(input.ProgressDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ProgressDescriptorId.GetHashCode();
