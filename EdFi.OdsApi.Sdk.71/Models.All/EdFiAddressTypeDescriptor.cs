...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_addressTypeDescriptor")]
    public partial class EdFiAddressTypeDescriptor : IEquatable<EdFiAddressTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAddressTypeDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiAddressTypeDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAddressTypeDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="addressTypeDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiAddressTypeDescriptor(string id = default(string), int addressTypeDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiAddressTypeDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiAddressTypeDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiAddressTypeDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "addressTypeDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AddressTypeDescriptorId: ").Append(AddressTypeDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiAddressTypeDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiAddressTypeDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiAddressTypeDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiAddressTypeDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AddressTypeDescriptorId == input.AddressTypeDescriptorId ||
                    this.AddressTypeDescriptorId.Equals(input.AddressTypeDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.AddressTypeDescriptorId.GetHashCode();
