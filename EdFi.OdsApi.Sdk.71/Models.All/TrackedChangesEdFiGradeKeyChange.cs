...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_gradeKeyChange")]
    public partial class TrackedChangesEdFiGradeKeyChange : IEquatable<TrackedChangesEdFiGradeKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiGradeKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiGradeKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiGradeKey oldKeyValues = default(TrackedChangesEdFiGradeKey), TrackedChangesEdFiGradeKey newKeyValues = default(TrackedChangesEdFiGradeKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiGradeKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiGradeKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiGradeKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiGradeKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiGradeKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiGradeKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiGradeKeyChange input)
        {
            if (input == null)
            {
                return false;
