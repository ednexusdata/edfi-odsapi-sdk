...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_deliveryMethodDescriptorKeyChange")]
    public partial class TrackedChangesEdFiDeliveryMethodDescriptorKeyChange : IEquatable<TrackedChangesEdFiDeliveryMethodDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiDeliveryMethodDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiDeliveryMethodDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiDeliveryMethodDescriptorKey oldKeyValues = default(TrackedChangesEdFiDeliveryMethodDescriptorKey), TrackedChangesEdFiDeliveryMethodDescriptorKey newKeyValues = default(TrackedChangesEdFiDeliveryMethodDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiDeliveryMethodDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiDeliveryMethodDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiDeliveryMethodDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiDeliveryMethodDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiDeliveryMethodDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiDeliveryMethodDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiDeliveryMethodDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
