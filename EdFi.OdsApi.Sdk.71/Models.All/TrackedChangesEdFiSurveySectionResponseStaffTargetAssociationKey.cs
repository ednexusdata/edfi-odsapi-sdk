...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_surveySectionResponseStaffTargetAssociationKey")]
    public partial class TrackedChangesEdFiSurveySectionResponseStaffTargetAssociationKey : IEquatable<TrackedChangesEdFiSurveySectionResponseStaffTargetAssociationKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiSurveySectionResponseStaffTargetAssociationKey(string staffUniqueId = default(string), string _namespace = default(string), string surveyIdentifier = default(string), string surveyResponseIdentifier = default(string), string surveySectionTitle = default(string))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSurveySectionResponseStaffTargetAssociationKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSurveySectionResponseStaffTargetAssociationKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSurveySectionResponseStaffTargetAssociationKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSurveySectionResponseStaffTargetAssociationKey input)
        {
            if (input == null)
            {
                return false;
