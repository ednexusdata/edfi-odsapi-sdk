...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_mediumOfInstructionDescriptorKey")]
    public partial class TrackedChangesEdFiMediumOfInstructionDescriptorKey : IEquatable<TrackedChangesEdFiMediumOfInstructionDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiMediumOfInstructionDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiMediumOfInstructionDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiMediumOfInstructionDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiMediumOfInstructionDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiMediumOfInstructionDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiMediumOfInstructionDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiMediumOfInstructionDescriptorKey input)
        {
            if (input == null)
            {
                return false;
