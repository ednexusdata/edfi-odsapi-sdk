...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_academicWeekKeyChange")]
    public partial class TrackedChangesEdFiAcademicWeekKeyChange : IEquatable<TrackedChangesEdFiAcademicWeekKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiAcademicWeekKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiAcademicWeekKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiAcademicWeekKey oldKeyValues = default(TrackedChangesEdFiAcademicWeekKey), TrackedChangesEdFiAcademicWeekKey newKeyValues = default(TrackedChangesEdFiAcademicWeekKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiAcademicWeekKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiAcademicWeekKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiAcademicWeekKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiAcademicWeekKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiAcademicWeekKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiAcademicWeekKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiAcademicWeekKeyChange input)
        {
            if (input == null)
            {
                return false;
