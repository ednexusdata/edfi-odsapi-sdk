...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiAssessmentItemPossibleResponse : IEquatable<EdFiAssessmentItemPossibleResponse>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // ResponseValue (string) minLength
            if (this.ResponseValue != null && this.ResponseValue.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ResponseValue, length must be greater than 1.", new [] { "ResponseValue" });
            }
            ...
            // ResponseDescription (string) minLength
            if (this.ResponseDescription != null && this.ResponseDescription.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ResponseDescription, length must be greater than 1.", new [] { "ResponseDescription" });
            }
