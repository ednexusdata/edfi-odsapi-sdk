...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_retestIndicatorDescriptor")]
    public partial class EdFiRetestIndicatorDescriptor : IEquatable<EdFiRetestIndicatorDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiRetestIndicatorDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiRetestIndicatorDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiRetestIndicatorDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="retestIndicatorDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiRetestIndicatorDescriptor(string id = default(string), int retestIndicatorDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiRetestIndicatorDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiRetestIndicatorDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiRetestIndicatorDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "retestIndicatorDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RetestIndicatorDescriptorId: ").Append(RetestIndicatorDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiRetestIndicatorDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiRetestIndicatorDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiRetestIndicatorDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiRetestIndicatorDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.RetestIndicatorDescriptorId == input.RetestIndicatorDescriptorId ||
                    this.RetestIndicatorDescriptorId.Equals(input.RetestIndicatorDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.RetestIndicatorDescriptorId.GetHashCode();
