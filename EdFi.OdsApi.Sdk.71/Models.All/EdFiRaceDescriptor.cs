...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// EdFiRaceDescriptor
    /// </summary>
    [DataContract(Name = "edFi_raceDescriptor")]
    public partial class EdFiRaceDescriptor : IEquatable<EdFiRaceDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiRaceDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiRaceDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiRaceDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="raceDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiRaceDescriptor(string id = default(string), int raceDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiRaceDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiRaceDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiRaceDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "raceDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RaceDescriptorId: ").Append(RaceDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiRaceDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiRaceDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiRaceDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiRaceDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.RaceDescriptorId == input.RaceDescriptorId ||
                    this.RaceDescriptorId.Equals(input.RaceDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.RaceDescriptorId.GetHashCode();
