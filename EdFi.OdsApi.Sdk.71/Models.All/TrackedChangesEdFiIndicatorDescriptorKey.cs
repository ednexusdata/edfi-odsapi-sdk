...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_indicatorDescriptorKey")]
    public partial class TrackedChangesEdFiIndicatorDescriptorKey : IEquatable<TrackedChangesEdFiIndicatorDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiIndicatorDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiIndicatorDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiIndicatorDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiIndicatorDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiIndicatorDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiIndicatorDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiIndicatorDescriptorKey input)
        {
            if (input == null)
            {
                return false;
