...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_communityOrganizationKey")]
    public partial class TrackedChangesEdFiCommunityOrganizationKey : IEquatable<TrackedChangesEdFiCommunityOrganizationKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCommunityOrganizationKey" /> class.
        /// </summary>
        /// <param name="communityOrganizationId">The identifier assigned to a community organization..</param>
        public TrackedChangesEdFiCommunityOrganizationKey(long communityOrganizationId = default(long))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCommunityOrganizationKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCommunityOrganizationKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCommunityOrganizationKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCommunityOrganizationKey input)
        {
            if (input == null)
            {
                return false;
