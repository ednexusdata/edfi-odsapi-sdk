...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiCourse : IEquatable<EdFiCourse>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // CourseDescription (string) minLength
            if (this.CourseDescription != null && this.CourseDescription.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CourseDescription, length must be greater than 1.", new [] { "CourseDescription" });
            }
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for MaxCompletionsForCredit, must be a value greater than or equal to 1.", new [] { "MaxCompletionsForCredit" });
            }

            // MaximumAvailableCredits (double?) minimum
            if (this.MaximumAvailableCredits < (double?)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for MaximumAvailableCredits, must be a value greater than or equal to 0.", new [] { "MaximumAvailableCredits" });
            }
            ...
            if (this.MinimumAvailableCredits < (double?)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for MinimumAvailableCredits, must be a value greater than or equal to 0.", new [] { "MinimumAvailableCredits" });
            }
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NumberOfParts, must be a value less than or equal to 8.", new [] { "NumberOfParts" });
            }

            // NumberOfParts (int) minimum
            if (this.NumberOfParts < (int)1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NumberOfParts, must be a value greater than or equal to 1.", new [] { "NumberOfParts" });
            }

            // TimeRequiredForCompletion (int?) minimum
            if (this.TimeRequiredForCompletion < (int?)1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TimeRequiredForCompletion, must be a value greater than or equal to 1.", new [] { "TimeRequiredForCompletion" });
            }
