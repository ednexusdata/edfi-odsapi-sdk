...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiStudentSectionAttendanceEvent : IEquatable<EdFiStudentSectionAttendanceEvent>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SectionAttendanceDuration, must be a value less than or equal to 1440.", new [] { "SectionAttendanceDuration" });
            }

            // SectionAttendanceDuration (int?) minimum
            if (this.SectionAttendanceDuration < (int?)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SectionAttendanceDuration, must be a value greater than or equal to 0.", new [] { "SectionAttendanceDuration" });
            }
