...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiSectionCharacteristicDescriptor : IEquatable<EdFiSectionCharacteristicDescriptor>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiSectionCharacteristicDescriptor(string id = default(string), int sectionCharacteristicDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            ...
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiSectionCharacteristicDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "sectionCharacteristicDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SectionCharacteristicDescriptorId: ").Append(SectionCharacteristicDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiSectionCharacteristicDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiSectionCharacteristicDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiSectionCharacteristicDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiSectionCharacteristicDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.SectionCharacteristicDescriptorId == input.SectionCharacteristicDescriptorId ||
                    this.SectionCharacteristicDescriptorId.Equals(input.SectionCharacteristicDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.SectionCharacteristicDescriptorId.GetHashCode();
