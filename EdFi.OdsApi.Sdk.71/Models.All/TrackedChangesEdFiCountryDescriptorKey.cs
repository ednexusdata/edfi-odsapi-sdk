...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_countryDescriptorKey")]
    public partial class TrackedChangesEdFiCountryDescriptorKey : IEquatable<TrackedChangesEdFiCountryDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCountryDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCountryDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCountryDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCountryDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCountryDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCountryDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCountryDescriptorKey input)
        {
            if (input == null)
            {
                return false;
