...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_neglectedOrDelinquentProgramDescriptor")]
    public partial class EdFiNeglectedOrDelinquentProgramDescriptor : IEquatable<EdFiNeglectedOrDelinquentProgramDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiNeglectedOrDelinquentProgramDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiNeglectedOrDelinquentProgramDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiNeglectedOrDelinquentProgramDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="neglectedOrDelinquentProgramDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiNeglectedOrDelinquentProgramDescriptor(string id = default(string), int neglectedOrDelinquentProgramDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiNeglectedOrDelinquentProgramDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiNeglectedOrDelinquentProgramDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiNeglectedOrDelinquentProgramDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "neglectedOrDelinquentProgramDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  NeglectedOrDelinquentProgramDescriptorId: ").Append(NeglectedOrDelinquentProgramDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiNeglectedOrDelinquentProgramDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiNeglectedOrDelinquentProgramDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiNeglectedOrDelinquentProgramDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiNeglectedOrDelinquentProgramDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.NeglectedOrDelinquentProgramDescriptorId == input.NeglectedOrDelinquentProgramDescriptorId ||
                    this.NeglectedOrDelinquentProgramDescriptorId.Equals(input.NeglectedOrDelinquentProgramDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.NeglectedOrDelinquentProgramDescriptorId.GetHashCode();
