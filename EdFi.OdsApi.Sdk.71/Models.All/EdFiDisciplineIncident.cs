...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiDisciplineIncident : IEquatable<EdFiDisciplineIncident>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // CaseNumber (string) minLength
            if (this.CaseNumber != null && this.CaseNumber.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CaseNumber, length must be greater than 1.", new [] { "CaseNumber" });
            }
            ...
            // IncidentDescription (string) minLength
            if (this.IncidentDescription != null && this.IncidentDescription.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for IncidentDescription, length must be greater than 1.", new [] { "IncidentDescription" });
            }
            ...
            // ReporterName (string) minLength
            if (this.ReporterName != null && this.ReporterName.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ReporterName, length must be greater than 1.", new [] { "ReporterName" });
            }
