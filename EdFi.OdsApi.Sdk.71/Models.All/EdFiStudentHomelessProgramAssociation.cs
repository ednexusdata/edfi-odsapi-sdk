...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiStudentHomelessProgramAssociation : IEquatable<EdFiStudentHomelessProgramAssociation>, IValidatableObject
    {
        ...
        public EdFiStudentHomelessProgramAssociation(string id = default(string), DateTime beginDate = default(DateTime), EdFiEducationOrganizationReference educationOrganizationReference = default(EdFiEducationOrganizationReference), EdFiProgramReference programReference = default(EdFiProgramReference), EdFiStudentReference studentReference = default(EdFiStudentReference), bool? awaitingFosterCare = default(bool?), DateTime? endDate = default(DateTime?), string homelessPrimaryNighttimeResidenceDescriptor = default(string), List<EdFiStudentHomelessProgramAssociationHomelessProgramService> homelessProgramServices = default(List<EdFiStudentHomelessProgramAssociationHomelessProgramService>), bool? homelessUnaccompaniedYouth = default(bool?), List<EdFiGeneralStudentProgramAssociationProgramParticipationStatus> programParticipationStatuses = default(List<EdFiGeneralStudentProgramAssociationProgramParticipationStatus>), string reasonExitedDescriptor = default(string), bool? servedOutsideOfRegularSession = default(bool?), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
