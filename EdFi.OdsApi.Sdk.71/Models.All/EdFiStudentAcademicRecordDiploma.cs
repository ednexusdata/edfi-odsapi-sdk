...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiStudentAcademicRecordDiploma : IEquatable<EdFiStudentAcademicRecordDiploma>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // DiplomaDescription (string) minLength
            if (this.DiplomaDescription != null && this.DiplomaDescription.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DiplomaDescription, length must be greater than 1.", new [] { "DiplomaDescription" });
            }
