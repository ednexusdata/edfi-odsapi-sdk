...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_teachingCredentialDescriptor")]
    public partial class EdFiTeachingCredentialDescriptor : IEquatable<EdFiTeachingCredentialDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiTeachingCredentialDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiTeachingCredentialDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiTeachingCredentialDescriptor" /> class.
        /// </summary>
        ...
        public EdFiTeachingCredentialDescriptor(string id = default(string), int teachingCredentialDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiTeachingCredentialDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiTeachingCredentialDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiTeachingCredentialDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "teachingCredentialDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TeachingCredentialDescriptorId: ").Append(TeachingCredentialDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiTeachingCredentialDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiTeachingCredentialDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiTeachingCredentialDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiTeachingCredentialDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.TeachingCredentialDescriptorId == input.TeachingCredentialDescriptorId ||
                    this.TeachingCredentialDescriptorId.Equals(input.TeachingCredentialDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.TeachingCredentialDescriptorId.GetHashCode();
