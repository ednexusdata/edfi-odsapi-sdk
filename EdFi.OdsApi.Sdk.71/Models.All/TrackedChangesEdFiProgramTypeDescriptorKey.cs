...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_programTypeDescriptorKey")]
    public partial class TrackedChangesEdFiProgramTypeDescriptorKey : IEquatable<TrackedChangesEdFiProgramTypeDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiProgramTypeDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiProgramTypeDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiProgramTypeDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiProgramTypeDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiProgramTypeDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiProgramTypeDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiProgramTypeDescriptorKey input)
        {
            if (input == null)
            {
                return false;
