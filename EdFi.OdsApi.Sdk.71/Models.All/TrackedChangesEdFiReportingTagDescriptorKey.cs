...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_reportingTagDescriptorKey")]
    public partial class TrackedChangesEdFiReportingTagDescriptorKey : IEquatable<TrackedChangesEdFiReportingTagDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiReportingTagDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiReportingTagDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiReportingTagDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiReportingTagDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiReportingTagDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiReportingTagDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiReportingTagDescriptorKey input)
        {
            if (input == null)
            {
                return false;
