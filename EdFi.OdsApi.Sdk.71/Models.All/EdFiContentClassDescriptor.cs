...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_contentClassDescriptor")]
    public partial class EdFiContentClassDescriptor : IEquatable<EdFiContentClassDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiContentClassDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiContentClassDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiContentClassDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="contentClassDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiContentClassDescriptor(string id = default(string), int contentClassDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiContentClassDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiContentClassDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiContentClassDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "contentClassDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ContentClassDescriptorId: ").Append(ContentClassDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiContentClassDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiContentClassDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiContentClassDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiContentClassDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ContentClassDescriptorId == input.ContentClassDescriptorId ||
                    this.ContentClassDescriptorId.Equals(input.ContentClassDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ContentClassDescriptorId.GetHashCode();
