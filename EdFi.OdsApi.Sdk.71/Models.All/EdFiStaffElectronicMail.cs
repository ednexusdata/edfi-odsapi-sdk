...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiStaffElectronicMail : IEquatable<EdFiStaffElectronicMail>, IValidatableObject
    {
        ...
        public EdFiStaffElectronicMail(string electronicMailTypeDescriptor = default(string), string electronicMailAddress = default(string), bool? doNotPublishIndicator = default(bool?), bool? primaryEmailAddressIndicator = default(bool?))
        {
            ...
            {
                throw new ArgumentNullException("electronicMailTypeDescriptor is a required property for EdFiStaffElectronicMail and cannot be null");
            }
            this.ElectronicMailTypeDescriptor = electronicMailTypeDescriptor;
            // to ensure "electronicMailAddress" is required (not null)
            if (electronicMailAddress == null)
            {
                throw new ArgumentNullException("electronicMailAddress is a required property for EdFiStaffElectronicMail and cannot be null");
            }
