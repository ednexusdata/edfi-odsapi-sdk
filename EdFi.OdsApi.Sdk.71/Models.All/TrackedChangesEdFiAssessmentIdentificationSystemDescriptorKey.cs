...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_assessmentIdentificationSystemDescriptorKey")]
    public partial class TrackedChangesEdFiAssessmentIdentificationSystemDescriptorKey : IEquatable<TrackedChangesEdFiAssessmentIdentificationSystemDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiAssessmentIdentificationSystemDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiAssessmentIdentificationSystemDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiAssessmentIdentificationSystemDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiAssessmentIdentificationSystemDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiAssessmentIdentificationSystemDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiAssessmentIdentificationSystemDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiAssessmentIdentificationSystemDescriptorKey input)
        {
            if (input == null)
            {
                return false;
