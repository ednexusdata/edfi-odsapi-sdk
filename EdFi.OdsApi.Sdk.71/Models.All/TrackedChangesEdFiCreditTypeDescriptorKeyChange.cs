...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_creditTypeDescriptorKeyChange")]
    public partial class TrackedChangesEdFiCreditTypeDescriptorKeyChange : IEquatable<TrackedChangesEdFiCreditTypeDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiCreditTypeDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiCreditTypeDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiCreditTypeDescriptorKey oldKeyValues = default(TrackedChangesEdFiCreditTypeDescriptorKey), TrackedChangesEdFiCreditTypeDescriptorKey newKeyValues = default(TrackedChangesEdFiCreditTypeDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiCreditTypeDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiCreditTypeDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiCreditTypeDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiCreditTypeDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiCreditTypeDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiCreditTypeDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiCreditTypeDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
