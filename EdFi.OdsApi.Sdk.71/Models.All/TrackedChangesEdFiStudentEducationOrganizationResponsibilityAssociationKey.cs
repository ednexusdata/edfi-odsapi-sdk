...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TrackedChangesEdFiStudentEducationOrganizationResponsibilityAssociationKey : IEquatable<TrackedChangesEdFiStudentEducationOrganizationResponsibilityAssociationKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiStudentEducationOrganizationResponsibilityAssociationKey(string responsibilityDescriptor = default(string), DateTime beginDate = default(DateTime), long educationOrganizationId = default(long), string studentUniqueId = default(string))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStudentEducationOrganizationResponsibilityAssociationKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStudentEducationOrganizationResponsibilityAssociationKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStudentEducationOrganizationResponsibilityAssociationKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStudentEducationOrganizationResponsibilityAssociationKey input)
        {
            if (input == null)
            {
                return false;
