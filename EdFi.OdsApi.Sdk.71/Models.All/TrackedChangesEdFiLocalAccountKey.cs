...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_localAccountKey")]
    public partial class TrackedChangesEdFiLocalAccountKey : IEquatable<TrackedChangesEdFiLocalAccountKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiLocalAccountKey(string accountIdentifier = default(string), int fiscalYear = default(int), long educationOrganizationId = default(long))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiLocalAccountKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiLocalAccountKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiLocalAccountKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiLocalAccountKey input)
        {
            if (input == null)
            {
                return false;
