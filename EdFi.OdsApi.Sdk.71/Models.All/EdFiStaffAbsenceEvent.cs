...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiStaffAbsenceEvent : IEquatable<EdFiStaffAbsenceEvent>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // AbsenceEventReason (string) minLength
            if (this.AbsenceEventReason != null && this.AbsenceEventReason.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AbsenceEventReason, length must be greater than 1.", new [] { "AbsenceEventReason" });
            }
