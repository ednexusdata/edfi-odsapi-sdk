...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_sourceDimensionKeyChange")]
    public partial class TrackedChangesEdFiSourceDimensionKeyChange : IEquatable<TrackedChangesEdFiSourceDimensionKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiSourceDimensionKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiSourceDimensionKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiSourceDimensionKey oldKeyValues = default(TrackedChangesEdFiSourceDimensionKey), TrackedChangesEdFiSourceDimensionKey newKeyValues = default(TrackedChangesEdFiSourceDimensionKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiSourceDimensionKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiSourceDimensionKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiSourceDimensionKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSourceDimensionKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSourceDimensionKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSourceDimensionKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSourceDimensionKeyChange input)
        {
            if (input == null)
            {
                return false;
