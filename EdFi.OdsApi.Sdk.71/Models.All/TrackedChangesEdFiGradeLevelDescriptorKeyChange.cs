...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_gradeLevelDescriptorKeyChange")]
    public partial class TrackedChangesEdFiGradeLevelDescriptorKeyChange : IEquatable<TrackedChangesEdFiGradeLevelDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiGradeLevelDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiGradeLevelDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiGradeLevelDescriptorKey oldKeyValues = default(TrackedChangesEdFiGradeLevelDescriptorKey), TrackedChangesEdFiGradeLevelDescriptorKey newKeyValues = default(TrackedChangesEdFiGradeLevelDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiGradeLevelDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiGradeLevelDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiGradeLevelDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiGradeLevelDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiGradeLevelDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiGradeLevelDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiGradeLevelDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
