...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_tpdm_rubricDimensionKeyChange")]
    public partial class TrackedChangesTpdmRubricDimensionKeyChange : IEquatable<TrackedChangesTpdmRubricDimensionKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesTpdmRubricDimensionKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesTpdmRubricDimensionKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesTpdmRubricDimensionKey oldKeyValues = default(TrackedChangesTpdmRubricDimensionKey), TrackedChangesTpdmRubricDimensionKey newKeyValues = default(TrackedChangesTpdmRubricDimensionKey))
        {
            this.Id = id;
        ...
        public TrackedChangesTpdmRubricDimensionKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesTpdmRubricDimensionKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesTpdmRubricDimensionKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesTpdmRubricDimensionKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesTpdmRubricDimensionKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesTpdmRubricDimensionKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesTpdmRubricDimensionKeyChange input)
        {
            if (input == null)
            {
                return false;
