...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class EdFiEducationOrganizationInterventionPrescriptionAssociation : IEquatable<EdFiEducationOrganizationInterventionPrescriptionAssociation>, IValidatableObject
    {
        ...
        /// <param name="beginDate">The begin date of the period during which the intervention prescription is available..</param>
        /// <param name="endDate">The end date of the period during which the intervention prescription is available..</param>
        /// <param name="etag">A unique system-generated value that identifies the version of the resource..</param>
        /// <param name="lastModifiedDate">The date and time the resource was last modified..</param>
        public EdFiEducationOrganizationInterventionPrescriptionAssociation(string id = default(string), EdFiEducationOrganizationReference educationOrganizationReference = default(EdFiEducationOrganizationReference), EdFiInterventionPrescriptionReference interventionPrescriptionReference = default(EdFiInterventionPrescriptionReference), DateTime? beginDate = default(DateTime?), DateTime? endDate = default(DateTime?), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
        ...
        /// <summary>
        /// The begin date of the period during which the intervention prescription is available.
        /// </summary>
        /// <value>The begin date of the period during which the intervention prescription is available.</value>
        [DataMember(Name = "beginDate", EmitDefaultValue = true)]
        [JsonConverter(typeof(OpenAPIDateConverter))]
        public DateTime? BeginDate { get; set; }

        /// <summary>
        /// The end date of the period during which the intervention prescription is available.
        /// </summary>
        /// <value>The end date of the period during which the intervention prescription is available.</value>
