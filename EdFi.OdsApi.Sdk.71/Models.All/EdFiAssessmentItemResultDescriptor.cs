...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_assessmentItemResultDescriptor")]
    public partial class EdFiAssessmentItemResultDescriptor : IEquatable<EdFiAssessmentItemResultDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAssessmentItemResultDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiAssessmentItemResultDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAssessmentItemResultDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="assessmentItemResultDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiAssessmentItemResultDescriptor(string id = default(string), int assessmentItemResultDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiAssessmentItemResultDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiAssessmentItemResultDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiAssessmentItemResultDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "assessmentItemResultDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AssessmentItemResultDescriptorId: ").Append(AssessmentItemResultDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiAssessmentItemResultDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiAssessmentItemResultDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiAssessmentItemResultDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiAssessmentItemResultDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AssessmentItemResultDescriptorId == input.AssessmentItemResultDescriptorId ||
                    this.AssessmentItemResultDescriptorId.Equals(input.AssessmentItemResultDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.AssessmentItemResultDescriptorId.GetHashCode();
