...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_postSecondaryEventCategoryDescriptor")]
    public partial class EdFiPostSecondaryEventCategoryDescriptor : IEquatable<EdFiPostSecondaryEventCategoryDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiPostSecondaryEventCategoryDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiPostSecondaryEventCategoryDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiPostSecondaryEventCategoryDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="postSecondaryEventCategoryDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiPostSecondaryEventCategoryDescriptor(string id = default(string), int postSecondaryEventCategoryDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiPostSecondaryEventCategoryDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiPostSecondaryEventCategoryDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiPostSecondaryEventCategoryDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "postSecondaryEventCategoryDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PostSecondaryEventCategoryDescriptorId: ").Append(PostSecondaryEventCategoryDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiPostSecondaryEventCategoryDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiPostSecondaryEventCategoryDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiPostSecondaryEventCategoryDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiPostSecondaryEventCategoryDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.PostSecondaryEventCategoryDescriptorId == input.PostSecondaryEventCategoryDescriptorId ||
                    this.PostSecondaryEventCategoryDescriptorId.Equals(input.PostSecondaryEventCategoryDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.PostSecondaryEventCategoryDescriptorId.GetHashCode();
