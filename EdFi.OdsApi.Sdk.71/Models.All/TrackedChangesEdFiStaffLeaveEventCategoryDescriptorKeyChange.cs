...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_staffLeaveEventCategoryDescriptorKeyChange")]
    public partial class TrackedChangesEdFiStaffLeaveEventCategoryDescriptorKeyChange : IEquatable<TrackedChangesEdFiStaffLeaveEventCategoryDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiStaffLeaveEventCategoryDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiStaffLeaveEventCategoryDescriptorKey oldKeyValues = default(TrackedChangesEdFiStaffLeaveEventCategoryDescriptorKey), TrackedChangesEdFiStaffLeaveEventCategoryDescriptorKey newKeyValues = default(TrackedChangesEdFiStaffLeaveEventCategoryDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiStaffLeaveEventCategoryDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiStaffLeaveEventCategoryDescriptorKey NewKeyValues { get; set; }
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStaffLeaveEventCategoryDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStaffLeaveEventCategoryDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStaffLeaveEventCategoryDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStaffLeaveEventCategoryDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
