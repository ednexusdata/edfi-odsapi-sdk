...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TrackedChangesEdFiStudentGradebookEntryKey : IEquatable<TrackedChangesEdFiStudentGradebookEntryKey>, IValidatableObject
    {
        /// <summary>
        ...
        public TrackedChangesEdFiStudentGradebookEntryKey(string gradebookEntryIdentifier = default(string), string _namespace = default(string), string studentUniqueId = default(string))
        {
        ...
        {
            return this.Equals(input as TrackedChangesEdFiStudentGradebookEntryKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiStudentGradebookEntryKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiStudentGradebookEntryKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiStudentGradebookEntryKey input)
        {
            if (input == null)
            {
                return false;
