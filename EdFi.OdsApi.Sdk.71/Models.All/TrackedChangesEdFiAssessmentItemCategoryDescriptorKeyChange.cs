...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_assessmentItemCategoryDescriptorKeyChange")]
    public partial class TrackedChangesEdFiAssessmentItemCategoryDescriptorKeyChange : IEquatable<TrackedChangesEdFiAssessmentItemCategoryDescriptorKeyChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiAssessmentItemCategoryDescriptorKeyChange" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiAssessmentItemCategoryDescriptorKeyChange(string id = default(string), decimal changeVersion = default(decimal), TrackedChangesEdFiAssessmentItemCategoryDescriptorKey oldKeyValues = default(TrackedChangesEdFiAssessmentItemCategoryDescriptorKey), TrackedChangesEdFiAssessmentItemCategoryDescriptorKey newKeyValues = default(TrackedChangesEdFiAssessmentItemCategoryDescriptorKey))
        {
            this.Id = id;
        ...
        public TrackedChangesEdFiAssessmentItemCategoryDescriptorKey OldKeyValues { get; set; }

        /// <summary>
        /// Gets or Sets NewKeyValues
        /// </summary>
        [DataMember(Name = "newKeyValues", EmitDefaultValue = false)]
        public TrackedChangesEdFiAssessmentItemCategoryDescriptorKey NewKeyValues { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiAssessmentItemCategoryDescriptorKeyChange {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiAssessmentItemCategoryDescriptorKeyChange);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiAssessmentItemCategoryDescriptorKeyChange instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiAssessmentItemCategoryDescriptorKeyChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiAssessmentItemCategoryDescriptorKeyChange input)
        {
            if (input == null)
            {
                return false;
