...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_interventionEffectivenessRatingDescriptor")]
    public partial class EdFiInterventionEffectivenessRatingDescriptor : IEquatable<EdFiInterventionEffectivenessRatingDescriptor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiInterventionEffectivenessRatingDescriptor" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiInterventionEffectivenessRatingDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiInterventionEffectivenessRatingDescriptor" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="interventionEffectivenessRatingDescriptorId">A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table..</param>
        ...
        public EdFiInterventionEffectivenessRatingDescriptor(string id = default(string), int interventionEffectivenessRatingDescriptorId = default(int), string codeValue = default(string), string description = default(string), DateTime? effectiveBeginDate = default(DateTime?), DateTime? effectiveEndDate = default(DateTime?), string _namespace = default(string), int? priorDescriptorId = default(int?), string shortDescription = default(string), string etag = default(string), DateTime lastModifiedDate = default(DateTime))
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiInterventionEffectivenessRatingDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "_namespace" is required (not null)
            if (_namespace == null)
            {
                throw new ArgumentNullException("_namespace is a required property for EdFiInterventionEffectivenessRatingDescriptor and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiInterventionEffectivenessRatingDescriptor and cannot be null");
            }
        ...
        [DataMember(Name = "interventionEffectivenessRatingDescriptorId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  InterventionEffectivenessRatingDescriptorId: ").Append(InterventionEffectivenessRatingDescriptorId).Append("\n");
        ...
        {
            return this.Equals(input as EdFiInterventionEffectivenessRatingDescriptor);
        }

        /// <summary>
        /// Returns true if EdFiInterventionEffectivenessRatingDescriptor instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiInterventionEffectivenessRatingDescriptor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiInterventionEffectivenessRatingDescriptor input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.InterventionEffectivenessRatingDescriptorId == input.InterventionEffectivenessRatingDescriptorId ||
                    this.InterventionEffectivenessRatingDescriptorId.Equals(input.InterventionEffectivenessRatingDescriptorId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.InterventionEffectivenessRatingDescriptorId.GetHashCode();
