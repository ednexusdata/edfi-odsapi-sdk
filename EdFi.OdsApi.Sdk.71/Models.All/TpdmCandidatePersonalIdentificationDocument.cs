...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    public partial class TpdmCandidatePersonalIdentificationDocument : IEquatable<TpdmCandidatePersonalIdentificationDocument>, IValidatableObject
    {
        ...
        public TpdmCandidatePersonalIdentificationDocument(string identificationDocumentUseDescriptor = default(string), string personalInformationVerificationDescriptor = default(string), string issuerCountryDescriptor = default(string), DateTime? documentExpirationDate = default(DateTime?), string documentTitle = default(string), string issuerDocumentIdentificationCode = default(string), string issuerName = default(string))
        {
            ...
            {
                throw new ArgumentNullException("identificationDocumentUseDescriptor is a required property for TpdmCandidatePersonalIdentificationDocument and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("personalInformationVerificationDescriptor is a required property for TpdmCandidatePersonalIdentificationDocument and cannot be null");
            }
