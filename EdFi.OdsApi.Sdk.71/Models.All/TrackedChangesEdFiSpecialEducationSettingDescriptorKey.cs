...
namespace EdFi.OdsApi.Sdk.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_specialEducationSettingDescriptorKey")]
    public partial class TrackedChangesEdFiSpecialEducationSettingDescriptorKey : IEquatable<TrackedChangesEdFiSpecialEducationSettingDescriptorKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackedChangesEdFiSpecialEducationSettingDescriptorKey" /> class.
        /// </summary>
        ...
        public TrackedChangesEdFiSpecialEducationSettingDescriptorKey(string _namespace = default(string), string codeValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackedChangesEdFiSpecialEducationSettingDescriptorKey {\n");
        ...
        {
            return this.Equals(input as TrackedChangesEdFiSpecialEducationSettingDescriptorKey);
        }

        /// <summary>
        /// Returns true if TrackedChangesEdFiSpecialEducationSettingDescriptorKey instances are equal
        /// </summary>
        /// <param name="input">Instance of TrackedChangesEdFiSpecialEducationSettingDescriptorKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrackedChangesEdFiSpecialEducationSettingDescriptorKey input)
        {
            if (input == null)
            {
                return false;
